...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:sitemap="http://www.sitemaps.org/schemas/sitemap/0.9" xmlns:xhtml="http://www.w3.org/1999/xhtml">
  ...
  <xsl:template match="/">
    <html xmlns="http://www.w3.org/1999/xhtml">
      <head>
        <title>XML Sitemap - FomiPeek</title>
      ...
      <body>
        ...
        <div class="info">
          ...
          <p>This sitemap contains all pages available on FomiPeek. Search engines use this file to crawl and index the website.</p>
        </div>
        ...
        <div class="footer">
          <p>Generated by FomiPeek | <a href="https://formipeek.com" style="color: #2563eb;">Visit Website</a></p>
        </div>
      </body>
    </html>
  </xsl:template>

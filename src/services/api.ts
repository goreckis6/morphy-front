...
const PRODUCTION_DEFAULTS = [
  'https://api.morphyimg.com' // Production backend
];
...
class ApiService {
  ...
  async convertFile(file: File, options: ConversionOptions = {}): Promise<ConversionResult> {
    ...
    } else if (fileName.endsWith('.docx') && options.format === 'epub') {
      endpoint = '/convert/docx-to-epub/single';
    } else if (fileName.endsWith('.docx') && options.format === 'mobi') {
      endpoint = '/convert/docx-to-mobi/single';
    } else if (fileName.endsWith('.docx') && options.format === 'odt') {
      endpoint = '/convert/docx-to-odt/single';
    } else if (fileName.endsWith('.docx') && options.format === 'txt') {
      endpoint = '/convert/docx-to-txt/single';
    } else if (fileName.endsWith('.doc') && options.format === 'csv') {
      endpoint = '/convert/doc-to-csv/single';
    } else if (fileName.endsWith('.doc') && options.format === 'epub') {
      endpoint = '/convert/doc-to-epub/single';
    } else if (fileName.endsWith('.doc') && options.format === 'mobi') {
      endpoint = '/convert/doc-to-mobi/single';
    } else if (fileName.endsWith('.doc') && options.format === 'txt') {
  ...
  async convertBatch(files: File[], options: ConversionOptions = {}): Promise<BatchConversionResult> {
    ...
    } else if (firstFileName?.endsWith('.docx') && options.format === 'epub') {
      endpoint = '/convert/docx-to-epub/batch';
    } else if (firstFileName?.endsWith('.docx') && options.format === 'mobi') {
      endpoint = '/convert/docx-to-mobi/batch';
    } else if (firstFileName?.endsWith('.docx') && options.format === 'odt') {
      endpoint = '/convert/docx-to-odt/batch';
    } else if (firstFileName?.endsWith('.docx') && options.format === 'txt') {
      endpoint = '/convert/docx-to-txt/batch';
    } else if (firstFileName?.endsWith('.doc') && options.format === 'csv') {
      endpoint = '/convert/doc-to-csv/batch';
    } else if (firstFileName?.endsWith('.doc') && options.format === 'epub') {
      endpoint = '/convert/doc-to-epub/batch';
    } else if (firstFileName?.endsWith('.doc') && options.format === 'mobi') {
      endpoint = '/convert/doc-to-mobi/batch';
    } else if (firstFileName?.endsWith('.doc') && options.format === 'txt') {
    ...
    } else if ((firstFileName?.toLowerCase().endsWith('.heic') || firstFileName?.toLowerCase().endsWith('.heif')) && options.format === 'png') {
  ...
  async convertBatchCsvToXlsx(files: File[]): Promise<BatchConversionResult> {
    const formData = new FormData();
    
    console.log('API: Starting CSV to XLSX batch conversion with', files.length, 'files');

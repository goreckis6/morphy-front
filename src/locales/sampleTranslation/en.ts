...
export const en: SamplePageTranslations = {
  sample_page: {
    ...
    formats: {
      docx: {
        meta: {
          title: 'Free DOCX Sample Files Download - Test Files | FormiPeek',
      ...
      doc: {
        meta: {
          title: 'Free DOC Sample Files Download - Microsoft Word DOC Test Files | FormiPeek',
          description: 'Download free DOC sample files for testing document conversion tools. Multiple file sizes: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing DOC to PDF, DOC to DOCX converters, and legacy Microsoft Word document processing.',
          keywords: 'DOC sample files, test DOC files, download DOC samples, free DOC test files, Microsoft Word DOC samples, DOC to PDF converter test, DOC to DOCX conversion, legacy Word document samples, .doc test files, document conversion samples'
        },
        schema: {
          name: 'Free DOC Sample Files - Download Microsoft Word DOC Test Files',
          description: 'Download free DOC sample files for testing document conversion tools. Multiple file sizes: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing DOC to PDF, DOC to DOCX converters, and legacy Microsoft Word document processing.'
        },
        hero: {
          title: 'DOC Sample Files',
          description: 'Download free DOC sample files for testing. Multiple file sizes available to test your document conversion tools, DOC to PDF converters, and legacy Microsoft Word document processors.'
        },
        about_description: 'These are test DOC files in various sizes for testing purposes'
      },
      pdf: {
        meta: {
          title: 'Free PDF Sample Files Download - PDF Test Files for Conversion Tools | FormiPeek',
          description: 'Download free PDF sample files for testing PDF converters, viewers, and processors. Multiple file sizes: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing PDF to Word, PDF to JPG, PDF compression, and PDF editing tools.',
          keywords: 'PDF sample files, test PDF files, download PDF samples, free PDF test files, PDF converter test files, PDF to Word samples, PDF to JPG samples, PDF compression test, PDF viewer test files, .pdf test files, document conversion samples'
        },
        schema: {
          name: 'Free PDF Sample Files - Download PDF Test Files for Conversion Tools',
          description: 'Download free PDF sample files for testing PDF converters, viewers, and processors. Multiple file sizes: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing PDF to Word, PDF to JPG, PDF compression, and PDF editing tools.'
        },
        hero: {
          title: 'PDF Sample Files',
          description: 'Download free PDF sample files for testing. Multiple file sizes available to test your PDF converters, PDF to Word tools, PDF compression software, and PDF processing applications.'
        },
        about_description: 'These are test PDF files in various sizes for testing purposes'
      },
      odp: {
        meta: {
          title: 'Free ODP Sample Files Download - OpenDocument Presentation Test Files | FormiPeek',
          description: 'Download free ODP sample files for testing presentation conversion tools. Multiple file sizes: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing ODP to PPT, ODP to PDF converters, LibreOffice Impress files, and OpenDocument format processing.',
          keywords: 'ODP sample files, test ODP files, download ODP samples, free ODP test files, OpenDocument presentation samples, ODP to PPT converter, ODP to PDF converter, LibreOffice Impress samples, .odp test files, presentation conversion samples, OpenDocument format test'
        },
        schema: {
          name: 'Free ODP Sample Files - Download OpenDocument Presentation Test Files',
          description: 'Download free ODP sample files for testing presentation conversion tools. Multiple file sizes: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing ODP to PPT, ODP to PDF converters, LibreOffice Impress files, and OpenDocument format processing.'
        },
        hero: {
          title: 'ODP Sample Files',
          description: 'Download free ODP sample OpenDocument presentation files for testing. Multiple file sizes available to test your presentation conversion tools, ODP to PPT converters, and OpenDocument format processors.'
        },
        about_description: 'These are test ODP files in various sizes for testing purposes'
      },
      rtf: {
        meta: {
          title: 'Free RTF Sample Files Download - Rich Text Format Test Files | FormiPeek',
          description: 'Download free RTF sample files for testing Rich Text Format conversion tools. Multiple file sizes: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing RTF to DOC, RTF to PDF converters, word processor compatibility, and document format conversion.',
          keywords: 'RTF sample files, test RTF files, download RTF samples, free RTF test files, Rich Text Format samples, RTF to DOC converter, RTF to PDF converter, .rtf test files, word processor test files, document format conversion samples'
        },
        schema: {
          name: 'Free RTF Sample Files - Download Rich Text Format Test Files',
          description: 'Download free RTF sample files for testing Rich Text Format conversion tools. Multiple file sizes: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing RTF to DOC, RTF to PDF converters, word processor compatibility, and document format conversion.'
        },
        hero: {
          title: 'RTF Sample Files',
          description: 'Download free RTF sample Rich Text Format document files for testing. Multiple file sizes available to test your document conversion tools, RTF to DOC converters, and word processor compatibility.'
        },
        about_description: 'These are test RTF files in various sizes for testing purposes'
      },
      epub: {
        meta: {
          title: 'Free EPUB Sample Files Download - eBook Test Files for Readers | FormiPeek',
          description: 'Download free EPUB sample files for testing eBook readers and conversion tools. Multiple file sizes: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing EPUB readers, EPUB to PDF, EPUB to MOBI converters, digital publishing tools, and eBook format compatibility.',
          keywords: 'EPUB sample files, test EPUB files, download EPUB samples, free EPUB test files, eBook samples, EPUB reader test, EPUB to PDF converter, EPUB to MOBI converter, .epub test files, digital publishing samples, eBook format test files'
        },
        schema: {
          name: 'Free EPUB Sample Files - Download eBook Test Files for Readers',
          description: 'Download free EPUB sample files for testing eBook readers and conversion tools. Multiple file sizes: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing EPUB readers, EPUB to PDF, EPUB to MOBI converters, digital publishing tools, and eBook format compatibility.'
        },
        hero: {
          title: 'EPUB Sample Files',
          description: 'Download free EPUB sample eBook files for testing. Multiple file sizes available to test your eBook readers, EPUB to PDF converters, EPUB to MOBI tools, and digital publishing applications.'
        },
        about_description: 'These are test EPUB files in various sizes for testing purposes'
      },
      'invoice-pdf': {
        meta: {
          title: 'Free Invoice PDF Sample Files Download - Invoice Document Test Files | FormiPeek',
          description: 'Download free Invoice PDF sample files for testing invoice processing and parsing tools. Multiple file sizes: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing invoice OCR, invoice data extraction, invoice automation, PDF invoice parsing, and document management systems.',
          keywords: 'Invoice PDF sample files, test Invoice PDF files, download Invoice PDF samples, free Invoice PDF test files, invoice document samples, invoice OCR test, invoice data extraction, invoice automation test, PDF invoice parsing, invoice processing samples, document management test files'
        },
        schema: {
          name: 'Free Invoice PDF Sample Files - Download Invoice Document Test Files',
          description: 'Download free Invoice PDF sample files for testing invoice processing and parsing tools. Multiple file sizes: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing invoice OCR, invoice data extraction, invoice automation, PDF invoice parsing, and document management systems.'
        },
        hero: {
          title: 'Invoice PDF Sample Files',
          description: 'Download free Invoice PDF sample invoice document files for testing. Multiple file sizes available to test your invoice processing tools, invoice OCR software, invoice data extraction systems, and document management applications.'
        },
        about_description: 'These are test Invoice PDF files in various sizes for testing purposes'
      },
      mobi: {
        meta: {
          title: 'Free MOBI Sample Files Download - MOBI eBook Test Files for Kindle | FormiPeek',
          description: 'Download free MOBI sample files for testing MOBI eBook readers and conversion tools. Multiple file sizes: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing Kindle compatibility, MOBI to EPUB, MOBI to PDF converters, eBook format conversion, and digital reading applications.',
          keywords: 'MOBI sample files, test MOBI files, download MOBI samples, free MOBI test files, MOBI eBook samples, Kindle test files, MOBI to EPUB converter, MOBI to PDF converter, .mobi test files, eBook conversion samples, digital reading test files'
        },
        schema: {
          name: 'Free MOBI Sample Files - Download MOBI eBook Test Files for Kindle',
          description: 'Download free MOBI sample files for testing MOBI eBook readers and conversion tools. Multiple file sizes: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing Kindle compatibility, MOBI to EPUB, MOBI to PDF converters, eBook format conversion, and digital reading applications.'
        },
        hero: {
          title: 'MOBI Sample Files',
          description: 'Download free MOBI sample MOBI eBook files for testing. Multiple file sizes available to test your MOBI eBook readers, MOBI to EPUB converters, MOBI to PDF tools, and Kindle compatibility applications.'
        },
        about_description: 'These are test MOBI files in various sizes for testing purposes'
      },
      csv: {
        meta: {
          title: 'Free CSV Sample Files Download - CSV Test Files for Data Processing | FormiPeek',
          description: 'Download free CSV sample files for testing data processing and conversion tools. Multiple file sizes: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing CSV to Excel, CSV to JSON converters, data import tools, spreadsheet applications, and comma-separated values processing.',
          keywords: 'CSV sample files, test CSV files, download CSV samples, free CSV test files, CSV to Excel converter, CSV to JSON converter, comma separated values samples, data processing test files, spreadsheet import samples, .csv test files, data conversion samples'
        },
        schema: {
          name: 'Free CSV Sample Files - Download CSV Test Files for Data Processing',
          description: 'Download free CSV sample files for testing data processing and conversion tools. Multiple file sizes: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing CSV to Excel, CSV to JSON converters, data import tools, spreadsheet applications, and comma-separated values processing.'
        },
        hero: {
          title: 'CSV Sample Files',
          description: 'Download free CSV sample data files for testing. Multiple file sizes available to test your CSV conversion tools, CSV to Excel converters, data processing applications, and spreadsheet import software.'
        },
        about_description: 'These are test CSV files in various sizes for testing purposes'
      },
      xls: {
        meta: {
          title: 'Free XLS Sample Files Download - Microsoft Excel XLS Test Files | FormiPeek',
          description: 'Download free XLS sample files for testing Excel conversion and data processing tools. Multiple file sizes: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing XLS to XLSX, XLS to CSV, XLS to PDF converters, Excel data extraction, and legacy spreadsheet processing.',
          keywords: 'XLS sample files, test XLS files, download XLS samples, free XLS test files, Microsoft Excel XLS samples, XLS to XLSX converter, XLS to CSV converter, XLS to PDF converter, Excel data extraction, .xls test files, spreadsheet conversion samples'
        },
        schema: {
          name: 'Free XLS Sample Files - Download Microsoft Excel XLS Test Files',
          description: 'Download free XLS sample files for testing Excel conversion and data processing tools. Multiple file sizes: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing XLS to XLSX, XLS to CSV, XLS to PDF converters, Excel data extraction, and legacy spreadsheet processing.'
        },
        hero: {
          title: 'XLS Sample Files',
          description: 'Download free XLS sample Excel spreadsheet files for testing. Multiple file sizes available to test your Excel conversion tools, XLS to XLSX converters, data processing applications, and spreadsheet import software.'
        },
        about_description: 'These are test XLS files in various sizes for testing purposes'
      },
      xlsx: {
        meta: {
          title: 'Free XLSX Sample Files Download - Excel XLSX Test Files for Conversion Tools | FormiPeek',
          description: 'Download free XLSX sample files for testing Excel conversion and data processing tools. Multiple file sizes: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing XLSX to CSV, XLSX to PDF, XLSX to JSON converters, Excel data analysis, spreadsheet automation, and Office Open XML processing.',
          keywords: 'XLSX sample files, test XLSX files, download XLSX samples, free XLSX test files, Excel XLSX samples, XLSX to CSV converter, XLSX to PDF converter, XLSX to JSON converter, Excel data analysis, .xlsx test files, spreadsheet automation samples, Office Open XML samples'
        },
        schema: {
          name: 'Free XLSX Sample Files - Download Excel XLSX Test Files for Conversion Tools',
          description: 'Download free XLSX sample files for testing Excel conversion and data processing tools. Multiple file sizes: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing XLSX to CSV, XLSX to PDF, XLSX to JSON converters, Excel data analysis, spreadsheet automation, and Office Open XML processing.'
        },
        hero: {
          title: 'XLSX Sample Files',
          description: 'Download free XLSX sample Excel spreadsheet files for testing. Multiple file sizes available to test your Excel conversion tools, XLSX to CSV converters, data analysis applications, and spreadsheet automation software.'
        },
        about_description: 'These are test XLSX files in various sizes for testing purposes'
      },
      xml: {
        meta: {
          title: 'Free XML Sample Files Download - XML Test Files for Parsing and Conversion | FormiPeek',
          description: 'Download free XML sample files for testing XML parsing, conversion, and data processing tools. Multiple file sizes: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing XML to JSON, XML to CSV converters, XML validation, structured data processing, and markup language parsing.',
          keywords: 'XML sample files, test XML files, download XML samples, free XML test files, XML to JSON converter, XML to CSV converter, XML validation test, Extensible Markup Language samples, structured data samples, .xml test files, markup language parsing samples'
        },
        schema: {
          name: 'Free XML Sample Files - Download XML Test Files for Parsing and Conversion',
          description: 'Download free XML sample files for testing XML parsing, conversion, and data processing tools. Multiple file sizes: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing XML to JSON, XML to CSV converters, XML validation, structured data processing, and markup language parsing.'
        },
        hero: {
          title: 'XML Sample Files',
          description: 'Download free XML sample markup files for testing. Multiple file sizes available to test your XML parsing tools, XML to JSON converters, XML validation software, and structured data processing applications.'
        },
        about_description: 'These are test XML files in various sizes for testing purposes'
      },
      html: {
        meta: {
          title: 'Free HTML Sample Files Download - HTML Test Files for Web Development | FormiPeek',
          description: 'Download free HTML sample files for testing web development and HTML processing tools. Multiple file sizes: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing HTML to PDF, HTML to DOCX converters, HTML validation, web scraping, browser rendering, and HyperText Markup Language processing.',
          keywords: 'HTML sample files, test HTML files, download HTML samples, free HTML test files, HTML to PDF converter, HTML to DOCX converter, HTML validation test, HyperText Markup Language samples, web development samples, .html test files, web scraping samples, browser rendering test'
        },
        schema: {
          name: 'Free HTML Sample Files - Download HTML Test Files for Web Development',
          description: 'Download free HTML sample files for testing web development and HTML processing tools. Multiple file sizes: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing HTML to PDF, HTML to DOCX converters, HTML validation, web scraping, browser rendering, and HyperText Markup Language processing.'
        },
        hero: {
          title: 'HTML Sample Files',
          description: 'Download free HTML sample HyperText Markup Language files for testing. Multiple file sizes available to test your HTML parsing tools, HTML to PDF converters, HTML validation software, and web development applications.'
        },
        about_description: 'These are test HTML files in various sizes for testing purposes'
      },
      ods: {
        meta: {
          title: 'Free ODS Sample Files Download - OpenDocument Spreadsheet Test Files | FormiPeek',
          description: 'Download free ODS sample files for testing spreadsheet conversion and data processing tools. Multiple file sizes: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing ODS to Excel, ODS to CSV converters, LibreOffice Calc files, OpenDocument format processing, and spreadsheet data extraction.',
          keywords: 'ODS sample files, test ODS files, download ODS samples, free ODS test files, OpenDocument spreadsheet samples, ODS to Excel converter, ODS to CSV converter, LibreOffice Calc samples, .ods test files, spreadsheet conversion samples, OpenDocument format test'
        },
        schema: {
          name: 'Free ODS Sample Files - Download OpenDocument Spreadsheet Test Files',
          description: 'Download free ODS sample files for testing spreadsheet conversion and data processing tools. Multiple file sizes: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing ODS to Excel, ODS to CSV converters, LibreOffice Calc files, OpenDocument format processing, and spreadsheet data extraction.'
        },
        hero: {
          title: 'ODS Sample Files',
          description: 'Download free ODS sample OpenDocument spreadsheet files for testing. Multiple file sizes available to test your spreadsheet conversion tools, ODS to Excel converters, and OpenDocument format processors.'
        },
        about_description: 'These are test ODS files in various sizes for testing purposes'
      },
      'ansible-yml': {
        meta: {
          title: 'Free Ansible YML Sample Files Download - YAML Configuration Test Files | FormiPeek',
          description: 'Download free Ansible YML sample files for testing YAML parsing and configuration management tools. Multiple file sizes: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing Ansible playbooks, YAML validation, DevOps automation, configuration management systems, and infrastructure as code tools.',
          keywords: 'Ansible YML sample files, test YML files, download YML samples, free YML test files, Ansible playbook samples, YAML configuration samples, YAML validation test, DevOps automation samples, .yml test files, configuration management samples, infrastructure as code samples'
        },
        schema: {
          name: 'Free Ansible YML Sample Files - Download YAML Configuration Test Files',
          description: 'Download free Ansible YML sample files for testing YAML parsing and configuration management tools. Multiple file sizes: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing Ansible playbooks, YAML validation, DevOps automation, configuration management systems, and infrastructure as code tools.'
        },
        hero: {
      ...
      'api-response-json': {
        meta: {
          title: 'Free API Response JSON Sample Files Download - JSON Test Files for API Development | FormiPeek',
      ...
      'arduino-ino': {
        meta: {
          title: 'Free Arduino INO Sample Files Download - Arduino Sketch Test Files for Embedded Development | FormiPeek',
      ...
      bat: {
        meta: {
          title: 'Free BAT Sample Files Download - Batch Script Test Files for Windows Automation | FormiPeek',
      ...
      asc: {
        meta: {
          title: 'Free ASC Sample Files Download - ASCII Text Test Files for Text Processing | FormiPeek',
      ...
      bib: {
        meta: {
          title: 'Free BIB Sample Files Download - Bibliography Test Files for Academic Research | FormiPeek',
      ...
      c: {
        meta: {
          title: 'Free C Sample Files Download - C Programming Language Test Files for Development | FormiPeek',
      ...
      'can-log': {
        meta: {
          title: 'Free CAN Log Sample Files Download - Controller Area Network Test Files for Automotive | FormiPeek',
      ...
      cmd: {
        meta: {
          title: 'Free CMD Sample Files Download - Windows Command Script Test Files for Automation | FormiPeek',
      ...
      conf: {
        meta: {
          title: 'Free CONF Sample Files Download - Configuration File Test Files for System Setup | FormiPeek',
      ...
      'config-ini': {
        meta: {
          title: 'Free Config INI Sample Files Download - INI Configuration Test Files for Applications | FormiPeek',
      ...
      cpp: {
        meta: {
          title: 'Free CPP Sample Files Download - C++ Programming Language Test Files for Development | FormiPeek',
      ...
      h: {
        meta: {
          title: 'Free H Sample Files Download - C/C++ Header File Test Files for Programming | FormiPeek',
      ...
      hpp: {
        meta: {
          title: 'Free HPP Sample Files Download - C++ Header File Test Files for Modern C++ Development | FormiPeek',
      ...
      hex: {
        meta: {
          title: 'Free HEX Sample Files Download - Test Hexadecimal Files for Firmware & Embedded Development | FormiPeek',
      ...
      cs: {
        meta: {
          title: 'Free CS Sample Files Download - Test C# Source Code Files for .NET Development | FormiPeek',
      ...
      css: {
        meta: {
          title: 'Free CSS Sample Files Download - Test Cascading Style Sheets for Web Development | FormiPeek',
      ...
      csr: {
        meta: {
          title: 'Free CSR Sample Files Download - Test Certificate Signing Request Files for SSL/TLS | FormiPeek',
      ...
      'customer-database-sql': {
        meta: {
          title: 'Free Customer Database SQL Sample Files Download - Test SQL Database Files | FormiPeek',
      ...
      dbf: {
        meta: {
          title: 'Free DBF Sample Files Download - Test dBASE Database Files for Data Management | FormiPeek',
      ...
      dem: {
        meta: {
          title: 'Free DEM Sample Files Download - Test Digital Elevation Model Files for GIS & Mapping | FormiPeek',
      ...
      der: {
        meta: {
          title: 'Free DER Sample Files Download - Test Distinguished Encoding Rules Certificate Files | FormiPeek',
      ...
      dmp: {
        meta: {
          title: 'Free DMP Sample Files Download - Test Memory Dump Files for Debugging & Analysis | FormiPeek',
      ...
      'docker-compose-yml': {
        meta: {
          title: 'Free Docker Compose YML Sample Files Download - Test Docker Compose Configuration Files | FormiPeek',
      ...
      dockerfile: {
        meta: {
          title: 'Free Dockerfile Sample Files Download - Test Docker Container Build Files | FormiPeek',
      ...
      editorconfig: {
        meta: {
          title: 'Free EditorConfig Sample Files Download - Test Editor Configuration Files | FormiPeek',
      ...
      ini: {
        meta: {
          title: 'Free INI Sample Files Download - Test Configuration INI Files for Applications | FormiPeek',
      ...
      intelhex: {
        meta: {
          title: 'Free IntelHex Sample Files Download - Test Intel Hexadecimal Files for Firmware Development | FormiPeek',
      ...
      ipynb: {
        meta: {
          title: 'Free IPYNB Sample Files Download - Test Jupyter Notebook Files for Data Science | FormiPeek',
      ...
      java: {
        meta: {
          title: 'Free Java Sample Files Download - Test Java Source Code Files for Development | FormiPeek',
      ...
      jks: {
        meta: {
          title: 'Free JKS Sample Files Download - Test Java KeyStore Files for SSL/TLS Security | FormiPeek',
      ...
      json: {
        meta: {
          title: 'Free JSON Sample Files Download - Test JSON Data Files for Web Development | FormiPeek',
      ...
      jsonl: {
        meta: {
          title: 'Free JSONL Sample Files Download - Test JSON Lines Files for Data Processing | FormiPeek',
      ...
      js: {
        meta: {
          title: 'Free JS Sample Files Download - Test JavaScript Source Code Files for Web Development | FormiPeek',
      ...
      jsx: {
        meta: {
          title: 'Free JSX Sample Files Download - Test React JSX Files for Front-End Development | FormiPeek',
      ...
      jwt: {
        meta: {
          title: 'Free JWT Sample Files Download - Test JSON Web Token Files for API Security | FormiPeek',
      ...
      key: {
        meta: {
          title: 'Free KEY Sample Files Download - Test Private Key Files for SSL/TLS Security | FormiPeek',
      ...
      kml: {
        meta: {
          title: 'Free KML Sample Files Download - Test Keyhole Markup Language Files for GIS & Mapping | FormiPeek',
      ...
      kt: {
        meta: {
          title: 'Free KT Sample Files Download - Test Kotlin Source Code Files for Android Development | FormiPeek',
      ...
      log: {
        meta: {
          title: 'Free LOG Sample Files Download - Test Log Files for Debugging & System Analysis | FormiPeek',
      ...
      lua: {
        meta: {
          title: 'Free LUA Sample Files Download - Test Lua Script Files for Game Development & Automation | FormiPeek',
      ...
      m3u: {
        meta: {
          title: 'Free M3U Sample Files Download - Test M3U Playlist Files for Media Players | FormiPeek',
      ...
      m3u8: {
        meta: {
          title: 'Free M3U8 Sample Files Download - Test M3U8 HLS Playlist Files for Video Streaming | FormiPeek',
      ...
      makefile: {
        meta: {
          title: 'Free Makefile Sample Files Download - Test Makefile Build Configuration Files | FormiPeek',
      ...
      mbtiles: {
        meta: {
          title: 'Free MBTiles Sample Files Download - Test MBTiles Map Tile Database Files | FormiPeek',
      ...
      md: {
        meta: {
          title: 'Free MD Sample Files Download - Test Markdown Documentation Files | FormiPeek',
      ...
      mdx: {
        meta: {
          title: 'Free MDX Sample Files Download - Test MDX React Markdown Files for Documentation | FormiPeek',
      ...
      apk: {
        meta: {
          title: 'Free APK Sample Files Download - Test Android Application Package Files | FormiPeek',
      ...
      appimage: {
        meta: {
          title: 'Free AppImage Sample Files Download - Test Linux Portable Application Files | FormiPeek',
      ...
      elf: {
        meta: {
          title: 'Free ELF Sample Files Download - Test Executable and Linkable Format Files for Linux/Unix | FormiPeek',
      ...
      exe: {
        meta: {
          title: 'Free EXE Sample Files Download - Test Windows Executable Files | FormiPeek',
      ...
      ipa: {
        meta: {
          title: 'Free IPA Sample Files Download - Test iOS Application Package Files | FormiPeek',
      ...
      jar: {
        meta: {
          title: 'Free JAR Sample Files Download - Test Java Archive Files | FormiPeek',
      ...
      crx: {
        meta: {
          title: 'Free CRX Sample Files Download - Test Chrome Extension Package Files | FormiPeek',
      ...
      '3ds': {
        meta: {
          title: 'Free 3DS Sample Files Download - Test 3D Model Files for 3D Printing & Modeling | FormiPeek',
      ...
      '3mf': {
        meta: {
          title: 'Free 3MF Sample Files Download - Test 3D Manufacturing Format Files for 3D Printing | FormiPeek',
      ...
      ai: {
        meta: {
          title: 'Free AI Sample Files Download - Test Adobe Illustrator Vector Graphics Files | FormiPeek',
      ...
      ase: {
        meta: {
          title: 'Free ASE Sample Files Download - Test Aseprite Sprite Animation Files | FormiPeek',
      ...
      'animation-fbx': {
        meta: {
          title: 'Free Animation FBX Sample Files Download - Test Autodesk FBX 3D Animation Files | FormiPeek',
      ...
      assetbundle: {
        meta: {
          title: 'Free AssetBundle Sample Files Download - Test Unity AssetBundle Files for Game Development | FormiPeek',
      ...
      blend: {
        meta: {
          title: 'Free BLEND Sample Files Download - Test Blender 3D Project Files | FormiPeek',
      ...
      bvh: {
        meta: {
          title: 'Free BVH Sample Files Download - Test Biovision Hierarchy Motion Capture Files | FormiPeek',
      ...
      dwg: {
        meta: {
          title: 'Free DWG Sample Files Download - Test AutoCAD Drawing Files for CAD Design | FormiPeek',
      ...
      dxf: {
        meta: {
          title: 'Download Free DXF Sample Files - AutoCAD Drawing Exchange Format Test Files | FormiPeek',
      ...
      ifc: {
        meta: {
          title: 'Download Free IFC Sample Files - Industry Foundation Classes BIM Test Files | FormiPeek',
      ...
      iges: {
        meta: {
          title: 'Download Free IGES Sample Files - Initial Graphics Exchange Specification CAD Test Files | FormiPeek',
      ...
      igs: {
        meta: {
          title: 'Download Free IGS Sample Files - Initial Graphics Exchange Specification CAD Test Files | FormiPeek',
      ...
      las: {
        meta: {
          title: 'Download Free LAS Sample Files - LiDAR Point Cloud Data Test Files | FormiPeek',
      ...
      ma: {
        meta: {
          title: 'Download Free MA Sample Files - Maya ASCII Scene Test Files | FormiPeek',
      ...
      max: {
        meta: {
          title: 'Download Free MAX Sample Files - 3ds Max Scene Test Files | FormiPeek',
      ...
      mb: {
        meta: {
          title: 'Download Free MB Sample Files - Maya Binary Scene Test Files | FormiPeek',
      ...
      indd: {
        meta: {
          title: 'Download Free INDD Sample Files - Adobe InDesign Document Test Files | FormiPeek',
      ...
      'animated-gif': {
        meta: {
          title: 'Download Free Animated GIF Sample Files - Animated Image Test Files | FormiPeek',
      ...
      apng: {
        meta: {
          title: 'Download Free APNG Sample Files - Animated PNG Image Test Files | FormiPeek',
      ...
      avif: {
        meta: {
          title: 'Download Free AVIF Sample Files - AV1 Image File Format Test Files | FormiPeek',
      ...
      bmp: {
        meta: {
          title: 'Download Free BMP Sample Files - Bitmap Image Test Files | FormiPeek',
      ...
      'barcode-svg': {
        meta: {
          title: 'Download Free Barcode SVG Sample Files - Scalable Vector Barcode Test Files | FormiPeek',
      ...
      avi: {
        meta: {
          title: 'Download Free AVI Sample Files - Audio Video Interleave Video Test Files | FormiPeek',
      ...
      '3gp': {
        meta: {
          title: 'Download Free 3GP Sample Files - 3GPP Mobile Video Test Files | FormiPeek',
      ...
      dav: {
        meta: {
          title: 'Free DAV Sample Files Download - DAV Video Test Files for Security Cameras | FormiPeek',
      ...
      dds: {
        meta: {
          title: 'Free DDS Sample Files Download - DirectDraw Surface Texture Test Files | FormiPeek',
      ...
      dng: {
        meta: {
          title: 'Free DNG Sample Files Download - Digital Negative Raw Image Test Files | FormiPeek',
      ...
      eps: {
        meta: {
          title: 'Free EPS Sample Files Download - Encapsulated PostScript Vector Graphics Test Files | FormiPeek',
      ...
      exr: {
        meta: {
          title: 'Free EXR Sample Files Download - OpenEXR High Dynamic Range Image Test Files | FormiPeek',
      ...
      hdr: {
        meta: {
          title: 'Free HDR Sample Files Download - High Dynamic Range Image Test Files | FormiPeek',
      ...
      heic: {
        meta: {
          title: 'Free HEIC Sample Files Download - High Efficiency Image Container Test Files | FormiPeek',
      ...
      heif: {
        meta: {
          title: 'Free HEIF Sample Files Download - High Efficiency Image Format Test Files | FormiPeek',
      ...
      icns: {
        meta: {
          title: 'Free ICNS Sample Files Download - macOS Icon Test Files | FormiPeek',
      ...
      ico: {
        meta: {
          title: 'Free ICO Sample Files Download - Windows Icon Test Files | FormiPeek',
      ...
      jpeg: {
        meta: {
          title: 'Free JPEG Sample Files Download - JPEG Image Test Files for Conversion Tools | FormiPeek',
      ...
      jpg: {
        meta: {
          title: 'Free JPG Sample Files Download - JPG Image Test Files for Conversion Tools | FormiPeek',
      ...
      m4v: {
        meta: {
          title: 'Free M4V Sample Files Download - M4V Video Test Files for Conversion Tools | FormiPeek',
      ...
      mkv: {
        meta: {
          title: 'Free MKV Sample Files Download - Matroska Video Test Files for Conversion Tools | FormiPeek',
      ...
      aac: {
        meta: {
          title: 'Free AAC Sample Files Download - Advanced Audio Coding Test Files | FormiPeek',
      ...
      ac3: {
        meta: {
          title: 'Free AC3 Sample Files Download - Dolby Digital Audio Test Files | FormiPeek',
      ...
      aif: {
        meta: {
          title: 'Free AIF Sample Files Download - Audio Interchange File Format Test Files | FormiPeek',
      ...
      aiff: {
        meta: {
          title: 'Free AIFF Sample Files Download - Audio Interchange File Format Test Files | FormiPeek',
      ...
      amr: {
        meta: {
          title: 'Free AMR Sample Files Download - Adaptive Multi-Rate Audio Test Files | FormiPeek',
      ...
      caf: {
        meta: {
          title: 'Free CAF Sample Files Download - Core Audio Format Test Files | FormiPeek',
      ...
      cue: {
        meta: {
          title: 'Free CUE Sample Files Download - CUE Sheet Test Files for Audio CD Burning | FormiPeek',
      ...
      m4a: {
        meta: {
          title: 'Free M4A Sample Files Download - M4A Audio Test Files for Conversion Tools | FormiPeek',
      ...
      midi: {
        meta: {
          title: 'Free MIDI Sample Files Download - MIDI Music Test Files for Music Sequencing | FormiPeek',
      ...
      ace: {
        meta: {
          title: 'Free ACE Sample Files Download - ACE Archive Test Files for Extraction Tools | FormiPeek',
      ...
      arj: {
        meta: {
          title: 'Free ARJ Sample Files Download - ARJ Archive Test Files for Extraction Tools | FormiPeek',
      ...
      bz2: {
        meta: {
          title: 'Free BZ2 Sample Files Download - BZ2 Compressed Archive Test Files | FormiPeek',
      ...
      gz: {
        meta: {
          title: 'Free GZ Sample Files Download - GZ Gzip Compressed Archive Test Files | FormiPeek',
      ...
      cab: {
        meta: {
          title: 'Free CAB Sample Files Download - CAB Windows Cabinet Archive Test Files | FormiPeek',
      ...
      cpio: {
        meta: {
          title: 'Free CPIO Sample Files Download - CPIO Archive Test Files for Extraction Tools | FormiPeek',
      ...
      zip: {
        meta: {
          title: 'Free ZIP Sample Files Download - ZIP Archive Test Files for Extraction Tools | FormiPeek',
      ...
      dmg: {
        meta: {
          title: 'Free DMG Sample Files Download - DMG macOS Disk Image Test Files | FormiPeek',
      ...
      img: {
        meta: {
          title: 'Free IMG Sample Files Download - IMG Disk Image Test Files | FormiPeek',
      ...
      iso: {
        meta: {
          title: 'Free ISO Sample Files Download - ISO Disk Image Test Files | FormiPeek',
      ...
      kmz: {
        meta: {
          title: 'Free KMZ Sample Files Download - KMZ Compressed KML Test Files | FormiPeek',
      ...
      laz: {
        meta: {
          title: 'Free LAZ Sample Files Download - LAZ Compressed LiDAR Test Files | FormiPeek',
      ...
      lha: {
        meta: {
          title: 'Free LHA Sample Files Download - LHA Archive Test Files for Extraction Tools | FormiPeek',
      ...
      lzh: {
        meta: {
          title: 'Free LZH Sample Files Download - LZH Archive Test Files for Extraction Tools | FormiPeek',
      ...
      lzma: {
        meta: {
          title: 'Free LZMA Sample Files Download - LZMA Compressed Archive Test Files | FormiPeek',
      ...
      '7z': {
        meta: {
          title: 'Free 7Z Sample Files Download - 7Z Archive Test Files for Extraction Tools | FormiPeek',

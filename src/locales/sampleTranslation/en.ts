...
export const en: SamplePageTranslations = {
  sample_page: {
    ...
    formats: {
      docx: {
        meta: {
          title: 'Free DOCX Sample Files Download - Test Files | FomiPeek',
      ...
      doc: {
        meta: {
          title: 'Free DOC Sample Files Download - Microsoft Word DOC Test Files | FomiPeek',
      ...
      pdf: {
        meta: {
          title: 'Free PDF Sample Files Download - PDF Test Files for Conversion Tools | FomiPeek',
      ...
      odp: {
        meta: {
          title: 'Free ODP Sample Files Download - OpenDocument Presentation Test Files | FomiPeek',
      ...
      rtf: {
        meta: {
          title: 'Free RTF Sample Files Download - Rich Text Format Test Files | FomiPeek',
      ...
      epub: {
        meta: {
          title: 'Free EPUB Sample Files Download - eBook Test Files for Readers | FomiPeek',
      ...
      'invoice-pdf': {
        meta: {
          title: 'Free Invoice PDF Sample Files Download - Invoice Document Test Files | FomiPeek',
      ...
      mobi: {
        meta: {
          title: 'Free MOBI Sample Files Download - MOBI eBook Test Files for Kindle | FomiPeek',
      ...
      csv: {
        meta: {
          title: 'Free CSV Sample Files Download - CSV Test Files for Data Processing | FomiPeek',
      ...
      xls: {
        meta: {
          title: 'Free XLS Sample Files Download - Microsoft Excel XLS Test Files | FomiPeek',
      ...
      xlsx: {
        meta: {
          title: 'Free XLSX Sample Files Download - Excel XLSX Test Files for Conversion Tools | FomiPeek',
      ...
      xml: {
        meta: {
          title: 'Free XML Sample Files Download - XML Test Files for Parsing and Conversion | FomiPeek',
      ...
      html: {
        meta: {
          title: 'Free HTML Sample Files Download - HTML Test Files for Web Development | FomiPeek',
      ...
      ods: {
        meta: {
          title: 'Free ODS Sample Files Download - OpenDocument Spreadsheet Test Files | FomiPeek',
      ...
      'ansible-yml': {
        meta: {
          title: 'Free Ansible YML Sample Files Download - YAML Configuration Test Files | FomiPeek',
      ...
      'api-response-json': {
        meta: {
          title: 'Free API Response JSON Sample Files Download - JSON Test Files for API Development | FomiPeek',
      ...
      'arduino-ino': {
        meta: {
          title: 'Free Arduino INO Sample Files Download - Arduino Sketch Test Files for Embedded Development | FomiPeek',
      ...
      bat: {
        meta: {
          title: 'Free BAT Sample Files Download - Batch Script Test Files for Windows Automation | FomiPeek',
      ...
      asc: {
        meta: {
          title: 'Free ASC Sample Files Download - ASCII Text Test Files for Text Processing | FomiPeek',
      ...
      bib: {
        meta: {
          title: 'Free BIB Sample Files Download - Bibliography Test Files for Academic Research | FomiPeek',
      ...
      c: {
        meta: {
          title: 'Free C Sample Files Download - C Programming Language Test Files for Development | FomiPeek',
      ...
      'can-log': {
        meta: {
          title: 'Free CAN Log Sample Files Download - Controller Area Network Test Files for Automotive | FomiPeek',
      ...
      cmd: {
        meta: {
          title: 'Free CMD Sample Files Download - Windows Command Script Test Files for Automation | FomiPeek',
      ...
      conf: {
        meta: {
          title: 'Free CONF Sample Files Download - Configuration File Test Files for System Setup | FomiPeek',
      ...
      'config-ini': {
        meta: {
          title: 'Free Config INI Sample Files Download - INI Configuration Test Files for Applications | FomiPeek',
      ...
      cpp: {
        meta: {
          title: 'Free CPP Sample Files Download - C++ Programming Language Test Files for Development | FomiPeek',
      ...
      h: {
        meta: {
          title: 'Free H Sample Files Download - C/C++ Header File Test Files for Programming | FomiPeek',
      ...
      hpp: {
        meta: {
          title: 'Free HPP Sample Files Download - C++ Header File Test Files for Modern C++ Development | FomiPeek',
      ...
      hex: {
        meta: {
          title: 'Free HEX Sample Files Download - Test Hexadecimal Files for Firmware & Embedded Development | FomiPeek',
      ...
      cs: {
        meta: {
          title: 'Free CS Sample Files Download - Test C# Source Code Files for .NET Development | FomiPeek',
      ...
      css: {
        meta: {
          title: 'Free CSS Sample Files Download - Test Cascading Style Sheets for Web Development | FomiPeek',
      ...
      csr: {
        meta: {
          title: 'Free CSR Sample Files Download - Test Certificate Signing Request Files for SSL/TLS | FomiPeek',
      ...
      'customer-database-sql': {
        meta: {
          title: 'Free Customer Database SQL Sample Files Download - Test SQL Database Files | FomiPeek',
      ...
      dbf: {
        meta: {
          title: 'Free DBF Sample Files Download - Test dBASE Database Files for Data Management | FomiPeek',
      ...
      dem: {
        meta: {
          title: 'Free DEM Sample Files Download - Test Digital Elevation Model Files for GIS & Mapping | FomiPeek',
      ...
      der: {
        meta: {
          title: 'Free DER Sample Files Download - Test Distinguished Encoding Rules Certificate Files | FomiPeek',
      ...
      dmp: {
        meta: {
          title: 'Free DMP Sample Files Download - Test Memory Dump Files for Debugging & Analysis | FomiPeek',
      ...
      'docker-compose-yml': {
        meta: {
          title: 'Free Docker Compose YML Sample Files Download - Test Docker Compose Configuration Files | FomiPeek',
      ...
      dockerfile: {
        meta: {
          title: 'Free Dockerfile Sample Files Download - Test Docker Container Build Files | FomiPeek',
      ...
      editorconfig: {
        meta: {
          title: 'Free EditorConfig Sample Files Download - Test Editor Configuration Files | FomiPeek',
      ...
      ini: {
        meta: {
          title: 'Free INI Sample Files Download - Test Configuration INI Files for Applications | FomiPeek',
      ...
      intelhex: {
        meta: {
          title: 'Free IntelHex Sample Files Download - Test Intel Hexadecimal Files for Firmware Development | FomiPeek',
      ...
      ipynb: {
        meta: {
          title: 'Free IPYNB Sample Files Download - Test Jupyter Notebook Files for Data Science | FomiPeek',
      ...
      java: {
        meta: {
          title: 'Free Java Sample Files Download - Test Java Source Code Files for Development | FomiPeek',
      ...
      jks: {
        meta: {
          title: 'Free JKS Sample Files Download - Test Java KeyStore Files for SSL/TLS Security | FomiPeek',
      ...
      json: {
        meta: {
          title: 'Free JSON Sample Files Download - Test JSON Data Files for Web Development | FomiPeek',
      ...
      jsonl: {
        meta: {
          title: 'Free JSONL Sample Files Download - Test JSON Lines Files for Data Processing | FomiPeek',
      ...
      js: {
        meta: {
          title: 'Free JS Sample Files Download - Test JavaScript Source Code Files for Web Development | FomiPeek',
      ...
      jsx: {
        meta: {
          title: 'Free JSX Sample Files Download - Test React JSX Files for Front-End Development | FomiPeek',
      ...
      jwt: {
        meta: {
          title: 'Free JWT Sample Files Download - Test JSON Web Token Files for API Security | FomiPeek',
      ...
      key: {
        meta: {
          title: 'Free KEY Sample Files Download - Test Private Key Files for SSL/TLS Security | FomiPeek',
      ...
      kml: {
        meta: {
          title: 'Free KML Sample Files Download - Test Keyhole Markup Language Files for GIS & Mapping | FomiPeek',
      ...
      kt: {
        meta: {
          title: 'Free KT Sample Files Download - Test Kotlin Source Code Files for Android Development | FomiPeek',
      ...
      log: {
        meta: {
          title: 'Free LOG Sample Files Download - Test Log Files for Debugging & System Analysis | FomiPeek',
      ...
      lua: {
        meta: {
          title: 'Free LUA Sample Files Download - Test Lua Script Files for Game Development & Automation | FomiPeek',
      ...
      m3u: {
        meta: {
          title: 'Free M3U Sample Files Download - Test M3U Playlist Files for Media Players | FomiPeek',
      ...
      m3u8: {
        meta: {
          title: 'Free M3U8 Sample Files Download - Test M3U8 HLS Playlist Files for Video Streaming | FomiPeek',
      ...
      makefile: {
        meta: {
          title: 'Free Makefile Sample Files Download - Test Makefile Build Configuration Files | FomiPeek',
      ...
      mbtiles: {
        meta: {
          title: 'Free MBTiles Sample Files Download - Test MBTiles Map Tile Database Files | FomiPeek',
      ...
      md: {
        meta: {
          title: 'Free MD Sample Files Download - Test Markdown Documentation Files | FomiPeek',
      ...
      mdx: {
        meta: {
          title: 'Free MDX Sample Files Download - Test MDX React Markdown Files for Documentation | FomiPeek',
      ...
      apk: {
        meta: {
          title: 'Free APK Sample Files Download - Test Android Application Package Files | FomiPeek',
      ...
      appimage: {
        meta: {
          title: 'Free AppImage Sample Files Download - Test Linux Portable Application Files | FomiPeek',
      ...
      elf: {
        meta: {
          title: 'Free ELF Sample Files Download - Test Executable and Linkable Format Files for Linux/Unix | FomiPeek',
      ...
      exe: {
        meta: {
          title: 'Free EXE Sample Files Download - Test Windows Executable Files | FomiPeek',
      ...
      ipa: {
        meta: {
          title: 'Free IPA Sample Files Download - Test iOS Application Package Files | FomiPeek',
      ...
      jar: {
        meta: {
          title: 'Free JAR Sample Files Download - Test Java Archive Files | FomiPeek',
      ...
      crx: {
        meta: {
          title: 'Free CRX Sample Files Download - Test Chrome Extension Package Files | FomiPeek',
      ...
      '3ds': {
        meta: {
          title: 'Free 3DS Sample Files Download - Test 3D Model Files for 3D Printing & Modeling | FomiPeek',
      ...
      '3mf': {
        meta: {
          title: 'Free 3MF Sample Files Download - Test 3D Manufacturing Format Files for 3D Printing | FomiPeek',
      ...
      ai: {
        meta: {
          title: 'Free AI Sample Files Download - Test Adobe Illustrator Vector Graphics Files | FomiPeek',
      ...
      ase: {
        meta: {
          title: 'Free ASE Sample Files Download - Test Aseprite Sprite Animation Files | FomiPeek',
      ...
      'animation-fbx': {
        meta: {
          title: 'Free Animation FBX Sample Files Download - Test Autodesk FBX 3D Animation Files | FomiPeek',
      ...
      assetbundle: {
        meta: {
          title: 'Free AssetBundle Sample Files Download - Test Unity AssetBundle Files for Game Development | FomiPeek',
      ...
      blend: {
        meta: {
          title: 'Free BLEND Sample Files Download - Test Blender 3D Project Files | FomiPeek',
      ...
      bvh: {
        meta: {
          title: 'Free BVH Sample Files Download - Test Biovision Hierarchy Motion Capture Files | FomiPeek',
      ...
      dwg: {
        meta: {
          title: 'Free DWG Sample Files Download - Test AutoCAD Drawing Files for CAD Design | FomiPeek',
      ...
      dxf: {
        meta: {
          title: 'Download Free DXF Sample Files - AutoCAD Drawing Exchange Format Test Files | FomiPeek',
      ...
      ifc: {
        meta: {
          title: 'Download Free IFC Sample Files - Industry Foundation Classes BIM Test Files | FomiPeek',
      ...
      iges: {
        meta: {
          title: 'Download Free IGES Sample Files - Initial Graphics Exchange Specification CAD Test Files | FomiPeek',
      ...
      igs: {
        meta: {
          title: 'Download Free IGS Sample Files - Initial Graphics Exchange Specification CAD Test Files | FomiPeek',
      ...
      las: {
        meta: {
          title: 'Download Free LAS Sample Files - LiDAR Point Cloud Data Test Files | FomiPeek',
      ...
      ma: {
        meta: {
          title: 'Download Free MA Sample Files - Maya ASCII Scene Test Files | FomiPeek',
      ...
      max: {
        meta: {
          title: 'Download Free MAX Sample Files - 3ds Max Scene Test Files | FomiPeek',
      ...
      mb: {
        meta: {
          title: 'Download Free MB Sample Files - Maya Binary Scene Test Files | FomiPeek',
      ...
      indd: {
        meta: {
          title: 'Download Free INDD Sample Files - Adobe InDesign Document Test Files | FomiPeek',
      ...
      'animated-gif': {
        meta: {
          title: 'Download Free Animated GIF Sample Files - Animated Image Test Files | FomiPeek',
      ...
      apng: {
        meta: {
          title: 'Download Free APNG Sample Files - Animated PNG Image Test Files | FomiPeek',
      ...
      avif: {
        meta: {
          title: 'Download Free AVIF Sample Files - AV1 Image File Format Test Files | FomiPeek',
      ...
      bmp: {
        meta: {
          title: 'Download Free BMP Sample Files - Bitmap Image Test Files | FomiPeek',
      ...
      'barcode-svg': {
        meta: {
          title: 'Download Free Barcode SVG Sample Files - Scalable Vector Barcode Test Files | FomiPeek',
      ...
      avi: {
        meta: {
          title: 'Download Free AVI Sample Files - Audio Video Interleave Video Test Files | FomiPeek',
      ...
      '3gp': {
        meta: {
          title: 'Download Free 3GP Sample Files - 3GPP Mobile Video Test Files | FomiPeek',
      ...
      dav: {
        meta: {
          title: 'Free DAV Sample Files Download - DAV Video Test Files for Security Cameras | FomiPeek',
      ...
      dds: {
        meta: {
          title: 'Free DDS Sample Files Download - DirectDraw Surface Texture Test Files | FomiPeek',
      ...
      dng: {
        meta: {
          title: 'Free DNG Sample Files Download - Digital Negative Raw Image Test Files | FomiPeek',
      ...
      eps: {
        meta: {
          title: 'Free EPS Sample Files Download - Encapsulated PostScript Vector Graphics Test Files | FomiPeek',
      ...
      exr: {
        meta: {
          title: 'Free EXR Sample Files Download - OpenEXR High Dynamic Range Image Test Files | FomiPeek',
      ...
      hdr: {
        meta: {
          title: 'Free HDR Sample Files Download - High Dynamic Range Image Test Files | FomiPeek',
      ...
      heic: {
        meta: {
          title: 'Free HEIC Sample Files Download - High Efficiency Image Container Test Files | FomiPeek',
      ...
      heif: {
        meta: {
          title: 'Free HEIF Sample Files Download - High Efficiency Image Format Test Files | FomiPeek',
      ...
      icns: {
        meta: {
          title: 'Free ICNS Sample Files Download - macOS Icon Test Files | FomiPeek',
      ...
      ico: {
        meta: {
          title: 'Free ICO Sample Files Download - Windows Icon Test Files | FomiPeek',
      ...
      jpeg: {
        meta: {
          title: 'Free JPEG Sample Files Download - JPEG Image Test Files for Conversion Tools | FomiPeek',
      ...
      jpg: {
        meta: {
          title: 'Free JPG Sample Files Download - JPG Image Test Files for Conversion Tools | FomiPeek',
      ...
      m4v: {
        meta: {
          title: 'Free M4V Sample Files Download - M4V Video Test Files for Conversion Tools | FomiPeek',
      ...
      mkv: {
        meta: {
          title: 'Free MKV Sample Files Download - Matroska Video Test Files for Conversion Tools | FomiPeek',
      ...
      aac: {
        meta: {
          title: 'Free AAC Sample Files Download - Advanced Audio Coding Test Files | FomiPeek',
      ...
      ac3: {
        meta: {
          title: 'Free AC3 Sample Files Download - Dolby Digital Audio Test Files | FomiPeek',
      ...
      aif: {
        meta: {
          title: 'Free AIF Sample Files Download - Audio Interchange File Format Test Files | FomiPeek',
      ...
      aiff: {
        meta: {
          title: 'Free AIFF Sample Files Download - Audio Interchange File Format Test Files | FomiPeek',
      ...
      amr: {
        meta: {
          title: 'Free AMR Sample Files Download - Adaptive Multi-Rate Audio Test Files | FomiPeek',
      ...
      caf: {
        meta: {
          title: 'Free CAF Sample Files Download - Core Audio Format Test Files | FomiPeek',
      ...
      cue: {
        meta: {
          title: 'Free CUE Sample Files Download - CUE Sheet Test Files for Audio CD Burning | FomiPeek',
      ...
      m4a: {
        meta: {
          title: 'Free M4A Sample Files Download - M4A Audio Test Files for Conversion Tools | FomiPeek',
      ...
      midi: {
        meta: {
          title: 'Free MIDI Sample Files Download - MIDI Music Test Files for Music Sequencing | FomiPeek',
      ...
      ace: {
        meta: {
          title: 'Free ACE Sample Files Download - ACE Archive Test Files for Extraction Tools | FomiPeek',
      ...
      arj: {
        meta: {
          title: 'Free ARJ Sample Files Download - ARJ Archive Test Files for Extraction Tools | FomiPeek',
      ...
      bz2: {
        meta: {
          title: 'Free BZ2 Sample Files Download - BZ2 Compressed Archive Test Files | FomiPeek',
      ...
      gz: {
        meta: {
          title: 'Free GZ Sample Files Download - GZ Gzip Compressed Archive Test Files | FomiPeek',
      ...
      cab: {
        meta: {
          title: 'Free CAB Sample Files Download - CAB Windows Cabinet Archive Test Files | FomiPeek',
      ...
      cpio: {
        meta: {
          title: 'Free CPIO Sample Files Download - CPIO Archive Test Files for Extraction Tools | FomiPeek',
      ...
      zip: {
        meta: {
          title: 'Free ZIP Sample Files Download - ZIP Archive Test Files for Extraction Tools | FomiPeek',
      ...
      dmg: {
        meta: {
          title: 'Free DMG Sample Files Download - DMG macOS Disk Image Test Files | FomiPeek',
      ...
      img: {
        meta: {
          title: 'Free IMG Sample Files Download - IMG Disk Image Test Files | FomiPeek',
      ...
      iso: {
        meta: {
          title: 'Free ISO Sample Files Download - ISO Disk Image Test Files | FomiPeek',
      ...
      kmz: {
        meta: {
          title: 'Free KMZ Sample Files Download - KMZ Compressed KML Test Files | FomiPeek',
      ...
      laz: {
        meta: {
          title: 'Free LAZ Sample Files Download - LAZ Compressed LiDAR Test Files | FomiPeek',
      ...
      lha: {
        meta: {
          title: 'Free LHA Sample Files Download - LHA Archive Test Files for Extraction Tools | FomiPeek',
      ...
      lzh: {
        meta: {
          title: 'Free LZH Sample Files Download - LZH Archive Test Files for Extraction Tools | FomiPeek',
      ...
      lzma: {
        meta: {
          title: 'Free LZMA Sample Files Download - LZMA Compressed Archive Test Files | FomiPeek',
      ...
      '7z': {
        meta: {
          title: 'Free 7Z Sample Files Download - 7Z Archive Test Files for Extraction Tools | FomiPeek',

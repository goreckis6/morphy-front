...
export const de: SamplePageTranslations = {
  sample_page: {
    common: {
    ...
    formats: {
      docx: {
        meta: {
          title: 'Kostenlose DOCX Beispieldateien herunterladen – Testdateien | FormiPeek',
      ...
      doc: {
        meta: {
          title: 'Kostenlose DOC Beispieldateien herunterladen – Microsoft Word DOC Testdateien | FormiPeek',
          description: 'Laden Sie kostenlose DOC Beispieldateien zum Testen von Dokumentkonvertierungstools herunter. Verschiedene Dateigrößen verfügbar: 100 KB, 1 MB, 5 MB, 50 MB und 100 MB. Perfekt zum Testen von DOC zu PDF, DOC zu DOCX Konvertern und Legacy Microsoft Word Dokumentverarbeitung.',
          keywords: 'DOC Beispieldateien, DOC Testdateien, DOC Beispiele herunterladen, kostenlose DOC Testdateien, Microsoft Word DOC Beispiele, DOC zu PDF Konverter Test, DOC zu DOCX Konvertierung, Legacy Word Dokumentbeispiele, .doc Testdateien, Dokumentkonvertierungsbeispiele'
        },
        schema: {
          name: 'Kostenlose DOC Beispieldateien – Microsoft Word DOC Testdateien herunterladen',
          description: 'Laden Sie kostenlose DOC Beispieldateien zum Testen von Dokumentkonvertierungstools herunter. Verschiedene Dateigrößen verfügbar: 100 KB, 1 MB, 5 MB, 50 MB und 100 MB. Perfekt zum Testen von DOC zu PDF, DOC zu DOCX Konvertern und Legacy Microsoft Word Dokumentverarbeitung.'
        },
        hero: {
          title: 'DOC Beispieldateien',
          description: 'Laden Sie kostenlose DOC Beispieldateien zum Testen herunter. Verschiedene Dateigrößen verfügbar, um Ihre Dokumentkonvertierungstools, DOC zu PDF Konverter und Legacy Microsoft Word Dokumentprozessoren zu testen.'
        },
        about_description: 'Dies sind DOC Testdateien in verschiedenen Größen für Testzwecke'
      },
      pdf: {
        meta: {
          title: 'Kostenlose PDF Beispieldateien herunterladen – PDF Testdateien für Konvertierungstools | FormiPeek',
          description: 'Laden Sie kostenlose PDF Beispieldateien zum Testen von PDF-Konvertern, Viewern und Prozessoren herunter. Verschiedene Dateigrößen verfügbar: 100 KB, 1 MB, 5 MB, 50 MB und 100 MB. Perfekt zum Testen von PDF zu Word, PDF zu JPG, PDF-Komprimierung und PDF-Bearbeitungstools.',
          keywords: 'PDF Beispieldateien, PDF Testdateien, PDF Beispiele herunterladen, kostenlose PDF Testdateien, PDF Konverter Testdateien, PDF zu Word Beispiele, PDF zu JPG Beispiele, PDF Komprimierung Test, PDF Viewer Testdateien, .pdf Testdateien, Dokumentkonvertierungsbeispiele'
        },
        schema: {
          name: 'Kostenlose PDF Beispieldateien – PDF Testdateien für Konvertierungstools herunterladen',
          description: 'Laden Sie kostenlose PDF Beispieldateien zum Testen von PDF-Konvertern, Viewern und Prozessoren herunter. Verschiedene Dateigrößen verfügbar: 100 KB, 1 MB, 5 MB, 50 MB und 100 MB. Perfekt zum Testen von PDF zu Word, PDF zu JPG, PDF-Komprimierung und PDF-Bearbeitungstools.'
        },
        hero: {
          title: 'PDF Beispieldateien',
          description: 'Laden Sie kostenlose PDF Beispieldateien zum Testen herunter. Verschiedene Dateigrößen verfügbar, um Ihre PDF-Konverter, PDF zu Word Tools, PDF-Komprimierungssoftware und PDF-Verarbeitungsanwendungen zu testen.'
        },
        about_description: 'Dies sind PDF Testdateien in verschiedenen Größen für Testzwecke'
      },
      odp: {
        meta: {
          title: 'Kostenlose ODP Beispieldateien herunterladen – OpenDocument Präsentations-Testdateien | FormiPeek',
          description: 'Laden Sie kostenlose ODP Beispieldateien zum Testen von Präsentationskonvertierungstools herunter. Verschiedene Dateigrößen verfügbar: 100 KB, 1 MB, 5 MB, 50 MB und 100 MB. Perfekt zum Testen von ODP zu PPT, ODP zu PDF Konvertern, LibreOffice Impress Dateien und OpenDocument Formatverarbeitung.',
          keywords: 'ODP Beispieldateien, ODP Testdateien, ODP Beispiele herunterladen, kostenlose ODP Testdateien, OpenDocument Präsentationsbeispiele, ODP zu PPT Konverter, ODP zu PDF Konverter, LibreOffice Impress Beispiele, .odp Testdateien, Präsentationskonvertierungsbeispiele, OpenDocument Format Test'
        },
        schema: {
          name: 'Kostenlose ODP Beispieldateien – OpenDocument Präsentations-Testdateien herunterladen',
          description: 'Laden Sie kostenlose ODP Beispieldateien zum Testen von Präsentationskonvertierungstools herunter. Verschiedene Dateigrößen verfügbar: 100 KB, 1 MB, 5 MB, 50 MB und 100 MB. Perfekt zum Testen von ODP zu PPT, ODP zu PDF Konvertern, LibreOffice Impress Dateien und OpenDocument Formatverarbeitung.'
        },
        hero: {
          title: 'ODP Beispieldateien',
          description: 'Laden Sie kostenlose ODP Beispieldateien OpenDocument Präsentationen zum Testen herunter. Verschiedene Dateigrößen verfügbar, um Ihre Präsentationskonvertierungstools, ODP zu PPT Konverter und OpenDocument Formatprozessoren zu testen.'
        },
        about_description: 'Dies sind ODP Testdateien in verschiedenen Größen für Testzwecke'
      },
      rtf: {
        meta: {
          title: 'Kostenlose RTF Beispieldateien herunterladen – Rich Text Format Testdateien | FormiPeek',
          description: 'Laden Sie kostenlose RTF Beispieldateien zum Testen von Rich Text Format Konvertierungstools herunter. Verschiedene Dateigrößen verfügbar: 100 KB, 1 MB, 5 MB, 50 MB und 100 MB. Perfekt zum Testen von RTF zu DOC, RTF zu PDF Konvertern, Textverarbeitungskompatibilität und Dokumentformatkonvertierung.',
          keywords: 'RTF Beispieldateien, RTF Testdateien, RTF Beispiele herunterladen, kostenlose RTF Testdateien, Rich Text Format Beispiele, RTF zu DOC Konverter, RTF zu PDF Konverter, .rtf Testdateien, Textverarbeitungs-Testdateien, Dokumentformatkonvertierungsbeispiele'
        },
        schema: {
          name: 'Kostenlose RTF Beispieldateien – Rich Text Format Testdateien herunterladen',
          description: 'Laden Sie kostenlose RTF Beispieldateien zum Testen von Rich Text Format Konvertierungstools herunter. Verschiedene Dateigrößen verfügbar: 100 KB, 1 MB, 5 MB, 50 MB und 100 MB. Perfekt zum Testen von RTF zu DOC, RTF zu PDF Konvertern, Textverarbeitungskompatibilität und Dokumentformatkonvertierung.'
        },
        hero: {
          title: 'RTF Beispieldateien',
          description: 'Laden Sie kostenlose RTF Beispieldateien Rich Text Format Dokumente zum Testen herunter. Verschiedene Dateigrößen verfügbar, um Ihre Dokumentkonvertierungstools, RTF zu DOC Konverter und Textverarbeitungskompatibilität zu testen.'
        },
        about_description: 'Dies sind RTF Testdateien in verschiedenen Größen für Testzwecke'
      },
      epub: {
        meta: {
          title: 'Kostenlose EPUB Beispieldateien herunterladen – eBook Testdateien für Reader | FormiPeek',
          description: 'Laden Sie kostenlose EPUB Beispieldateien zum Testen von eBook-Readern und Konvertierungstools herunter. Verschiedene Dateigrößen verfügbar: 100 KB, 1 MB, 5 MB, 50 MB und 100 MB. Perfekt zum Testen von EPUB-Readern, EPUB zu PDF, EPUB zu MOBI Konvertern, digitalen Publikationstools und eBook-Formatkompatibilität.',
          keywords: 'EPUB Beispieldateien, EPUB Testdateien, EPUB Beispiele herunterladen, kostenlose EPUB Testdateien, eBook Beispiele, EPUB Reader Test, EPUB zu PDF Konverter, EPUB zu MOBI Konverter, .epub Testdateien, digitale Publikationsbeispiele, eBook Format Testdateien'
        },
        schema: {
          name: 'Kostenlose EPUB Beispieldateien – eBook Testdateien für Reader herunterladen',
          description: 'Laden Sie kostenlose EPUB Beispieldateien zum Testen von eBook-Readern und Konvertierungstools herunter. Verschiedene Dateigrößen verfügbar: 100 KB, 1 MB, 5 MB, 50 MB und 100 MB. Perfekt zum Testen von EPUB-Readern, EPUB zu PDF, EPUB zu MOBI Konvertern, digitalen Publikationstools und eBook-Formatkompatibilität.'
        },
        hero: {
          title: 'EPUB Beispieldateien',
          description: 'Laden Sie kostenlose EPUB Beispieldateien eBook-Dateien zum Testen herunter. Verschiedene Dateigrößen verfügbar, um Ihre eBook-Reader, EPUB zu PDF Konverter, EPUB zu MOBI Tools und digitale Publikationsanwendungen zu testen.'
        },
        about_description: 'Dies sind EPUB Testdateien in verschiedenen Größen für Testzwecke'
      },
      'invoice-pdf': {
        meta: {
          title: 'Kostenlose Rechnungs-PDF Beispieldateien herunterladen – Rechnungsdokument Testdateien | FormiPeek',
          description: 'Laden Sie kostenlose Rechnungs-PDF Beispieldateien zum Testen von Rechnungsverarbeitungs- und Parsing-Tools herunter. Verschiedene Dateigrößen verfügbar: 100 KB, 1 MB, 5 MB, 50 MB und 100 MB. Perfekt zum Testen von Rechnungs-OCR, Rechnungsdatenextraktion, Rechnungsautomatisierung, PDF-Rechnungsparsing und Dokumentmanagementsystemen.',
          keywords: 'Rechnungs-PDF Beispieldateien, Rechnungs-PDF Testdateien, Rechnungs-PDF Beispiele herunterladen, kostenlose Rechnungs-PDF Testdateien, Rechnungsdokumentbeispiele, Rechnungs-OCR Test, Rechnungsdatenextraktion, Rechnungsautomatisierung Test, PDF Rechnungsparsing, Rechnungsverarbeitungsbeispiele, Dokumentmanagement Testdateien'
        },
        schema: {
          name: 'Kostenlose Rechnungs-PDF Beispieldateien – Rechnungsdokument Testdateien herunterladen',
          description: 'Laden Sie kostenlose Rechnungs-PDF Beispieldateien zum Testen von Rechnungsverarbeitungs- und Parsing-Tools herunter. Verschiedene Dateigrößen verfügbar: 100 KB, 1 MB, 5 MB, 50 MB und 100 MB. Perfekt zum Testen von Rechnungs-OCR, Rechnungsdatenextraktion, Rechnungsautomatisierung, PDF-Rechnungsparsing und Dokumentmanagementsystemen.'
        },
        hero: {
          title: 'Rechnungs-PDF Beispieldateien',
          description: 'Laden Sie kostenlose Rechnungs-PDF Beispieldateien Rechnungsdokumente zum Testen herunter. Verschiedene Dateigrößen verfügbar, um Ihre Rechnungsverarbeitungstools, Rechnungs-OCR-Software, Rechnungsdatenextraktionssysteme und Dokumentmanagementanwendungen zu testen.'
        },
        about_description: 'Dies sind Rechnungs-PDF Testdateien in verschiedenen Größen für Testzwecke'
      },
      mobi: {
        meta: {
          title: 'Kostenlose MOBI Beispieldateien herunterladen – MOBI eBook Testdateien für Kindle | FormiPeek',
          description: 'Laden Sie kostenlose MOBI Beispieldateien zum Testen von MOBI eBook-Readern und Konvertierungstools herunter. Verschiedene Dateigrößen verfügbar: 100 KB, 1 MB, 5 MB, 50 MB und 100 MB. Perfekt zum Testen von Kindle-Kompatibilität, MOBI zu EPUB, MOBI zu PDF Konvertern, eBook-Formatkonvertierung und digitalen Leseanwendungen.',
          keywords: 'MOBI Beispieldateien, MOBI Testdateien, MOBI Beispiele herunterladen, kostenlose MOBI Testdateien, MOBI eBook Beispiele, Kindle Testdateien, MOBI zu EPUB Konverter, MOBI zu PDF Konverter, .mobi Testdateien, eBook Konvertierungsbeispiele, digitale Lese-Testdateien'
        },
        schema: {
          name: 'Kostenlose MOBI Beispieldateien – MOBI eBook Testdateien für Kindle herunterladen',
          description: 'Laden Sie kostenlose MOBI Beispieldateien zum Testen von MOBI eBook-Readern und Konvertierungstools herunter. Verschiedene Dateigrößen verfügbar: 100 KB, 1 MB, 5 MB, 50 MB und 100 MB. Perfekt zum Testen von Kindle-Kompatibilität, MOBI zu EPUB, MOBI zu PDF Konvertern, eBook-Formatkonvertierung und digitalen Leseanwendungen.'
        },
        hero: {
          title: 'MOBI Beispieldateien',
          description: 'Laden Sie kostenlose MOBI Beispieldateien MOBI eBook-Dateien zum Testen herunter. Verschiedene Dateigrößen verfügbar, um Ihre MOBI eBook-Reader, MOBI zu EPUB Konverter, MOBI zu PDF Tools und Kindle-Kompatibilitätsanwendungen zu testen.'
        },
        about_description: 'Dies sind MOBI Testdateien in verschiedenen Größen für Testzwecke'
      },
      csv: {
        meta: {
          title: 'Kostenlose CSV Beispieldateien herunterladen – CSV Testdateien für Datenverarbeitung | FormiPeek',
          description: 'Laden Sie kostenlose CSV Beispieldateien zum Testen von Datenverarbeitungs- und Konvertierungstools herunter. Verschiedene Dateigrößen: 100 KB, 1 MB, 5 MB, 50 MB und 100 MB. Perfekt zum Testen von CSV zu Excel, CSV zu JSON Konvertern, Datenimport-Tools, Tabellenkalkulationsanwendungen und Komma-getrennte Werte-Verarbeitung.',
          keywords: 'CSV Beispieldateien, CSV Testdateien, CSV Beispiele herunterladen, kostenlose CSV Testdateien, CSV zu Excel Konverter, CSV zu JSON Konverter, Komma-getrennte Werte Beispiele, Datenverarbeitung Testdateien, Tabellenkalkulationsimport Beispiele, .csv Testdateien, Datenkonvertierung Beispiele'
        },
        schema: {
          name: 'Kostenlose CSV Beispieldateien – CSV Testdateien für Datenverarbeitung herunterladen',
          description: 'Laden Sie kostenlose CSV Beispieldateien zum Testen von Datenverarbeitungs- und Konvertierungstools herunter. Verschiedene Dateigrößen: 100 KB, 1 MB, 5 MB, 50 MB und 100 MB. Perfekt zum Testen von CSV zu Excel, CSV zu JSON Konvertern, Datenimport-Tools, Tabellenkalkulationsanwendungen und Komma-getrennte Werte-Verarbeitung.'
        },
        hero: {
          title: 'CSV Beispieldateien',
          description: 'Laden Sie kostenlose CSV Beispieldateien zum Testen herunter. Verschiedene Dateigrößen verfügbar, um Ihre CSV-Konvertierungstools, CSV zu Excel Konverter, Datenverarbeitungsanwendungen und Tabellenkalkulationsimport-Software zu testen.'
        },
        about_description: 'Dies sind CSV Testdateien in verschiedenen Größen für Testzwecke'
      },
      xls: {
        meta: {
          title: 'Kostenlose XLS Beispieldateien herunterladen – Microsoft Excel XLS Testdateien | FormiPeek',
          description: 'Laden Sie kostenlose XLS Beispieldateien zum Testen von Excel-Konvertierungs- und Datenverarbeitungstools herunter. Verschiedene Dateigrößen: 100 KB, 1 MB, 5 MB, 50 MB und 100 MB. Perfekt zum Testen von XLS zu XLSX, XLS zu CSV, XLS zu PDF Konvertern, Excel-Datenextraktion und Legacy-Tabellenkalkulationsverarbeitung.',
          keywords: 'XLS Beispieldateien, XLS Testdateien, XLS Beispiele herunterladen, kostenlose XLS Testdateien, Microsoft Excel XLS Beispiele, XLS zu XLSX Konverter, XLS zu CSV Konverter, XLS zu PDF Konverter, Excel Datenextraktion, .xls Testdateien, Tabellenkalkulationskonvertierung Beispiele'
        },
        schema: {
          name: 'Kostenlose XLS Beispieldateien – Microsoft Excel XLS Testdateien herunterladen',
          description: 'Laden Sie kostenlose XLS Beispieldateien zum Testen von Excel-Konvertierungs- und Datenverarbeitungstools herunter. Verschiedene Dateigrößen: 100 KB, 1 MB, 5 MB, 50 MB und 100 MB. Perfekt zum Testen von XLS zu XLSX, XLS zu CSV, XLS zu PDF Konvertern, Excel-Datenextraktion und Legacy-Tabellenkalkulationsverarbeitung.'
        },
        hero: {
          title: 'XLS Beispieldateien',
          description: 'Laden Sie kostenlose XLS Excel-Tabellenkalkulations-Beispieldateien zum Testen herunter. Verschiedene Dateigrößen verfügbar, um Ihre Excel-Konvertierungstools, XLS zu XLSX Konverter, Datenverarbeitungsanwendungen und Tabellenkalkulationsimport-Software zu testen.'
        },
        about_description: 'Dies sind XLS Testdateien in verschiedenen Größen für Testzwecke'
      },
      xlsx: {
        meta: {
          title: 'Kostenlose XLSX Beispieldateien herunterladen – Excel XLSX Testdateien für Konvertierungstools | FormiPeek',
          description: 'Laden Sie kostenlose XLSX Beispieldateien zum Testen von Excel-Konvertierungs- und Datenverarbeitungstools herunter. Verschiedene Dateigrößen: 100 KB, 1 MB, 5 MB, 50 MB und 100 MB. Perfekt zum Testen von XLSX zu CSV, XLSX zu PDF, XLSX zu JSON Konvertern, Excel-Datenanalyse, Tabellenkalkulationsautomatisierung und Office Open XML-Verarbeitung.',
          keywords: 'XLSX Beispieldateien, XLSX Testdateien, XLSX Beispiele herunterladen, kostenlose XLSX Testdateien, Excel XLSX Beispiele, XLSX zu CSV Konverter, XLSX zu PDF Konverter, XLSX zu JSON Konverter, Excel Datenanalyse, .xlsx Testdateien, Tabellenkalkulationsautomatisierung Beispiele, Office Open XML Beispiele'
        },
        schema: {
          name: 'Kostenlose XLSX Beispieldateien – Excel XLSX Testdateien für Konvertierungstools herunterladen',
          description: 'Laden Sie kostenlose XLSX Beispieldateien zum Testen von Excel-Konvertierungs- und Datenverarbeitungstools herunter. Verschiedene Dateigrößen: 100 KB, 1 MB, 5 MB, 50 MB und 100 MB. Perfekt zum Testen von XLSX zu CSV, XLSX zu PDF, XLSX zu JSON Konvertern, Excel-Datenanalyse, Tabellenkalkulationsautomatisierung und Office Open XML-Verarbeitung.'
        },
        hero: {
          title: 'XLSX Beispieldateien',
          description: 'Laden Sie kostenlose XLSX Excel-Tabellenkalkulations-Beispieldateien zum Testen herunter. Verschiedene Dateigrößen verfügbar, um Ihre Excel-Konvertierungstools, XLSX zu CSV Konverter, Datenanalyseanwendungen und Tabellenkalkulationsautomatisierungs-Software zu testen.'
        },
        about_description: 'Dies sind XLSX Testdateien in verschiedenen Größen für Testzwecke'
      },
      xml: {
        meta: {
          title: 'Kostenlose XML Beispieldateien herunterladen – XML Testdateien für Parsing und Konvertierung | FormiPeek',
          description: 'Laden Sie kostenlose XML Beispieldateien zum Testen von XML-Parsing, Konvertierung und Datenverarbeitungstools herunter. Verschiedene Dateigrößen: 100 KB, 1 MB, 5 MB, 50 MB und 100 MB. Perfekt zum Testen von XML zu JSON, XML zu CSV Konvertern, XML-Validierung, strukturierte Datenverarbeitung und Markup-Sprache-Parsing.',
          keywords: 'XML Beispieldateien, XML Testdateien, XML Beispiele herunterladen, kostenlose XML Testdateien, XML zu JSON Konverter, XML zu CSV Konverter, XML Validierungstest, Extensible Markup Language Beispiele, strukturierte Daten Beispiele, .xml Testdateien, Markup-Sprache-Parsing Beispiele'
        },
        schema: {
          name: 'Kostenlose XML Beispieldateien – XML Testdateien für Parsing und Konvertierung herunterladen',
          description: 'Laden Sie kostenlose XML Beispieldateien zum Testen von XML-Parsing, Konvertierung und Datenverarbeitungstools herunter. Verschiedene Dateigrößen: 100 KB, 1 MB, 5 MB, 50 MB und 100 MB. Perfekt zum Testen von XML zu JSON, XML zu CSV Konvertern, XML-Validierung, strukturierte Datenverarbeitung und Markup-Sprache-Parsing.'
        },
        hero: {
          title: 'XML Beispieldateien',
          description: 'Laden Sie kostenlose XML Beispieldateien zum Testen herunter. Verschiedene Dateigrößen verfügbar, um Ihre XML-Parsing-Tools, XML zu JSON Konverter, XML-Validierungssoftware und strukturierte Datenverarbeitungsanwendungen zu testen.'
        },
        about_description: 'Dies sind XML Testdateien in verschiedenen Größen für Testzwecke'
      },
      html: {
        meta: {
          title: 'Kostenlose HTML Beispieldateien herunterladen – HTML Testdateien für Webentwicklung | FormiPeek',
          description: 'Laden Sie kostenlose HTML Beispieldateien zum Testen von Webentwicklungs- und HTML-Verarbeitungstools herunter. Verschiedene Dateigrößen: 100 KB, 1 MB, 5 MB, 50 MB und 100 MB. Perfekt zum Testen von HTML zu PDF, HTML zu DOCX Konvertern, HTML-Validierung, Web-Scraping, Browser-Rendering und HyperText Markup Language-Verarbeitung.',
          keywords: 'HTML Beispieldateien, HTML Testdateien, HTML Beispiele herunterladen, kostenlose HTML Testdateien, HTML zu PDF Konverter, HTML zu DOCX Konverter, HTML Validierungstest, HyperText Markup Language Beispiele, Webentwicklung Beispiele, .html Testdateien, Web-Scraping Beispiele, Browser-Rendering Test'
        },
        schema: {
          name: 'Kostenlose HTML Beispieldateien – HTML Testdateien für Webentwicklung herunterladen',
          description: 'Laden Sie kostenlose HTML Beispieldateien zum Testen von Webentwicklungs- und HTML-Verarbeitungstools herunter. Verschiedene Dateigrößen: 100 KB, 1 MB, 5 MB, 50 MB und 100 MB. Perfekt zum Testen von HTML zu PDF, HTML zu DOCX Konvertern, HTML-Validierung, Web-Scraping, Browser-Rendering und HyperText Markup Language-Verarbeitung.'
        },
        hero: {
          title: 'HTML Beispieldateien',
          description: 'Laden Sie kostenlose HTML HyperText Markup Language Beispieldateien zum Testen herunter. Verschiedene Dateigrößen verfügbar, um Ihre HTML-Parsing-Tools, HTML zu PDF Konverter, HTML-Validierungssoftware und Webentwicklungsanwendungen zu testen.'
        },
        about_description: 'Dies sind HTML Testdateien in verschiedenen Größen für Testzwecke'
      },
      ods: {
        meta: {
          title: 'Kostenlose ODS Beispieldateien herunterladen – OpenDocument Tabellenkalkulations-Testdateien | FormiPeek',
          description: 'Laden Sie kostenlose ODS Beispieldateien zum Testen von Tabellenkalkulationskonvertierungs- und Datenverarbeitungstools herunter. Verschiedene Dateigrößen: 100 KB, 1 MB, 5 MB, 50 MB und 100 MB. Perfekt zum Testen von ODS zu Excel, ODS zu CSV Konvertern, LibreOffice Calc-Dateien, OpenDocument-Format-Verarbeitung und Tabellenkalkulationsdatenextraktion.',
          keywords: 'ODS Beispieldateien, ODS Testdateien, ODS Beispiele herunterladen, kostenlose ODS Testdateien, OpenDocument Tabellenkalkulations-Beispiele, ODS zu Excel Konverter, ODS zu CSV Konverter, LibreOffice Calc Beispiele, .ods Testdateien, Tabellenkalkulationskonvertierung Beispiele, OpenDocument Format Test'
        },
        schema: {
          name: 'Kostenlose ODS Beispieldateien – OpenDocument Tabellenkalkulations-Testdateien herunterladen',
          description: 'Laden Sie kostenlose ODS Beispieldateien zum Testen von Tabellenkalkulationskonvertierungs- und Datenverarbeitungstools herunter. Verschiedene Dateigrößen: 100 KB, 1 MB, 5 MB, 50 MB und 100 MB. Perfekt zum Testen von ODS zu Excel, ODS zu CSV Konvertern, LibreOffice Calc-Dateien, OpenDocument-Format-Verarbeitung und Tabellenkalkulationsdatenextraktion.'
        },
        hero: {
          title: 'ODS Beispieldateien',
          description: 'Laden Sie kostenlose ODS OpenDocument Tabellenkalkulations-Beispieldateien zum Testen herunter. Verschiedene Dateigrößen verfügbar, um Ihre Tabellenkalkulationskonvertierungstools, ODS zu Excel Konverter und OpenDocument-Format-Prozessoren zu testen.'
        },
        about_description: 'Dies sind ODS Testdateien in verschiedenen Größen für Testzwecke'
      },
      'ansible-yml': {
        meta: {
          title: 'Kostenlose Ansible YML Beispieldateien herunterladen – YAML Konfigurations-Testdateien | FormiPeek',
          description: 'Laden Sie kostenlose Ansible YML Beispieldateien zum Testen von YAML-Parsing und Konfigurationsverwaltungstools herunter. Verschiedene Dateigrößen: 100 KB, 1 MB, 5 MB, 50 MB und 100 MB. Perfekt zum Testen von Ansible Playbooks, YAML-Validierung, DevOps-Automatisierung, Konfigurationsverwaltungssystemen und Infrastructure as Code-Tools.',
          keywords: 'Ansible YML Beispieldateien, YML Testdateien, YML Beispiele herunterladen, kostenlose YML Testdateien, Ansible Playbook Beispiele, YAML Konfigurations-Beispiele, YAML Validierungstest, DevOps Automatisierung Beispiele, .yml Testdateien, Konfigurationsverwaltung Beispiele, Infrastructure as Code Beispiele'
        },
        schema: {
          name: 'Kostenlose Ansible YML Beispieldateien – YAML Konfigurations-Testdateien herunterladen',
          description: 'Laden Sie kostenlose Ansible YML Beispieldateien zum Testen von YAML-Parsing und Konfigurationsverwaltungstools herunter. Verschiedene Dateigrößen: 100 KB, 1 MB, 5 MB, 50 MB und 100 MB. Perfekt zum Testen von Ansible Playbooks, YAML-Validierung, DevOps-Automatisierung, Konfigurationsverwaltungssystemen und Infrastructure as Code-Tools.'
        },
        hero: {
      ...
      'api-response-json': {
        meta: {
          title: 'Kostenlose API Response JSON Beispieldateien – JSON-Testdateien für API-Entwicklung | FormiPeek',
      ...
      'arduino-ino': {
        meta: {
          title: 'Kostenlose Arduino INO Beispieldateien – Arduino Sketch Testdateien für Embedded-Entwicklung | FormiPeek',
      ...
      bat: {
        meta: {
          title: 'Kostenlose BAT Beispieldateien – Batch-Skript Testdateien für Windows-Automatisierung | FormiPeek',
      ...
      asc: {
        meta: {
          title: 'Kostenlose ASC Beispieldateien – ASCII-Text Testdateien für Textverarbeitung | FormiPeek',
      ...
      bib: {
        meta: {
          title: 'Kostenlose BIB Beispieldateien – Bibliographie Testdateien für akademische Forschung | FormiPeek',
      ...
      c: {
        meta: {
          title: 'Kostenlose C Beispieldateien – C-Programmiersprache Testdateien für Entwicklung | FormiPeek',
      ...
      'can-log': {
        meta: {
          title: 'Kostenlose CAN Log Beispieldateien – Controller Area Network Testdateien für Automobil | FormiPeek',
      ...
      cmd: {
        meta: {
          title: 'Kostenlose CMD Beispieldateien – Windows-Befehlsskript Testdateien für Automatisierung | FormiPeek',
      ...
      conf: {
        meta: {
          title: 'Kostenlose CONF Beispieldateien – Konfigurationsdatei Testdateien für Systemeinrichtung | FormiPeek',
      ...
      'config-ini': {
        meta: {
          title: 'Kostenlose Config INI Beispieldateien – INI-Konfiguration Testdateien für Anwendungen | FormiPeek',
      ...
      cpp: {
        meta: {
          title: 'Kostenlose CPP Beispieldateien – C++ Programmiersprache Testdateien für Entwicklung | FormiPeek',
      ...
      h: {
        meta: {
          title: 'Kostenlose H Beispieldateien – C/C++ Header-Datei Testdateien für Programmierung | FormiPeek',
      ...
      hpp: {
        meta: {
          title: 'Kostenlose HPP Beispieldateien – C++ Header-Datei Testdateien für moderne C++-Entwicklung | FormiPeek',
      ...
      hex: {
        meta: {
          title: 'Kostenlose HEX-Beispieldateien herunterladen - Test-Hexadezimaldateien für Firmware & Embedded-Entwicklung | FormiPeek',
      ...
      cs: {
        meta: {
          title: 'Kostenlose CS-Beispieldateien herunterladen - Test-C#-Quellcodedateien für .NET-Entwicklung | FormiPeek',
      ...
      css: {
        meta: {
          title: 'Kostenlose CSS-Beispieldateien herunterladen - Test-Cascading Style Sheets für Webentwicklung | FormiPeek',
      ...
      csr: {
        meta: {
          title: 'Kostenlose CSR-Beispieldateien herunterladen - Test-Zertifikatsignaturanfrage-Dateien für SSL/TLS | FormiPeek',
      ...
      'customer-database-sql': {
        meta: {
          title: 'Kostenlose Customer Database SQL-Beispieldateien herunterladen - Test-SQL-Datenbankdateien | FormiPeek',
      ...
      dbf: {
        meta: {
          title: 'Kostenlose DBF-Beispieldateien herunterladen - Test-dBASE-Datenbankdateien für Datenverwaltung | FormiPeek',
      ...
      dem: {
        meta: {
          title: 'Kostenlose DEM-Beispieldateien herunterladen - Test-Digital Elevation Model-Dateien für GIS & Kartierung | FormiPeek',
      ...
      der: {
        meta: {
          title: 'Kostenlose DER-Beispieldateien herunterladen - Test-Distinguished Encoding Rules-Zertifikatsdateien | FormiPeek',
      ...
      dmp: {
        meta: {
          title: 'Kostenlose DMP-Beispieldateien herunterladen - Test-Speicherabbilddateien für Debugging & Analyse | FormiPeek',
      ...
      'docker-compose-yml': {
        meta: {
          title: 'Kostenlose Docker Compose YML-Beispieldateien herunterladen - Test-Docker Compose-Konfigurationsdateien | FormiPeek',
      ...
      dockerfile: {
        meta: {
          title: 'Kostenlose Dockerfile-Beispieldateien herunterladen - Test-Docker-Container-Build-Dateien | FormiPeek',
      ...
      editorconfig: {
        meta: {
          title: 'Kostenlose EditorConfig-Beispieldateien herunterladen - Test-Editor-Konfigurationsdateien | FormiPeek',
      ...
      ini: {
        meta: {
          title: 'Kostenlose INI-Beispieldateien herunterladen - Test-Konfigurations-INI-Dateien für Anwendungen | FormiPeek',
      ...
      intelhex: {
        meta: {
          title: 'Kostenlose IntelHex-Beispieldateien herunterladen - Test-Intel-Hexadezimaldateien für Firmware-Entwicklung | FormiPeek',
      ...
      ipynb: {
        meta: {
          title: 'Kostenlose IPYNB-Beispieldateien herunterladen - Test-Jupyter Notebook-Dateien für Data Science | FormiPeek',
      ...
      java: {
        meta: {
          title: 'Kostenlose Java-Beispieldateien herunterladen - Test-Java-Quellcodedateien für Entwicklung | FormiPeek',
      ...
      jks: {
        meta: {
          title: 'Kostenlose JKS-Beispieldateien herunterladen - Test-Java KeyStore-Dateien für SSL/TLS-Sicherheit | FormiPeek',
      ...
      json: {
        meta: {
          title: 'Kostenlose JSON-Beispieldateien herunterladen - Test-JSON-Datendateien für Webentwicklung | FormiPeek',
      ...
      jsonl: {
        meta: {
          title: 'Kostenlose JSONL-Beispieldateien herunterladen - Test-JSON Lines-Dateien für Datenverarbeitung | FormiPeek',
      ...
      js: {
        meta: {
          title: 'Kostenlose JS-Beispieldateien herunterladen - Test-JavaScript-Quellcodedateien für Webentwicklung | FormiPeek',
      ...
      jsx: {
        meta: {
          title: 'Kostenlose JSX-Beispieldateien herunterladen - Test-React JSX-Dateien für Front-End-Entwicklung | FormiPeek',
      ...
      jwt: {
        meta: {
          title: 'Kostenlose JWT-Beispieldateien herunterladen - Test-JSON Web Token-Dateien für API-Sicherheit | FormiPeek',
      ...
      key: {
        meta: {
          title: 'Kostenlose KEY-Beispieldateien herunterladen - Test-Private-Key-Dateien für SSL/TLS-Sicherheit | FormiPeek',
      ...
      kml: {
        meta: {
          title: 'Kostenlose KML-Beispieldateien herunterladen - Test-Keyhole Markup Language-Dateien für GIS & Kartierung | FormiPeek',
      ...
      kt: {
        meta: {
          title: 'Kostenlose KT-Beispieldateien herunterladen - Test-Kotlin-Quellcodedateien für Android-Entwicklung | FormiPeek',
      ...
      log: {
        meta: {
          title: 'Kostenlose LOG-Beispieldateien herunterladen - Test-Logdateien für Debugging & Systemanalyse | FormiPeek',
      ...
      lua: {
        meta: {
          title: 'Kostenlose LUA-Beispieldateien herunterladen - Test-Lua-Skriptdateien für Spieleentwicklung & Automatisierung | FormiPeek',
      ...
      m3u: {
        meta: {
          title: 'Kostenlose M3U-Beispieldateien herunterladen - Test-M3U-Playlistdateien für Mediaplayer | FormiPeek',
      ...
      m3u8: {
        meta: {
          title: 'Kostenlose M3U8-Beispieldateien herunterladen - Test-M3U8 HLS-Playlistdateien für Video-Streaming | FormiPeek',
      ...
      makefile: {
        meta: {
          title: 'Kostenlose Makefile-Beispieldateien herunterladen - Test-Makefile-Build-Konfigurationsdateien | FormiPeek',
      ...
      mbtiles: {
        meta: {
          title: 'Kostenlose MBTiles-Beispieldateien herunterladen - Test-MBTiles-Kartentile-Datenbankdateien | FormiPeek',
      ...
      md: {
        meta: {
          title: 'Kostenlose MD-Beispieldateien herunterladen - Test-Markdown-Dokumentationsdateien | FormiPeek',
      ...
      mdx: {
        meta: {
          title: 'Kostenlose MDX-Beispieldateien herunterladen - Test-MDX React Markdown-Dateien für Dokumentation | FormiPeek',
      ...
      apk: {
        meta: {
          title: 'Kostenlose APK-Beispieldateien herunterladen - Testdateien für Android-Anwendungspakete | FormiPeek',
      ...
      appimage: {
        meta: {
          title: 'Kostenlose AppImage-Beispieldateien herunterladen - Testdateien für portable Linux-Anwendungen | FormiPeek',
      ...
      elf: {
        meta: {
          title: 'Kostenlose ELF-Beispieldateien herunterladen - Testdateien für Executable and Linkable Format für Linux/Unix | FormiPeek',
      ...
      exe: {
        meta: {
          title: 'Kostenlose EXE-Beispieldateien herunterladen - Testdateien für Windows-Executables | FormiPeek',
      ...
      ipa: {
        meta: {
          title: 'Kostenlose IPA-Beispieldateien herunterladen - Testdateien für iOS-Anwendungspakete | FormiPeek',
      ...
      jar: {
        meta: {
          title: 'Kostenlose JAR-Beispieldateien herunterladen - Testdateien für Java-Archive | FormiPeek',
      ...
      crx: {
        meta: {
          title: 'Kostenlose CRX-Beispieldateien herunterladen - Testdateien für Chrome-Erweiterungspakete | FormiPeek',
      ...
      '3ds': {
        meta: {
          title: 'Kostenlose 3DS-Beispieldateien herunterladen - Testdateien für 3D-Modelle für 3D-Druck & Modellierung | FormiPeek',
      ...
      '3mf': {
        meta: {
          title: 'Kostenlose 3MF-Beispieldateien herunterladen - Testdateien für 3D Manufacturing Format für 3D-Druck | FormiPeek',
      ...
      ai: {
        meta: {
          title: 'Kostenlose AI-Beispieldateien herunterladen - Testdateien für Adobe Illustrator Vektorgrafiken | FormiPeek',
      ...
      ase: {
        meta: {
          title: 'Kostenlose ASE-Beispieldateien herunterladen - Testdateien für Aseprite Sprite-Animationen | FormiPeek',
      ...
      'animation-fbx': {
        meta: {
          title: 'Kostenlose Animation FBX-Beispieldateien herunterladen - Testdateien für Autodesk FBX 3D-Animationen | FormiPeek',
      ...
      assetbundle: {
        meta: {
          title: 'Kostenlose AssetBundle-Beispieldateien herunterladen - Testdateien für Unity AssetBundle für Spieleentwicklung | FormiPeek',
      ...
      blend: {
        meta: {
          title: 'Kostenlose BLEND-Beispieldateien herunterladen - Testdateien für Blender 3D-Projekte | FormiPeek',
      ...
      bvh: {
        meta: {
          title: 'Kostenlose BVH-Beispieldateien herunterladen - Testdateien für Biovision Hierarchy Motion Capture | FormiPeek',
      ...
      dwg: {
        meta: {
          title: 'Kostenlose DWG-Beispieldateien herunterladen - Testdateien für AutoCAD-Zeichnungen für CAD-Design | FormiPeek',
      ...
      dxf: {
        meta: {
          title: 'Kostenlose DXF-Beispieldateien herunterladen - Drawing Exchange Format Testdateien AutoCAD | FormiPeek',
      ...
      ifc: {
        meta: {
          title: 'Kostenlose IFC-Beispieldateien herunterladen - Industry Foundation Classes BIM Testdateien | FormiPeek',
      ...
      iges: {
        meta: {
          title: 'Kostenlose IGES-Beispieldateien herunterladen - Initial Graphics Exchange Specification CAD Testdateien | FormiPeek',
      ...
      igs: {
        meta: {
          title: 'Kostenlose IGS-Beispieldateien herunterladen - Initial Graphics Exchange Specification CAD Testdateien | FormiPeek',
      ...
      las: {
        meta: {
          title: 'Kostenlose LAS-Beispieldateien herunterladen - LiDAR-Punktwolken-Daten Testdateien | FormiPeek',
      ...
      ma: {
        meta: {
          title: 'Kostenlose MA-Beispieldateien herunterladen - Maya ASCII-Szene Testdateien | FormiPeek',
      ...
      max: {
        meta: {
          title: 'Kostenlose MAX-Beispieldateien herunterladen - 3ds Max-Szene Testdateien | FormiPeek',
      ...
      mb: {
        meta: {
          title: 'Kostenlose MB-Beispieldateien herunterladen - Maya Binary-Szene Testdateien | FormiPeek',
      ...
      indd: {
        meta: {
          title: 'Kostenlose INDD-Beispieldateien herunterladen - Adobe InDesign-Dokument Testdateien | FormiPeek',
      ...
      'animated-gif': {
        meta: {
          title: 'Kostenlose animierte GIF-Beispieldateien herunterladen - Animierte Bild Testdateien | FormiPeek',
      ...
      apng: {
        meta: {
          title: 'Kostenlose APNG-Beispieldateien herunterladen - Animierte PNG-Bild Testdateien | FormiPeek',
      ...
      avif: {
        meta: {
          title: 'Kostenlose AVIF-Beispieldateien herunterladen - AV1 Image File Format Testdateien | FormiPeek',
      ...
      bmp: {
        meta: {
          title: 'Kostenlose BMP-Beispieldateien herunterladen - Bitmap-Bild Testdateien | FormiPeek',
      ...
      'barcode-svg': {
        meta: {
          title: 'Kostenlose Barcode-SVG-Beispieldateien herunterladen - Skalierbare Vektor-Barcode Testdateien | FormiPeek',
      ...
      avi: {
        meta: {
          title: 'Kostenlose AVI-Beispieldateien herunterladen - Audio Video Interleave Video Testdateien | FormiPeek',
      ...
      '3gp': {
        meta: {
          title: 'Kostenlose 3GP-Beispieldateien herunterladen - 3GPP Mobile Video Testdateien | FormiPeek',
      ...
      dav: {
        meta: {
          title: 'Kostenlose DAV-Beispieldateien herunterladen - DAV-Video-Testdateien für Sicherheitskameras | FormiPeek',
      ...
      dds: {
        meta: {
          title: 'Kostenlose DDS-Beispieldateien herunterladen - DirectDraw Surface-Textur-Testdateien | FormiPeek',
      ...
      dng: {
        meta: {
          title: 'Kostenlose DNG-Beispieldateien herunterladen - Digital Negative-Rohbild-Testdateien | FormiPeek',
      ...
      eps: {
        meta: {
          title: 'Kostenlose EPS-Beispieldateien herunterladen - Encapsulated PostScript-Vektorgrafik-Testdateien | FormiPeek',
      ...
      exr: {
        meta: {
          title: 'Kostenlose EXR-Beispieldateien herunterladen - OpenEXR High Dynamic Range-Bild-Testdateien | FormiPeek',
      ...
      hdr: {
        meta: {
          title: 'Kostenlose HDR-Beispieldateien herunterladen - High Dynamic Range-Bild-Testdateien | FormiPeek',
      ...
      heic: {
        meta: {
          title: 'Kostenlose HEIC-Beispieldateien herunterladen - High Efficiency Image Container-Testdateien | FormiPeek',
      ...
      heif: {
        meta: {
          title: 'Kostenlose HEIF-Beispieldateien herunterladen - High Efficiency Image Format-Testdateien | FormiPeek',
      ...
      icns: {
        meta: {
          title: 'Kostenlose ICNS-Beispieldateien herunterladen - macOS-Icon-Testdateien | FormiPeek',
      ...
      ico: {
        meta: {
          title: 'Kostenlose ICO-Beispieldateien herunterladen - Windows-Icon-Testdateien | FormiPeek',
      ...
      jpeg: {
        meta: {
          title: 'Kostenlose JPEG-Beispieldateien herunterladen - JPEG-Bild-Testdateien für Konvertierungstools | FormiPeek',
      ...
      jpg: {
        meta: {
          title: 'Kostenlose JPG-Beispieldateien herunterladen - JPG-Bild-Testdateien für Konvertierungstools | FormiPeek',
      ...
      m4v: {
        meta: {
          title: 'Kostenlose M4V-Beispieldateien herunterladen - M4V-Video-Testdateien für Konvertierungstools | FormiPeek',
      ...
      mkv: {
        meta: {
          title: 'Kostenlose MKV-Beispieldateien herunterladen - Matroska-Video-Testdateien für Konvertierungstools | FormiPeek',
      ...
      aac: {
        meta: {
          title: 'Kostenlose AAC-Beispieldateien herunterladen - Advanced Audio Coding Testdateien | FormiPeek',
      ...
      ac3: {
        meta: {
          title: 'Kostenlose AC3-Beispieldateien herunterladen - Dolby Digital Audio Testdateien | FormiPeek',
      ...
      aif: {
        meta: {
          title: 'Kostenlose AIF-Beispieldateien herunterladen - Audio Interchange File Format Testdateien | FormiPeek',
      ...
      aiff: {
        meta: {
          title: 'Kostenlose AIFF-Beispieldateien herunterladen - Audio Interchange File Format Testdateien | FormiPeek',
      ...
      amr: {
        meta: {
          title: 'Kostenlose AMR-Beispieldateien herunterladen - Adaptive Multi-Rate Audio Testdateien | FormiPeek',
      ...
      caf: {
        meta: {
          title: 'Kostenlose CAF-Beispieldateien herunterladen - Core Audio Format Testdateien | FormiPeek',
      ...
      cue: {
        meta: {
          title: 'Kostenlose CUE-Beispieldateien herunterladen - CUE Sheet Testdateien für Audio-CD-Brennen | FormiPeek',
      ...
      m4a: {
        meta: {
          title: 'Kostenlose M4A-Beispieldateien herunterladen - M4A Audio Testdateien für Konvertierungstools | FormiPeek',
      ...
      midi: {
        meta: {
          title: 'Kostenlose MIDI-Beispieldateien herunterladen - MIDI Music Testdateien für Musiksequenzierung | FormiPeek',
      ...
      ace: {
        meta: {
          title: 'Kostenlose ACE-Beispieldateien herunterladen - ACE Archiv Testdateien für Extraktionstools | FormiPeek',
      ...
      arj: {
        meta: {
          title: 'Kostenlose ARJ-Beispieldateien herunterladen - ARJ Archiv Testdateien für Extraktionstools | FormiPeek',
      ...
      bz2: {
        meta: {
          title: 'Kostenlose BZ2-Beispieldateien herunterladen - BZ2 Komprimierte Archiv Testdateien | FormiPeek',
      ...
      gz: {
        meta: {
          title: 'Kostenlose GZ-Beispieldateien herunterladen - GZ Gzip Komprimierte Archiv Testdateien | FormiPeek',
      ...
      cab: {
        meta: {
          title: 'Kostenlose CAB-Beispieldateien herunterladen - CAB Windows Cabinet Archiv Testdateien | FormiPeek',
      ...
      cpio: {
        meta: {
          title: 'Kostenlose CPIO-Beispieldateien herunterladen - CPIO Archiv Testdateien für Extraktionstools | FormiPeek',
      ...
      zip: {
        meta: {
          title: 'Kostenlose ZIP-Beispieldateien herunterladen - ZIP Archiv Testdateien für Extraktionstools | FormiPeek',
      ...
      dmg: {
        meta: {
          title: 'Kostenlose DMG-Beispieldateien herunterladen - DMG macOS Disk Image Testdateien | FormiPeek',
      ...
      img: {
        meta: {
          title: 'Kostenlose IMG-Beispieldateien herunterladen - IMG Disk Image Testdateien | FormiPeek',
      ...
      iso: {
        meta: {
          title: 'Kostenlose ISO-Beispieldateien herunterladen - ISO Disk Image Testdateien | FormiPeek',
      ...
      kmz: {
        meta: {
          title: 'Kostenlose KMZ-Beispieldateien herunterladen - KMZ Komprimierte KML Testdateien | FormiPeek',
      ...
      laz: {
        meta: {
          title: 'Kostenlose LAZ-Beispieldateien herunterladen - LAZ Komprimierte LiDAR Testdateien | FormiPeek',
      ...
      lha: {
        meta: {
          title: 'Kostenlose LHA-Beispieldateien herunterladen - LHA Archiv Testdateien für Extraktionstools | FormiPeek',
      ...
      lzh: {
        meta: {
          title: 'Kostenlose LZH-Beispieldateien herunterladen - LZH Archiv Testdateien für Extraktionstools | FormiPeek',
      ...
      lzma: {
        meta: {
          title: 'Kostenlose LZMA-Beispieldateien herunterladen - LZMA Komprimierte Archiv Testdateien | FormiPeek',
      ...
      '7z': {
        meta: {
          title: 'Kostenlose 7Z-Beispieldateien herunterladen - 7Z Archiv Testdateien für Extraktionstools | FormiPeek',

...
export const zh: SamplePageTranslations = {
  sample_page: {
    ...
    formats: {
      docx: {
        meta: {
          title: '下载免费DOCX示例文件 - 测试文件 | FomiPeek',
      ...
      doc: {
        meta: {
          title: '下载免费DOC示例文件 - Microsoft Word DOC测试文件 | FomiPeek',
      ...
      pdf: {
        meta: {
          title: '下载免费PDF示例文件 - 转换工具用PDF测试文件 | FomiPeek',
      ...
      odp: {
        meta: {
          title: '下载免费ODP示例文件 - OpenDocument演示测试文件 | FomiPeek',
      ...
      rtf: {
        meta: {
          title: '下载免费RTF示例文件 - Rich Text Format测试文件 | FomiPeek',
      ...
      epub: {
        meta: {
          title: '下载免费EPUB示例文件 - 读者用eBook测试文件 | FomiPeek',
      ...
      'invoice-pdf': {
        meta: {
          title: '下载免费发票PDF示例文件 - 发票文档测试文件 | FomiPeek',
      ...
      mobi: {
        meta: {
          title: '下载免费MOBI示例文件 - Kindle用MOBI eBook测试文件 | FomiPeek',
      ...
      csv: {
        meta: {
          title: '下载免费CSV示例文件 - 用于数据处理的CSV测试文件 | FomiPeek',
      ...
      xls: {
        meta: {
          title: '下载免费XLS示例文件 - Microsoft Excel XLS测试文件 | FomiPeek',
      ...
      xlsx: {
        meta: {
          title: '下载免费XLSX示例文件 - 用于转换工具的Excel XLSX测试文件 | FomiPeek',
      ...
      xml: {
        meta: {
          title: '下载免费XML示例文件 - 用于解析和转换的XML测试文件 | FomiPeek',
      ...
      html: {
        meta: {
          title: '下载免费HTML示例文件 - 用于Web开发的HTML测试文件 | FomiPeek',
      ...
      ods: {
        meta: {
          title: '下载免费ODS示例文件 - OpenDocument电子表格测试文件 | FomiPeek',
      ...
      'ansible-yml': {
        meta: {
          title: '下载免费Ansible YML示例文件 - YAML配置测试文件 | FomiPeek',
      ...
      'api-response-json': {
        meta: {
          title: '下载免费API Response JSON示例文件 - 用于API开发的JSON测试文件 | FomiPeek',
      ...
      'arduino-ino': {
        meta: {
          title: '下载免费Arduino INO示例文件 - 用于嵌入式开发的Arduino Sketch测试文件 | FomiPeek',
      ...
      bat: {
        meta: {
          title: '下载免费BAT示例文件 - 用于Windows自动化的批处理脚本测试文件 | FomiPeek',
      ...
      asc: {
        meta: {
          title: '下载免费ASC示例文件 - 用于文本处理的ASCII文本测试文件 | FomiPeek',
      ...
      bib: {
        meta: {
          title: '下载免费BIB示例文件 - 用于学术研究的参考文献测试文件 | FomiPeek',
      ...
      c: {
        meta: {
          title: '下载免费C示例文件 - 用于开发的C编程语言测试文件 | FomiPeek',
      ...
      'can-log': {
        meta: {
          title: '下载免费CAN Log示例文件 - 用于汽车的Controller Area Network测试文件 | FomiPeek',
      ...
      cmd: {
        meta: {
          title: '下载免费CMD示例文件 - 用于自动化的Windows命令脚本测试文件 | FomiPeek',
      ...
      conf: {
        meta: {
          title: '下载免费CONF示例文件 - 用于系统配置的配置文件测试文件 | FomiPeek',
      ...
      'config-ini': {
        meta: {
          title: '下载免费Config INI示例文件 - 用于应用程序的INI配置测试文件 | FomiPeek',
      ...
      cpp: {
        meta: {
          title: '下载免费CPP示例文件 - 用于开发的C++编程语言测试文件 | FomiPeek',
      ...
      h: {
        meta: {
          title: '下载免费H示例文件 - 用于编程的C/C++头文件测试文件 | FomiPeek',
      ...
      hpp: {
        meta: {
          title: '下载免费HPP示例文件 - 用于现代C++开发的C++头文件测试文件 | FomiPeek',
      ...
      hex: {
        meta: {
          title: '下载免费HEX示例文件 - 固件和嵌入式系统开发的hex测试文件 | FomiPeek',
      ...
      cs: {
        meta: {
          title: '下载免费CS示例文件 - .NET开发的C#源代码测试文件 | FomiPeek',
      ...
      css: {
        meta: {
          title: '下载免费CSS示例文件 - Web开发的样式表测试文件 | FomiPeek',
      ...
      csr: {
        meta: {
          title: '下载免费CSR示例文件 - SSL/TLS的证书签名请求测试文件 | FomiPeek',
      ...
      'customer-database-sql': {
        meta: {
          title: '下载免费Customer Database SQL示例文件 - SQL数据库测试文件 | FomiPeek',
      ...
      dbf: {
        meta: {
          title: '下载免费DBF示例文件 - 数据管理的dBASE数据库测试文件 | FomiPeek',
      ...
      dem: {
        meta: {
          title: '下载免费DEM示例文件 - GIS和地图制作的数字高程模型测试文件 | FomiPeek',
      ...
      der: {
        meta: {
          title: '下载免费DER示例文件 - Distinguished Encoding Rules证书测试文件 | FomiPeek',
      ...
      dmp: {
        meta: {
          title: '下载免费DMP示例文件 - 调试和分析的内存转储测试文件 | FomiPeek',
      ...
      'docker-compose-yml': {
        meta: {
          title: '下载免费Docker Compose YML示例文件 - Docker Compose配置测试文件 | FomiPeek',
      ...
      dockerfile: {
        meta: {
          title: '下载免费Dockerfile示例文件 - Docker容器构建测试文件 | FomiPeek',
      ...
      editorconfig: {
        meta: {
          title: '下载免费EditorConfig示例文件 - 编辑器配置测试文件 | FomiPeek',
      ...
      ini: {
        meta: {
          title: '下载免费INI示例文件 - 应用程序的INI配置测试文件 | FomiPeek',
      ...
      intelhex: {
        meta: {
          title: '下载免费IntelHex示例文件 - 固件开发的Intel hex测试文件 | FomiPeek',
      ...
      ipynb: {
        meta: {
          title: '下载免费IPYNB示例文件 - 数据科学的Jupyter Notebook测试文件 | FomiPeek',
      ...
      java: {
        meta: {
          title: '下载免费Java示例文件 - 开发的Java源代码测试文件 | FomiPeek',
      ...
      jks: {
        meta: {
          title: '下载免费JKS示例文件 - SSL/TLS安全的Java KeyStore测试文件 | FomiPeek',
      ...
      json: {
        meta: {
          title: '下载免费JSON示例文件 - Web开发的JSON数据测试文件 | FomiPeek',
      ...
      jsonl: {
        meta: {
          title: '下载免费JSONL示例文件 - 数据处理的JSON Lines测试文件 | FomiPeek',
      ...
      js: {
        meta: {
          title: '下载免费JS示例文件 - Web开发的JavaScript源代码测试文件 | FomiPeek',
      ...
      jsx: {
        meta: {
          title: '下载免费JSX示例文件 - 前端开发的React JSX测试文件 | FomiPeek',
      ...
      jwt: {
        meta: {
          title: '下载免费JWT示例文件 - API安全的JSON Web Token测试文件 | FomiPeek',
      ...
      key: {
        meta: {
          title: '下载免费KEY示例文件 - SSL/TLS安全的私钥测试文件 | FomiPeek',
      ...
      kml: {
        meta: {
          title: '下载免费KML示例文件 - GIS和地图制作的Keyhole Markup Language测试文件 | FomiPeek',
      ...
      kt: {
        meta: {
          title: '下载免费KT示例文件 - Android开发的Kotlin源代码测试文件 | FomiPeek',
      ...
      log: {
        meta: {
          title: '下载免费LOG示例文件 - 调试和系统分析的日志测试文件 | FomiPeek',
      ...
      lua: {
        meta: {
          title: '下载免费LUA示例文件 - 游戏开发和自动化的Lua脚本测试文件 | FomiPeek',
      ...
      m3u: {
        meta: {
          title: '下载免费M3U示例文件 - 媒体播放器的M3U播放列表测试文件 | FomiPeek',
      ...
      m3u8: {
        meta: {
          title: '下载免费M3U8示例文件 - video流式传输的M3U8 HLS播放列表测试文件 | FomiPeek',
      ...
      makefile: {
        meta: {
          title: '下载免费Makefile示例文件 - Makefile构建配置测试文件 | FomiPeek',
      ...
      mbtiles: {
        meta: {
          title: '下载免费MBTiles示例文件 - MBTiles地图瓦片数据库测试文件 | FomiPeek',
      ...
      md: {
        meta: {
          title: '下载免费MD示例文件 - Markdown文档测试文件 | FomiPeek',
      ...
      mdx: {
        meta: {
          title: '下载免费MDX示例文件 - 文档的MDX React Markdown测试文件 | FomiPeek',
      ...
      apk: {
        meta: {
          title: '下载免费APK示例文件 - Android应用程序包测试文件 | FomiPeek',
      ...
      appimage: {
        meta: {
          title: '下载免费AppImage示例文件 - Linux便携式应用程序测试文件 | FomiPeek',
      ...
      elf: {
        meta: {
          title: '下载免费ELF示例文件 - Linux/Unix的Executable and Linkable Format测试文件 | FomiPeek',
      ...
      exe: {
        meta: {
          title: '下载免费EXE示例文件 - Windows可执行文件测试文件 | FomiPeek',
      ...
      ipa: {
        meta: {
          title: '下载免费IPA示例文件 - iOS应用程序包测试文件 | FomiPeek',
      ...
      jar: {
        meta: {
          title: '下载免费JAR示例文件 - Java归档测试文件 | FomiPeek',
      ...
      crx: {
        meta: {
          title: '下载免费CRX示例文件 - Chrome扩展程序包测试文件 | FomiPeek',
      ...
      '3ds': {
        meta: {
          title: '下载免费3DS示例文件 - 3D打印和建模的3D模型测试文件 | FomiPeek',
      ...
      '3mf': {
        meta: {
          title: '下载免费3MF示例文件 - 3D打印的3D Manufacturing Format测试文件 | FomiPeek',
      ...
      ai: {
        meta: {
          title: '下载免费AI示例文件 - Adobe Illustrator矢量图形测试文件 | FomiPeek',
      ...
      ase: {
        meta: {
          title: '下载免费ASE示例文件 - Aseprite精灵动画测试文件 | FomiPeek',
      ...
      'animation-fbx': {
        meta: {
          title: '下载免费Animation FBX示例文件 - Autodesk FBX 3D动画测试文件 | FomiPeek',
      ...
      assetbundle: {
        meta: {
          title: '下载免费AssetBundle示例文件 - 游戏开发的Unity AssetBundle测试文件 | FomiPeek',
      ...
      blend: {
        meta: {
          title: '下载免费BLEND示例文件 - Blender 3D项目测试文件 | FomiPeek',
      ...
      bvh: {
        meta: {
          title: '下载免费BVH示例文件 - Biovision Hierarchy动作捕捉测试文件 | FomiPeek',
      ...
      dwg: {
        meta: {
          title: '下载免费DWG示例文件 - CAD设计的AutoCAD图纸测试文件 | FomiPeek',
      ...
      dxf: {
        meta: {
          title: '下载免费DXF示例文件 - Drawing Exchange Format测试文件AutoCAD | FomiPeek',
      ...
      ifc: {
        meta: {
          title: '下载免费IFC示例文件 - Industry Foundation Classes BIM测试文件 | FomiPeek',
      ...
      iges: {
        meta: {
          title: '下载免费IGES示例文件 - Initial Graphics Exchange Specification CAD测试文件 | FomiPeek',
      ...
      igs: {
        meta: {
          title: '下载免费IGS示例文件 - Initial Graphics Exchange Specification CAD测试文件 | FomiPeek',
      ...
      las: {
        meta: {
          title: '下载免费LAS示例文件 - LiDAR点云数据测试文件 | FomiPeek',
      ...
      ma: {
        meta: {
          title: '下载免费MA示例文件 - Maya ASCII场景测试文件 | FomiPeek',
      ...
      max: {
        meta: {
          title: '下载免费MAX示例文件 - 3ds Max场景测试文件 | FomiPeek',
      ...
      mb: {
        meta: {
          title: '下载免费MB示例文件 - Maya Binary场景测试文件 | FomiPeek',
      ...
      indd: {
        meta: {
          title: '下载免费INDD示例文件 - Adobe InDesign文档测试文件 | FomiPeek',
      ...
      'animated-gif': {
        meta: {
          title: '下载免费动画GIF示例文件 - 动画图像测试文件 | FomiPeek',
      ...
      apng: {
        meta: {
          title: '下载免费APNG示例文件 - 动画PNG图像测试文件 | FomiPeek',
      ...
      avif: {
        meta: {
          title: '下载免费AVIF示例文件 - AV1图像文件格式测试文件 | FomiPeek',
      ...
      bmp: {
        meta: {
          title: '下载免费BMP示例文件 - 位图图像测试文件 | FomiPeek',
      ...
      'barcode-svg': {
        meta: {
          title: '下载免费条形码SVG示例文件 - 可缩放矢量条形码测试文件 | FomiPeek',
      ...
      avi: {
        meta: {
          title: '下载免费AVI示例文件 - Audio Video Interleave视频测试文件 | FomiPeek',
      ...
      '3gp': {
        meta: {
          title: '下载免费3GP示例文件 - 3GPP移动视频测试文件 | FomiPeek',
      ...
      dav: {
        meta: {
          title: '下载免费DAV示例文件 - 安全摄像头DAV视频测试文件 | FomiPeek',
      ...
      dds: {
        meta: {
          title: '下载免费DDS示例文件 - DirectDraw Surface纹理测试文件 | FomiPeek',
      ...
      dng: {
        meta: {
          title: '下载免费DNG示例文件 - Digital Negative原始图像测试文件 | FomiPeek',
      ...
      eps: {
        meta: {
          title: '下载免费EPS示例文件 - Encapsulated PostScript矢量图形测试文件 | FomiPeek',
      ...
      exr: {
        meta: {
          title: '下载免费EXR示例文件 - OpenEXR高动态范围图像测试文件 | FomiPeek',
      ...
      hdr: {
        meta: {
          title: '下载免费HDR示例文件 - 高动态范围图像测试文件 | FomiPeek',
      ...
      heic: {
        meta: {
          title: '下载免费HEIC示例文件 - 高效图像容器测试文件 | FomiPeek',
      ...
      heif: {
        meta: {
          title: '下载免费HEIF示例文件 - 高效图像格式测试文件 | FomiPeek',
      ...
      icns: {
        meta: {
          title: '下载免费ICNS示例文件 - macOS图标测试文件 | FomiPeek',
      ...
      ico: {
        meta: {
          title: '下载免费ICO示例文件 - Windows图标测试文件 | FomiPeek',
      ...
      jpeg: {
        meta: {
          title: '下载免费JPEG示例文件 - 转换工具用JPEG图像测试文件 | FomiPeek',
      ...
      jpg: {
        meta: {
          title: '下载免费JPG示例文件 - 转换工具用JPG图像测试文件 | FomiPeek',
      ...
      m4v: {
        meta: {
          title: '下载免费M4V示例文件 - 转换工具用M4V视频测试文件 | FomiPeek',
      ...
      mkv: {
        meta: {
          title: '下载免费MKV示例文件 - 转换工具用Matroska视频测试文件 | FomiPeek',
      ...
      aac: {
        meta: {
          title: '下载免费AAC示例文件 - 高级音频编码测试文件 | FomiPeek',
      ...
      ac3: {
        meta: {
          title: '下载免费AC3示例文件 - 杜比数字音频测试文件 | FomiPeek',
      ...
      aif: {
        meta: {
          title: '下载免费AIF示例文件 - 音频交换文件格式测试文件 | FomiPeek',
      ...
      aiff: {
        meta: {
          title: '下载免费AIFF示例文件 - 音频交换文件格式测试文件 | FomiPeek',
      ...
      amr: {
        meta: {
          title: '下载免费AMR示例文件 - 自适应多速率音频测试文件 | FomiPeek',
      ...
      caf: {
        meta: {
          title: '下载免费CAF示例文件 - 核心音频格式测试文件 | FomiPeek',
      ...
      cue: {
        meta: {
          title: '下载免费CUE示例文件 - 用于音频CD刻录的CUE Sheet测试文件 | FomiPeek',
      ...
      m4a: {
        meta: {
          title: '下载免费M4A示例文件 - 用于转换工具的M4A音频测试文件 | FomiPeek',
      ...
      midi: {
        meta: {
          title: '下载免费MIDI示例文件 - 用于音乐排序的MIDI Music测试文件 | FomiPeek',
      ...
      ace: {
        meta: {
          title: '下载免费ACE示例文件 - 用于提取工具的ACE Archive测试文件 | FomiPeek',
      ...
      arj: {
        meta: {
          title: '下载免费ARJ示例文件 - 用于提取工具的ARJ Archive测试文件 | FomiPeek',
      ...
      bz2: {
        meta: {
          title: '下载免费BZ2示例文件 - BZ2 Compressed Archive测试文件 | FomiPeek',
      ...
      gz: {
        meta: {
          title: '下载免费GZ示例文件 - GZ Gzip Compressed Archive测试文件 | FomiPeek',
      ...
      cab: {
        meta: {
          title: '下载免费CAB示例文件 - CAB Windows Cabinet Archive测试文件 | FomiPeek',
      ...
      cpio: {
        meta: {
          title: '下载免费CPIO示例文件 - 用于提取工具的CPIO Archive测试文件 | FomiPeek',
      ...
      zip: {
        meta: {
          title: '下载免费ZIP示例文件 - 用于提取工具的ZIP Archive测试文件 | FomiPeek',
      ...
      dmg: {
        meta: {
          title: '下载免费DMG示例文件 - DMG macOS Disk Image测试文件 | FomiPeek',
      ...
      img: {
        meta: {
          title: '下载免费IMG示例文件 - IMG Disk Image测试文件 | FomiPeek',
      ...
      iso: {
        meta: {
          title: '下载免费ISO示例文件 - ISO Disk Image测试文件 | FomiPeek',
      ...
      kmz: {
        meta: {
          title: '下载免费KMZ示例文件 - KMZ Compressed KML测试文件 | FomiPeek',
      ...
      laz: {
        meta: {
          title: '下载免费LAZ示例文件 - LAZ Compressed LiDAR测试文件 | FomiPeek',
      ...
      lha: {
        meta: {
          title: '下载免费LHA示例文件 - 用于提取工具的LHA Archive测试文件 | FomiPeek',
      ...
      lzh: {
        meta: {
          title: '下载免费LZH示例文件 - 用于提取工具的LZH Archive测试文件 | FomiPeek',
      ...
      lzma: {
        meta: {
          title: '下载免费LZMA示例文件 - LZMA Compressed Archive测试文件 | FomiPeek',
      ...
      '7z': {
        meta: {
          title: '下载免费7Z示例文件 - 用于提取工具的7Z Archive测试文件 | FomiPeek',

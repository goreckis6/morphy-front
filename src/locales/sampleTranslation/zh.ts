...
export const zh: SamplePageTranslations = {
  sample_page: {
    ...
    formats: {
      docx: {
        meta: {
          title: '下载免费DOCX示例文件 - 测试文件 | FormiPeek',
      ...
      doc: {
        meta: {
          title: '下载免费DOC示例文件 - Microsoft Word DOC测试文件 | FormiPeek',
          description: '下载免费DOC示例文件用于测试文档转换工具。提供多种文件大小：100 KB、1 MB、5 MB、50 MB 和 100 MB。非常适合测试DOC转PDF、DOC转DOCX转换器以及旧版Microsoft Word文档处理。',
          keywords: 'DOC示例文件、DOC测试文件、下载DOC示例、免费DOC测试文件、Microsoft Word DOC示例、DOC转PDF转换器测试、DOC转DOCX转换、旧版Word文档示例、.doc测试文件、文档转换示例'
        },
        schema: {
          name: '免费DOC示例文件 - 下载Microsoft Word DOC测试文件',
          description: '下载免费DOC示例文件用于测试文档转换工具。提供多种文件大小：100 KB、1 MB、5 MB、50 MB 和 100 MB。非常适合测试DOC转PDF、DOC转DOCX转换器以及旧版Microsoft Word文档处理。'
        },
        hero: {
          title: 'DOC示例文件',
          description: '下载免费DOC示例文件用于测试。提供多种文件大小，用于测试您的文档转换工具、DOC转PDF转换器和旧版Microsoft Word文档处理器。'
        },
        about_description: '这些是用于测试目的的各种大小的DOC测试文件'
      },
      pdf: {
        meta: {
          title: '下载免费PDF示例文件 - 转换工具用PDF测试文件 | FormiPeek',
          description: '下载免费PDF示例文件用于测试PDF转换器、查看器和处理器。提供多种文件大小：100 KB、1 MB、5 MB、50 MB 和 100 MB。非常适合测试PDF转Word、PDF转JPG、PDF压缩和PDF编辑工具。',
          keywords: 'PDF示例文件、PDF测试文件、下载PDF示例、免费PDF测试文件、PDF转换器测试文件、PDF转Word示例、PDF转JPG示例、PDF压缩测试、PDF查看器测试文件、.pdf测试文件、文档转换示例'
        },
        schema: {
          name: '免费PDF示例文件 - 下载转换工具用PDF测试文件',
          description: '下载免费PDF示例文件用于测试PDF转换器、查看器和处理器。提供多种文件大小：100 KB、1 MB、5 MB、50 MB 和 100 MB。非常适合测试PDF转Word、PDF转JPG、PDF压缩和PDF编辑工具。'
        },
        hero: {
          title: 'PDF示例文件',
          description: '下载免费PDF示例文件用于测试。提供多种文件大小，用于测试您的PDF转换器、PDF转Word工具、PDF压缩软件和PDF处理应用程序。'
        },
        about_description: '这些是用于测试目的的各种大小的PDF测试文件'
      },
      odp: {
        meta: {
          title: '下载免费ODP示例文件 - OpenDocument演示测试文件 | FormiPeek',
          description: '下载免费ODP示例文件用于测试演示转换工具。提供多种文件大小：100 KB、1 MB、5 MB、50 MB 和 100 MB。非常适合测试ODP转PPT、ODP转PDF转换器、LibreOffice Impress文件和OpenDocument格式处理。',
          keywords: 'ODP示例文件、ODP测试文件、下载ODP示例、免费ODP测试文件、OpenDocument演示示例、ODP转PPT转换器、ODP转PDF转换器、LibreOffice Impress示例、.odp测试文件、演示转换示例、OpenDocument格式测试'
        },
        schema: {
          name: '免费ODP示例文件 - 下载OpenDocument演示测试文件',
          description: '下载免费ODP示例文件用于测试演示转换工具。提供多种文件大小：100 KB、1 MB、5 MB、50 MB 和 100 MB。非常适合测试ODP转PPT、ODP转PDF转换器、LibreOffice Impress文件和OpenDocument格式处理。'
        },
        hero: {
          title: 'ODP示例文件',
          description: '下载免费ODP示例文件OpenDocument演示用于测试。提供多种文件大小，用于测试您的演示转换工具、ODP转PPT转换器和OpenDocument格式处理器。'
        },
        about_description: '这些是用于测试目的的各种大小的ODP测试文件'
      },
      rtf: {
        meta: {
          title: '下载免费RTF示例文件 - Rich Text Format测试文件 | FormiPeek',
          description: '下载免费RTF示例文件用于测试Rich Text Format转换工具。提供多种文件大小：100 KB、1 MB、5 MB、50 MB 和 100 MB。非常适合测试RTF转DOC、RTF转PDF转换器、文字处理器兼容性和文档格式转换。',
          keywords: 'RTF示例文件、RTF测试文件、下载RTF示例、免费RTF测试文件、Rich Text Format示例、RTF转DOC转换器、RTF转PDF转换器、.rtf测试文件、文字处理器测试文件、文档格式转换示例'
        },
        schema: {
          name: '免费RTF示例文件 - 下载Rich Text Format测试文件',
          description: '下载免费RTF示例文件用于测试Rich Text Format转换工具。提供多种文件大小：100 KB、1 MB、5 MB、50 MB 和 100 MB。非常适合测试RTF转DOC、RTF转PDF转换器、文字处理器兼容性和文档格式转换。'
        },
        hero: {
          title: 'RTF示例文件',
          description: '下载免费RTF示例文件Rich Text Format文档用于测试。提供多种文件大小，用于测试您的文档转换工具、RTF转DOC转换器和文字处理器兼容性。'
        },
        about_description: '这些是用于测试目的的各种大小的RTF测试文件'
      },
      epub: {
        meta: {
          title: '下载免费EPUB示例文件 - 读者用eBook测试文件 | FormiPeek',
          description: '下载免费EPUB示例文件用于测试eBook阅读器和转换工具。提供多种文件大小：100 KB、1 MB、5 MB、50 MB 和 100 MB。非常适合测试EPUB阅读器、EPUB转PDF、EPUB转MOBI转换器、数字出版工具和eBook格式兼容性。',
          keywords: 'EPUB示例文件、EPUB测试文件、下载EPUB示例、免费EPUB测试文件、eBook示例、EPUB阅读器测试、EPUB转PDF转换器、EPUB转MOBI转换器、.epub测试文件、数字出版示例、eBook格式测试文件'
        },
        schema: {
          name: '免费EPUB示例文件 - 下载读者用eBook测试文件',
          description: '下载免费EPUB示例文件用于测试eBook阅读器和转换工具。提供多种文件大小：100 KB、1 MB、5 MB、50 MB 和 100 MB。非常适合测试EPUB阅读器、EPUB转PDF、EPUB转MOBI转换器、数字出版工具和eBook格式兼容性。'
        },
        hero: {
          title: 'EPUB示例文件',
          description: '下载免费EPUB示例文件用于测试。提供多种文件大小，用于测试您的eBook阅读器、EPUB转PDF转换器、EPUB转MOBI工具和数字出版应用程序。'
        },
        about_description: '这些是用于测试目的的各种大小的EPUB测试文件'
      },
      'invoice-pdf': {
        meta: {
          title: '下载免费发票PDF示例文件 - 发票文档测试文件 | FormiPeek',
          description: '下载免费发票PDF示例文件用于测试发票处理和解析工具。提供多种文件大小：100 KB、1 MB、5 MB、50 MB 和 100 MB。非常适合测试发票OCR、发票数据提取、发票自动化、发票PDF解析和文档管理系统。',
          keywords: '发票PDF示例文件、发票PDF测试文件、下载发票PDF示例、免费发票PDF测试文件、发票文档示例、发票OCR测试、发票数据提取、发票自动化测试、发票PDF解析、发票处理示例、文档管理测试文件'
        },
        schema: {
          name: '免费发票PDF示例文件 - 下载发票文档测试文件',
          description: '下载免费发票PDF示例文件用于测试发票处理和解析工具。提供多种文件大小：100 KB、1 MB、5 MB、50 MB 和 100 MB。非常适合测试发票OCR、发票数据提取、发票自动化、发票PDF解析和文档管理系统。'
        },
        hero: {
          title: '发票PDF示例文件',
          description: '下载免费发票PDF示例文件用于测试。提供多种文件大小，用于测试您的发票处理工具、发票OCR软件、发票数据提取系统和文档管理应用程序。'
        },
        about_description: '这些是用于测试目的的各种大小的发票PDF测试文件'
      },
      mobi: {
        meta: {
          title: '下载免费MOBI示例文件 - Kindle用MOBI eBook测试文件 | FormiPeek',
          description: '下载免费MOBI示例文件用于测试MOBI eBook阅读器和转换工具。提供多种文件大小：100 KB、1 MB、5 MB、50 MB 和 100 MB。非常适合测试Kindle兼容性、MOBI转EPUB、MOBI转PDF转换器、eBook格式转换和数字阅读应用程序。',
          keywords: 'MOBI示例文件、MOBI测试文件、下载MOBI示例、免费MOBI测试文件、MOBI eBook示例、Kindle测试文件、MOBI转EPUB转换器、MOBI转PDF转换器、.mobi测试文件、eBook转换示例、数字阅读测试文件'
        },
        schema: {
          name: '免费MOBI示例文件 - 下载Kindle用MOBI eBook测试文件',
          description: '下载免费MOBI示例文件用于测试MOBI eBook阅读器和转换工具。提供多种文件大小：100 KB、1 MB、5 MB、50 MB 和 100 MB。非常适合测试Kindle兼容性、MOBI转EPUB、MOBI转PDF转换器、eBook格式转换和数字阅读应用程序。'
        },
        hero: {
          title: 'MOBI示例文件',
          description: '下载免费MOBI示例文件用于测试。提供多种文件大小，用于测试您的MOBI eBook阅读器、MOBI转EPUB转换器、MOBI转PDF工具和Kindle兼容性应用程序。'
        },
        about_description: '这些是用于测试目的的各种大小的MOBI测试文件'
      },
      csv: {
        meta: {
          title: '下载免费CSV示例文件 - 用于数据处理的CSV测试文件 | FormiPeek',
          description: '下载免费CSV示例文件用于测试数据处理和转换工具。提供多种文件大小：100 KB、1 MB、5 MB、50 MB 和 100 MB。非常适合测试CSV转Excel、CSV转JSON转换器、数据导入工具、电子表格应用程序和逗号分隔值处理。',
          keywords: 'CSV示例文件、CSV测试文件、下载CSV示例、免费CSV测试文件、CSV转Excel转换器、CSV转JSON转换器、逗号分隔值示例、数据处理测试文件、电子表格导入示例、.csv测试文件、数据转换示例'
        },
        schema: {
          name: '免费CSV示例文件 - 下载用于数据处理的CSV测试文件',
          description: '下载免费CSV示例文件用于测试数据处理和转换工具。提供多种文件大小：100 KB、1 MB、5 MB、50 MB 和 100 MB。非常适合测试CSV转Excel、CSV转JSON转换器、数据导入工具、电子表格应用程序和逗号分隔值处理。'
        },
        hero: {
          title: 'CSV示例文件',
          description: '下载免费CSV示例文件用于测试。提供多种文件大小，用于测试您的CSV转换工具、CSV转Excel转换器、数据处理应用程序和电子表格导入软件。'
        },
        about_description: '这些是用于测试目的的各种大小的CSV测试文件'
      },
      xls: {
        meta: {
          title: '下载免费XLS示例文件 - Microsoft Excel XLS测试文件 | FormiPeek',
          description: '下载免费XLS示例文件用于测试Excel转换和数据处理工具。提供多种文件大小：100 KB、1 MB、5 MB、50 MB 和 100 MB。非常适合测试XLS转XLSX、XLS转CSV、XLS转PDF转换器、Excel数据提取和旧版电子表格处理。',
          keywords: 'XLS示例文件、XLS测试文件、下载XLS示例、免费XLS测试文件、Microsoft Excel XLS示例、XLS转XLSX转换器、XLS转CSV转换器、XLS转PDF转换器、Excel数据提取、.xls测试文件、电子表格转换示例'
        },
        schema: {
          name: '免费XLS示例文件 - 下载Microsoft Excel XLS测试文件',
          description: '下载免费XLS示例文件用于测试Excel转换和数据处理工具。提供多种文件大小：100 KB、1 MB、5 MB、50 MB 和 100 MB。非常适合测试XLS转XLSX、XLS转CSV、XLS转PDF转换器、Excel数据提取和旧版电子表格处理。'
        },
        hero: {
          title: 'XLS示例文件',
          description: '下载免费XLS Excel电子表格示例文件用于测试。提供多种文件大小，用于测试您的Excel转换工具、XLS转XLSX转换器、数据处理应用程序和电子表格导入软件。'
        },
        about_description: '这些是用于测试目的的各种大小的XLS测试文件'
      },
      xlsx: {
        meta: {
          title: '下载免费XLSX示例文件 - 用于转换工具的Excel XLSX测试文件 | FormiPeek',
          description: '下载免费XLSX示例文件用于测试Excel转换和数据处理工具。提供多种文件大小：100 KB、1 MB、5 MB、50 MB 和 100 MB。非常适合测试XLSX转CSV、XLSX转PDF、XLSX转JSON转换器、Excel数据分析、电子表格自动化和Office Open XML处理。',
          keywords: 'XLSX示例文件、XLSX测试文件、下载XLSX示例、免费XLSX测试文件、Excel XLSX示例、XLSX转CSV转换器、XLSX转PDF转换器、XLSX转JSON转换器、Excel数据分析、.xlsx测试文件、电子表格自动化示例、Office Open XML示例'
        },
        schema: {
          name: '免费XLSX示例文件 - 下载用于转换工具的Excel XLSX测试文件',
          description: '下载免费XLSX示例文件用于测试Excel转换和数据处理工具。提供多种文件大小：100 KB、1 MB、5 MB、50 MB 和 100 MB。非常适合测试XLSX转CSV、XLSX转PDF、XLSX转JSON转换器、Excel数据分析、电子表格自动化和Office Open XML处理。'
        },
        hero: {
          title: 'XLSX示例文件',
          description: '下载免费XLSX Excel电子表格示例文件用于测试。提供多种文件大小，用于测试您的Excel转换工具、XLSX转CSV转换器、数据分析应用程序和电子表格自动化软件。'
        },
        about_description: '这些是用于测试目的的各种大小的XLSX测试文件'
      },
      xml: {
        meta: {
          title: '下载免费XML示例文件 - 用于解析和转换的XML测试文件 | FormiPeek',
          description: '下载免费XML示例文件用于测试XML解析、转换和数据处理工具。提供多种文件大小：100 KB、1 MB、5 MB、50 MB 和 100 MB。非常适合测试XML转JSON、XML转CSV转换器、XML验证、结构化数据处理和标记语言解析。',
          keywords: 'XML示例文件、XML测试文件、下载XML示例、免费XML测试文件、XML转JSON转换器、XML转CSV转换器、XML验证测试、Extensible Markup Language示例、结构化数据示例、.xml测试文件、标记语言解析示例'
        },
        schema: {
          name: '免费XML示例文件 - 下载用于解析和转换的XML测试文件',
          description: '下载免费XML示例文件用于测试XML解析、转换和数据处理工具。提供多种文件大小：100 KB、1 MB、5 MB、50 MB 和 100 MB。非常适合测试XML转JSON、XML转CSV转换器、XML验证、结构化数据处理和标记语言解析。'
        },
        hero: {
          title: 'XML示例文件',
          description: '下载免费XML示例文件用于测试。提供多种文件大小，用于测试您的XML解析工具、XML转JSON转换器、XML验证软件和结构化数据处理应用程序。'
        },
        about_description: '这些是用于测试目的的各种大小的XML测试文件'
      },
      html: {
        meta: {
          title: '下载免费HTML示例文件 - 用于Web开发的HTML测试文件 | FormiPeek',
          description: '下载免费HTML示例文件用于测试Web开发和HTML处理工具。提供多种文件大小：100 KB、1 MB、5 MB、50 MB 和 100 MB。非常适合测试HTML转PDF、HTML转DOCX转换器、HTML验证、网页抓取、浏览器渲染和HyperText Markup Language处理。',
          keywords: 'HTML示例文件、HTML测试文件、下载HTML示例、免费HTML测试文件、HTML转PDF转换器、HTML转DOCX转换器、HTML验证测试、HyperText Markup Language示例、Web开发示例、.html测试文件、网页抓取示例、浏览器渲染测试'
        },
        schema: {
          name: '免费HTML示例文件 - 下载用于Web开发的HTML测试文件',
          description: '下载免费HTML示例文件用于测试Web开发和HTML处理工具。提供多种文件大小：100 KB、1 MB、5 MB、50 MB 和 100 MB。非常适合测试HTML转PDF、HTML转DOCX转换器、HTML验证、网页抓取、浏览器渲染和HyperText Markup Language处理。'
        },
        hero: {
          title: 'HTML示例文件',
          description: '下载免费HTML HyperText Markup Language示例文件用于测试。提供多种文件大小，用于测试您的HTML解析工具、HTML转PDF转换器、HTML验证软件和Web开发应用程序。'
        },
        about_description: '这些是用于测试目的的各种大小的HTML测试文件'
      },
      ods: {
        meta: {
          title: '下载免费ODS示例文件 - OpenDocument电子表格测试文件 | FormiPeek',
          description: '下载免费ODS示例文件用于测试电子表格转换和数据处理工具。提供多种文件大小：100 KB、1 MB、5 MB、50 MB 和 100 MB。非常适合测试ODS转Excel、ODS转CSV转换器、LibreOffice Calc文件、OpenDocument格式处理和电子表格数据提取。',
          keywords: 'ODS示例文件、ODS测试文件、下载ODS示例、免费ODS测试文件、OpenDocument电子表格示例、ODS转Excel转换器、ODS转CSV转换器、LibreOffice Calc示例、.ods测试文件、电子表格转换示例、OpenDocument格式测试'
        },
        schema: {
          name: '免费ODS示例文件 - 下载OpenDocument电子表格测试文件',
          description: '下载免费ODS示例文件用于测试电子表格转换和数据处理工具。提供多种文件大小：100 KB、1 MB、5 MB、50 MB 和 100 MB。非常适合测试ODS转Excel、ODS转CSV转换器、LibreOffice Calc文件、OpenDocument格式处理和电子表格数据提取。'
        },
        hero: {
          title: 'ODS示例文件',
          description: '下载免费ODS OpenDocument Spreadsheet示例文件用于测试。提供多种文件大小，用于测试您的电子表格转换工具、ODS转Excel转换器和OpenDocument格式处理器。'
        },
        about_description: '这些是用于测试目的的各种大小的ODS测试文件'
      },
      'ansible-yml': {
        meta: {
          title: '下载免费Ansible YML示例文件 - YAML配置测试文件 | FormiPeek',
          description: '下载免费Ansible YML示例文件用于测试YAML解析和配置管理工具。提供多种文件大小：100 KB、1 MB、5 MB、50 MB 和 100 MB。非常适合测试Ansible playbook、YAML验证、DevOps自动化、配置管理系统和infrastructure as code工具。',
          keywords: 'Ansible YML示例文件、YML测试文件、下载YML示例、免费YML测试文件、Ansible playbook示例、YAML配置示例、YAML验证测试、DevOps自动化示例、.yml测试文件、配置管理示例、infrastructure as code示例'
        },
        schema: {
          name: '免费Ansible YML示例文件 - 下载YAML配置测试文件',
          description: '下载免费Ansible YML示例文件用于测试YAML解析和配置管理工具。提供多种文件大小：100 KB、1 MB、5 MB、50 MB 和 100 MB。非常适合测试Ansible playbook、YAML验证、DevOps自动化、配置管理系统和infrastructure as code工具。'
        },
        hero: {
          title: 'Ansible YML示例文件',
      ...
      'api-response-json': {
        meta: {
          title: '下载免费API Response JSON示例文件 - 用于API开发的JSON测试文件 | FormiPeek',
      ...
      'arduino-ino': {
        meta: {
          title: '下载免费Arduino INO示例文件 - 用于嵌入式开发的Arduino Sketch测试文件 | FormiPeek',
      ...
      bat: {
        meta: {
          title: '下载免费BAT示例文件 - 用于Windows自动化的批处理脚本测试文件 | FormiPeek',
      ...
      asc: {
        meta: {
          title: '下载免费ASC示例文件 - 用于文本处理的ASCII文本测试文件 | FormiPeek',
      ...
      bib: {
        meta: {
          title: '下载免费BIB示例文件 - 用于学术研究的参考文献测试文件 | FormiPeek',
      ...
      c: {
        meta: {
          title: '下载免费C示例文件 - 用于开发的C编程语言测试文件 | FormiPeek',
      ...
      'can-log': {
        meta: {
          title: '下载免费CAN Log示例文件 - 用于汽车的Controller Area Network测试文件 | FormiPeek',
      ...
      cmd: {
        meta: {
          title: '下载免费CMD示例文件 - 用于自动化的Windows命令脚本测试文件 | FormiPeek',
      ...
      conf: {
        meta: {
          title: '下载免费CONF示例文件 - 用于系统配置的配置文件测试文件 | FormiPeek',
      ...
      'config-ini': {
        meta: {
          title: '下载免费Config INI示例文件 - 用于应用程序的INI配置测试文件 | FormiPeek',
      ...
      cpp: {
        meta: {
          title: '下载免费CPP示例文件 - 用于开发的C++编程语言测试文件 | FormiPeek',
      ...
      h: {
        meta: {
          title: '下载免费H示例文件 - 用于编程的C/C++头文件测试文件 | FormiPeek',
      ...
      hpp: {
        meta: {
          title: '下载免费HPP示例文件 - 用于现代C++开发的C++头文件测试文件 | FormiPeek',
      ...
      hex: {
        meta: {
          title: '下载免费HEX示例文件 - 固件和嵌入式系统开发的hex测试文件 | FormiPeek',
      ...
      cs: {
        meta: {
          title: '下载免费CS示例文件 - .NET开发的C#源代码测试文件 | FormiPeek',
      ...
      css: {
        meta: {
          title: '下载免费CSS示例文件 - Web开发的样式表测试文件 | FormiPeek',
      ...
      csr: {
        meta: {
          title: '下载免费CSR示例文件 - SSL/TLS的证书签名请求测试文件 | FormiPeek',
      ...
      'customer-database-sql': {
        meta: {
          title: '下载免费Customer Database SQL示例文件 - SQL数据库测试文件 | FormiPeek',
      ...
      dbf: {
        meta: {
          title: '下载免费DBF示例文件 - 数据管理的dBASE数据库测试文件 | FormiPeek',
      ...
      dem: {
        meta: {
          title: '下载免费DEM示例文件 - GIS和地图制作的数字高程模型测试文件 | FormiPeek',
      ...
      der: {
        meta: {
          title: '下载免费DER示例文件 - Distinguished Encoding Rules证书测试文件 | FormiPeek',
      ...
      dmp: {
        meta: {
          title: '下载免费DMP示例文件 - 调试和分析的内存转储测试文件 | FormiPeek',
      ...
      'docker-compose-yml': {
        meta: {
          title: '下载免费Docker Compose YML示例文件 - Docker Compose配置测试文件 | FormiPeek',
      ...
      dockerfile: {
        meta: {
          title: '下载免费Dockerfile示例文件 - Docker容器构建测试文件 | FormiPeek',
      ...
      editorconfig: {
        meta: {
          title: '下载免费EditorConfig示例文件 - 编辑器配置测试文件 | FormiPeek',
      ...
      ini: {
        meta: {
          title: '下载免费INI示例文件 - 应用程序的INI配置测试文件 | FormiPeek',
      ...
      intelhex: {
        meta: {
          title: '下载免费IntelHex示例文件 - 固件开发的Intel hex测试文件 | FormiPeek',
      ...
      ipynb: {
        meta: {
          title: '下载免费IPYNB示例文件 - 数据科学的Jupyter Notebook测试文件 | FormiPeek',
      ...
      java: {
        meta: {
          title: '下载免费Java示例文件 - 开发的Java源代码测试文件 | FormiPeek',
      ...
      jks: {
        meta: {
          title: '下载免费JKS示例文件 - SSL/TLS安全的Java KeyStore测试文件 | FormiPeek',
      ...
      json: {
        meta: {
          title: '下载免费JSON示例文件 - Web开发的JSON数据测试文件 | FormiPeek',
      ...
      jsonl: {
        meta: {
          title: '下载免费JSONL示例文件 - 数据处理的JSON Lines测试文件 | FormiPeek',
      ...
      js: {
        meta: {
          title: '下载免费JS示例文件 - Web开发的JavaScript源代码测试文件 | FormiPeek',
      ...
      jsx: {
        meta: {
          title: '下载免费JSX示例文件 - 前端开发的React JSX测试文件 | FormiPeek',
      ...
      jwt: {
        meta: {
          title: '下载免费JWT示例文件 - API安全的JSON Web Token测试文件 | FormiPeek',
      ...
      key: {
        meta: {
          title: '下载免费KEY示例文件 - SSL/TLS安全的私钥测试文件 | FormiPeek',
      ...
      kml: {
        meta: {
          title: '下载免费KML示例文件 - GIS和地图制作的Keyhole Markup Language测试文件 | FormiPeek',
      ...
      kt: {
        meta: {
          title: '下载免费KT示例文件 - Android开发的Kotlin源代码测试文件 | FormiPeek',
      ...
      log: {
        meta: {
          title: '下载免费LOG示例文件 - 调试和系统分析的日志测试文件 | FormiPeek',
      ...
      lua: {
        meta: {
          title: '下载免费LUA示例文件 - 游戏开发和自动化的Lua脚本测试文件 | FormiPeek',
      ...
      m3u: {
        meta: {
          title: '下载免费M3U示例文件 - 媒体播放器的M3U播放列表测试文件 | FormiPeek',
      ...
      m3u8: {
        meta: {
          title: '下载免费M3U8示例文件 - video流式传输的M3U8 HLS播放列表测试文件 | FormiPeek',
      ...
      makefile: {
        meta: {
          title: '下载免费Makefile示例文件 - Makefile构建配置测试文件 | FormiPeek',
      ...
      mbtiles: {
        meta: {
          title: '下载免费MBTiles示例文件 - MBTiles地图瓦片数据库测试文件 | FormiPeek',
      ...
      md: {
        meta: {
          title: '下载免费MD示例文件 - Markdown文档测试文件 | FormiPeek',
      ...
      mdx: {
        meta: {
          title: '下载免费MDX示例文件 - 文档的MDX React Markdown测试文件 | FormiPeek',
      ...
      apk: {
        meta: {
          title: '下载免费APK示例文件 - Android应用程序包测试文件 | FormiPeek',
      ...
      appimage: {
        meta: {
          title: '下载免费AppImage示例文件 - Linux便携式应用程序测试文件 | FormiPeek',
      ...
      elf: {
        meta: {
          title: '下载免费ELF示例文件 - Linux/Unix的Executable and Linkable Format测试文件 | FormiPeek',
      ...
      exe: {
        meta: {
          title: '下载免费EXE示例文件 - Windows可执行文件测试文件 | FormiPeek',
      ...
      ipa: {
        meta: {
          title: '下载免费IPA示例文件 - iOS应用程序包测试文件 | FormiPeek',
      ...
      jar: {
        meta: {
          title: '下载免费JAR示例文件 - Java归档测试文件 | FormiPeek',
      ...
      crx: {
        meta: {
          title: '下载免费CRX示例文件 - Chrome扩展程序包测试文件 | FormiPeek',
      ...
      '3ds': {
        meta: {
          title: '下载免费3DS示例文件 - 3D打印和建模的3D模型测试文件 | FormiPeek',
      ...
      '3mf': {
        meta: {
          title: '下载免费3MF示例文件 - 3D打印的3D Manufacturing Format测试文件 | FormiPeek',
      ...
      ai: {
        meta: {
          title: '下载免费AI示例文件 - Adobe Illustrator矢量图形测试文件 | FormiPeek',
      ...
      ase: {
        meta: {
          title: '下载免费ASE示例文件 - Aseprite精灵动画测试文件 | FormiPeek',
      ...
      'animation-fbx': {
        meta: {
          title: '下载免费Animation FBX示例文件 - Autodesk FBX 3D动画测试文件 | FormiPeek',
      ...
      assetbundle: {
        meta: {
          title: '下载免费AssetBundle示例文件 - 游戏开发的Unity AssetBundle测试文件 | FormiPeek',
      ...
      blend: {
        meta: {
          title: '下载免费BLEND示例文件 - Blender 3D项目测试文件 | FormiPeek',
      ...
      bvh: {
        meta: {
          title: '下载免费BVH示例文件 - Biovision Hierarchy动作捕捉测试文件 | FormiPeek',
      ...
      dwg: {
        meta: {
          title: '下载免费DWG示例文件 - CAD设计的AutoCAD图纸测试文件 | FormiPeek',
      ...
      dxf: {
        meta: {
          title: '下载免费DXF示例文件 - Drawing Exchange Format测试文件AutoCAD | FormiPeek',
      ...
      ifc: {
        meta: {
          title: '下载免费IFC示例文件 - Industry Foundation Classes BIM测试文件 | FormiPeek',
      ...
      iges: {
        meta: {
          title: '下载免费IGES示例文件 - Initial Graphics Exchange Specification CAD测试文件 | FormiPeek',
      ...
      igs: {
        meta: {
          title: '下载免费IGS示例文件 - Initial Graphics Exchange Specification CAD测试文件 | FormiPeek',
      ...
      las: {
        meta: {
          title: '下载免费LAS示例文件 - LiDAR点云数据测试文件 | FormiPeek',
      ...
      ma: {
        meta: {
          title: '下载免费MA示例文件 - Maya ASCII场景测试文件 | FormiPeek',
      ...
      max: {
        meta: {
          title: '下载免费MAX示例文件 - 3ds Max场景测试文件 | FormiPeek',
      ...
      mb: {
        meta: {
          title: '下载免费MB示例文件 - Maya Binary场景测试文件 | FormiPeek',
      ...
      indd: {
        meta: {
          title: '下载免费INDD示例文件 - Adobe InDesign文档测试文件 | FormiPeek',
      ...
      'animated-gif': {
        meta: {
          title: '下载免费动画GIF示例文件 - 动画图像测试文件 | FormiPeek',
      ...
      apng: {
        meta: {
          title: '下载免费APNG示例文件 - 动画PNG图像测试文件 | FormiPeek',
      ...
      avif: {
        meta: {
          title: '下载免费AVIF示例文件 - AV1图像文件格式测试文件 | FormiPeek',
      ...
      bmp: {
        meta: {
          title: '下载免费BMP示例文件 - 位图图像测试文件 | FormiPeek',
      ...
      'barcode-svg': {
        meta: {
          title: '下载免费条形码SVG示例文件 - 可缩放矢量条形码测试文件 | FormiPeek',
      ...
      avi: {
        meta: {
          title: '下载免费AVI示例文件 - Audio Video Interleave视频测试文件 | FormiPeek',
      ...
      '3gp': {
        meta: {
          title: '下载免费3GP示例文件 - 3GPP移动视频测试文件 | FormiPeek',
      ...
      dav: {
        meta: {
          title: '下载免费DAV示例文件 - 安全摄像头DAV视频测试文件 | FormiPeek',
      ...
      dds: {
        meta: {
          title: '下载免费DDS示例文件 - DirectDraw Surface纹理测试文件 | FormiPeek',
      ...
      dng: {
        meta: {
          title: '下载免费DNG示例文件 - Digital Negative原始图像测试文件 | FormiPeek',
      ...
      eps: {
        meta: {
          title: '下载免费EPS示例文件 - Encapsulated PostScript矢量图形测试文件 | FormiPeek',
      ...
      exr: {
        meta: {
          title: '下载免费EXR示例文件 - OpenEXR高动态范围图像测试文件 | FormiPeek',
      ...
      hdr: {
        meta: {
          title: '下载免费HDR示例文件 - 高动态范围图像测试文件 | FormiPeek',
      ...
      heic: {
        meta: {
          title: '下载免费HEIC示例文件 - 高效图像容器测试文件 | FormiPeek',
      ...
      heif: {
        meta: {
          title: '下载免费HEIF示例文件 - 高效图像格式测试文件 | FormiPeek',
      ...
      icns: {
        meta: {
          title: '下载免费ICNS示例文件 - macOS图标测试文件 | FormiPeek',
      ...
      ico: {
        meta: {
          title: '下载免费ICO示例文件 - Windows图标测试文件 | FormiPeek',
      ...
      jpeg: {
        meta: {
          title: '下载免费JPEG示例文件 - 转换工具用JPEG图像测试文件 | FormiPeek',
      ...
      jpg: {
        meta: {
          title: '下载免费JPG示例文件 - 转换工具用JPG图像测试文件 | FormiPeek',
      ...
      m4v: {
        meta: {
          title: '下载免费M4V示例文件 - 转换工具用M4V视频测试文件 | FormiPeek',
      ...
      mkv: {
        meta: {
          title: '下载免费MKV示例文件 - 转换工具用Matroska视频测试文件 | FormiPeek',
      ...
      aac: {
        meta: {
          title: '下载免费AAC示例文件 - 高级音频编码测试文件 | FormiPeek',
      ...
      ac3: {
        meta: {
          title: '下载免费AC3示例文件 - 杜比数字音频测试文件 | FormiPeek',
      ...
      aif: {
        meta: {
          title: '下载免费AIF示例文件 - 音频交换文件格式测试文件 | FormiPeek',
      ...
      aiff: {
        meta: {
          title: '下载免费AIFF示例文件 - 音频交换文件格式测试文件 | FormiPeek',
      ...
      amr: {
        meta: {
          title: '下载免费AMR示例文件 - 自适应多速率音频测试文件 | FormiPeek',
      ...
      caf: {
        meta: {
          title: '下载免费CAF示例文件 - 核心音频格式测试文件 | FormiPeek',
      ...
      cue: {
        meta: {
          title: '下载免费CUE示例文件 - 用于音频CD刻录的CUE Sheet测试文件 | FormiPeek',
      ...
      m4a: {
        meta: {
          title: '下载免费M4A示例文件 - 用于转换工具的M4A音频测试文件 | FormiPeek',
      ...
      midi: {
        meta: {
          title: '下载免费MIDI示例文件 - 用于音乐排序的MIDI Music测试文件 | FormiPeek',
      ...
      ace: {
        meta: {
          title: '下载免费ACE示例文件 - 用于提取工具的ACE Archive测试文件 | FormiPeek',
      ...
      arj: {
        meta: {
          title: '下载免费ARJ示例文件 - 用于提取工具的ARJ Archive测试文件 | FormiPeek',
      ...
      bz2: {
        meta: {
          title: '下载免费BZ2示例文件 - BZ2 Compressed Archive测试文件 | FormiPeek',
      ...
      gz: {
        meta: {
          title: '下载免费GZ示例文件 - GZ Gzip Compressed Archive测试文件 | FormiPeek',
      ...
      cab: {
        meta: {
          title: '下载免费CAB示例文件 - CAB Windows Cabinet Archive测试文件 | FormiPeek',
      ...
      cpio: {
        meta: {
          title: '下载免费CPIO示例文件 - 用于提取工具的CPIO Archive测试文件 | FormiPeek',
      ...
      zip: {
        meta: {
          title: '下载免费ZIP示例文件 - 用于提取工具的ZIP Archive测试文件 | FormiPeek',
      ...
      dmg: {
        meta: {
          title: '下载免费DMG示例文件 - DMG macOS Disk Image测试文件 | FormiPeek',
      ...
      img: {
        meta: {
          title: '下载免费IMG示例文件 - IMG Disk Image测试文件 | FormiPeek',
      ...
      iso: {
        meta: {
          title: '下载免费ISO示例文件 - ISO Disk Image测试文件 | FormiPeek',
      ...
      kmz: {
        meta: {
          title: '下载免费KMZ示例文件 - KMZ Compressed KML测试文件 | FormiPeek',
      ...
      laz: {
        meta: {
          title: '下载免费LAZ示例文件 - LAZ Compressed LiDAR测试文件 | FormiPeek',
      ...
      lha: {
        meta: {
          title: '下载免费LHA示例文件 - 用于提取工具的LHA Archive测试文件 | FormiPeek',
      ...
      lzh: {
        meta: {
          title: '下载免费LZH示例文件 - 用于提取工具的LZH Archive测试文件 | FormiPeek',
      ...
      lzma: {
        meta: {
          title: '下载免费LZMA示例文件 - LZMA Compressed Archive测试文件 | FormiPeek',
      ...
      '7z': {
        meta: {
          title: '下载免费7Z示例文件 - 用于提取工具的7Z Archive测试文件 | FormiPeek',

...
export const ja: SamplePageTranslations = {
  sample_page: {
    ...
    formats: {
      ...
      doc: {
        meta: {
          title: '無料DOCサンプルファイルをダウンロード - Microsoft Word DOCテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料DOCサンプルファイル - Microsoft Word DOCテストファイルをダウンロード',
          description: 'ドキュメント変換ツールをテストするための無料DOCサンプルファイルをダウンロード。複数のファイルサイズを利用可能: 100 KB、1 MB、5 MB、50 MB、100 MB。DOCからPDF、DOCからDOCXへのコンバーター、レガシーMicrosoft Wordドキュメント処理のテストに最適です。'
        },
        hero: {
          title: 'DOCサンプルファイル',
          description: 'テスト用の無料DOCサンプルファイルをダウンロード。ドキュメント変換ツール、DOCからPDFへのコンバーター、レガシーMicrosoft Wordドキュメントプロセッサーをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのDOCテストファイルです'
      },
      pdf: {
        meta: {
          title: '無料PDFサンプルファイルをダウンロード - 変換ツール用PDFテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料PDFサンプルファイル - 変換ツール用PDFテストファイルをダウンロード',
          description: 'PDFコンバーター、ビューアー、プロセッサーをテストするための無料PDFサンプルファイルをダウンロード。複数のファイルサイズを利用可能: 100 KB、1 MB、5 MB、50 MB、100 MB。PDFからWord、PDFからJPG、PDF圧縮、PDF編集ツールのテストに最適です。'
        },
        hero: {
          title: 'PDFサンプルファイル',
          description: 'テスト用の無料PDFサンプルファイルをダウンロード。PDFコンバーター、PDFからWordツール、PDF圧縮ソフトウェア、PDF処理アプリケーションをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのPDFテストファイルです'
      },
      odp: {
        meta: {
          title: '無料ODPサンプルファイルをダウンロード - OpenDocumentプレゼンテーションテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料ODPサンプルファイル - OpenDocumentプレゼンテーションテストファイルをダウンロード',
          description: 'プレゼンテーション変換ツールをテストするための無料ODPサンプルファイルをダウンロード。複数のファイルサイズを利用可能: 100 KB、1 MB、5 MB、50 MB、100 MB。ODPからPPT、ODPからPDFへのコンバーター、LibreOffice Impressファイル、OpenDocument形式処理のテストに最適です。'
        },
        hero: {
          title: 'ODPサンプルファイル',
          description: 'テスト用の無料ODPサンプルファイルOpenDocumentプレゼンテーションをダウンロード。プレゼンテーション変換ツール、ODPからPPTへのコンバーター、OpenDocument形式プロセッサーをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのODPテストファイルです'
      },
      rtf: {
        meta: {
          title: '無料RTFサンプルファイルをダウンロード - Rich Text Formatテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料RTFサンプルファイル - Rich Text Formatテストファイルをダウンロード',
          description: 'Rich Text Format変換ツールをテストするための無料RTFサンプルファイルをダウンロード。複数のファイルサイズを利用可能: 100 KB、1 MB、5 MB、50 MB、100 MB。RTFからDOC、RTFからPDFへのコンバーター、ワードプロセッサー互換性、ドキュメント形式変換のテストに最適です。'
        },
        hero: {
          title: 'RTFサンプルファイル',
          description: 'テスト用の無料RTFサンプルファイルRich Text Formatドキュメントをダウンロード。ドキュメント変換ツール、RTFからDOCへのコンバーター、ワードプロセッサー互換性をテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのRTFテストファイルです'
      },
      epub: {
        meta: {
          title: '無料EPUBサンプルファイルをダウンロード - リーダー用eBookテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料EPUBサンプルファイル - リーダー用eBookテストファイルをダウンロード',
          description: 'eBookリーダーと変換ツールをテストするための無料EPUBサンプルファイルをダウンロード。複数のファイルサイズを利用可能: 100 KB、1 MB、5 MB、50 MB、100 MB。EPUBリーダー、EPUBからPDF、EPUBからMOBIへのコンバーター、デジタル出版ツール、eBook形式互換性のテストに最適です。'
        },
        hero: {
          title: 'EPUBサンプルファイル',
          description: 'テスト用の無料EPUBサンプルファイルをダウンロード。eBookリーダー、EPUBからPDFへのコンバーター、EPUBからMOBIツール、デジタル出版アプリケーションをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのEPUBテストファイルです'
      },
      'invoice-pdf': {
        meta: {
          title: '無料請求書PDFサンプルファイルをダウンロード - 請求書ドキュメントテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料請求書PDFサンプルファイル - 請求書ドキュメントテストファイルをダウンロード',
          description: '請求書処理および解析ツールをテストするための無料請求書PDFサンプルファイルをダウンロード。複数のファイルサイズを利用可能: 100 KB、1 MB、5 MB、50 MB、100 MB。請求書OCR、請求書データ抽出、請求書自動化、請求書PDF解析、ドキュメント管理システムのテストに最適です。'
        },
        hero: {
          title: '請求書PDFサンプルファイル',
          description: 'テスト用の無料請求書PDFサンプルファイルをダウンロード。請求書処理ツール、請求書OCRソフトウェア、請求書データ抽出システム、ドキュメント管理アプリケーションをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズの請求書PDFテストファイルです'
      },
      mobi: {
        meta: {
          title: '無料MOBIサンプルファイルをダウンロード - Kindle用MOBI eBookテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料MOBIサンプルファイル - Kindle用MOBI eBookテストファイルをダウンロード',
          description: 'MOBI eBookリーダーと変換ツールをテストするための無料MOBIサンプルファイルをダウンロード。複数のファイルサイズを利用可能: 100 KB、1 MB、5 MB、50 MB、100 MB。Kindle互換性、MOBIからEPUB、MOBIからPDFへのコンバーター、eBook形式変換、デジタルリーディングアプリケーションのテストに最適です。'
        },
        hero: {
          title: 'MOBIサンプルファイル',
          description: 'テスト用の無料MOBIサンプルファイルをダウンロード。MOBI eBookリーダー、MOBIからEPUBへのコンバーター、MOBIからPDFツール、Kindle互換性アプリケーションをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのMOBIテストファイルです'
      },
      csv: {
        meta: {
          title: '無料CSVサンプルファイルをダウンロード - データ処理用CSVテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料CSVサンプルファイル - データ処理用CSVテストファイルをダウンロード',
          description: 'データ処理および変換ツールをテストするための無料CSVサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。CSVからExcel、CSVからJSONへのコンバーター、データインポートツール、スプレッドシートアプリケーション、カンマ区切り値処理のテストに最適です。'
        },
        hero: {
          title: 'CSVサンプルファイル',
          description: 'テスト用の無料CSVサンプルファイルをダウンロード。CSV変換ツール、CSVからExcelへのコンバーター、データ処理アプリケーション、スプレッドシートインポートソフトウェアをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのCSVテストファイルです'
      },
      xls: {
        meta: {
          title: '無料XLSサンプルファイルをダウンロード - Microsoft Excel XLSテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料XLSサンプルファイル - Microsoft Excel XLSテストファイルをダウンロード',
          description: 'Excel変換およびデータ処理ツールをテストするための無料XLSサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。XLSからXLSX、XLSからCSV、XLSからPDFへのコンバーター、Excelデータ抽出、レガシースプレッドシート処理のテストに最適です。'
        },
        hero: {
          title: 'XLSサンプルファイル',
          description: 'テスト用の無料XLS Excelスプレッドシートサンプルファイルをダウンロード。Excel変換ツール、XLSからXLSXへのコンバーター、データ処理アプリケーション、スプレッドシートインポートソフトウェアをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのXLSテストファイルです'
      },
      xlsx: {
        meta: {
          title: '無料XLSXサンプルファイルをダウンロード - 変換ツール用Excel XLSXテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料XLSXサンプルファイル - 変換ツール用Excel XLSXテストファイルをダウンロード',
          description: 'Excel変換およびデータ処理ツールをテストするための無料XLSXサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。XLSXからCSV、XLSXからPDF、XLSXからJSONへのコンバーター、Excelデータ分析、スプレッドシート自動化、Office Open XML処理のテストに最適です。'
        },
        hero: {
          title: 'XLSXサンプルファイル',
          description: 'テスト用の無料XLSX Excelスプレッドシートサンプルファイルをダウンロード。Excel変換ツール、XLSXからCSVへのコンバーター、データ分析アプリケーション、スプレッドシート自動化ソフトウェアをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのXLSXテストファイルです'
      },
      xml: {
        meta: {
          title: '無料XMLサンプルファイルをダウンロード - 解析および変換用XMLテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料XMLサンプルファイル - 解析および変換用XMLテストファイルをダウンロード',
          description: 'XML解析、変換、データ処理ツールをテストするための無料XMLサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。XMLからJSON、XMLからCSVへのコンバーター、XML検証、構造化データ処理、マークアップ言語解析のテストに最適です。'
        },
        hero: {
          title: 'XMLサンプルファイル',
          description: 'テスト用の無料XMLサンプルファイルをダウンロード。XML解析ツール、XMLからJSONへのコンバーター、XML検証ソフトウェア、構造化データ処理アプリケーションをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのXMLテストファイルです'
      },
      html: {
        meta: {
          title: '無料HTMLサンプルファイルをダウンロード - Web開発用HTMLテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料HTMLサンプルファイル - Web開発用HTMLテストファイルをダウンロード',
          description: 'Web開発およびHTML処理ツールをテストするための無料HTMLサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。HTMLからPDF、HTMLからDOCXへのコンバーター、HTML検証、Webスクレイピング、ブラウザレンダリング、HyperText Markup Language処理のテストに最適です。'
        },
        hero: {
          title: 'HTMLサンプルファイル',
          description: 'テスト用の無料HTML HyperText Markup Languageサンプルファイルをダウンロード。HTML解析ツール、HTMLからPDFへのコンバーター、HTML検証ソフトウェア、Web開発アプリケーションをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのHTMLテストファイルです'
      },
      ods: {
        meta: {
          title: '無料ODSサンプルファイルをダウンロード - OpenDocumentスプレッドシートテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料ODSサンプルファイル - OpenDocumentスプレッドシートテストファイルをダウンロード',
          description: 'スプレッドシート変換およびデータ処理ツールをテストするための無料ODSサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。ODSからExcel、ODSからCSVへのコンバーター、LibreOffice Calcファイル、OpenDocument形式処理、スプレッドシートデータ抽出のテストに最適です。'
        },
        hero: {
          title: 'ODSサンプルファイル',
          description: 'テスト用の無料ODS OpenDocument Spreadsheetサンプルファイルをダウンロード。スプレッドシート変換ツール、ODSからExcelへのコンバーター、OpenDocument形式プロセッサをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのODSテストファイルです'
      },
      'ansible-yml': {
        meta: {
          title: '無料Ansible YMLサンプルファイルをダウンロード - YAML設定テストファイル | MorphyHub',
        ...
        schema: {
          name: '無料Ansible YMLサンプルファイル - YAML設定テストファイルをダウンロード',
          description: 'YAML解析および設定管理ツールをテストするための無料Ansible YMLサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。Ansible playbook、YAML検証、DevOps自動化、設定管理システム、infrastructure as codeツールのテストに最適です。'
        },
        hero: {
          title: 'Ansible YMLサンプルファイル',
          description: 'テスト用の無料Ansible YML設定サンプルファイルをダウンロード。YAML解析ツール、Ansible playbookバリデーター、設定管理システム、DevOps自動化アプリケーションをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのAnsible YMLテストファイルです'
      },
      'api-response-json': {
        meta: {
          title: '無料API Response JSONサンプルファイルをダウンロード - API開発用JSONテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料API Response JSONサンプルファイル - API開発用JSONテストファイルをダウンロード',
          description: 'JSON解析、API統合、Web開発ツールをテストするための無料API Response JSONサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。REST API応答、JSONバリデーター、APIモッキング、webhookテスト、データ交換形式処理のテストに最適です。'
        },
        hero: {
          title: 'API Response JSONサンプルファイル',
          description: 'テスト用の無料API Response JSONサンプルファイルをダウンロード。JSON解析ツール、API応答ハンドラー、REST APIバリデーター、Web開発アプリケーションをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのAPI Response JSONテストファイルです'
      },
      'arduino-ino': {
        meta: {
          title: '無料Arduino INOサンプルファイルをダウンロード - 組み込み開発用Arduino Sketchテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料Arduino INOサンプルファイル - 組み込み開発用Arduino Sketchテストファイルをダウンロード',
          description: 'Arduino Sketchコンパイルおよび組み込みプログラミングツールをテストするための無料Arduino INOサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。Arduino IDE、Sketch検証、マイクロコントローラー programming、組み込みシステム開発、IoTデバイステストのテストに最適です。'
        },
        hero: {
          title: 'Arduino INOサンプルファイル',
          description: 'テスト用の無料Arduino INO Arduino Sketchソースコードファイルをダウンロード。Arduino開発ツール、Sketchコンパイルソフトウェア、組み込みプログラミングアプリケーションをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのArduino INO (Arduino Sketch)ソースコードファイルです'
      },
      bat: {
        meta: {
          title: '無料BATサンプルファイルをダウンロード - Windows自動化用バッチスクリプトテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料BATサンプルファイル - Windows自動化用バッチスクリプトテストファイルをダウンロード',
          description: 'Windows自動化およびコマンドライン処理ツールをテストするための無料BATバッチスクリプトサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。バッチスクリプト実行、Windowsタスク自動化、コマンドラインツール、スクリプトバリデーター、システム管理ユーティリティのテストに最適です。'
        },
        hero: {
          title: 'BATサンプルファイル',
          description: 'テスト用の無料BATバッチスクリプトサンプルファイルをダウンロード。バッチスクリプト実行ツール、Windows自動化ソフトウェア、コマンドライン処理アプリケーションをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのBAT (Batch)スクリプトファイルです'
      },
      asc: {
        meta: {
          title: '無料ASCサンプルファイルをダウンロード - テキスト処理用ASCIIテキストテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料ASCサンプルファイル - テキスト処理用ASCIIテキストテストファイルをダウンロード',
          description: 'テキスト処理およびエンコーディングツールをテストするための無料ASC ASCIIテキストサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。ASCIIエンコーディング、テキストファイル解析、プレーンテキストエディター、文字エンコーディング検証、テキスト形式変換ツールのテストに最適です。'
        },
        hero: {
          title: 'ASCサンプルファイル',
          description: 'テスト用の無料ASC ASCIIテキストサンプルファイルをダウンロード。テキスト処理ツール、ASCIIエンコーディングソフトウェア、プレーンテキストファイル処理アプリケーションをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのASC (ASCII Text)ファイルです'
      },
      bib: {
        meta: {
          title: '無料BIBサンプルファイルをダウンロード - 学術研究用参考文献テストファイル | MorphyHub',
        ...
        schema: {
          name: '無料BIBサンプルファイル - 学術研究用参考文献テストファイルをダウンロード',
          description: '参考文献管理および引用ツールをテストするための無料BIB参考文献サンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。BibTeX形式処理、参考文献マネージャー、引用ジェネレーター、学術執筆ツール、LaTeX参考文献統合のテストに最適です。'
        },
        hero: {
          title: 'BIBサンプルファイル',
          description: 'テスト用の無料BIB参考文献サンプルファイルをダウンロード。参考文献管理ツール、BibTeXプロセッサー、引用処理アプリケーションをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのBIB (Bibliography)ファイルです'
      },
      c: {
        meta: {
          title: '無料Cサンプルファイルをダウンロード - 開発用Cプログラミング言語テストファイル | MorphyHub',
        ...
        schema: {
          name: '無料Cサンプルファイル - 開発用Cプログラミング言語テストファイルをダウンロード',
          description: 'Cコードコンパイルおよび開発ツールをテストするための無料Cソースコードサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。Cコンパイラー、構文チェッカー、コードアナライザー、GCC toolchain、組み込みC開発、システムプログラミングツールのテストに最適です。'
        },
        hero: {
          title: 'Cサンプルファイル',
          description: 'テスト用の無料C Cソースコードサンプルファイルをダウンロード。Cコードコンパイルツール、C構文チェッカー、C開発アプリケーションをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのCソースコードファイルです'
      },
      'can-log': {
        meta: {
          title: '無料CAN Logサンプルファイルをダウンロード - 自動車用Controller Area Networkテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料CAN Logサンプルファイル - 自動車用Controller Area Networkテストファイルをダウンロード',
          description: 'CANバス解析および自動車診断ツールをテストするための無料CAN Logサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。CANバスアナライザー、自動車診断ツール、車両ネットワークプロトコル、OBD-IIテスト、組み込み自動車システムのテストに最適です。'
        },
        hero: {
          title: 'CAN Logサンプルファイル',
          description: 'テスト用の無料CAN Log Controller Area Networkログファイルをダウンロード。CANバス解析ツール、自動車診断ソフトウェア、ネットワークプロトコルアプリケーションをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのCAN Log (Controller Area Network)ログファイルです'
      },
      cmd: {
        meta: {
          title: '無料CMDサンプルファイルをダウンロード - 自動化用Windowsコマンドスクリプトテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料CMDサンプルファイル - 自動化用Windowsコマンドスクリプトテストファイルをダウンロード',
          description: 'バッチスクリプト実行およびWindows自動化ツールをテストするための無料CMD Windowsコマンドスクリプトサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。Windowsコマンドプロンプト、バッチファイル実行、スクリプト自動化、システム管理、Windowsタスクスケジューリングツールのテストに最適です。'
        },
        hero: {
          title: 'CMDサンプルファイル',
          description: 'テスト用の無料CMD Windowsコマンドスクリプトサンプルファイルをダウンロード。バッチスクリプト実行ツール、Windowsコマンド処理ソフトウェア、自動化アプリケーションをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのCMD (Windows Command Script)ファイルです'
      },
      conf: {
        meta: {
          title: '無料CONFサンプルファイルをダウンロード - システム設定用設定ファイルテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料CONFサンプルファイル - システム設定用設定ファイルテストファイルをダウンロード',
          description: '設定ファイル解析およびシステム設定ツールをテストするための無料CONF設定サンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。サーバー設定、アプリケーション設定、設定ファイルバリデーター、システム管理ツール、ソフトウェア展開ユーティリティのテストに最適です。'
        },
        hero: {
          title: 'CONFサンプルファイル',
          description: 'テスト用の無料CONF設定サンプルファイルをダウンロード。設定ファイル解析ツール、サーバー設定ソフトウェア、アプリケーション設定アプリケーションをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのCONF設定ファイルです'
      },
      'config-ini': {
        meta: {
          title: '無料Config INIサンプルファイルをダウンロード - アプリケーション用INI設定テストファイル | MorphyHub',
        ...
        schema: {
          name: '無料Config INIサンプルファイル - アプリケーション用INI設定テストファイルをダウンロード',
          description: 'INIファイル解析および設定管理ツールをテストするための無料Config INI INI設定サンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。INIパーサー、アプリケーション設定、設定管理、Windows INIファイル、ソフトウェア設定ユーティリティのテストに最適です。'
        },
        hero: {
          title: 'Config INIサンプルファイル',
          description: 'テスト用の無料Config INI INI設定サンプルファイルをダウンロード。INIファイル解析ツール、設定管理ソフトウェア、アプリケーション設定アプリケーションをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのConfig INI設定ファイルです'
      },
      cpp: {
        meta: {
          title: '無料CPPサンプルファイルをダウンロード - 開発用C++プログラミング言語テストファイル | MorphyHub',
        ...
        schema: {
          name: '無料CPPサンプルファイル - 開発用C++プログラミング言語テストファイルをダウンロード',
          description: 'C++コードコンパイルおよび開発ツールをテストするための無料CPP C++ソースコードサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。C++コンパイラー、構文チェッカー、コードアナライザー、GCC/G++ toolchain、モダンC++機能、オブジェクト指向プログラミングツールのテストに最適です。'
        },
        hero: {
          title: 'CPPサンプルファイル',
          description: 'テスト用の無料CPP C++ソースコードサンプルファイルをダウンロード。C++コードコンパイルツール、C++構文チェッカー、C++開発アプリケーションをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのC++ソースコードファイルです'
      },
      h: {
        meta: {
          title: '無料Hサンプルファイルをダウンロード - プログラミング用C/C++ヘッダーファイルテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料Hサンプルファイル - プログラミング用C/C++ヘッダーファイルテストファイルをダウンロード',
          description: 'ヘッダーファイル処理および開発ツールをテストするための無料H C/C++ヘッダーファイルサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。C/C++コンパイラー、ヘッダーファイルインクルード、プリプロセッサーツール、コード組織、クロスプラットフォーム開発ユーティリティのテストに最適です。'
        },
        hero: {
          title: 'Hサンプルファイル',
          description: 'テスト用の無料H C/C++ヘッダーファイルサンプルファイルをダウンロード。C/C++コードコンパイルツール、ヘッダーファイル処理ソフトウェア、開発アプリケーションをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのH (C/C++ header)ファイルです'
      },
      hpp: {
        meta: {
          title: '無料HPPサンプルファイルをダウンロード - モダンC++開発用C++ヘッダーファイルテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料HPPサンプルファイル - モダンC++開発用C++ヘッダーファイルテストファイルをダウンロード',
          description: 'C++ヘッダーファイル処理および開発ツールをテストするための無料HPP C++ヘッダーファイルサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。C++コンパイラー、header-onlyライブラリー、テンプレートメタプログラミング、モダンC++機能、高度なC++開発ユーティリティのテストに最適です。'
        },
        hero: {
          title: 'HPPサンプルファイル',
          description: 'テスト用の無料HPP C++ヘッダーファイルサンプルファイルをダウンロード。C++コードコンパイルツール、ヘッダーファイル処理ソフトウェア、C++開発アプリケーションをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのHPP (C++ header)ファイルです'
      },
      hex: {
        meta: {
          title: '無料HEXサンプルファイルをダウンロード - ファームウェアおよび組み込みシステム開発用hexテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料HEXサンプルファイル - ファームウェアおよび組み込みシステム開発用hexテストファイルをダウンロード',
          description: 'ファームウェアプログラミング、組み込みシステム開発、バイナリデータ分析をテストするための無料HEX hexサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。hexエディター、ファームウェアローダー、マイクロコントローラープログラミング、組み込み開発ツールのテストに最適です。'
        },
        hero: {
          title: 'HEXサンプルファイル',
          description: 'テスト用の無料HEX hexサンプルファイルをダウンロード。hexエディター、ファームウェアプログラミングツール、組み込み開発アプリケーションをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのHEX (hex)ファイルです'
      },
      cs: {
        meta: {
          title: '無料CSサンプルファイルをダウンロード - .NET開発用C#ソースコードテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料CSサンプルファイル - .NET開発用C#ソースコードテストファイルをダウンロード',
          description: 'C#コンパイル、.NET開発、Visual Studioツールをテストするための無料CS C#ソースコードサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。C#コンパイラー、.NETフレームワーク、Visual Studio IDE、コード分析ツール、C#開発環境のテストに最適です。'
        },
        hero: {
          title: 'CSサンプルファイル',
          description: 'テスト用の無料CS C#ソースコードサンプルファイルをダウンロード。C#コンパイル、.NET開発、Visual Studioツールをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのCS (C#)ソースコードファイルです'
      },
      css: {
        meta: {
          title: '無料CSSサンプルファイルをダウンロード - Web開発用スタイルシートテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料CSSサンプルファイル - Web開発用スタイルシートテストファイルをダウンロード',
          description: 'Webスタイリング、CSS解析、フロントエンドツールをテストするための無料CSSスタイルシートサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。CSSバリデーター、プリプロセッサー（SASS、LESS）、CSSミニファイアー、Webブラウザー、フロントエンド開発フレームワークのテストに最適です。'
        },
        hero: {
          title: 'CSSサンプルファイル',
          description: 'テスト用の無料CSSスタイルシートサンプルファイルをダウンロード。CSSバリデーター、プリプロセッサー、Web開発ツールをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのCSS (Cascading Style Sheets)ファイルです'
      },
      csr: {
        meta: {
          title: '無料CSRサンプルファイルをダウンロード - SSL/TLS用証明書署名リクエストテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料CSRサンプルファイル - SSL/TLS用証明書署名リクエストテストファイルをダウンロード',
          description: 'SSL/TLS証明書生成、PKI管理、セキュリティツールをテストするための無料CSR証明書署名リクエストサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。証明機関、OpenSSL、SSL証明書生成、PKIインフラストラクチャ、セキュリティ証明書管理ツールのテストに最適です。'
        },
        hero: {
          title: 'CSRサンプルファイル',
          description: 'テスト用の無料CSR証明書署名リクエストサンプルファイルをダウンロード。SSL/TLS証明書生成、PKI管理ツールをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのCSR (Certificate Signing Request)ファイルです'
      },
      'customer-database-sql': {
        meta: {
          title: '無料Customer Database SQLサンプルファイルをダウンロード - SQLデータベーステストファイル | MorphyHub',
        ...
        schema: {
          name: '無料Customer Database SQLサンプルファイル - SQLデータベーステストファイルをダウンロード',
          description: 'SQLデータベース操作、クエリ実行、データベース管理ツールをテストするための無料Customer Database SQLサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。SQLパーサー、データベースインポートツール、SQLite、MySQL、PostgreSQL、データベース管理システムのテストに最適です。'
        },
        hero: {
          title: 'Customer Database SQLサンプルファイル',
          description: 'テスト用の無料Customer Database SQLサンプルファイルをダウンロード。SQLパーサー、データベースインポートツール、データベース管理システムをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのCustomer Database SQLファイルです'
      },
      dbf: {
        meta: {
          title: '無料DBFサンプルファイルをダウンロード - データ管理用dBASEデータベーステストファイル | MorphyHub',
        ...
        schema: {
          name: '無料DBFサンプルファイル - データ管理用dBASEデータベーステストファイルをダウンロード',
          description: 'データベース操作、データインポート/エクスポート、レガシーデータベース形式をテストするための無料DBF dBASEデータベースサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。dBASE互換性、データベースコンバーター、データ移行ツール、スプレッドシートアプリケーション、データベース管理システムのテストに最適です。'
        },
        hero: {
          title: 'DBFサンプルファイル',
          description: 'テスト用の無料DBF dBASEデータベースサンプルファイルをダウンロード。データベースコンバーター、データ移行ツール、データベース管理システムをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのDBF (dBASEデータベース)ファイルです'
      },
      dem: {
        meta: {
          title: '無料DEMサンプルファイルをダウンロード - GISおよびマッピング用デジタル標高モデルテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料DEMサンプルファイル - GISおよびマッピング用デジタル標高モデルテストファイルをダウンロード',
          description: 'GISアプリケーション、地形マッピング、地理空間分析ツールをテストするための無料DEMデジタル標高モデルサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。GISソフトウェア、地形可視化、標高データ処理、マッピングアプリケーション、地理空間分析ツールのテストに最適です。'
        },
        hero: {
          title: 'DEMサンプルファイル',
          description: 'テスト用の無料DEMデジタル標高モデルサンプルファイルをダウンロード。GISソフトウェア、地形可視化、地理空間分析ツールをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのDEM (Digital Elevation Model)ファイルです'
      },
      der: {
        meta: {
          title: '無料DERサンプルファイルをダウンロード - Distinguished Encoding Rules証明書テストファイル | MorphyHub',
        ...
        schema: {
          name: '無料DERサンプルファイル - Distinguished Encoding Rules証明書テストファイルをダウンロード',
          description: 'SSL/TLS証明書、PKI管理、セキュリティツールをテストするための無料DER Distinguished Encoding Rules証明書サンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。証明書解析、OpenSSL、PKIインフラストラクチャ、SSL証明書検証、セキュリティ証明書管理ツールのテストに最適です。'
        },
        hero: {
          title: 'DERサンプルファイル',
          description: 'テスト用の無料DER Distinguished Encoding Rules証明書サンプルファイルをダウンロード。証明書解析、OpenSSL、PKI管理ツールをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのDER (Distinguished Encoding Rules)証明書ファイルです'
      },
      dmp: {
        meta: {
          title: '無料DMPサンプルファイルをダウンロード - デバッグおよび分析用メモリダンプテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料DMPサンプルファイル - デバッグおよび分析用メモリダンプテストファイルをダウンロード',
          description: 'クラッシュ分析、デバッグツール、システム診断をテストするための無料DMPメモリダンプサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。デバッガー、クラッシュ分析ツール、メモリアナライザー、システム診断ツール、フォレンジック分析アプリケーションのテストに最適です。'
        },
        hero: {
          title: 'DMPサンプルファイル',
          description: 'テスト用の無料DMPメモリダンプサンプルファイルをダウンロード。クラッシュ分析、デバッグ、システム診断ツールをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのDMP (メモリダンプ)ファイルです'
      },
      'docker-compose-yml': {
        meta: {
          title: '無料Docker Compose YMLサンプルファイルをダウンロード - Docker Compose設定テストファイル | MorphyHub',
        ...
        schema: {
          name: '無料Docker Compose YMLサンプルファイル - Docker Compose設定テストファイルをダウンロード',
          description: 'Dockerコンテナオーケストレーション、マルチコンテナアプリケーション、DevOpsツールをテストするための無料Docker Compose YML設定サンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。Docker Compose、コンテナオーケストレーション、YAML解析、DevOps自動化、コンテナ化アプリケーションデプロイメントツールのテストに最適です。'
        },
        hero: {
          title: 'Docker Compose YMLサンプルファイル',
          description: 'テスト用の無料Docker Compose YML設定サンプルファイルをダウンロード。Docker Compose、コンテナオーケストレーション、DevOps自動化ツールをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのDocker Compose YML設定ファイルです'
      },
      dockerfile: {
        meta: {
          title: '無料Dockerfileサンプルファイルをダウンロード - Dockerコンテナビルドテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料Dockerfileサンプルファイル - Dockerコンテナビルドテストファイルをダウンロード',
          description: 'コンテナ化、Dockerビルド、DevOpsツールをテストするための無料Dockerfile Dockerコンテナビルドサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。Dockerビルド、コンテナイメージ作成、Dockerfile解析、コンテナ化ツール、DevOps自動化プラットフォームのテストに最適です。'
        },
        hero: {
          title: 'Dockerfileサンプルファイル',
          description: 'テスト用の無料Dockerfile Dockerコンテナビルドサンプルファイルをダウンロード。Dockerビルド、コンテナイメージ作成、コンテナ化ツールをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのDockerfile (Dockerコンテナビルド)ファイルです'
      },
      editorconfig: {
        meta: {
          title: '無料EditorConfigサンプルファイルをダウンロード - エディター設定テストファイル | MorphyHub',
        ...
        schema: {
          name: '無料EditorConfigサンプルファイル - エディター設定テストファイルをダウンロード',
          description: 'コードエディター設定、フォーマット一貫性、開発ツールをテストするための無料EditorConfigエディター設定サンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。EditorConfigパーサー、コードエディタープラグイン、フォーマットツール、IDE設定、開発環境セットアップツールのテストに最適です。'
        },
        hero: {
          title: 'EditorConfigサンプルファイル',
          description: 'テスト用の無料EditorConfigエディター設定サンプルファイルをダウンロード。EditorConfigパーサー、コードエディタープラグイン、フォーマットツールをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのEditorConfig (エディター設定)ファイルです'
      },
      ini: {
        meta: {
          title: '無料INIサンプルファイルをダウンロード - アプリケーション用INI設定テストファイル | MorphyHub',
        ...
        schema: {
          name: '無料INIサンプルファイル - アプリケーション用INI設定テストファイルをダウンロード',
          description: 'アプリケーション設定、INIファイル解析、設定管理ツールをテストするための無料INI設定サンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。INIパーサー、アプリケーション設定、設定管理、Windows INIファイル、ソフトウェア設定ユーティリティのテストに最適です。'
        },
        hero: {
          title: 'INIサンプルファイル',
          description: 'テスト用の無料INI設定サンプルファイルをダウンロード。INIパーサー、アプリケーション設定、設定管理ツールをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのINI (設定)ファイルです'
      },
      intelhex: {
        meta: {
          title: '無料IntelHexサンプルファイルをダウンロード - ファームウェア開発用Intel hexテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料IntelHexサンプルファイル - ファームウェア開発用Intel hexテストファイルをダウンロード',
          description: 'ファームウェアプログラミング、組み込みシステム開発、マイクロコントローラーツールをテストするための無料IntelHex Intel hexサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。IntelHexパーサー、ファームウェアローダー、マイクロコントローラープログラミング、組み込み開発ツール、hexファイル処理アプリケーションのテストに最適です。'
        },
        hero: {
          title: 'IntelHexサンプルファイル',
          description: 'テスト用の無料IntelHex Intel hexサンプルファイルをダウンロード。IntelHexパーサー、ファームウェアローダー、組み込み開発ツールをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのIntelHex (Intel hex)ファイルです'
      },
      ipynb: {
        meta: {
          title: '無料IPYNBサンプルファイルをダウンロード - データサイエンス用Jupyter Notebookテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料IPYNBサンプルファイル - データサイエンス用Jupyter Notebookテストファイルをダウンロード',
          description: 'データサイエンスワークフロー、Python実行、ノートブック分析ツールをテストするための無料IPYNB Jupyter Notebookサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。Jupyter Notebook、Pythonデータサイエンスツール、ノートブックビューアー、データ分析アプリケーション、科学計算プラットフォームのテストに最適です。'
        },
        hero: {
          title: 'IPYNBサンプルファイル',
          description: 'テスト用の無料IPYNB Jupyter Notebookサンプルファイルをダウンロード。Jupyter Notebook、Pythonデータサイエンスツール、ノートブック分析アプリケーションをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのIPYNB (Jupyter Notebook)ファイルです'
      },
      java: {
        meta: {
          title: '無料Javaサンプルファイルをダウンロード - 開発用Javaソースコードテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料Javaサンプルファイル - 開発用Javaソースコードテストファイルをダウンロード',
          description: 'Javaコンパイル、JVMアプリケーション、開発ツールをテストするための無料Java Javaソースコードサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。Javaコンパイラー、JVM、IDEサポート（Eclipse、IntelliJ）、Javaビルドツール（Maven、Gradle）、Java開発環境のテストに最適です。'
        },
        hero: {
          title: 'Javaサンプルファイル',
          description: 'テスト用の無料Java Javaソースコードサンプルファイルをダウンロード。Javaコンパイラー、JVM、Java開発ツールをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのJavaソースコードファイルです'
      },
      jks: {
        meta: {
          title: '無料JKSサンプルファイルをダウンロード - SSL/TLSセキュリティ用Java KeyStoreテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料JKSサンプルファイル - SSL/TLSセキュリティ用Java KeyStoreテストファイルをダウンロード',
          description: 'SSL/TLS証明書ストレージ、Javaセキュリティ、PKI管理ツールをテストするための無料JKS Java KeyStoreサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。Java KeyStore管理、JKS解析、SSL証明書ストレージ、Javaセキュリティツール、PKIインフラストラクチャのテストに最適です。'
        },
        hero: {
          title: 'JKSサンプルファイル',
          description: 'テスト用の無料JKS Java KeyStoreサンプルファイルをダウンロード。Java KeyStore管理、JKS解析、SSL証明書ストレージツールをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのJKS (Java KeyStore)ファイルです'
      },
      json: {
        meta: {
          title: '無料JSONサンプルファイルをダウンロード - Web開発用JSONデータテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料JSONサンプルファイル - Web開発用JSONデータテストファイルをダウンロード',
          description: 'JSON解析、API統合、Web開発ツールをテストするための無料JSON JSONデータサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。JSONパーサー、APIレスポンス、データ交換形式、Webアプリケーション、JSON検証ツールのテストに最適です。'
        },
        hero: {
          title: 'JSONサンプルファイル',
          description: 'テスト用の無料JSON JSONデータサンプルファイルをダウンロード。JSONパーサー、API統合、Web開発ツールをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのJSON (JavaScript Object Notation)ファイルです'
      },
      jsonl: {
        meta: {
          title: '無料JSONLサンプルファイルをダウンロード - データ処理用JSON Linesテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料JSONLサンプルファイル - データ処理用JSON Linesテストファイルをダウンロード',
          description: 'データ処理、JSONストリーミング、ビッグデータツールをテストするための無料JSONL JSON Linesサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。JSONLパーサー、データストリーミングアプリケーション、ETLツール、ビッグデータ処理、ログファイル分析ツールのテストに最適です。'
        },
        hero: {
          title: 'JSONLサンプルファイル',
          description: 'テスト用の無料JSONL JSON Linesサンプルファイルをダウンロード。JSONLパーサー、データストリーミングアプリケーション、ビッグデータ処理ツールをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのJSONL (JSON Lines)ファイルです'
      },
      js: {
        meta: {
          title: '無料JSサンプルファイルをダウンロード - Web開発用JavaScriptソースコードテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料JSサンプルファイル - Web開発用JavaScriptソースコードテストファイルをダウンロード',
          description: 'JavaScript実行、Web開発、フロントエンドツールをテストするための無料JS JavaScriptソースコードサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。JavaScriptエンジン、Node.js、Webブラウザー、JavaScriptミニファイアー、コード分析ツール、フロントエンド開発フレームワークのテストに最適です。'
        },
        hero: {
          title: 'JSサンプルファイル',
          description: 'テスト用の無料JS JavaScriptソースコードサンプルファイルをダウンロード。JavaScriptエンジン、Node.js、Web開発ツールをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのJS (JavaScript)ソースコードファイルです'
      },
      jsx: {
        meta: {
          title: '無料JSXサンプルファイルをダウンロード - フロントエンド開発用React JSXテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料JSXサンプルファイル - フロントエンド開発用React JSXテストファイルをダウンロード',
          description: 'React開発、JSXコンパイル、フロントエンドフレームワークをテストするための無料JSX React JSXサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。React、JSXトランスパイラー（Babel）、フロントエンドビルドツール、React開発環境、モダンJavaScriptフレームワークのテストに最適です。'
        },
        hero: {
          title: 'JSXサンプルファイル',
          description: 'テスト用の無料JSX React JSXサンプルファイルをダウンロード。React、JSXトランスパイラー、フロントエンド開発ツールをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのJSX (React JSX)ファイルです'
      },
      jwt: {
        meta: {
          title: '無料JWTサンプルファイルをダウンロード - APIセキュリティ用JSON Web Tokenテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料JWTサンプルファイル - APIセキュリティ用JSON Web Tokenテストファイルをダウンロード',
          description: 'API認証、JWTトークン解析、セキュリティツールをテストするための無料JWT JSON Web Tokenサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。JWTパーサー、API認証、トークン検証、OAuth 2.0、セキュリティテストツールのテストに最適です。'
        },
        hero: {
          title: 'JWTサンプルファイル',
          description: 'テスト用の無料JWT JSON Web Tokenサンプルファイルをダウンロード。JWTパーサー、API認証、セキュリティツールをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのJWT (JSON Web Token)ファイルです'
      },
      key: {
        meta: {
          title: '無料KEYサンプルファイルをダウンロード - SSL/TLSセキュリティ用秘密鍵テストファイル | MorphyHub',
        ...
        schema: {
          name: '無料KEYサンプルファイル - SSL/TLSセキュリティ用秘密鍵テストファイルをダウンロード',
          description: 'SSL/TLS証明書、暗号化操作、セキュリティツールをテストするための無料KEY秘密鍵サンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。秘密鍵解析、OpenSSL、SSL証明書生成、暗号化ライブラリー、セキュリティ証明書管理ツールのテストに最適です。'
        },
        hero: {
          title: 'KEYサンプルファイル',
          description: 'テスト用の無料KEY秘密鍵サンプルファイルをダウンロード。秘密鍵解析、OpenSSL、セキュリティ証明書管理ツールをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのKEY (秘密鍵)ファイルです'
      },
      kml: {
        meta: {
          title: '無料KMLサンプルファイルをダウンロード - GISおよびマッピング用Keyhole Markup Languageテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料KMLサンプルファイル - GISおよびマッピング用Keyhole Markup Languageテストファイルをダウンロード',
          description: 'GISアプリケーション、地図可視化、地理空間ツールをテストするための無料KML Keyhole Markup Language地理データサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。Google Earth、GISソフトウェア、地図レンダリング、地理データ処理、地理空間分析ツールのテストに最適です。'
        },
        hero: {
          title: 'KMLサンプルファイル',
          description: 'テスト用の無料KML Keyhole Markup Language地理データサンプルファイルをダウンロード。GISソフトウェア、地図可視化、地理空間分析ツールをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのKML (Keyhole Markup Language)地理データファイルです'
      },
      kt: {
        meta: {
          title: '無料KTサンプルファイルをダウンロード - Android開発用Kotlinソースコードテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料KTサンプルファイル - Android開発用Kotlinソースコードテストファイルをダウンロード',
          description: 'Kotlinコンパイル、Android開発、JVMアプリケーションをテストするための無料KT Kotlinソースコードサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。Kotlinコンパイラー、Android Studio、Kotlin/JVM、IDEサポート、Kotlin開発環境のテストに最適です。'
        },
        hero: {
          title: 'KTサンプルファイル',
          description: 'テスト用の無料KT Kotlinソースコードサンプルファイルをダウンロード。Kotlinコンパイラー、Android Studio、Kotlin開発ツールをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのKT (Kotlin)ソースコードファイルです'
      },
      log: {
        meta: {
          title: '無料LOGサンプルファイルをダウンロード - デバッグおよびシステム分析用ログテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料LOGサンプルファイル - デバッグおよびシステム分析用ログテストファイルをダウンロード',
          description: 'ログ解析、システム分析、デバッグツールをテストするための無料LOGログサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。ログアナライザー、システム監視ツール、デバッグアプリケーション、ログ集約システム、システム診断ツールのテストに最適です。'
        },
        hero: {
          title: 'LOGサンプルファイル',
          description: 'テスト用の無料LOGログサンプルファイルをダウンロード。ログアナライザー、システム監視、デバッグツールをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのLOGファイルです'
      },
      lua: {
        meta: {
          title: '無料LUAサンプルファイルをダウンロード - ゲーム開発および自動化用Luaスクリプトテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料LUAサンプルファイル - ゲーム開発および自動化用Luaスクリプトテストファイルをダウンロード',
          description: 'Lua実行、ゲーム開発、自動化ツールをテストするための無料LUA Luaスクリプトサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。Luaインタープリター、ゲームエンジン、スクリプト環境、自動化ツール、組み込みLuaアプリケーションのテストに最適です。'
        },
        hero: {
          title: 'LUAサンプルファイル',
          description: 'テスト用の無料LUA Luaスクリプトサンプルファイルをダウンロード。Luaインタープリター、ゲームエンジン、自動化ツールをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのLUA (Luaスクリプト)ファイルです'
      },
      m3u: {
        meta: {
          title: '無料M3Uサンプルファイルをダウンロード - メディアプレーヤー用M3Uプレイリストテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料M3Uサンプルファイル - メディアプレーヤー用M3Uプレイリストテストファイルをダウンロード',
          description: 'メディアプレーヤー、プレイリスト解析、audio/videoストリーミングツールをテストするための無料M3U M3Uプレイリストサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。メディアプレーヤー、プレイリストマネージャー、ストリーミングアプリケーション、audioプレーヤー、videoプレーヤーソフトウェアのテストに最適です。'
        },
        hero: {
          title: 'M3Uサンプルファイル',
          description: 'テスト用の無料M3U M3Uプレイリストサンプルファイルをダウンロード。メディアプレーヤー、プレイリストマネージャー、ストリーミングアプリケーションをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのM3U (プレイリスト)ファイルです'
      },
      m3u8: {
        meta: {
          title: '無料M3U8サンプルファイルをダウンロード - videoストリーミング用M3U8 HLSプレイリストテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料M3U8サンプルファイル - videoストリーミング用M3U8 HLSプレイリストテストファイルをダウンロード',
          description: 'videoストリーミング、HLSプレーヤー、メディア配信ツールをテストするための無料M3U8 M3U8 HLS (HTTP Live Streaming)プレイリストサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。HLSプレーヤー、videoストリーミングプラットフォーム、適応ビットレートストリーミング、メディアサーバー、video配信システムのテストに最適です。'
        },
        hero: {
          title: 'M3U8サンプルファイル',
          description: 'テスト用の無料M3U8 M3U8 HLSプレイリストサンプルファイルをダウンロード。HLSプレーヤー、videoストリーミングプラットフォーム、メディア配信システムをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのM3U8 (HLSプレイリスト)ファイルです'
      },
      makefile: {
        meta: {
          title: '無料Makefileサンプルファイルをダウンロード - Makefileビルド設定テストファイル | MorphyHub',
        ...
        schema: {
          name: '無料Makefileサンプルファイル - Makefileビルド設定テストファイルをダウンロード',
          description: 'ビルド自動化、Makeビルドシステム、開発ツールをテストするための無料Makefileビルド設定サンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。Makeビルドシステム、ビルド自動化ツール、C/C++コンパイル、ビルドスクリプト、開発ビルド環境のテストに最適です。'
        },
        hero: {
          title: 'Makefileサンプルファイル',
          description: 'テスト用の無料Makefileビルド設定サンプルファイルをダウンロード。Makeビルドシステム、ビルド自動化ツール、開発ビルド環境をテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのMakefile (ビルド設定)ファイルです'
      },
      mbtiles: {
        meta: {
          title: '無料MBTilesサンプルファイルをダウンロード - MBTilesマップタイルデータベーステストファイル | MorphyHub',
        ...
        schema: {
          name: '無料MBTilesサンプルファイル - MBTilesマップタイルデータベーステストファイルをダウンロード',
          description: 'マップレンダリング、GISアプリケーション、マッピングツールをテストするための無料MBTilesマップタイルデータベースサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。マップタイルサーバー、GISソフトウェア、マップレンダリングエンジン、モバイルマッピングアプリケーション、オフラインマップツールのテストに最適です。'
        },
        hero: {
          title: 'MBTilesサンプルファイル',
          description: 'テスト用の無料MBTilesマップタイルデータベースサンプルファイルをダウンロード。マップタイルサーバー、GISソフトウェア、マップレンダリングエンジンをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのMBTiles (マップタイルデータベース)ファイルです'
      },
      md: {
        meta: {
          title: '無料MDサンプルファイルをダウンロード - Markdownドキュメントテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料MDサンプルファイル - Markdownドキュメントテストファイルをダウンロード',
          description: 'Markdown解析、ドキュメントツール、コンテンツ管理システムをテストするための無料MD Markdownドキュメントサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。Markdownパーサー、ドキュメントジェネレーター、静的サイトジェネレーター、GitHub Markdown、コンテンツ管理プラットフォームのテストに最適です。'
        },
        hero: {
          title: 'MDサンプルファイル',
          description: 'テスト用の無料MD Markdownドキュメントサンプルファイルをダウンロード。Markdownパーサー、ドキュメントジェネレーター、コンテンツ管理システムをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのMD (Markdown)ファイルです'
      },
      mdx: {
        meta: {
          title: '無料MDXサンプルファイルをダウンロード - ドキュメント用MDX React Markdownテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料MDXサンプルファイル - ドキュメント用MDX React Markdownテストファイルをダウンロード',
          description: 'Reactドキュメント、静的サイトジェネレーター、コンテンツ管理システムをテストするための無料MDX MDX (Markdown + JSX)サンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。MDXパーサー、Reactドキュメントツール、Next.js、Gatsby、静的サイトジェネレーター、モダンドキュメントプラットフォームのテストに最適です。'
        },
        hero: {
          title: 'MDXサンプルファイル',
          description: 'テスト用の無料MDX MDX (Markdown + JSX)サンプルファイルをダウンロード。MDXパーサー、Reactドキュメントツール、静的サイトジェネレーターをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのMDX (Markdown + JSX)ファイルです'
      },
      apk: {
        meta: {
          title: '無料APKサンプルファイルをダウンロード - Androidアプリケーションパッケージテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料APKサンプルファイル - Androidアプリケーションパッケージテストファイルをダウンロード',
          description: 'Androidアプリのインストール、APK分析、リバースエンジニアリング、モバイル開発ツールをテストするための無料APK Androidアプリケーションパッケージサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。APKインストーラー、Androidエミュレーター、アプリアナライザー、セキュリティスキャナー、モバイルアプリ開発プラットフォームのテストに最適です。'
        },
        hero: {
          title: 'APKサンプルファイル',
          description: 'テスト用の無料APK Androidアプリケーションパッケージサンプルファイルをダウンロード。Androidアプリインストールツール、APKアナライザー、モバイル開発プラットフォームをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのAPK (Androidアプリケーションパッケージ)ファイルです'
      },
      appimage: {
        meta: {
          title: '無料AppImageサンプルファイルをダウンロード - Linuxポータブルアプリケーションテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料AppImageサンプルファイル - Linuxポータブルアプリケーションテストファイルをダウンロード',
          description: 'Linuxアプリの配布、AppImageの実行、ディストリビューション間の互換性をテストするための無料AppImage Linuxポータブルアプリケーションサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。AppImageランナー、Linuxアプリケーションランチャー、ポータブルアプリツール、ユニバーサルLinuxソフトウェア配布のテストに最適です。'
        },
        hero: {
          title: 'AppImageサンプルファイル',
          description: 'テスト用の無料AppImage Linuxポータブルアプリケーションサンプルファイルをダウンロード。AppImageランナー、Linuxアプリケーションランチャー、ポータブルアプリツールをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのAppImage (Linuxポータブルアプリケーション)ファイルです'
      },
      elf: {
        meta: {
          title: '無料ELFサンプルファイルをダウンロード - Linux/Unix用Executable and Linkable Formatテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料ELFサンプルファイル - Linux/Unix用Executable and Linkable Formatテストファイルをダウンロード',
          description: 'Linux/Unixバイナリ分析、ELFパース、リバースエンジニアリング、システムデバッグをテストするための無料ELF Executable and Linkable Formatサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。ELFアナライザー、バイナリ逆アセンブラー、リバースエンジニアリングツール、システムデバッガー、Linux実行可能ファイル分析プラットフォームのテストに最適です。'
        },
        hero: {
          title: 'ELFサンプルファイル',
          description: 'テスト用の無料ELF Executable and Linkable Formatサンプルファイルをダウンロード。ELFアナライザー、バイナリ逆アセンブラー、リバースエンジニアリングツールをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのELF (Executable and Linkable Format)ファイルです'
      },
      exe: {
        meta: {
          title: '無料EXEサンプルファイルをダウンロード - Windows実行可能ファイルテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料EXEサンプルファイル - Windows実行可能ファイルテストファイルをダウンロード',
          description: 'Windowsアプリケーションの実行、EXE分析、バイナリパース、Windows開発ツールをテストするための無料EXE Windows実行可能ファイルサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。Windows実行可能ファイルアナライザー、バイナリ逆アセンブラー、リバースエンジニアリングツール、マルウェア分析プラットフォーム、Windowsアプリケーション開発のテストに最適です。'
        },
        hero: {
          title: 'EXEサンプルファイル',
          description: 'テスト用の無料EXE Windows実行可能ファイルサンプルファイルをダウンロード。Windows実行可能ファイルアナライザー、バイナリ逆アセンブラー、リバースエンジニアリングツールをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのEXE (Windows実行可能ファイル)ファイルです'
      },
      ipa: {
        meta: {
          title: '無料IPAサンプルファイルをダウンロード - iOSアプリケーションパッケージテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料IPAサンプルファイル - iOSアプリケーションパッケージテストファイルをダウンロード',
          description: 'iOSアプリのインストール、IPA分析、iOSアプリの配布、モバイル開発ツールをテストするための無料IPA iOSアプリケーションパッケージサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。IPAインストーラー、iOSシミュレーター、アプリアナライザー、iOS開発ツール、モバイルアプリ配布プラットフォームのテストに最適です。'
        },
        hero: {
          title: 'IPAサンプルファイル',
          description: 'テスト用の無料IPA iOSアプリケーションパッケージサンプルファイルをダウンロード。iOSアプリインストールツール、IPAアナライザー、モバイル開発プラットフォームをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのIPA (iOSアプリケーションパッケージ)ファイルです'
      },
      jar: {
        meta: {
          title: '無料JARサンプルファイルをダウンロード - Javaアーカイブテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料JARサンプルファイル - Javaアーカイブテストファイルをダウンロード',
          description: 'Javaアプリケーションの実行、JAR抽出、JAR分析、Java開発ツールをテストするための無料JAR Javaアーカイブサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。JAR抽出ツール、Javaランタイム環境、JARアナライザー、Java開発ツール、Javaアプリケーションデプロイメントプラットフォームのテストに最適です。'
        },
        hero: {
          title: 'JARサンプルファイル',
          description: 'テスト用の無料JAR Javaアーカイブサンプルファイルをダウンロード。JAR抽出ツール、Javaランタイム環境、Java開発ツールをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのJAR (Javaアーカイブ)ファイルです'
      },
      crx: {
        meta: {
          title: '無料CRXサンプルファイルをダウンロード - Chrome拡張機能パッケージテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料CRXサンプルファイル - Chrome拡張機能パッケージテストファイルをダウンロード',
          description: 'Chrome拡張機能のインストール、CRX分析、ブラウザ拡張機能の開発、Web拡張機能ツールをテストするための無料CRX Chrome拡張機能パッケージサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。CRXインストーラー、Chrome拡張機能アナライザー、ブラウザ拡張機能開発ツール、Web拡張機能配布プラットフォームのテストに最適です。'
        },
        hero: {
          title: 'CRXサンプルファイル',
          description: 'テスト用の無料CRX Chrome拡張機能パッケージサンプルファイルをダウンロード。Chrome拡張機能インストールツール、CRXアナライザー、ブラウザ拡張機能開発プラットフォームをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのCRX (Chrome拡張機能パッケージ)ファイルです'
      },
      '3ds': {
        meta: {
          title: '無料3DSサンプルファイルをダウンロード - 3Dプリンティングおよびモデリング用3Dモデルテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料3DSサンプルファイル - 3Dプリンティングおよびモデリング用3Dモデルテストファイルをダウンロード',
          description: '3Dモデリングソフトウェア、3Dプリンティングツール、メッシュ変換、3D可視化アプリケーションをテストするための無料3DS 3Dモデルサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。3Dモデルビューアー、3Dプリンター、CADソフトウェア、メッシュエディター、3Dグラフィックスアプリケーションのテストに最適です。'
        },
        hero: {
          title: '3DSサンプルファイル',
          description: 'テスト用の無料3DS 3Dモデルサンプルファイルをダウンロード。3Dモデリングソフトウェア、3Dプリンティングツール、3D可視化アプリケーションをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズの3DS (3Dモデル)ファイルです'
      },
      '3mf': {
        meta: {
          title: '無料3MFサンプルファイルをダウンロード - 3Dプリンティング用3D Manufacturing Formatテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料3MFサンプルファイル - 3Dプリンティング用3D Manufacturing Formatテストファイルをダウンロード',
          description: '3Dプリンティング、付加製造、3Dモデルスライシング、3Dプリンターの互換性をテストするための無料3MF 3D Manufacturing Formatサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。3Dプリンタースライサー、付加製造ソフトウェア、3MFビューアー、3Dプリンティングワークフロー、最新の3D製造プラットフォームのテストに最適です。'
        },
        hero: {
          title: '3MFサンプルファイル',
          description: 'テスト用の無料3MF 3D Manufacturing Formatサンプルファイルをダウンロード。3Dプリンタースライサー、付加製造ソフトウェア、3Dプリンティングワークフローをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズの3MF (3D Manufacturing Format)ファイルです'
      },
      ai: {
        meta: {
          title: '無料AIサンプルファイルをダウンロード - Adobe Illustratorベクターグラフィックステストファイル | MorphyHub',
        ...
        schema: {
          name: '無料AIサンプルファイル - Adobe Illustratorベクターグラフィックステストファイルをダウンロード',
          description: 'ベクターグラフィック編集、AIファイル変換、デザインソフトウェアの互換性、グラフィックデザインツールをテストするための無料AI Adobe Illustratorベクターグラフィックスサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。Adobe Illustrator、ベクターグラフィックスエディター、AIファイルコンバーター、デザインソフトウェア、プロフェッショナルグラフィックデザインプラットフォームのテストに最適です。'
        },
        hero: {
          title: 'AIサンプルファイル',
          description: 'テスト用の無料AI Adobe Illustratorベクターグラフィックスサンプルファイルをダウンロード。ベクターグラフィックスエディター、AIファイルコンバーター、デザインソフトウェアをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのAI (Adobe Illustrator)ベクターグラフィックスファイルです'
      },
      ase: {
        meta: {
          title: '無料ASEサンプルファイルをダウンロード - Asepriteスプライトアニメーションテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料ASEサンプルファイル - Asepriteスプライトアニメーションテストファイルをダウンロード',
          description: 'ピクセルアート編集、スプライトアニメーション、ゲーム開発ツール、2Dアニメーションソフトウェアをテストするための無料ASE Asepriteスプライトアニメーションサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。Aseprite、ピクセルアートエディター、スプライトアニメーションツール、ゲーム開発ソフトウェア、2Dアニメーションプラットフォームのテストに最適です。'
        },
        hero: {
          title: 'ASEサンプルファイル',
          description: 'テスト用の無料ASE Asepriteスプライトアニメーションサンプルファイルをダウンロード。ピクセルアートエディター、スプライトアニメーションツール、ゲーム開発ソフトウェアをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのASE (Asepriteスプライトアニメーション)ファイルです'
      },
      'animation-fbx': {
        meta: {
          title: '無料Animation FBXサンプルファイルをダウンロード - Autodesk FBX 3Dアニメーションテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料Animation FBXサンプルファイル - Autodesk FBX 3Dアニメーションテストファイルをダウンロード',
          description: '3Dアニメーション、キャラクターリギング、モーションキャプチャデータ、3Dグラフィックスソフトウェアをテストするための無料Animation FBX Autodesk FBX 3Dアニメーションサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。3Dアニメーションソフトウェア、ゲームエンジン、モーションキャプチャツール、キャラクターアニメーションプラットフォーム、3Dグラフィックスアプリケーションのテストに最適です。'
        },
        hero: {
          title: 'Animation FBXサンプルファイル',
          description: 'テスト用の無料Animation FBX Autodesk FBX 3Dアニメーションサンプルファイルをダウンロード。3Dアニメーションソフトウェア、ゲームエンジン、モーションキャプチャツールをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのAnimation FBX (Autodesk FBX 3Dアニメーション)ファイルです'
      },
      assetbundle: {
        meta: {
          title: '無料AssetBundleサンプルファイルをダウンロード - ゲーム開発用Unity AssetBundleテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料AssetBundleサンプルファイル - ゲーム開発用Unity AssetBundleテストファイルをダウンロード',
          description: 'Unityゲーム開発、アセット読み込み、ゲームリソース管理、Unityエンジンツールをテストするための無料AssetBundle Unity AssetBundleサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。Unityエンジン、ゲームアセットローダー、Unity開発ツール、ゲームリソースマネージャー、Unityゲーム開発プラットフォームのテストに最適です。'
        },
        hero: {
          title: 'AssetBundleサンプルファイル',
          description: 'テスト用の無料AssetBundle Unity AssetBundleサンプルファイルをダウンロード。Unityエンジン、ゲームアセットローダー、Unity開発ツールをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのAssetBundle (Unity AssetBundle)ファイルです'
      },
      blend: {
        meta: {
          title: '無料BLENDサンプルファイルをダウンロード - Blender 3Dプロジェクトテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料BLENDサンプルファイル - Blender 3Dプロジェクトテストファイルをダウンロード',
          description: '3Dモデリング、Blenderプロジェクトの互換性、3Dアニメーションワークフロー、3Dグラフィックスソフトウェアをテストするための無料BLEND Blender 3Dプロジェクトサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。Blenderソフトウェア、3Dモデリングツール、Blenderプロジェクトビューアー、3Dアニメーションプラットフォーム、プロフェッショナル3Dグラフィックスアプリケーションのテストに最適です。'
        },
        hero: {
          title: 'BLENDサンプルファイル',
          description: 'テスト用の無料BLEND Blender 3Dプロジェクトサンプルファイルをダウンロード。Blenderソフトウェア、3Dモデリングツール、3Dアニメーションプラットフォームをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのBLEND (Blender 3Dプロジェクト)ファイルです'
      },
      bvh: {
        meta: {
          title: '無料BVHサンプルファイルをダウンロード - Biovision Hierarchyモーションキャプチャテストファイル | MorphyHub',
        ...
        schema: {
          name: '無料BVHサンプルファイル - Biovision Hierarchyモーションキャプチャテストファイルをダウンロード',
          description: 'モーションキャプチャデータ、キャラクターアニメーション、スケレタルアニメーションシステム、3Dアニメーションソフトウェアをテストするための無料BVH Biovision Hierarchyモーションキャプチャサンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。モーションキャプチャビューアー、キャラクターアニメーションツール、スケレタルアニメーションシステム、3Dアニメーションプラットフォーム、モーションキャプチャ分析ソフトウェアのテストに最適です。'
        },
        hero: {
          title: 'BVHサンプルファイル',
          description: 'テスト用の無料BVH Biovision Hierarchyモーションキャプチャサンプルファイルをダウンロード。モーションキャプチャビューアー、キャラクターアニメーションツール、3Dアニメーションプラットフォームをテストするための複数のファイルサイズを利用できます。'
        },
        about_description: 'これらはテスト目的のさまざまなサイズのBVH (Biovision Hierarchyモーションキャプチャ)ファイルです'
      },
      dwg: {
        meta: {
          title: '無料DWGサンプルファイルをダウンロード - CADデザイン用AutoCAD図面テストファイル | MorphyHub',
        ...
        schema: {
          name: '無料DWGサンプルファイル - CADデザイン用AutoCAD図面テストファイルをダウンロード',
          description: 'CADソフトウェア、AutoCADの互換性、技術図面ツール、エンジニアリングデザインアプリケーションをテストするための無料DWG AutoCAD図面サンプルファイルをダウンロード。複数のファイルサイズ: 100 KB、1 MB、5 MB、50 MB、100 MB。AutoCAD、CADビューアー、技術図面ソフトウェア、エンジニアリングデザインツール、プロフェッショナルCADプラットフォームのテストに最適です。'
        },
        hero: {
          title: 'DWGサンプルファイル',

  ...
  sample_page: {
    ...
    formats: {
      ...
      doc: {
        ...
        schema: {
          name: 'Ücretsiz DOC örnek dosyaları - Microsoft Word DOC test dosyalarını indir',
          description: 'Belge dönüştürme araçlarını test etmek için ücretsiz DOC örnek dosyalarını indirin. Birden fazla dosya boyutu mevcut: 100 KB, 1 MB, 5 MB, 50 MB ve 100 MB. DOC\'dan PDF\'e, DOC\'dan DOCX\'e dönüştürücüleri ve eski Microsoft Word belge işlemeyi test etmek için mükemmel.'
        },
        hero: {
          title: 'DOC örnek dosyaları',
          description: 'Test için ücretsiz DOC örnek dosyalarını indirin. Belge dönüştürme araçlarınızı, DOC\'dan PDF\'e dönüştürücüleri ve eski Microsoft Word belge işlemcilerini test etmek için birden fazla dosya boyutu mevcut.'
        },
        about_description: 'Bunlar test amaçlı çeşitli boyutlarda DOC test dosyalarıdır'
      },
      pdf: {
        meta: {
        ...
        schema: {
          name: 'Ücretsiz PDF örnek dosyaları - Dönüştürme araçları için PDF test dosyalarını indir',
          description: 'PDF dönüştürücüleri, görüntüleyicileri ve işlemcileri test etmek için ücretsiz PDF örnek dosyalarını indirin. Birden fazla dosya boyutu mevcut: 100 KB, 1 MB, 5 MB, 50 MB ve 100 MB. PDF\'den Word\'e, PDF\'den JPG\'ye, PDF sıkıştırma ve PDF düzenleme araçlarını test etmek için mükemmel.'
        },
        hero: {
          title: 'PDF örnek dosyaları',
          description: 'Test için ücretsiz PDF örnek dosyalarını indirin. PDF dönüştürücülerinizi, PDF\'den Word\'e araçlarını, PDF sıkıştırma yazılımlarını ve PDF işleme uygulamalarını test etmek için birden fazla dosya boyutu mevcut.'
        },
        about_description: 'Bunlar test amaçlı çeşitli boyutlarda PDF test dosyalarıdır'
      },
      odp: {
        meta: {
        ...
        schema: {
          name: 'Ücretsiz ODP örnek dosyaları - OpenDocument sunum test dosyalarını indir',
          description: 'Sunum dönüştürme araçlarını test etmek için ücretsiz ODP örnek dosyalarını indirin. Birden fazla dosya boyutu mevcut: 100 KB, 1 MB, 5 MB, 50 MB ve 100 MB. ODP\'den PPT\'ye, ODP\'den PDF\'e dönüştürücüleri, LibreOffice Impress dosyalarını ve OpenDocument format işlemeyi test etmek için mükemmel.'
        },
        hero: {
          title: 'ODP örnek dosyaları',
          description: 'Test için ücretsiz ODP örnek dosyalarını OpenDocument sunumlarını indirin. Sunum dönüştürme araçlarınızı, ODP\'den PPT\'ye dönüştürücüleri ve OpenDocument format işlemcilerini test etmek için birden fazla dosya boyutu mevcut.'
        },
        about_description: 'Bunlar test amaçlı çeşitli boyutlarda ODP test dosyalarıdır'
      },
      rtf: {
        meta: {
        ...
        schema: {
          name: 'Ücretsiz RTF örnek dosyaları - Rich Text Format test dosyalarını indir',
          description: 'Rich Text Format dönüştürme araçlarını test etmek için ücretsiz RTF örnek dosyalarını indirin. Birden fazla dosya boyutu mevcut: 100 KB, 1 MB, 5 MB, 50 MB ve 100 MB. RTF\'den DOC\'a, RTF\'den PDF\'e dönüştürücüleri, kelime işlemci uyumluluğunu ve belge format dönüştürmeyi test etmek için mükemmel.'
        },
        hero: {
          title: 'RTF örnek dosyaları',
          description: 'Test için ücretsiz RTF örnek dosyalarını Rich Text Format belgelerini indirin. Belge dönüştürme araçlarınızı, RTF\'den DOC\'a dönüştürücüleri ve kelime işlemci uyumluluğunu test etmek için birden fazla dosya boyutu mevcut.'
        },
        about_description: 'Bunlar test amaçlı çeşitli boyutlarda RTF test dosyalarıdır'
      },
      epub: {
        meta: {
        ...
        schema: {
          name: 'Ücretsiz EPUB örnek dosyaları - Okuyucular için eBook test dosyalarını indir',
          description: 'eBook okuyucuları ve dönüştürme araçlarını test etmek için ücretsiz EPUB örnek dosyalarını indirin. Birden fazla dosya boyutu mevcut: 100 KB, 1 MB, 5 MB, 50 MB ve 100 MB. EPUB okuyucuları, EPUB\'dan PDF\'e, EPUB\'dan MOBI\'ye dönüştürücüleri, dijital yayıncılık araçlarını ve eBook format uyumluluğunu test etmek için mükemmel.'
        },
        hero: {
          title: 'EPUB örnek dosyaları',
          description: 'Test için ücretsiz EPUB örnek dosyalarını indirin. eBook okuyucularınızı, EPUB\'dan PDF\'e dönüştürücüleri, EPUB\'dan MOBI\'ye araçları ve dijital yayıncılık uygulamalarını test etmek için birden fazla dosya boyutu mevcut.'
        },
        about_description: 'Bunlar test amaçlı çeşitli boyutlarda EPUB test dosyalarıdır'
      },
      'invoice-pdf': {
        meta: {
        ...
        schema: {
          name: 'Ücretsiz fatura PDF örnek dosyaları - Fatura belge test dosyalarını indir',
          description: 'Fatura işleme ve ayrıştırma araçlarını test etmek için ücretsiz fatura PDF örnek dosyalarını indirin. Birden fazla dosya boyutu mevcut: 100 KB, 1 MB, 5 MB, 50 MB ve 100 MB. Fatura OCR, fatura veri çıkarma, fatura otomasyonu, fatura PDF ayrıştırma ve belge yönetim sistemlerini test etmek için mükemmel.'
        },
        hero: {
          title: 'Fatura PDF örnek dosyaları',
          description: 'Test için ücretsiz fatura PDF örnek dosyalarını indirin. Fatura işleme araçlarınızı, fatura OCR yazılımlarını, fatura veri çıkarma sistemlerini ve belge yönetim uygulamalarını test etmek için birden fazla dosya boyutu mevcut.'
        },
        about_description: 'Bunlar test amaçlı çeşitli boyutlarda fatura PDF test dosyalarıdır'
      },
      mobi: {
        meta: {
        ...
        schema: {
          name: 'Ücretsiz MOBI örnek dosyaları - Kindle için MOBI eBook test dosyalarını indir',
          description: 'MOBI eBook okuyucuları ve dönüştürme araçlarını test etmek için ücretsiz MOBI örnek dosyalarını indirin. Birden fazla dosya boyutu mevcut: 100 KB, 1 MB, 5 MB, 50 MB ve 100 MB. Kindle uyumluluğu, MOBI\'den EPUB\'a, MOBI\'den PDF\'e dönüştürücüleri, eBook format dönüştürmeyi ve dijital okuma uygulamalarını test etmek için mükemmel.'
        },
        hero: {
          title: 'MOBI örnek dosyaları',
          description: 'Test için ücretsiz MOBI örnek dosyalarını indirin. MOBI eBook okuyucularınızı, MOBI\'den EPUB\'a dönüştürücüleri, MOBI\'den PDF\'e araçları ve Kindle uyumluluk uygulamalarını test etmek için birden fazla dosya boyutu mevcut.'
        },
        about_description: 'Bunlar test amaçlı çeşitli boyutlarda MOBI test dosyalarıdır'
      },
      csv: {
        meta: {
        ...
        schema: {
          name: 'Ücretsiz CSV örnek dosyaları - Veri işleme için CSV test dosyalarını indirin',
          description: 'Veri işleme ve dönüştürme araçlarını test etmek için ücretsiz CSV örnek dosyalarını indirin. Birden fazla dosya boyutu: 100 KB, 1 MB, 5 MB, 50 MB ve 100 MB. CSV\'den Excel\'e, CSV\'den JSON\'a dönüştürücüleri, veri içe aktarma araçlarını, elektronik tablo uygulamalarını ve virgülle ayrılmış değer işlemeyi test etmek için mükemmel.'
        },
        hero: {
          title: 'CSV örnek dosyaları',
          description: 'Test için ücretsiz CSV örnek dosyalarını indirin. CSV dönüştürme araçlarınızı, CSV\'den Excel\'e dönüştürücüleri, veri işleme uygulamalarınızı ve elektronik tablo içe aktarma yazılımınızı test etmek için birden fazla dosya boyutu mevcut.'
        },
        about_description: 'Bunlar test amaçlı çeşitli boyutlarda CSV test dosyalarıdır'
      },
      xls: {
        meta: {
        ...
        schema: {
          name: 'Ücretsiz XLS örnek dosyaları - Microsoft Excel XLS test dosyalarını indirin',
          description: 'Excel dönüştürme ve veri işleme araçlarını test etmek için ücretsiz XLS örnek dosyalarını indirin. Birden fazla dosya boyutu: 100 KB, 1 MB, 5 MB, 50 MB ve 100 MB. XLS\'den XLSX\'e, XLS\'den CSV\'ye, XLS\'den PDF\'e dönüştürücüleri, Excel veri çıkarma ve eski elektronik tablo işlemeyi test etmek için mükemmel.'
        },
        hero: {
          title: 'XLS örnek dosyaları',
          description: 'Test için ücretsiz XLS Excel elektronik tablo örnek dosyalarını indirin. Excel dönüştürme araçlarınızı, XLS\'den XLSX\'e dönüştürücüleri, veri işleme uygulamalarınızı ve elektronik tablo içe aktarma yazılımınızı test etmek için birden fazla dosya boyutu mevcut.'
        },
        about_description: 'Bunlar test amaçlı çeşitli boyutlarda XLS test dosyalarıdır'
      },
      xlsx: {
        meta: {
        ...
        schema: {
          name: 'Ücretsiz XLSX örnek dosyaları - Dönüştürme araçları için Excel XLSX test dosyalarını indirin',
          description: 'Excel dönüştürme ve veri işleme araçlarını test etmek için ücretsiz XLSX örnek dosyalarını indirin. Birden fazla dosya boyutu: 100 KB, 1 MB, 5 MB, 50 MB ve 100 MB. XLSX\'den CSV\'ye, XLSX\'den PDF\'e, XLSX\'den JSON\'a dönüştürücüleri, Excel veri analizi, elektronik tablo otomasyonu ve Office Open XML işlemeyi test etmek için mükemmel.'
        },
        hero: {
          title: 'XLSX örnek dosyaları',
          description: 'Test için ücretsiz XLSX Excel elektronik tablo örnek dosyalarını indirin. Excel dönüştürme araçlarınızı, XLSX\'den CSV\'ye dönüştürücüleri, veri analizi uygulamalarınızı ve elektronik tablo otomasyonu yazılımınızı test etmek için birden fazla dosya boyutu mevcut.'
        },
        about_description: 'Bunlar test amaçlı çeşitli boyutlarda XLSX test dosyalarıdır'
      },
      xml: {
        meta: {
        ...
        schema: {
          name: 'Ücretsiz XML örnek dosyaları - Ayrıştırma ve dönüştürme için XML test dosyalarını indirin',
          description: 'XML ayrıştırma, dönüştürme ve veri işleme araçlarını test etmek için ücretsiz XML örnek dosyalarını indirin. Birden fazla dosya boyutu: 100 KB, 1 MB, 5 MB, 50 MB ve 100 MB. XML\'den JSON\'a, XML\'den CSV\'ye dönüştürücüleri, XML doğrulama, yapılandırılmış veri işleme ve işaretleme dili ayrıştırmayı test etmek için mükemmel.'
        },
        hero: {
          title: 'XML örnek dosyaları',
          description: 'Test için ücretsiz XML örnek dosyalarını indirin. XML ayrıştırma araçlarınızı, XML\'den JSON\'a dönüştürücüleri, XML doğrulama yazılımınızı ve yapılandırılmış veri işleme uygulamalarınızı test etmek için birden fazla dosya boyutu mevcut.'
        },
        about_description: 'Bunlar test amaçlı çeşitli boyutlarda XML test dosyalarıdır'
      },
      html: {
        meta: {
        ...
        schema: {
          name: 'Ücretsiz HTML örnek dosyaları - Web geliştirme için HTML test dosyalarını indirin',
          description: 'Web geliştirme ve HTML işleme araçlarını test etmek için ücretsiz HTML örnek dosyalarını indirin. Birden fazla dosya boyutu: 100 KB, 1 MB, 5 MB, 50 MB ve 100 MB. HTML\'den PDF\'e, HTML\'den DOCX\'e dönüştürücüleri, HTML doğrulama, web kazıma, tarayıcı oluşturma ve HyperText Markup Language işlemeyi test etmek için mükemmel.'
        },
        hero: {
          title: 'HTML örnek dosyaları',
          description: 'Test için ücretsiz HTML HyperText Markup Language örnek dosyalarını indirin. HTML ayrıştırma araçlarınızı, HTML\'den PDF\'e dönüştürücüleri, HTML doğrulama yazılımınızı ve web geliştirme uygulamalarınızı test etmek için birden fazla dosya boyutu mevcut.'
        },
        about_description: 'Bunlar test amaçlı çeşitli boyutlarda HTML test dosyalarıdır'
      },
      ods: {
        meta: {
        ...
        schema: {
          name: 'Ücretsiz ODS örnek dosyaları - OpenDocument elektronik tablo test dosyalarını indirin',
          description: 'Elektronik tablo dönüştürme ve veri işleme araçlarını test etmek için ücretsiz ODS örnek dosyalarını indirin. Birden fazla dosya boyutu: 100 KB, 1 MB, 5 MB, 50 MB ve 100 MB. ODS\'den Excel\'e, ODS\'den CSV\'ye dönüştürücüleri, LibreOffice Calc dosyalarını, OpenDocument format işlemeyi ve elektronik tablo veri çıkarmayı test etmek için mükemmel.'
        },
        hero: {
          title: 'ODS örnek dosyaları',
          description: 'Test için ücretsiz ODS OpenDocument Spreadsheet örnek dosyalarını indirin. Elektronik tablo dönüştürme araçlarınızı, ODS\'den Excel\'e dönüştürücüleri ve OpenDocument format işlemcilerinizi test etmek için birden fazla dosya boyutu mevcut.'
        },
        about_description: 'Bunlar test amaçlı çeşitli boyutlarda ODS test dosyalarıdır'
      },
      'ansible-yml': {
        meta: {
        ...
        schema: {
          name: 'Ücretsiz Ansible YML örnek dosyaları - YAML yapılandırma test dosyalarını indirin',
          description: 'YAML ayrıştırma ve yapılandırma yönetimi araçlarını test etmek için ücretsiz Ansible YML örnek dosyalarını indirin. Birden fazla dosya boyutu: 100 KB, 1 MB, 5 MB, 50 MB ve 100 MB. Ansible playbook\'larını, YAML doğrulama, DevOps otomasyonu, yapılandırma yönetimi sistemlerini ve infrastructure as code araçlarını test etmek için mükemmel.'
        },
        hero: {
          title: 'Ansible YML örnek dosyaları',

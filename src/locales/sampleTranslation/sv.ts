...
export const sv: SamplePageTranslations = {
  sample_page: {
    ...
    formats: {
      docx: {
        meta: {
          title: 'Ladda ner gratis DOCX-exempelfiler - Testfiler | FormiPeek',
      ...
      doc: {
        meta: {
          title: 'Ladda ner gratis DOC-exempelfiler - Microsoft Word DOC testfiler | FormiPeek',
        ...
        schema: {
          name: 'Gratis DOC-exempelfiler - Ladda ner Microsoft Word DOC testfiler',
          description: 'Ladda ner gratis DOC-exempelfiler för att testa dokumentkonverteringsverktyg. Flera filstorlekar tillgängliga: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa DOC till PDF, DOC till DOCX konverterare och legacy Microsoft Word dokumentbearbetning.'
        },
        hero: {
          title: 'DOC-exempelfiler',
          description: 'Ladda ner gratis DOC-exempelfiler för testning. Flera filstorlekar tillgängliga för att testa dina dokumentkonverteringsverktyg, DOC till PDF konverterare och legacy Microsoft Word dokumentprocessorer.'
        },
        about_description: 'Detta är DOC-testfiler i olika storlekar för teständamål'
      },
      pdf: {
        meta: {
          title: 'Ladda ner gratis PDF-exempelfiler - PDF testfiler för konverteringsverktyg | FormiPeek',
        ...
        schema: {
          name: 'Gratis PDF-exempelfiler - Ladda ner PDF testfiler för konverteringsverktyg',
          description: 'Ladda ner gratis PDF-exempelfiler för att testa PDF-konverterare, visare och processorer. Flera filstorlekar tillgängliga: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa PDF till Word, PDF till JPG, PDF-komprimering och PDF-redigeringsverktyg.'
        },
        hero: {
          title: 'PDF-exempelfiler',
          description: 'Ladda ner gratis PDF-exempelfiler för testning. Flera filstorlekar tillgängliga för att testa dina PDF-konverterare, PDF till Word verktyg, PDF-komprimeringsprogram och PDF-bearbetningsapplikationer.'
        },
        about_description: 'Detta är PDF-testfiler i olika storlekar för teständamål'
      },
      odp: {
        meta: {
          title: 'Ladda ner gratis ODP-exempelfiler - OpenDocument presentation testfiler | FormiPeek',
        ...
        schema: {
          name: 'Gratis ODP-exempelfiler - Ladda ner OpenDocument presentation testfiler',
          description: 'Ladda ner gratis ODP-exempelfiler för att testa presentationskonverteringsverktyg. Flera filstorlekar tillgängliga: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa ODP till PPT, ODP till PDF konverterare, LibreOffice Impress filer och OpenDocument formatbearbetning.'
        },
        hero: {
          title: 'ODP-exempelfiler',
          description: 'Ladda ner gratis ODP-exempelfiler OpenDocument presentationer för testning. Flera filstorlekar tillgängliga för att testa dina presentationskonverteringsverktyg, ODP till PPT konverterare och OpenDocument formatprocessorer.'
        },
        about_description: 'Detta är ODP-testfiler i olika storlekar för teständamål'
      },
      rtf: {
        meta: {
          title: 'Ladda ner gratis RTF-exempelfiler - Rich Text Format testfiler | FormiPeek',
        ...
        schema: {
          name: 'Gratis RTF-exempelfiler - Ladda ner Rich Text Format testfiler',
          description: 'Ladda ner gratis RTF-exempelfiler för att testa Rich Text Format konverteringsverktyg. Flera filstorlekar tillgängliga: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa RTF till DOC, RTF till PDF konverterare, ordbehandlarkompatibilitet och dokumentformatskonvertering.'
        },
        hero: {
          title: 'RTF-exempelfiler',
          description: 'Ladda ner gratis RTF-exempelfiler Rich Text Format dokument för testning. Flera filstorlekar tillgängliga för att testa dina dokumentkonverteringsverktyg, RTF till DOC konverterare och ordbehandlarkompatibilitet.'
        },
        about_description: 'Detta är RTF-testfiler i olika storlekar för teständamål'
      },
      epub: {
        meta: {
          title: 'Ladda ner gratis EPUB-exempelfiler - eBook testfiler för läsare | FormiPeek',
        ...
        schema: {
          name: 'Gratis EPUB-exempelfiler - Ladda ner eBook testfiler för läsare',
          description: 'Ladda ner gratis EPUB-exempelfiler för att testa eBook-läsare och konverteringsverktyg. Flera filstorlekar tillgängliga: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa EPUB-läsare, EPUB till PDF, EPUB till MOBI konverterare, digitala publiceringsverktyg och eBook-formatskompatibilitet.'
        },
        hero: {
          title: 'EPUB-exempelfiler',
          description: 'Ladda ner gratis EPUB-exempelfiler eBook-filer för testning. Flera filstorlekar tillgängliga för att testa dina eBook-läsare, EPUB till PDF konverterare, EPUB till MOBI verktyg och digitala publiceringsapplikationer.'
        },
        about_description: 'Detta är EPUB-testfiler i olika storlekar för teständamål'
      },
      'invoice-pdf': {
        meta: {
          title: 'Ladda ner gratis faktura PDF-exempelfiler - Fakturadokument testfiler | FormiPeek',
        ...
        schema: {
          name: 'Gratis faktura PDF-exempelfiler - Ladda ner fakturadokument testfiler',
          description: 'Ladda ner gratis faktura PDF-exempelfiler för att testa fakturabearbetnings- och parsningsverktyg. Flera filstorlekar tillgängliga: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa faktura OCR, fakturadataextraktion, fakturaautomatisering, faktura PDF-parsning och dokumenthanteringssystem.'
        },
        hero: {
          title: 'Faktura PDF-exempelfiler',
          description: 'Ladda ner gratis faktura PDF-exempelfiler fakturadokument för testning. Flera filstorlekar tillgängliga för att testa dina fakturabearbetningsverktyg, faktura OCR-programvara, fakturadataextraktionssystem och dokumenthanteringsapplikationer.'
        },
        about_description: 'Detta är faktura PDF-testfiler i olika storlekar för teständamål'
      },
      mobi: {
        meta: {
          title: 'Ladda ner gratis MOBI-exempelfiler - MOBI eBook testfiler för Kindle | FormiPeek',
        ...
        schema: {
          name: 'Gratis MOBI-exempelfiler - Ladda ner MOBI eBook testfiler för Kindle',
          description: 'Ladda ner gratis MOBI-exempelfiler för att testa MOBI eBook-läsare och konverteringsverktyg. Flera filstorlekar tillgängliga: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa Kindle-kompatibilitet, MOBI till EPUB, MOBI till PDF konverterare, eBook-formatskonvertering och digitala läsapplikationer.'
        },
        hero: {
          title: 'MOBI-exempelfiler',
          description: 'Ladda ner gratis MOBI-exempelfiler MOBI eBook-filer för testning. Flera filstorlekar tillgängliga för att testa dina MOBI eBook-läsare, MOBI till EPUB konverterare, MOBI till PDF verktyg och Kindle-kompatibilitetsapplikationer.'
        },
        about_description: 'Detta är MOBI-testfiler i olika storlekar för teständamål'
      },
      csv: {
        meta: {
          title: 'Ladda ner gratis CSV-exempelfiler - CSV-testfiler för datahantering | FormiPeek',
        ...
        schema: {
          name: 'Gratis CSV-exempelfiler - Ladda ner CSV-testfiler för datahantering',
          description: 'Ladda ner gratis CSV-exempelfiler för att testa datahanterings- och konverteringsverktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa CSV till Excel, CSV till JSON konverterare, dataimportverktyg, kalkylbladsapplikationer och komma-separerade värden bearbetning.'
        },
        hero: {
          title: 'CSV-exempelfiler',
          description: 'Ladda ner gratis CSV-exempelfiler för testning. Flera filstorlekar tillgängliga för att testa dina CSV-konverteringsverktyg, CSV till Excel konverterare, datahanteringsapplikationer och kalkylblad importprogram.'
        },
        about_description: 'Detta är CSV-testfiler i olika storlekar för teständamål'
      },
      xls: {
        meta: {
          title: 'Ladda ner gratis XLS-exempelfiler - Microsoft Excel XLS-testfiler | FormiPeek',
        ...
        schema: {
          name: 'Gratis XLS-exempelfiler - Ladda ner Microsoft Excel XLS-testfiler',
          description: 'Ladda ner gratis XLS-exempelfiler för att testa Excel-konverterings- och datahanteringsverktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa XLS till XLSX, XLS till CSV, XLS till PDF konverterare, Excel-dataextraktion och äldre kalkylbladsbearbetning.'
        },
        hero: {
          title: 'XLS-exempelfiler',
          description: 'Ladda ner gratis XLS Excel kalkylblads-exempelfiler för testning. Flera filstorlekar tillgängliga för att testa dina Excel-konverteringsverktyg, XLS till XLSX konverterare, datahanteringsapplikationer och kalkylblad importprogram.'
        },
        about_description: 'Detta är XLS-testfiler i olika storlekar för teständamål'
      },
      xlsx: {
        meta: {
          title: 'Ladda ner gratis XLSX-exempelfiler - Excel XLSX-testfiler för konverteringsverktyg | FormiPeek',
        ...
        schema: {
          name: 'Gratis XLSX-exempelfiler - Ladda ner Excel XLSX-testfiler för konverteringsverktyg',
          description: 'Ladda ner gratis XLSX-exempelfiler för att testa Excel-konverterings- och datahanteringsverktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa XLSX till CSV, XLSX till PDF, XLSX till JSON konverterare, Excel-dataanalys, kalkylbladsautomatisering och Office Open XML-bearbetning.'
        },
        hero: {
          title: 'XLSX-exempelfiler',
          description: 'Ladda ner gratis XLSX Excel kalkylblads-exempelfiler för testning. Flera filstorlekar tillgängliga för att testa dina Excel-konverteringsverktyg, XLSX till CSV konverterare, dataanalysapplikationer och kalkylbladsautomatiseringsprogram.'
        },
        about_description: 'Detta är XLSX-testfiler i olika storlekar för teständamål'
      },
      xml: {
        meta: {
          title: 'Ladda ner gratis XML-exempelfiler - XML-testfiler för parsing och konvertering | FormiPeek',
        ...
        schema: {
          name: 'Gratis XML-exempelfiler - Ladda ner XML-testfiler för parsing och konvertering',
          description: 'Ladda ner gratis XML-exempelfiler för att testa XML-parsing, konvertering och datahanteringsverktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa XML till JSON, XML till CSV konverterare, XML-validering, strukturerad datahantering och märkspråkparsing.'
        },
        hero: {
          title: 'XML-exempelfiler',
          description: 'Ladda ner gratis XML-exempelfiler för testning. Flera filstorlekar tillgängliga för att testa dina XML-parsingverktyg, XML till JSON konverterare, XML-valideringsprogram och strukturerad datahanteringsapplikationer.'
        },
        about_description: 'Detta är XML-testfiler i olika storlekar för teständamål'
      },
      html: {
        meta: {
          title: 'Ladda ner gratis HTML-exempelfiler - HTML-testfiler för webbutveckling | FormiPeek',
        ...
        schema: {
          name: 'Gratis HTML-exempelfiler - Ladda ner HTML-testfiler för webbutveckling',
          description: 'Ladda ner gratis HTML-exempelfiler för att testa webbutvecklings- och HTML-bearbetningsverktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa HTML till PDF, HTML till DOCX konverterare, HTML-validering, web scraping, webbläsarrendering och HyperText Markup Language-bearbetning.'
        },
        hero: {
          title: 'HTML-exempelfiler',
          description: 'Ladda ner gratis HTML HyperText Markup Language-exempelfiler för testning. Flera filstorlekar tillgängliga för att testa dina HTML-parsingverktyg, HTML till PDF konverterare, HTML-valideringsprogram och webbutvecklingsapplikationer.'
        },
        about_description: 'Detta är HTML-testfiler i olika storlekar för teständamål'
      },
      ods: {
        meta: {
          title: 'Ladda ner gratis ODS-exempelfiler - OpenDocument kalkylblad testfiler | FormiPeek',
        ...
        schema: {
          name: 'Gratis ODS-exempelfiler - Ladda ner OpenDocument kalkylblad testfiler',
          description: 'Ladda ner gratis ODS-exempelfiler för att testa kalkylblads-konverterings- och datahanteringsverktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa ODS till Excel, ODS till CSV konverterare, LibreOffice Calc-filer, OpenDocument-formatbearbetning och kalkylbladsdataextraktion.'
        },
        hero: {
          title: 'ODS-exempelfiler',
          description: 'Ladda ner gratis ODS OpenDocument Spreadsheet-exempelfiler för testning. Flera filstorlekar tillgängliga för att testa dina kalkylblads-konverteringsverktyg, ODS till Excel konverterare och OpenDocument-formatprocessorer.'
        },
        about_description: 'Detta är ODS-testfiler i olika storlekar för teständamål'
      },
      'ansible-yml': {
        meta: {
          title: 'Ladda ner gratis Ansible YML-exempelfiler - YAML-konfiguration testfiler | FormiPeek',
        ...
        schema: {
          name: 'Gratis Ansible YML-exempelfiler - Ladda ner YAML-konfiguration testfiler',
          description: 'Ladda ner gratis Ansible YML-exempelfiler för att testa YAML-parsing och konfigurationshanteringsverktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa Ansible playbooks, YAML-validering, DevOps-automatisering, konfigurationshanteringssystem och infrastructure as code-verktyg.'
        },
        hero: {
          title: 'Ansible YML-exempelfiler',
      ...
      'api-response-json': {
        meta: {
          title: 'Ladda ner gratis API Response JSON-exempelfiler - JSON-testfiler för API-utveckling | FormiPeek',
      ...
      'arduino-ino': {
        meta: {
          title: 'Ladda ner gratis Arduino INO-exempelfiler - Arduino Sketch-testfiler för embedded-utveckling | FormiPeek',
      ...
      bat: {
        meta: {
          title: 'Ladda ner gratis BAT-exempelfiler - Batch-skript-testfiler för Windows-automatisering | FormiPeek',
      ...
      asc: {
        meta: {
          title: 'Ladda ner gratis ASC-exempelfiler - ASCII-text-testfiler för textbearbetning | FormiPeek',
      ...
      bib: {
        meta: {
          title: 'Ladda ner gratis BIB-exempelfiler - Bibliografitestfiler för akademisk forskning | FormiPeek',
      ...
      c: {
        meta: {
          title: 'Ladda ner gratis C-exempelfiler - C-programmeringsspråkstestfiler för utveckling | FormiPeek',
      ...
      'can-log': {
        meta: {
          title: 'Ladda ner gratis CAN Log-exempelfiler - Controller Area Network-testfiler för bilindustri | FormiPeek',
      ...
      cmd: {
        meta: {
          title: 'Ladda ner gratis CMD-exempelfiler - Windows-kommandoskript-testfiler för automatisering | FormiPeek',
      ...
      conf: {
        meta: {
          title: 'Ladda ner gratis CONF-exempelfiler - Konfigurationsfil-testfiler för systemkonfiguration | FormiPeek',
      ...
      'config-ini': {
        meta: {
          title: 'Ladda ner gratis Config INI-exempelfiler - INI-konfigurationstestfiler för applikationer | FormiPeek',
      ...
      cpp: {
        meta: {
          title: 'Ladda ner gratis CPP-exempelfiler - C++-programmeringsspråkstestfiler för utveckling | FormiPeek',
      ...
      h: {
        meta: {
          title: 'Ladda ner gratis H-exempelfiler - C/C++-headerfil-testfiler för programmering | FormiPeek',
      ...
      hpp: {
        meta: {
          title: 'Ladda ner gratis HPP-exempelfiler - C++-headerfil-testfiler för modern C++-utveckling | FormiPeek',
      ...
      hex: {
        meta: {
          title: 'Ladda ner gratis HEX-exempelfiler - Hex-testfiler för firmware- och inbyggda systemutveckling | FormiPeek',
        ...
        schema: {
          name: 'Gratis HEX-exempelfiler - Ladda ner hex-testfiler för firmware- och inbyggda systemutveckling',
          description: 'Ladda ner gratis HEX hex-exempelfiler för att testa firmware-programmering, inbyggda systemutveckling och binärdataanalys. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa hex-redigerare, firmware-laddare, mikrokontrollerprogrammering och inbyggda utvecklingsverktyg.'
        },
        hero: {
          title: 'HEX-exempelfiler',
          description: 'Ladda ner gratis HEX hex-exempelfiler för testning. Flera filstorlekar tillgängliga för att testa dina hex-redigerare, firmware-programmeringsverktyg och inbyggda utvecklingsapplikationer.'
        },
        about_description: 'Detta är HEX (hex) filer i olika storlekar för teständamål'
      },
      cs: {
        meta: {
          title: 'Ladda ner gratis CS-exempelfiler - C#-källkodstestfiler för .NET-utveckling | FormiPeek',
        ...
        schema: {
          name: 'Gratis CS-exempelfiler - Ladda ner C#-källkodstestfiler för .NET-utveckling',
          description: 'Ladda ner gratis CS C#-källkodsexempelfiler för att testa C#-kompilering, .NET-utveckling och Visual Studio-verktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa C#-kompilatorer, .NET-ramverk, Visual Studio IDE, kodanalysverktyg och C#-utvecklingsmiljöer.'
        },
        hero: {
          title: 'CS-exempelfiler',
          description: 'Ladda ner gratis CS C#-källkodsexempelfiler för testning. Flera filstorlekar tillgängliga för att testa din C#-kompilering, .NET-utveckling och Visual Studio-verktyg.'
        },
        about_description: 'Detta är CS (C#) källkodsfiler i olika storlekar för teständamål'
      },
      css: {
        meta: {
          title: 'Ladda ner gratis CSS-exempelfiler - Stylesheet-testfiler för webbutveckling | FormiPeek',
        ...
        schema: {
          name: 'Gratis CSS-exempelfiler - Ladda ner stylesheet-testfiler för webbutveckling',
          description: 'Ladda ner gratis CSS-stylesheetexempelfiler för att testa webbstyling, CSS-tolkning och front-end-verktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa CSS-validerare, preprocessorer (SASS, LESS), CSS-minifierare, webbrowsers och front-end-utvecklingsramverk.'
        },
        hero: {
          title: 'CSS-exempelfiler',
          description: 'Ladda ner gratis CSS-stylesheetexempelfiler för testning. Flera filstorlekar tillgängliga för att testa dina CSS-validerare, preprocessorer och webbutvecklingsverktyg.'
        },
        about_description: 'Detta är CSS (Cascading Style Sheets) filer i olika storlekar för teständamål'
      },
      csr: {
        meta: {
          title: 'Ladda ner gratis CSR-exempelfiler - Certifikatsigneringsförfrågan-testfiler för SSL/TLS | FormiPeek',
        ...
        schema: {
          name: 'Gratis CSR-exempelfiler - Ladda ner certifikatsigneringsförfrågan-testfiler för SSL/TLS',
          description: 'Ladda ner gratis CSR-certifikatsigneringsförfråganexempelfiler för att testa SSL/TLS-certifikatgenerering, PKI-hantering och säkerhetsverktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa certifikatutfärdare, OpenSSL, SSL-certifikatgenerering, PKI-infrastruktur och säkerhetscertifikathanteringsverktyg.'
        },
        hero: {
          title: 'CSR-exempelfiler',
          description: 'Ladda ner gratis CSR-certifikatsigneringsförfråganexempelfiler för testning. Flera filstorlekar tillgängliga för att testa din SSL/TLS-certifikatgenerering och PKI-hanteringsverktyg.'
        },
        about_description: 'Detta är CSR (Certificate Signing Request) filer i olika storlekar för teständamål'
      },
      'customer-database-sql': {
        meta: {
          title: 'Ladda ner gratis Customer Database SQL-exempelfiler - SQL-databastestfiler | FormiPeek',
        ...
        schema: {
          name: 'Gratis Customer Database SQL-exempelfiler - Ladda ner SQL-databastestfiler',
          description: 'Ladda ner gratis Customer Database SQL-exempelfiler för att testa SQL-databasoperationer, frågekörning och databashanteringsverktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa SQL-parsers, databasimportverktyg, SQLite, MySQL, PostgreSQL och databashanteringssystem.'
        },
        hero: {
          title: 'Customer Database SQL-exempelfiler',
          description: 'Ladda ner gratis Customer Database SQL-exempelfiler för testning. Flera filstorlekar tillgängliga för att testa dina SQL-parsers, databasimportverktyg och databashanteringssystem.'
        },
        about_description: 'Detta är Customer Database SQL-filer i olika storlekar för teständamål'
      },
      dbf: {
        meta: {
          title: 'Ladda ner gratis DBF-exempelfiler - dBASE-databastestfiler för datahantering | FormiPeek',
        ...
        schema: {
          name: 'Gratis DBF-exempelfiler - Ladda ner dBASE-databastestfiler för datahantering',
          description: 'Ladda ner gratis DBF dBASE-databas-exempelfiler för att testa databasoperationer, dataimport/export och äldre databasformat. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa dBASE-kompatibilitet, databaskonverterare, datamigreringsverktyg, kalkylbladsapplikationer och databashanteringssystem.'
        },
        hero: {
          title: 'DBF-exempelfiler',
          description: 'Ladda ner gratis DBF dBASE-databas-exempelfiler för testning. Flera filstorlekar tillgängliga för att testa dina databaskonverterare, datamigreringsverktyg och databashanteringssystem.'
        },
        about_description: 'Detta är DBF (dBASE-databas) filer i olika storlekar för teständamål'
      },
      dem: {
        meta: {
          title: 'Ladda ner gratis DEM-exempelfiler - Digitala höjdmodelltestfiler för GIS och kartläggning | FormiPeek',
        ...
        schema: {
          name: 'Gratis DEM-exempelfiler - Ladda ner digitala höjdmodelltestfiler för GIS och kartläggning',
          description: 'Ladda ner gratis DEM digitala höjdmodelexempelfiler för att testa GIS-applikationer, terrängkartläggning och geospatiala analysverktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa GIS-programvara, terrängvisualisering, höjddatabearbetning, kartläggningsapplikationer och geospatiala analysverktyg.'
        },
        hero: {
          title: 'DEM-exempelfiler',
          description: 'Ladda ner gratis DEM digitala höjdmodelexempelfiler för testning. Flera filstorlekar tillgängliga för att testa din GIS-programvara, terrängvisualisering och geospatiala analysverktyg.'
        },
        about_description: 'Detta är DEM (Digital Elevation Model) filer i olika storlekar för teständamål'
      },
      der: {
        meta: {
          title: 'Ladda ner gratis DER-exempelfiler - Distinguished Encoding Rules-certifikattestfiler | FormiPeek',
        ...
        schema: {
          name: 'Gratis DER-exempelfiler - Ladda ner Distinguished Encoding Rules-certifikattestfiler',
          description: 'Ladda ner gratis DER Distinguished Encoding Rules-certifikatexempelfiler för att testa SSL/TLS-certifikat, PKI-hantering och säkerhetsverktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa certifikattolkning, OpenSSL, PKI-infrastruktur, SSL-certifikatvalidering och säkerhetscertifikathanteringsverktyg.'
        },
        hero: {
          title: 'DER-exempelfiler',
          description: 'Ladda ner gratis DER Distinguished Encoding Rules-certifikatexempelfiler för testning. Flera filstorlekar tillgängliga för att testa din certifikattolkning, OpenSSL och PKI-hanteringsverktyg.'
        },
        about_description: 'Detta är DER (Distinguished Encoding Rules) certifikatfiler i olika storlekar för teständamål'
      },
      dmp: {
        meta: {
          title: 'Ladda ner gratis DMP-exempelfiler - Minnesdump-testfiler för felsökning och analys | FormiPeek',
        ...
        schema: {
          name: 'Gratis DMP-exempelfiler - Ladda ner minnesdump-testfiler för felsökning och analys',
          description: 'Ladda ner gratis DMP-minnesdumpexempelfiler för att testa kraschanalys, felsökningsverktyg och systemdiagnostik. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa felsökare, kraschanalysverktyg, minnesanalysatorer, systemdiagnostikverktyg och forensiska analysapplikationer.'
        },
        hero: {
          title: 'DMP-exempelfiler',
          description: 'Ladda ner gratis DMP-minnesdumpexempelfiler för testning. Flera filstorlekar tillgängliga för att testa din kraschanalys, felsökning och systemdiagnostikverktyg.'
        },
        about_description: 'Detta är DMP (minnesdump) filer i olika storlekar för teständamål'
      },
      'docker-compose-yml': {
        meta: {
          title: 'Ladda ner gratis Docker Compose YML-exempelfiler - Docker Compose-konfigurationstestfiler | FormiPeek',
        ...
        schema: {
          name: 'Gratis Docker Compose YML-exempelfiler - Ladda ner Docker Compose-konfigurationstestfiler',
          description: 'Ladda ner gratis Docker Compose YML-konfigurationsexempelfiler för att testa Docker-containerorkestrering, multi-containerapplikationer och DevOps-verktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa Docker Compose, containerorkestrering, YAML-tolkning, DevOps-automatisering och containeriserade applikationsdistributionsverktyg.'
        },
        hero: {
          title: 'Docker Compose YML-exempelfiler',
          description: 'Ladda ner gratis Docker Compose YML-konfigurationsexempelfiler för testning. Flera filstorlekar tillgängliga för att testa din Docker Compose, containerorkestrering och DevOps-automatiseringsverktyg.'
        },
        about_description: 'Detta är Docker Compose YML-konfigurationsfiler i olika storlekar för teständamål'
      },
      dockerfile: {
        meta: {
          title: 'Ladda ner gratis Dockerfile-exempelfiler - Docker-containerbyggtestfiler | FormiPeek',
        ...
        schema: {
          name: 'Gratis Dockerfile-exempelfiler - Ladda ner Docker-containerbyggtestfiler',
          description: 'Ladda ner gratis Dockerfile Docker-containerbygg-exempelfiler för att testa containerisering, Docker-bygg och DevOps-verktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa Docker-bygg, containerimage-skapande, Dockerfile-tolkning, containeriseringsverktyg och DevOps-automatiseringsplattformar.'
        },
        hero: {
          title: 'Dockerfile-exempelfiler',
          description: 'Ladda ner gratis Dockerfile Docker-containerbygg-exempelfiler för testning. Flera filstorlekar tillgängliga för att testa dina Docker-bygg, containerimage-skapande och containeriseringsverktyg.'
        },
        about_description: 'Detta är Dockerfile (Docker-containerbygg) filer i olika storlekar för teständamål'
      },
      editorconfig: {
        meta: {
          title: 'Ladda ner gratis EditorConfig-exempelfiler - Redigerarkonfigurationstestfiler | FormiPeek',
        ...
        schema: {
          name: 'Gratis EditorConfig-exempelfiler - Ladda ner redigerarkonfigurationstestfiler',
          description: 'Ladda ner gratis EditorConfig-redigerarkonfigurationsexempelfiler för att testa kodredigerarinställningar, formatkonsistens och utvecklingsverktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa EditorConfig-parsers, kodredigerarplugins, formatverktyg, IDE-konfiguration och utvecklingsmiljöinställningsverktyg.'
        },
        hero: {
          title: 'EditorConfig-exempelfiler',
          description: 'Ladda ner gratis EditorConfig-redigerarkonfigurationsexempelfiler för testning. Flera filstorlekar tillgängliga för att testa dina EditorConfig-parsers, kodredigerarplugins och formatverktyg.'
        },
        about_description: 'Detta är EditorConfig (redigerarkonfiguration) filer i olika storlekar för teständamål'
      },
      ini: {
        meta: {
          title: 'Ladda ner gratis INI-exempelfiler - INI-konfigurationstestfiler för applikationer | FormiPeek',
        ...
        schema: {
          name: 'Gratis INI-exempelfiler - Ladda ner INI-konfigurationstestfiler för applikationer',
          description: 'Ladda ner gratis INI-konfigurationsexempelfiler för att testa applikationsinställningar, INI-filtolkning och konfigurationshanteringsverktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa INI-parsers, applikationskonfiguration, inställningshantering, Windows INI-filer och programvarukonfigurationsverktyg.'
        },
        hero: {
          title: 'INI-exempelfiler',
          description: 'Ladda ner gratis INI-konfigurationsexempelfiler för testning. Flera filstorlekar tillgängliga för att testa dina INI-parsers, applikationskonfiguration och inställningshanteringsverktyg.'
        },
        about_description: 'Detta är INI (konfiguration) filer i olika storlekar för teständamål'
      },
      intelhex: {
        meta: {
          title: 'Ladda ner gratis IntelHex-exempelfiler - Intel hex-testfiler för firmware-utveckling | FormiPeek',
        ...
        schema: {
          name: 'Gratis IntelHex-exempelfiler - Ladda ner Intel hex-testfiler för firmware-utveckling',
          description: 'Ladda ner gratis IntelHex Intel hex-exempelfiler för att testa firmware-programmering, inbyggda systemutveckling och mikrokontrollerverktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa IntelHex-parsers, firmware-laddare, mikrokontrollerprogrammering, inbyggda utvecklingsverktyg och hex-filbearbetningsapplikationer.'
        },
        hero: {
          title: 'IntelHex-exempelfiler',
          description: 'Ladda ner gratis IntelHex Intel hex-exempelfiler för testning. Flera filstorlekar tillgängliga för att testa dina IntelHex-parsers, firmware-laddare och inbyggda utvecklingsverktyg.'
        },
        about_description: 'Detta är IntelHex (Intel hex) filer i olika storlekar för teständamål'
      },
      ipynb: {
        meta: {
          title: 'Ladda ner gratis IPYNB-exempelfiler - Jupyter Notebook-testfiler för datavetenskap | FormiPeek',
        ...
        schema: {
          name: 'Gratis IPYNB-exempelfiler - Ladda ner Jupyter Notebook-testfiler för datavetenskap',
          description: 'Ladda ner gratis IPYNB Jupyter Notebook-exempelfiler för att testa datavetenskapsarbetsflöden, Python-körning och notebook-analysverktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa Jupyter Notebook, Python-datavetenskapsverktyg, notebook-visare, dataanalysapplikationer och vetenskapliga beräkningsplattformar.'
        },
        hero: {
          title: 'IPYNB-exempelfiler',
          description: 'Ladda ner gratis IPYNB Jupyter Notebook-exempelfiler för testning. Flera filstorlekar tillgängliga för att testa din Jupyter Notebook, Python-datavetenskapsverktyg och notebook-analysapplikationer.'
        },
        about_description: 'Detta är IPYNB (Jupyter Notebook) filer i olika storlekar för teständamål'
      },
      java: {
        meta: {
          title: 'Ladda ner gratis Java-exempelfiler - Java-källkodstestfiler för utveckling | FormiPeek',
        ...
        schema: {
          name: 'Gratis Java-exempelfiler - Ladda ner Java-källkodstestfiler för utveckling',
          description: 'Ladda ner gratis Java Java-källkodsexempelfiler för att testa Java-kompilering, JVM-applikationer och utvecklingsverktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa Java-kompilatorer, JVM, IDE-stöd (Eclipse, IntelliJ), Java-byggverktyg (Maven, Gradle) och Java-utvecklingsmiljöer.'
        },
        hero: {
          title: 'Java-exempelfiler',
          description: 'Ladda ner gratis Java Java-källkodsexempelfiler för testning. Flera filstorlekar tillgängliga för att testa dina Java-kompilatorer, JVM och Java-utvecklingsverktyg.'
        },
        about_description: 'Detta är Java-källkodsfiler i olika storlekar för teständamål'
      },
      jks: {
        meta: {
          title: 'Ladda ner gratis JKS-exempelfiler - Java KeyStore-testfiler för SSL/TLS-säkerhet | FormiPeek',
        ...
        schema: {
          name: 'Gratis JKS-exempelfiler - Ladda ner Java KeyStore-testfiler för SSL/TLS-säkerhet',
          description: 'Ladda ner gratis JKS Java KeyStore-exempelfiler för att testa SSL/TLS-certifikatlagring, Java-säkerhet och PKI-hanteringsverktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa Java KeyStore-hantering, JKS-tolkning, SSL-certifikatlagring, Java-säkerhetsverktyg och PKI-infrastruktur.'
        },
        hero: {
          title: 'JKS-exempelfiler',
          description: 'Ladda ner gratis JKS Java KeyStore-exempelfiler för testning. Flera filstorlekar tillgängliga för att testa din Java KeyStore-hantering, JKS-tolkning och SSL-certifikatlagringsverktyg.'
        },
        about_description: 'Detta är JKS (Java KeyStore) filer i olika storlekar för teständamål'
      },
      json: {
        meta: {
          title: 'Ladda ner gratis JSON-exempelfiler - JSON-datatestfiler för webbutveckling | FormiPeek',
        ...
        schema: {
          name: 'Gratis JSON-exempelfiler - Ladda ner JSON-datatestfiler för webbutveckling',
          description: 'Ladda ner gratis JSON JSON-dataexempelfiler för att testa JSON-tolkning, API-integration och webbutvecklingsverktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa JSON-parsers, API-svar, datautbytesformat, webbapplikationer och JSON-valideringsverktyg.'
        },
        hero: {
          title: 'JSON-exempelfiler',
          description: 'Ladda ner gratis JSON JSON-dataexempelfiler för testning. Flera filstorlekar tillgängliga för att testa dina JSON-parsers, API-integration och webbutvecklingsverktyg.'
        },
        about_description: 'Detta är JSON (JavaScript Object Notation) filer i olika storlekar för teständamål'
      },
      jsonl: {
        meta: {
          title: 'Ladda ner gratis JSONL-exempelfiler - JSON Lines-testfiler för databearbetning | FormiPeek',
        ...
        schema: {
          name: 'Gratis JSONL-exempelfiler - Ladda ner JSON Lines-testfiler för databearbetning',
          description: 'Ladda ner gratis JSONL JSON Lines-exempelfiler för att testa databearbetning, JSON-strömning och big data-verktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa JSONL-parsers, dataströmningsapplikationer, ETL-verktyg, big data-bearbetning och loggfilanalysverktyg.'
        },
        hero: {
          title: 'JSONL-exempelfiler',
          description: 'Ladda ner gratis JSONL JSON Lines-exempelfiler för testning. Flera filstorlekar tillgängliga för att testa dina JSONL-parsers, dataströmningsapplikationer och big data-bearbetningsverktyg.'
        },
        about_description: 'Detta är JSONL (JSON Lines) filer i olika storlekar för teständamål'
      },
      js: {
        meta: {
          title: 'Ladda ner gratis JS-exempelfiler - JavaScript-källkodstestfiler för webbutveckling | FormiPeek',
        ...
        schema: {
          name: 'Gratis JS-exempelfiler - Ladda ner JavaScript-källkodstestfiler för webbutveckling',
          description: 'Ladda ner gratis JS JavaScript-källkodsexempelfiler för att testa JavaScript-körning, webbutveckling och front-end-verktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa JavaScript-motorer, Node.js, webbrowsers, JavaScript-minifierare, kodanalysverktyg och front-end-utvecklingsramverk.'
        },
        hero: {
          title: 'JS-exempelfiler',
          description: 'Ladda ner gratis JS JavaScript-källkodsexempelfiler för testning. Flera filstorlekar tillgängliga för att testa dina JavaScript-motorer, Node.js och webbutvecklingsverktyg.'
        },
        about_description: 'Detta är JS (JavaScript) källkodsfiler i olika storlekar för teständamål'
      },
      jsx: {
        meta: {
          title: 'Ladda ner gratis JSX-exempelfiler - React JSX-testfiler för front-end-utveckling | FormiPeek',
        ...
        schema: {
          name: 'Gratis JSX-exempelfiler - Ladda ner React JSX-testfiler för front-end-utveckling',
          description: 'Ladda ner gratis JSX React JSX-exempelfiler för att testa React-utveckling, JSX-kompilering och front-end-ramverk. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa React, JSX-transpilerare (Babel), front-end-byggverktyg, React-utvecklingsmiljöer och moderna JavaScript-ramverk.'
        },
        hero: {
          title: 'JSX-exempelfiler',
          description: 'Ladda ner gratis JSX React JSX-exempelfiler för testning. Flera filstorlekar tillgängliga för att testa din React, JSX-transpilerare och front-end-utvecklingsverktyg.'
        },
        about_description: 'Detta är JSX (React JSX) filer i olika storlekar för teständamål'
      },
      jwt: {
        meta: {
          title: 'Ladda ner gratis JWT-exempelfiler - JSON Web Token-testfiler för API-säkerhet | FormiPeek',
        ...
        schema: {
          name: 'Gratis JWT-exempelfiler - Ladda ner JSON Web Token-testfiler för API-säkerhet',
          description: 'Ladda ner gratis JWT JSON Web Token-exempelfiler för att testa API-autentisering, JWT-tokentolkning och säkerhetsverktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa JWT-parsers, API-autentisering, tokenvalidering, OAuth 2.0 och säkerhetstestverktyg.'
        },
        hero: {
          title: 'JWT-exempelfiler',
          description: 'Ladda ner gratis JWT JSON Web Token-exempelfiler för testning. Flera filstorlekar tillgängliga för att testa dina JWT-parsers, API-autentisering och säkerhetsverktyg.'
        },
        about_description: 'Detta är JWT (JSON Web Token) filer i olika storlekar för teständamål'
      },
      key: {
        meta: {
          title: 'Ladda ner gratis KEY-exempelfiler - Privatnyckel-testfiler för SSL/TLS-säkerhet | FormiPeek',
        ...
        schema: {
          name: 'Gratis KEY-exempelfiler - Ladda ner privatnyckel-testfiler för SSL/TLS-säkerhet',
          description: 'Ladda ner gratis KEY-privatnyckelexempelfiler för att testa SSL/TLS-certifikat, kryptografiska operationer och säkerhetsverktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa privatnyckeltolkning, OpenSSL, SSL-certifikatgenerering, kryptografibibliotek och säkerhetscertifikathanteringsverktyg.'
        },
        hero: {
          title: 'KEY-exempelfiler',
          description: 'Ladda ner gratis KEY-privatnyckelexempelfiler för testning. Flera filstorlekar tillgängliga för att testa din privatnyckeltolkning, OpenSSL och säkerhetscertifikathanteringsverktyg.'
        },
        about_description: 'Detta är KEY (privatnyckel) filer i olika storlekar för teständamål'
      },
      kml: {
        meta: {
          title: 'Ladda ner gratis KML-exempelfiler - Keyhole Markup Language-testfiler för GIS och kartläggning | FormiPeek',
        ...
        schema: {
          name: 'Gratis KML-exempelfiler - Ladda ner Keyhole Markup Language-testfiler för GIS och kartläggning',
          description: 'Ladda ner gratis KML Keyhole Markup Language-geodataexempelfiler för att testa GIS-applikationer, kartvisualisering och geospatiala verktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa Google Earth, GIS-programvara, kartrendering, geodatabearbetning och geospatiala analysverktyg.'
        },
        hero: {
          title: 'KML-exempelfiler',
          description: 'Ladda ner gratis KML Keyhole Markup Language-geodataexempelfiler för testning. Flera filstorlekar tillgängliga för att testa din GIS-programvara, kartvisualisering och geospatiala analysverktyg.'
        },
        about_description: 'Detta är KML (Keyhole Markup Language) geodatafiler i olika storlekar för teständamål'
      },
      kt: {
        meta: {
          title: 'Ladda ner gratis KT-exempelfiler - Kotlin-källkodstestfiler för Android-utveckling | FormiPeek',
        ...
        schema: {
          name: 'Gratis KT-exempelfiler - Ladda ner Kotlin-källkodstestfiler för Android-utveckling',
          description: 'Ladda ner gratis KT Kotlin-källkodsexempelfiler för att testa Kotlin-kompilering, Android-utveckling och JVM-applikationer. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa Kotlin-kompilatorer, Android Studio, Kotlin/JVM, IDE-stöd och Kotlin-utvecklingsmiljöer.'
        },
        hero: {
          title: 'KT-exempelfiler',
          description: 'Ladda ner gratis KT Kotlin-källkodsexempelfiler för testning. Flera filstorlekar tillgängliga för att testa dina Kotlin-kompilatorer, Android Studio och Kotlin-utvecklingsverktyg.'
        },
        about_description: 'Detta är KT (Kotlin) källkodsfiler i olika storlekar för teständamål'
      },
      log: {
        meta: {
          title: 'Ladda ner gratis LOG-exempelfiler - Loggtestfiler för felsökning och systemanalys | FormiPeek',
        ...
        schema: {
          name: 'Gratis LOG-exempelfiler - Ladda ner loggtestfiler för felsökning och systemanalys',
          description: 'Ladda ner gratis LOG-loggexempelfiler för att testa loggtolkning, systemanalys och felsökningsverktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa logganalysatorer, systemövervakningsverktyg, felsökningsapplikationer, loggaggregeringssystem och systemdiagnostikverktyg.'
        },
        hero: {
          title: 'LOG-exempelfiler',
          description: 'Ladda ner gratis LOG-loggexempelfiler för testning. Flera filstorlekar tillgängliga för att testa dina logganalysatorer, systemövervakning och felsökningsverktyg.'
        },
        about_description: 'Detta är LOG-filer i olika storlekar för teständamål'
      },
      lua: {
        meta: {
          title: 'Ladda ner gratis LUA-exempelfiler - Lua-skripttestfiler för spelutveckling och automatisering | FormiPeek',
        ...
        schema: {
          name: 'Gratis LUA-exempelfiler - Ladda ner Lua-skripttestfiler för spelutveckling och automatisering',
          description: 'Ladda ner gratis LUA Lua-skriptexempelfiler för att testa Lua-körning, spelutveckling och automatiseringsverktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa Lua-tolkar, spelmotorer, skriptmiljöer, automatiseringsverktyg och inbyggda Lua-applikationer.'
        },
        hero: {
          title: 'LUA-exempelfiler',
          description: 'Ladda ner gratis LUA Lua-skriptexempelfiler för testning. Flera filstorlekar tillgängliga för att testa dina Lua-tolkar, spelmotorer och automatiseringsverktyg.'
        },
        about_description: 'Detta är LUA (Lua-skript) filer i olika storlekar för teständamål'
      },
      m3u: {
        meta: {
          title: 'Ladda ner gratis M3U-exempelfiler - M3U-spellistetestfiler för mediaspelare | FormiPeek',
        ...
        schema: {
          name: 'Gratis M3U-exempelfiler - Ladda ner M3U-spellistetestfiler för mediaspelare',
          description: 'Ladda ner gratis M3U M3U-spellistexempelfiler för att testa mediaspelare, spellistetolkning och audio/video-strömningsverktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa mediaspelare, spellistehanterare, strömningsapplikationer, audio-spelare och video-spelarprogramvara.'
        },
        hero: {
          title: 'M3U-exempelfiler',
          description: 'Ladda ner gratis M3U M3U-spellistexempelfiler för testning. Flera filstorlekar tillgängliga för att testa dina mediaspelare, spellistehanterare och strömningsapplikationer.'
        },
        about_description: 'Detta är M3U (spellista) filer i olika storlekar för teständamål'
      },
      m3u8: {
        meta: {
          title: 'Ladda ner gratis M3U8-exempelfiler - M3U8 HLS-spellistetestfiler för video-strömning | FormiPeek',
        ...
        schema: {
          name: 'Gratis M3U8-exempelfiler - Ladda ner M3U8 HLS-spellistetestfiler för video-strömning',
          description: 'Ladda ner gratis M3U8 M3U8 HLS (HTTP Live Streaming) spellistexempelfiler för att testa video-strömning, HLS-spelare och medieleveransverktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa HLS-spelare, video-strömningsplattformar, adaptiv bitrate-strömning, mediaservrar och video-leveranssystem.'
        },
        hero: {
          title: 'M3U8-exempelfiler',
          description: 'Ladda ner gratis M3U8 M3U8 HLS-spellistexempelfiler för testning. Flera filstorlekar tillgängliga för att testa dina HLS-spelare, video-strömningsplattformar och medieleveranssystem.'
        },
        about_description: 'Detta är M3U8 (HLS-spellista) filer i olika storlekar för teständamål'
      },
      makefile: {
        meta: {
          title: 'Ladda ner gratis Makefile-exempelfiler - Makefile-byggkonfigurationstestfiler | FormiPeek',
        ...
        schema: {
          name: 'Gratis Makefile-exempelfiler - Ladda ner Makefile-byggkonfigurationstestfiler',
          description: 'Ladda ner gratis Makefile-byggkonfigurationsexempelfiler för att testa byggautomatisering, Make-byggsystem och utvecklingsverktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa Make-byggsystem, byggautomatiseringsverktyg, C/C++-kompilering, byggskript och utvecklingsbyggmiljöer.'
        },
        hero: {
          title: 'Makefile-exempelfiler',
          description: 'Ladda ner gratis Makefile-byggkonfigurationsexempelfiler för testning. Flera filstorlekar tillgängliga för att testa ditt Make-byggsystem, byggautomatiseringsverktyg och utvecklingsbyggmiljöer.'
        },
        about_description: 'Detta är Makefile (byggkonfiguration) filer i olika storlekar för teständamål'
      },
      mbtiles: {
        meta: {
          title: 'Ladda ner gratis MBTiles-exempelfiler - MBTiles-karttilesdatabastestfiler | FormiPeek',
        ...
        schema: {
          name: 'Gratis MBTiles-exempelfiler - Ladda ner MBTiles-karttilesdatabastestfiler',
          description: 'Ladda ner gratis MBTiles-karttilesdatabas-exempelfiler för att testa kartrendering, GIS-applikationer och kartläggningsverktyg. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa karttileservrar, GIS-programvara, kartrenderingmotorer, mobila kartläggningsapplikationer och offline-kartverktyg.'
        },
        hero: {
          title: 'MBTiles-exempelfiler',
          description: 'Ladda ner gratis MBTiles-karttilesdatabas-exempelfiler för testning. Flera filstorlekar tillgängliga för att testa dina karttileservrar, GIS-programvara och kartrenderingmotorer.'
        },
        about_description: 'Detta är MBTiles (karttilesdatabas) filer i olika storlekar för teständamål'
      },
      md: {
        meta: {
          title: 'Ladda ner gratis MD-exempelfiler - Markdown-dokumentationstestfiler | FormiPeek',
        ...
        schema: {
          name: 'Gratis MD-exempelfiler - Ladda ner Markdown-dokumentationstestfiler',
          description: 'Ladda ner gratis MD Markdown-dokumentationsexempelfiler för att testa Markdown-tolkning, dokumentationsverktyg och innehållshanteringssystem. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa Markdown-parsers, dokumentationsgeneratorer, statiska webbplatsgeneratorer, GitHub Markdown och innehållshanteringsplattformar.'
        },
        hero: {
          title: 'MD-exempelfiler',
          description: 'Ladda ner gratis MD Markdown-dokumentationsexempelfiler för testning. Flera filstorlekar tillgängliga för att testa dina Markdown-parsers, dokumentationsgeneratorer och innehållshanteringssystem.'
        },
        about_description: 'Detta är MD (Markdown) filer i olika storlekar för teständamål'
      },
      mdx: {
        meta: {
          title: 'Ladda ner gratis MDX-exempelfiler - MDX React Markdown-testfiler för dokumentation | FormiPeek',
        ...
        schema: {
          name: 'Gratis MDX-exempelfiler - Ladda ner MDX React Markdown-testfiler för dokumentation',
          description: 'Ladda ner gratis MDX MDX (Markdown + JSX) exempelfiler för att testa React-dokumentation, statiska webbplatsgeneratorer och innehållshanteringssystem. Flera filstorlekar: 100 KB, 1 MB, 5 MB, 50 MB och 100 MB. Perfekt för att testa MDX-parsers, React-dokumentationsverktyg, Next.js, Gatsby, statiska webbplatsgeneratorer och moderna dokumentationsplattformar.'
        },
        hero: {
          title: 'MDX-exempelfiler',
      ...
      apk: {
        meta: {
          title: 'Ladda ner gratis APK-exempelfiler - Android-applikationspaket testfiler | FormiPeek',
      ...
      appimage: {
        meta: {
          title: 'Ladda ner gratis AppImage-exempelfiler - Linux portabla applikationer testfiler | FormiPeek',
      ...
      elf: {
        meta: {
          title: 'Ladda ner gratis ELF-exempelfiler - Executable and Linkable Format testfiler för Linux/Unix | FormiPeek',
      ...
      exe: {
        meta: {
          title: 'Ladda ner gratis EXE-exempelfiler - Windows executable testfiler | FormiPeek',
      ...
      ipa: {
        meta: {
          title: 'Ladda ner gratis IPA-exempelfiler - iOS-applikationspaket testfiler | FormiPeek',
      ...
      jar: {
        meta: {
          title: 'Ladda ner gratis JAR-exempelfiler - Java-arkiv testfiler | FormiPeek',
      ...
      crx: {
        meta: {
          title: 'Ladda ner gratis CRX-exempelfiler - Chrome-tilläggspaket testfiler | FormiPeek',
      ...
      '3ds': {
        meta: {
          title: 'Ladda ner gratis 3DS-exempelfiler - 3D-modell testfiler för 3D-utskrift och modellering | FormiPeek',
      ...
      '3mf': {
        meta: {
          title: 'Ladda ner gratis 3MF-exempelfiler - 3D Manufacturing Format testfiler för 3D-utskrift | FormiPeek',
      ...
      ai: {
        meta: {
          title: 'Ladda ner gratis AI-exempelfiler - Adobe Illustrator vektorgrafik testfiler | FormiPeek',
      ...
      ase: {
        meta: {
          title: 'Ladda ner gratis ASE-exempelfiler - Aseprite sprite-animation testfiler | FormiPeek',
      ...
      'animation-fbx': {
        meta: {
          title: 'Ladda ner gratis Animation FBX-exempelfiler - Autodesk FBX 3D-animation testfiler | FormiPeek',
      ...
      assetbundle: {
        meta: {
          title: 'Ladda ner gratis AssetBundle-exempelfiler - Unity AssetBundle testfiler för spelutveckling | FormiPeek',
      ...
      blend: {
        meta: {
          title: 'Ladda ner gratis BLEND-exempelfiler - Blender 3D-projekt testfiler | FormiPeek',
      ...
      bvh: {
        meta: {
          title: 'Ladda ner gratis BVH-exempelfiler - Biovision Hierarchy motion capture testfiler | FormiPeek',
      ...
      dwg: {
        meta: {
          title: 'Ladda ner gratis DWG-exempelfiler - AutoCAD-ritning testfiler för CAD-design | FormiPeek',
      ...
      dxf: {
        meta: {
          title: 'Ladda ner Gratis DXF Exempelfiler - Drawing Exchange Format Testfiler AutoCAD | FormiPeek',
      ...
      ifc: {
        meta: {
          title: 'Ladda ner Gratis IFC Exempelfiler - Industry Foundation Classes BIM Testfiler | FormiPeek',
      ...
      iges: {
        meta: {
          title: 'Ladda ner Gratis IGES Exempelfiler - Initial Graphics Exchange Specification CAD Testfiler | FormiPeek',
      ...
      igs: {
        meta: {
          title: 'Ladda ner Gratis IGS Exempelfiler - Initial Graphics Exchange Specification CAD Testfiler | FormiPeek',
      ...
      las: {
        meta: {
          title: 'Ladda ner Gratis LAS Exempelfiler - LiDAR Point Cloud Data Testfiler | FormiPeek',
      ...
      ma: {
        meta: {
          title: 'Ladda ner Gratis MA Exempelfiler - Maya ASCII Scene Testfiler | FormiPeek',
      ...
      max: {
        meta: {
          title: 'Ladda ner Gratis MAX Exempelfiler - 3ds Max Scene Testfiler | FormiPeek',
      ...
      mb: {
        meta: {
          title: 'Ladda ner Gratis MB Exempelfiler - Maya Binary Scene Testfiler | FormiPeek',
      ...
      indd: {
        meta: {
          title: 'Ladda ner Gratis INDD Exempelfiler - Adobe InDesign Dokument Testfiler | FormiPeek',
      ...
      'animated-gif': {
        meta: {
          title: 'Ladda ner Gratis Animerade GIF Exempelfiler - Animerade Bild Testfiler | FormiPeek',
      ...
      apng: {
        meta: {
          title: 'Ladda ner Gratis APNG Exempelfiler - Animerade PNG Bild Testfiler | FormiPeek',
      ...
      avif: {
        meta: {
          title: 'Ladda ner Gratis AVIF Exempelfiler - AV1 Image File Format Testfiler | FormiPeek',
      ...
      bmp: {
        meta: {
          title: 'Ladda ner Gratis BMP Exempelfiler - Bitmap Bild Testfiler | FormiPeek',
      ...
      'barcode-svg': {
        meta: {
          title: 'Ladda ner Gratis Streckkod SVG Exempelfiler - Skalbara Vektor Streckkod Testfiler | FormiPeek',
      ...
      avi: {
        meta: {
          title: 'Ladda ner Gratis AVI Exempelfiler - Audio Video Interleave Video Testfiler | FormiPeek',
      ...
      '3gp': {
        meta: {
          title: 'Ladda ner Gratis 3GP Exempelfiler - 3GPP Mobile Video Testfiler | FormiPeek',
      ...
      dav: {
        meta: {
          title: 'Ladda ner Gratis DAV Exempelfiler - DAV Video Testfiler för Säkerhetskameror | FormiPeek',
      ...
      dds: {
        meta: {
          title: 'Ladda ner Gratis DDS Exempelfiler - DirectDraw Surface Textur Testfiler | FormiPeek',
      ...
      dng: {
        meta: {
          title: 'Ladda ner Gratis DNG Exempelfiler - Digital Negative Raw Bild Testfiler | FormiPeek',
      ...
      eps: {
        meta: {
          title: 'Ladda ner Gratis EPS Exempelfiler - Encapsulated PostScript Vektorgrafik Testfiler | FormiPeek',
      ...
      exr: {
        meta: {
          title: 'Ladda ner Gratis EXR Exempelfiler - OpenEXR High Dynamic Range Bild Testfiler | FormiPeek',
      ...
      hdr: {
        meta: {
          title: 'Ladda ner Gratis HDR Exempelfiler - High Dynamic Range Bild Testfiler | FormiPeek',
      ...
      heic: {
        meta: {
          title: 'Ladda ner Gratis HEIC Exempelfiler - High Efficiency Image Container Testfiler | FormiPeek',
      ...
      heif: {
        meta: {
          title: 'Ladda ner Gratis HEIF Exempelfiler - High Efficiency Image Format Testfiler | FormiPeek',
      ...
      icns: {
        meta: {
          title: 'Ladda ner Gratis ICNS Exempelfiler - macOS Ikon Testfiler | FormiPeek',
      ...
      ico: {
        meta: {
          title: 'Ladda ner Gratis ICO Exempelfiler - Windows Ikon Testfiler | FormiPeek',
      ...
      jpeg: {
        meta: {
          title: 'Ladda ner Gratis JPEG Exempelfiler - JPEG Bild Testfiler för Konverteringsverktyg | FormiPeek',
      ...
      jpg: {
        meta: {
          title: 'Ladda ner Gratis JPG Exempelfiler - JPG Bild Testfiler för Konverteringsverktyg | FormiPeek',
      ...
      m4v: {
        meta: {
          title: 'Ladda ner Gratis M4V Exempelfiler - M4V Video Testfiler för Konverteringsverktyg | FormiPeek',
      ...
      mkv: {
        meta: {
          title: 'Ladda ner Gratis MKV Exempelfiler - Matroska Video Testfiler för Konverteringsverktyg | FormiPeek',
      ...
      aac: {
        meta: {
          title: 'Ladda ner Gratis AAC Exempelfiler - Advanced Audio Coding Testfiler | FormiPeek',
      ...
      ac3: {
        meta: {
          title: 'Ladda ner Gratis AC3 Exempelfiler - Dolby Digital Audio Testfiler | FormiPeek',
      ...
      aif: {
        meta: {
          title: 'Ladda ner Gratis AIF Exempelfiler - Audio Interchange File Format Testfiler | FormiPeek',
      ...
      aiff: {
        meta: {
          title: 'Ladda ner Gratis AIFF Exempelfiler - Audio Interchange File Format Testfiler | FormiPeek',
      ...
      amr: {
        meta: {
          title: 'Ladda ner Gratis AMR Exempelfiler - Adaptive Multi-Rate Audio Testfiler | FormiPeek',
      ...
      caf: {
        meta: {
          title: 'Ladda ner Gratis CAF Exempelfiler - Core Audio Format Testfiler | FormiPeek',
      ...
      cue: {
        meta: {
          title: 'Ladda ner Gratis CUE Exempelfiler - CUE Sheet Testfiler för Audio CD-bränning | FormiPeek',
      ...
      m4a: {
        meta: {
          title: 'Ladda ner Gratis M4A Exempelfiler - M4A Audio Testfiler för Konverteringsverktyg | FormiPeek',
      ...
      midi: {
        meta: {
          title: 'Ladda ner Gratis MIDI Exempelfiler - MIDI Music Testfiler för Musiksekvensering | FormiPeek',
      ...
      ace: {
        meta: {
          title: 'Ladda ner Gratis ACE Exempelfiler - ACE Archive Testfiler för Extraktionsverktyg | FormiPeek',
      ...
      arj: {
        meta: {
          title: 'Ladda ner Gratis ARJ Exempelfiler - ARJ Archive Testfiler för Extraktionsverktyg | FormiPeek',
      ...
      bz2: {
        meta: {
          title: 'Ladda ner Gratis BZ2 Exempelfiler - BZ2 Compressed Archive Testfiler | FormiPeek',
      ...
      gz: {
        meta: {
          title: 'Ladda ner Gratis GZ Exempelfiler - GZ Gzip Compressed Archive Testfiler | FormiPeek',
      ...
      cab: {
        meta: {
          title: 'Ladda ner Gratis CAB Exempelfiler - CAB Windows Cabinet Archive Testfiler | FormiPeek',
      ...
      cpio: {
        meta: {
          title: 'Ladda ner Gratis CPIO Exempelfiler - CPIO Archive Testfiler för Extraktionsverktyg | FormiPeek',
      ...
      zip: {
        meta: {
          title: 'Ladda ner Gratis ZIP Exempelfiler - ZIP Archive Testfiler för Extraktionsverktyg | FormiPeek',
      ...
      dmg: {
        meta: {
          title: 'Ladda ner Gratis DMG Exempelfiler - DMG macOS Disk Image Testfiler | FormiPeek',
      ...
      img: {
        meta: {
          title: 'Ladda ner Gratis IMG Exempelfiler - IMG Disk Image Testfiler | FormiPeek',
      ...
      iso: {
        meta: {
          title: 'Ladda ner Gratis ISO Exempelfiler - ISO Disk Image Testfiler | FormiPeek',
      ...
      kmz: {
        meta: {
          title: 'Ladda ner Gratis KMZ Exempelfiler - KMZ Compressed KML Testfiler | FormiPeek',
      ...
      laz: {
        meta: {
          title: 'Ladda ner Gratis LAZ Exempelfiler - LAZ Compressed LiDAR Testfiler | FormiPeek',
      ...
      lha: {
        meta: {
          title: 'Ladda ner Gratis LHA Exempelfiler - LHA Archive Testfiler för Extraktionsverktyg | FormiPeek',
      ...
      lzh: {
        meta: {
          title: 'Ladda ner Gratis LZH Exempelfiler - LZH Archive Testfiler för Extraktionsverktyg | FormiPeek',
      ...
      lzma: {
        meta: {
          title: 'Ladda ner Gratis LZMA Exempelfiler - LZMA Compressed Archive Testfiler | FormiPeek',
      ...
      '7z': {
        meta: {
          title: 'Ladda ner Gratis 7Z Exempelfiler - 7Z Archive Testfiler för Extraktionsverktyg | FormiPeek',

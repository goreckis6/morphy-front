...
export const nl: SamplePageTranslations = {
  sample_page: {
    common: {
      ...
      download_ready_in: 'Download klaar over {{countdown}}s...',
      about_title: 'Over deze voorbeeldbestanden',
      about_items: [
        'Dit zijn testbestanden in verschillende formaten voor testdoeleinden',
        'Bestanden worden veilig gehost en zijn gratis te downloaden',
        'Perfect voor het testen van documentconversietools en bestandsprocessors',
        'Geen registratie of account vereist'
      ],
      features: {
        multiple_sizes: {
          title: 'Meerdere formaten',
          description: 'Testbestanden van 100 KB tot 100 MB'
        },
        free_download: {
          title: 'Gratis download',
          description: 'Geen registratie of betaling vereist'
        },
        safe_tested: {
          title: 'Veilig en getest',
          description: 'Alle bestanden zijn veilig en getest op compatibiliteit'
        }
      }
    },
    formats: {
      docx: {
        meta: {
          title: 'Gratis DOCX voorbeeldbestanden downloaden - Testbestanden | FormiPeek',
        ...
        schema: {
          name: 'Gratis DOCX voorbeeldbestanden - Download testbestanden',
          description: 'Download gratis DOCX voorbeeldbestanden voor testen. Meerdere bestandsformaten beschikbaar: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van documentconversietools.'
        },
        hero: {
          title: 'DOCX voorbeeldbestanden',
          description: 'Download gratis DOCX voorbeeldbestanden voor testen. Meerdere bestandsformaten beschikbaar om uw documentconversie- en verwerkingstools te testen.'
        },
        about_description: 'Dit zijn DOCX testbestanden in verschillende formaten voor testdoeleinden'
      },
      doc: {
        meta: {
          title: 'Gratis DOC voorbeeldbestanden downloaden - Microsoft Word DOC testbestanden | FormiPeek',
        ...
        schema: {
          name: 'Gratis DOC voorbeeldbestanden - Download Microsoft Word DOC testbestanden',
          description: 'Download gratis DOC voorbeeldbestanden om documentconversietools te testen. Meerdere bestandsformaten beschikbaar: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van DOC naar PDF, DOC naar DOCX converters en legacy Microsoft Word documentverwerking.'
        },
        hero: {
          title: 'DOC voorbeeldbestanden',
          description: 'Download gratis DOC voorbeeldbestanden voor testen. Meerdere bestandsformaten beschikbaar om uw documentconversietools, DOC naar PDF converters en legacy Microsoft Word documentprocessors te testen.'
        },
        about_description: 'Dit zijn DOC testbestanden in verschillende formaten voor testdoeleinden'
      },
      pdf: {
        meta: {
          title: 'Gratis PDF voorbeeldbestanden downloaden - PDF testbestanden voor conversietools | FormiPeek',
        ...
        schema: {
          name: 'Gratis PDF voorbeeldbestanden - Download PDF testbestanden voor conversietools',
          description: 'Download gratis PDF voorbeeldbestanden om PDF converters, viewers en processors te testen. Meerdere bestandsformaten beschikbaar: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van PDF naar Word, PDF naar JPG, PDF compressie en PDF bewerkingstools.'
        },
        hero: {
          title: 'PDF voorbeeldbestanden',
          description: 'Download gratis PDF voorbeeldbestanden voor testen. Meerdere bestandsformaten beschikbaar om uw PDF converters, PDF naar Word tools, PDF compressiesoftware en PDF verwerkingsapplicaties te testen.'
        },
        about_description: 'Dit zijn PDF testbestanden in verschillende formaten voor testdoeleinden'
      },
      odp: {
        meta: {
          title: 'Gratis ODP voorbeeldbestanden downloaden - OpenDocument presentatie testbestanden | FormiPeek',
        ...
        schema: {
          name: 'Gratis ODP voorbeeldbestanden - Download OpenDocument presentatie testbestanden',
          description: 'Download gratis ODP voorbeeldbestanden om presentatieconversietools te testen. Meerdere bestandsformaten beschikbaar: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van ODP naar PPT, ODP naar PDF converters, LibreOffice Impress bestanden en OpenDocument formaatverwerking.'
        },
        hero: {
          title: 'ODP voorbeeldbestanden',
          description: 'Download gratis ODP voorbeeldbestanden OpenDocument presentaties voor testen. Meerdere bestandsformaten beschikbaar om uw presentatieconversietools, ODP naar PPT converters en OpenDocument formaatprocessors te testen.'
        },
        about_description: 'Dit zijn ODP testbestanden in verschillende formaten voor testdoeleinden'
      },
      rtf: {
        meta: {
          title: 'Gratis RTF voorbeeldbestanden downloaden - Rich Text Format testbestanden | FormiPeek',
        ...
        schema: {
          name: 'Gratis RTF voorbeeldbestanden - Download Rich Text Format testbestanden',
          description: 'Download gratis RTF voorbeeldbestanden om Rich Text Format conversietools te testen. Meerdere bestandsformaten beschikbaar: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van RTF naar DOC, RTF naar PDF converters, tekstverwerker compatibiliteit en documentformaatconversie.'
        },
        hero: {
          title: 'RTF voorbeeldbestanden',
          description: 'Download gratis RTF voorbeeldbestanden Rich Text Format documenten voor testen. Meerdere bestandsformaten beschikbaar om uw documentconversietools, RTF naar DOC converters en tekstverwerker compatibiliteit te testen.'
        },
        about_description: 'Dit zijn RTF testbestanden in verschillende formaten voor testdoeleinden'
      },
      epub: {
        meta: {
          title: 'Gratis EPUB voorbeeldbestanden downloaden - eBook testbestanden voor lezers | FormiPeek',
        ...
        schema: {
          name: 'Gratis EPUB voorbeeldbestanden - Download eBook testbestanden voor lezers',
          description: 'Download gratis EPUB voorbeeldbestanden om eBook lezers en conversietools te testen. Meerdere bestandsformaten beschikbaar: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van EPUB lezers, EPUB naar PDF, EPUB naar MOBI converters, digitale publicatietools en eBook formaatcompatibiliteit.'
        },
        hero: {
          title: 'EPUB voorbeeldbestanden',
          description: 'Download gratis EPUB voorbeeldbestanden eBook bestanden voor testen. Meerdere bestandsformaten beschikbaar om uw eBook lezers, EPUB naar PDF converters, EPUB naar MOBI tools en digitale publicatieapplicaties te testen.'
        },
        about_description: 'Dit zijn EPUB testbestanden in verschillende formaten voor testdoeleinden'
      },
      'invoice-pdf': {
        meta: {
          title: 'Gratis factuur PDF voorbeeldbestanden downloaden - Factuurdocument testbestanden | FormiPeek',
        ...
        schema: {
          name: 'Gratis factuur PDF voorbeeldbestanden - Download factuurdocument testbestanden',
          description: 'Download gratis factuur PDF voorbeeldbestanden om factuurverwerking en parsing tools te testen. Meerdere bestandsformaten beschikbaar: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van factuur OCR, factuurdata extractie, factuur automatisering, factuur PDF parsing en documentbeheersystemen.'
        },
        hero: {
          title: 'Factuur PDF voorbeeldbestanden',
          description: 'Download gratis factuur PDF voorbeeldbestanden factuurdocumenten voor testen. Meerdere bestandsformaten beschikbaar om uw factuurverwerkingstools, factuur OCR software, factuurdata extractiesystemen en documentbeheerapplicaties te testen.'
        },
        about_description: 'Dit zijn factuur PDF testbestanden in verschillende formaten voor testdoeleinden'
      },
      mobi: {
        meta: {
          title: 'Gratis MOBI voorbeeldbestanden downloaden - MOBI eBook testbestanden voor Kindle | FormiPeek',
        ...
        schema: {
          name: 'Gratis MOBI voorbeeldbestanden - Download MOBI eBook testbestanden voor Kindle',
          description: 'Download gratis MOBI voorbeeldbestanden om MOBI eBook lezers en conversietools te testen. Meerdere bestandsformaten beschikbaar: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van Kindle compatibiliteit, MOBI naar EPUB, MOBI naar PDF converters, eBook formaatconversie en digitale leesapplicaties.'
        },
        hero: {
          title: 'MOBI voorbeeldbestanden',
          description: 'Download gratis MOBI voorbeeldbestanden MOBI eBook bestanden voor testen. Meerdere bestandsformaten beschikbaar om uw MOBI eBook lezers, MOBI naar EPUB converters, MOBI naar PDF tools en Kindle compatibiliteitsapplicaties te testen.'
        },
        about_description: 'Dit zijn MOBI testbestanden in verschillende formaten voor testdoeleinden'
      },
      csv: {
        meta: {
          title: 'Download gratis CSV voorbeeldbestanden - CSV testbestanden voor gegevensverwerking | FormiPeek',
        ...
        schema: {
          name: 'Gratis CSV voorbeeldbestanden - Download CSV testbestanden voor gegevensverwerking',
          description: 'Download gratis CSV voorbeeldbestanden om gegevensverwerking en conversietools te testen. Meerdere bestandsformaten: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van CSV naar Excel, CSV naar JSON converters, gegevensimporttools, spreadsheetapplicaties en komma-gescheiden waarden verwerking.'
        },
        hero: {
          title: 'CSV voorbeeldbestanden',
          description: 'Download gratis CSV voorbeeldbestanden voor testen. Meerdere bestandsformaten beschikbaar om uw CSV conversietools, CSV naar Excel converters, gegevensverwerkingsapplicaties en spreadsheet import software te testen.'
        },
        about_description: 'Dit zijn CSV testbestanden in verschillende formaten voor testdoeleinden'
      },
      xls: {
        meta: {
          title: 'Download gratis XLS voorbeeldbestanden - Microsoft Excel XLS testbestanden | FormiPeek',
        ...
        schema: {
          name: 'Gratis XLS voorbeeldbestanden - Download Microsoft Excel XLS testbestanden',
          description: 'Download gratis XLS voorbeeldbestanden om Excel conversie en gegevensverwerkingstools te testen. Meerdere bestandsformaten: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van XLS naar XLSX, XLS naar CSV, XLS naar PDF converters, Excel gegevensextractie en legacy spreadsheet verwerking.'
        },
        hero: {
          title: 'XLS voorbeeldbestanden',
          description: 'Download gratis XLS Excel spreadsheet voorbeeldbestanden voor testen. Meerdere bestandsformaten beschikbaar om uw Excel conversietools, XLS naar XLSX converters, gegevensverwerkingsapplicaties en spreadsheet import software te testen.'
        },
        about_description: 'Dit zijn XLS testbestanden in verschillende formaten voor testdoeleinden'
      },
      xlsx: {
        meta: {
          title: 'Download gratis XLSX voorbeeldbestanden - Excel XLSX testbestanden voor conversietools | FormiPeek',
        ...
        schema: {
          name: 'Gratis XLSX voorbeeldbestanden - Download Excel XLSX testbestanden voor conversietools',
          description: 'Download gratis XLSX voorbeeldbestanden om Excel conversie en gegevensverwerkingstools te testen. Meerdere bestandsformaten: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van XLSX naar CSV, XLSX naar PDF, XLSX naar JSON converters, Excel gegevensanalyse, spreadsheet automatisering en Office Open XML verwerking.'
        },
        hero: {
          title: 'XLSX voorbeeldbestanden',
          description: 'Download gratis XLSX Excel spreadsheet voorbeeldbestanden voor testen. Meerdere bestandsformaten beschikbaar om uw Excel conversietools, XLSX naar CSV converters, gegevensanalyseapplicaties en spreadsheet automatisering software te testen.'
        },
        about_description: 'Dit zijn XLSX testbestanden in verschillende formaten voor testdoeleinden'
      },
      xml: {
        meta: {
          title: 'Download gratis XML voorbeeldbestanden - XML testbestanden voor parsing en conversie | FormiPeek',
        ...
        schema: {
          name: 'Gratis XML voorbeeldbestanden - Download XML testbestanden voor parsing en conversie',
          description: 'Download gratis XML voorbeeldbestanden om XML parsing, conversie en gegevensverwerkingstools te testen. Meerdere bestandsformaten: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van XML naar JSON, XML naar CSV converters, XML validatie, gestructureerde gegevensverwerking en markup taal parsing.'
        },
        hero: {
          title: 'XML voorbeeldbestanden',
          description: 'Download gratis XML voorbeeldbestanden voor testen. Meerdere bestandsformaten beschikbaar om uw XML parsing tools, XML naar JSON converters, XML validatiesoftware en gestructureerde gegevensverwerkingsapplicaties te testen.'
        },
        about_description: 'Dit zijn XML testbestanden in verschillende formaten voor testdoeleinden'
      },
      html: {
        meta: {
          title: 'Download gratis HTML voorbeeldbestanden - HTML testbestanden voor webontwikkeling | FormiPeek',
        ...
        schema: {
          name: 'Gratis HTML voorbeeldbestanden - Download HTML testbestanden voor webontwikkeling',
          description: 'Download gratis HTML voorbeeldbestanden om webontwikkeling en HTML verwerkingstools te testen. Meerdere bestandsformaten: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van HTML naar PDF, HTML naar DOCX converters, HTML validatie, web scraping, browser rendering en HyperText Markup Language verwerking.'
        },
        hero: {
          title: 'HTML voorbeeldbestanden',
          description: 'Download gratis HTML HyperText Markup Language voorbeeldbestanden voor testen. Meerdere bestandsformaten beschikbaar om uw HTML parsing tools, HTML naar PDF converters, HTML validatiesoftware en webontwikkelingsapplicaties te testen.'
        },
        about_description: 'Dit zijn HTML testbestanden in verschillende formaten voor testdoeleinden'
      },
      ods: {
        meta: {
          title: 'Download gratis ODS voorbeeldbestanden - OpenDocument spreadsheet testbestanden | FormiPeek',
        ...
        schema: {
          name: 'Gratis ODS voorbeeldbestanden - Download OpenDocument spreadsheet testbestanden',
          description: 'Download gratis ODS voorbeeldbestanden om spreadsheet conversie en gegevensverwerkingstools te testen. Meerdere bestandsformaten: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van ODS naar Excel, ODS naar CSV converters, LibreOffice Calc bestanden, OpenDocument formaat verwerking en spreadsheet gegevensextractie.'
        },
        hero: {
          title: 'ODS voorbeeldbestanden',
          description: 'Download gratis ODS OpenDocument Spreadsheet voorbeeldbestanden voor testen. Meerdere bestandsformaten beschikbaar om uw spreadsheet conversietools, ODS naar Excel converters en OpenDocument formaat processors te testen.'
        },
        about_description: 'Dit zijn ODS testbestanden in verschillende formaten voor testdoeleinden'
      },
      'ansible-yml': {
        meta: {
          title: 'Download gratis Ansible YML voorbeeldbestanden - YAML configuratie testbestanden | FormiPeek',
        ...
        schema: {
          name: 'Gratis Ansible YML voorbeeldbestanden - Download YAML configuratie testbestanden',
          description: 'Download gratis Ansible YML voorbeeldbestanden om YAML parsing en configuratiebeheertools te testen. Meerdere bestandsformaten: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van Ansible playbooks, YAML validatie, DevOps automatisering, configuratiebeheersystemen en infrastructure as code tools.'
        },
        hero: {
          title: 'Ansible YML voorbeeldbestanden',
      ...
      'api-response-json': {
        meta: {
          title: 'Gratis API Response JSON voorbeeldbestanden downloaden - JSON testbestanden voor API ontwikkeling | FormiPeek',
      ...
      'arduino-ino': {
        meta: {
          title: 'Gratis Arduino INO voorbeeldbestanden downloaden - Arduino Sketch testbestanden voor embedded ontwikkeling | FormiPeek',
      ...
      bat: {
        meta: {
          title: 'Gratis BAT voorbeeldbestanden downloaden - Batch script testbestanden voor Windows automatisering | FormiPeek',
      ...
      asc: {
        meta: {
          title: 'Gratis ASC voorbeeldbestanden downloaden - ASCII tekst testbestanden voor tekstverwerking | FormiPeek',
      ...
      bib: {
        meta: {
          title: 'Gratis BIB voorbeeldbestanden downloaden - Bibliografie testbestanden voor academisch onderzoek | FormiPeek',
      ...
      c: {
        meta: {
          title: 'Gratis C voorbeeldbestanden downloaden - C programmeertaal testbestanden voor ontwikkeling | FormiPeek',
      ...
      'can-log': {
        meta: {
          title: 'Gratis CAN Log voorbeeldbestanden downloaden - Controller Area Network testbestanden voor automobiel | FormiPeek',
      ...
      cmd: {
        meta: {
          title: 'Gratis CMD voorbeeldbestanden downloaden - Windows opdracht script testbestanden voor automatisering | FormiPeek',
      ...
      conf: {
        meta: {
          title: 'Gratis CONF voorbeeldbestanden downloaden - Configuratie testbestanden voor systeem configuratie | FormiPeek',
      ...
      'config-ini': {
        meta: {
          title: 'Gratis Config INI voorbeeldbestanden downloaden - INI configuratie testbestanden voor applicaties | FormiPeek',
      ...
      cpp: {
        meta: {
          title: 'Gratis CPP voorbeeldbestanden downloaden - C++ programmeertaal testbestanden voor ontwikkeling | FormiPeek',
      ...
      h: {
        meta: {
          title: 'Gratis H voorbeeldbestanden downloaden - C/C++ header bestand testbestanden voor programmering | FormiPeek',
      ...
      hpp: {
        meta: {
          title: 'Gratis HPP voorbeeldbestanden downloaden - C++ header bestand testbestanden voor moderne C++ ontwikkeling | FormiPeek',
      ...
      hex: {
        meta: {
          title: 'Gratis HEX voorbeeldbestanden downloaden - Hexadecimale testbestanden voor firmware ontwikkeling en embedded systemen | FormiPeek',
        ...
        schema: {
          name: 'Gratis HEX voorbeeldbestanden - Download hexadecimale testbestanden voor firmware ontwikkeling en embedded systemen',
          description: 'Download gratis HEX hexadecimale voorbeeldbestanden om firmware programmering, embedded systeem ontwikkeling en binaire data analyse te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van hex editors, firmware loaders, microcontroller programmering en embedded ontwikkeling tools.'
        },
        hero: {
          title: 'HEX voorbeeldbestanden',
          description: 'Download gratis HEX hexadecimale voorbeeldbestanden voor tests. Meerdere bestandsgroottes beschikbaar om uw hex editors, firmware programmering tools en embedded ontwikkeling applicaties te testen.'
        },
        about_description: 'Dit zijn HEX (hexadecimaal) testbestanden in verschillende formaten voor testdoeleinden'
      },
      cs: {
        meta: {
          title: 'Gratis CS voorbeeldbestanden downloaden - C# broncode testbestanden voor .NET ontwikkeling | FormiPeek',
        ...
        schema: {
          name: 'Gratis CS voorbeeldbestanden - Download C# broncode testbestanden voor .NET ontwikkeling',
          description: 'Download gratis CS C# broncode voorbeeldbestanden om C# compilatie, .NET ontwikkeling en Visual Studio tools te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van C# compilers, .NET frameworks, Visual Studio IDE, code analyse tools en C# ontwikkeling omgevingen.'
        },
        hero: {
          title: 'CS voorbeeldbestanden',
          description: 'Download gratis CS C# broncode voorbeeldbestanden voor tests. Meerdere bestandsgroottes beschikbaar om uw C# compilatie, .NET ontwikkeling en Visual Studio tools te testen.'
        },
        about_description: 'Dit zijn CS (C#) broncode testbestanden in verschillende formaten voor testdoeleinden'
      },
      css: {
        meta: {
          title: 'Gratis CSS voorbeeldbestanden downloaden - Stylesheet testbestanden voor web ontwikkeling | FormiPeek',
        ...
        schema: {
          name: 'Gratis CSS voorbeeldbestanden - Download stylesheet testbestanden voor web ontwikkeling',
          description: 'Download gratis CSS stylesheet voorbeeldbestanden om web styling, CSS parsing en front-end tools te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van CSS validators, preprocessors (SASS, LESS), CSS minifiers, web browsers en front-end ontwikkeling frameworks.'
        },
        hero: {
          title: 'CSS voorbeeldbestanden',
          description: 'Download gratis CSS stylesheet voorbeeldbestanden voor tests. Meerdere bestandsgroottes beschikbaar om uw CSS validators, preprocessors en web ontwikkeling tools te testen.'
        },
        about_description: 'Dit zijn CSS (Cascading Style Sheets) testbestanden in verschillende formaten voor testdoeleinden'
      },
      csr: {
        meta: {
          title: 'Gratis CSR voorbeeldbestanden downloaden - Certificaat ondertekeningsverzoek testbestanden voor SSL/TLS | FormiPeek',
        ...
        schema: {
          name: 'Gratis CSR voorbeeldbestanden - Download certificaat ondertekeningsverzoek testbestanden voor SSL/TLS',
          description: 'Download gratis CSR certificaat ondertekeningsverzoek voorbeeldbestanden om SSL/TLS certificaat generatie, PKI beheer en beveiliging tools te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van certificeringsautoriteiten, OpenSSL, SSL certificaat generatie, PKI infrastructuur en beveiligingscertificaat beheer tools.'
        },
        hero: {
          title: 'CSR voorbeeldbestanden',
          description: 'Download gratis CSR certificaat ondertekeningsverzoek voorbeeldbestanden voor tests. Meerdere bestandsgroottes beschikbaar om uw SSL/TLS certificaat generatie en PKI beheer tools te testen.'
        },
        about_description: 'Dit zijn CSR (Certificate Signing Request) testbestanden in verschillende formaten voor testdoeleinden'
      },
      'customer-database-sql': {
        meta: {
          title: 'Gratis Customer Database SQL voorbeeldbestanden downloaden - SQL database testbestanden | FormiPeek',
        ...
        schema: {
          name: 'Gratis Customer Database SQL voorbeeldbestanden - Download SQL database testbestanden',
          description: 'Download gratis Customer Database SQL voorbeeldbestanden om SQL database operaties, query uitvoering en database beheer tools te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van SQL parsers, database import tools, SQLite, MySQL, PostgreSQL en database beheer systemen.'
        },
        hero: {
          title: 'Customer Database SQL voorbeeldbestanden',
          description: 'Download gratis Customer Database SQL voorbeeldbestanden voor tests. Meerdere bestandsgroottes beschikbaar om uw SQL parsers, database import tools en database beheer systemen te testen.'
        },
        about_description: 'Dit zijn Customer Database SQL testbestanden in verschillende formaten voor testdoeleinden'
      },
      dbf: {
        meta: {
          title: 'Gratis DBF voorbeeldbestanden downloaden - dBASE database testbestanden voor data beheer | FormiPeek',
        ...
        schema: {
          name: 'Gratis DBF voorbeeldbestanden - Download dBASE database testbestanden voor data beheer',
          description: 'Download gratis DBF dBASE database voorbeeldbestanden om database operaties, data import/export en legacy database formaten te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van dBASE compatibiliteit, database converters, data migratie tools, spreadsheet applicaties en database beheer systemen.'
        },
        hero: {
          title: 'DBF voorbeeldbestanden',
          description: 'Download gratis DBF dBASE database voorbeeldbestanden voor tests. Meerdere bestandsgroottes beschikbaar om uw database converters, data migratie tools en database beheer systemen te testen.'
        },
        about_description: 'Dit zijn DBF (dBASE database) testbestanden in verschillende formaten voor testdoeleinden'
      },
      dem: {
        meta: {
          title: 'Gratis DEM voorbeeldbestanden downloaden - Digitaal hoogtemodel testbestanden voor GIS en mapping | FormiPeek',
        ...
        schema: {
          name: 'Gratis DEM voorbeeldbestanden - Download digitaal hoogtemodel testbestanden voor GIS en mapping',
          description: 'Download gratis DEM digitaal hoogtemodel voorbeeldbestanden om GIS applicaties, terrein mapping en geospatiale analyse tools te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van GIS software, terrein visualisatie, hoogte data verwerking, mapping applicaties en geospatiale analyse tools.'
        },
        hero: {
          title: 'DEM voorbeeldbestanden',
          description: 'Download gratis DEM digitaal hoogtemodel voorbeeldbestanden voor tests. Meerdere bestandsgroottes beschikbaar om uw GIS software, terrein visualisatie en geospatiale analyse tools te testen.'
        },
        about_description: 'Dit zijn DEM (Digital Elevation Model) testbestanden in verschillende formaten voor testdoeleinden'
      },
      der: {
        meta: {
          title: 'Gratis DER voorbeeldbestanden downloaden - Distinguished Encoding Rules certificaat testbestanden | FormiPeek',
        ...
        schema: {
          name: 'Gratis DER voorbeeldbestanden - Download Distinguished Encoding Rules certificaat testbestanden',
          description: 'Download gratis DER Distinguished Encoding Rules certificaat voorbeeldbestanden om SSL/TLS certificaten, PKI beheer en beveiliging tools te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van certificaat parsing, OpenSSL, PKI infrastructuur, SSL certificaat validatie en beveiligingscertificaat beheer tools.'
        },
        hero: {
          title: 'DER voorbeeldbestanden',
          description: 'Download gratis DER Distinguished Encoding Rules certificaat voorbeeldbestanden voor tests. Meerdere bestandsgroottes beschikbaar om uw certificaat parsing, OpenSSL en PKI beheer tools te testen.'
        },
        about_description: 'Dit zijn DER (Distinguished Encoding Rules) certificaat testbestanden in verschillende formaten voor testdoeleinden'
      },
      dmp: {
        meta: {
          title: 'Gratis DMP voorbeeldbestanden downloaden - Geheugen dump testbestanden voor debugging en analyse | FormiPeek',
        ...
        schema: {
          name: 'Gratis DMP voorbeeldbestanden - Download geheugen dump testbestanden voor debugging en analyse',
          description: 'Download gratis DMP geheugen dump voorbeeldbestanden om crash analyse, debugging tools en systeem diagnostiek te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van debuggers, crash analyse tools, geheugen analysers, systeem diagnostiek tools en forensische analyse applicaties.'
        },
        hero: {
          title: 'DMP voorbeeldbestanden',
          description: 'Download gratis DMP geheugen dump voorbeeldbestanden voor tests. Meerdere bestandsgroottes beschikbaar om uw crash analyse, debugging en systeem diagnostiek tools te testen.'
        },
        about_description: 'Dit zijn DMP (geheugen dump) testbestanden in verschillende formaten voor testdoeleinden'
      },
      'docker-compose-yml': {
        meta: {
          title: 'Gratis Docker Compose YML voorbeeldbestanden downloaden - Docker Compose configuratie testbestanden | FormiPeek',
        ...
        schema: {
          name: 'Gratis Docker Compose YML voorbeeldbestanden - Download Docker Compose configuratie testbestanden',
          description: 'Download gratis Docker Compose YML configuratie voorbeeldbestanden om Docker container orkestratie, multi-container applicaties en DevOps tools te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van Docker Compose, container orkestratie, YAML parsing, DevOps automatisering en gecontaineriseerde applicatie deployment tools.'
        },
        hero: {
          title: 'Docker Compose YML voorbeeldbestanden',
          description: 'Download gratis Docker Compose YML configuratie voorbeeldbestanden voor tests. Meerdere bestandsgroottes beschikbaar om Docker Compose, container orkestratie en DevOps automatisering tools te testen.'
        },
        about_description: 'Dit zijn Docker Compose YML configuratie testbestanden in verschillende formaten voor testdoeleinden'
      },
      dockerfile: {
        meta: {
          title: 'Gratis Dockerfile voorbeeldbestanden downloaden - Docker container build testbestanden | FormiPeek',
        ...
        schema: {
          name: 'Gratis Dockerfile voorbeeldbestanden - Download Docker container build testbestanden',
          description: 'Download gratis Dockerfile Docker container build voorbeeldbestanden om containerisatie, Docker build en DevOps tools te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van Docker build, container image creatie, Dockerfile parsing, containerisatie tools en DevOps automatisering platforms.'
        },
        hero: {
          title: 'Dockerfile voorbeeldbestanden',
          description: 'Download gratis Dockerfile Docker container build voorbeeldbestanden voor tests. Meerdere bestandsgroottes beschikbaar om uw Docker builds, container image creatie en containerisatie tools te testen.'
        },
        about_description: 'Dit zijn Dockerfile (Docker container build) testbestanden in verschillende formaten voor testdoeleinden'
      },
      editorconfig: {
        meta: {
          title: 'Gratis EditorConfig voorbeeldbestanden downloaden - Editor configuratie testbestanden | FormiPeek',
        ...
        schema: {
          name: 'Gratis EditorConfig voorbeeldbestanden - Download editor configuratie testbestanden',
          description: 'Download gratis EditorConfig editor configuratie voorbeeldbestanden om code editor instellingen, formaat consistentie en ontwikkeling tools te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van EditorConfig parsers, code editor plugins, formaat tools, IDE configuratie en ontwikkeling omgeving setup tools.'
        },
        hero: {
          title: 'EditorConfig voorbeeldbestanden',
          description: 'Download gratis EditorConfig editor configuratie voorbeeldbestanden voor tests. Meerdere bestandsgroottes beschikbaar om uw EditorConfig parsers, code editor plugins en formaat tools te testen.'
        },
        about_description: 'Dit zijn EditorConfig (editor configuratie) testbestanden in verschillende formaten voor testdoeleinden'
      },
      ini: {
        meta: {
          title: 'Gratis INI voorbeeldbestanden downloaden - INI configuratie testbestanden voor applicaties | FormiPeek',
        ...
        schema: {
          name: 'Gratis INI voorbeeldbestanden - Download INI configuratie testbestanden voor applicaties',
          description: 'Download gratis INI configuratie voorbeeldbestanden om applicatie instellingen, INI bestand parsing en configuratie beheer tools te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van INI parsers, applicatie configuratie, instelling beheer, Windows INI bestanden en software configuratie utilities.'
        },
        hero: {
          title: 'INI voorbeeldbestanden',
          description: 'Download gratis INI configuratie voorbeeldbestanden voor tests. Meerdere bestandsgroottes beschikbaar om uw INI parsers, applicatie configuratie en instelling beheer tools te testen.'
        },
        about_description: 'Dit zijn INI (configuratie) testbestanden in verschillende formaten voor testdoeleinden'
      },
      intelhex: {
        meta: {
          title: 'Gratis IntelHex voorbeeldbestanden downloaden - Intel hexadecimale testbestanden voor firmware ontwikkeling | FormiPeek',
        ...
        schema: {
          name: 'Gratis IntelHex voorbeeldbestanden - Download Intel hexadecimale testbestanden voor firmware ontwikkeling',
          description: 'Download gratis IntelHex Intel hexadecimale voorbeeldbestanden om firmware programmering, embedded systeem ontwikkeling en microcontroller tools te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van IntelHex parsers, firmware loaders, microcontroller programmering, embedded ontwikkeling tools en hex bestand verwerking applicaties.'
        },
        hero: {
          title: 'IntelHex voorbeeldbestanden',
          description: 'Download gratis IntelHex Intel hexadecimale voorbeeldbestanden voor tests. Meerdere bestandsgroottes beschikbaar om uw IntelHex parsers, firmware loaders en embedded ontwikkeling tools te testen.'
        },
        about_description: 'Dit zijn IntelHex (Intel hexadecimaal) testbestanden in verschillende formaten voor testdoeleinden'
      },
      ipynb: {
        meta: {
          title: 'Gratis IPYNB voorbeeldbestanden downloaden - Jupyter Notebook testbestanden voor data science | FormiPeek',
        ...
        schema: {
          name: 'Gratis IPYNB voorbeeldbestanden - Download Jupyter Notebook testbestanden voor data science',
          description: 'Download gratis IPYNB Jupyter Notebook voorbeeldbestanden om data science workflows, Python uitvoering en notebook analyse tools te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van Jupyter Notebook, Python data science tools, notebook viewers, data analyse applicaties en wetenschappelijke computing platforms.'
        },
        hero: {
          title: 'IPYNB voorbeeldbestanden',
          description: 'Download gratis IPYNB Jupyter Notebook voorbeeldbestanden voor tests. Meerdere bestandsgroottes beschikbaar om Jupyter Notebook, Python data science tools en notebook analyse applicaties te testen.'
        },
        about_description: 'Dit zijn IPYNB (Jupyter Notebook) testbestanden in verschillende formaten voor testdoeleinden'
      },
      java: {
        meta: {
          title: 'Gratis Java voorbeeldbestanden downloaden - Java broncode testbestanden voor ontwikkeling | FormiPeek',
        ...
        schema: {
          name: 'Gratis Java voorbeeldbestanden - Download Java broncode testbestanden voor ontwikkeling',
          description: 'Download gratis Java Java broncode voorbeeldbestanden om Java compilatie, JVM applicaties en ontwikkeling tools te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van Java compilers, JVM, IDE ondersteuning (Eclipse, IntelliJ), Java build tools (Maven, Gradle) en Java ontwikkeling omgevingen.'
        },
        hero: {
          title: 'Java voorbeeldbestanden',
          description: 'Download gratis Java Java broncode voorbeeldbestanden voor tests. Meerdere bestandsgroottes beschikbaar om uw Java compilers, JVM en Java ontwikkeling tools te testen.'
        },
        about_description: 'Dit zijn Java broncode testbestanden in verschillende formaten voor testdoeleinden'
      },
      jks: {
        meta: {
          title: 'Gratis JKS voorbeeldbestanden downloaden - Java KeyStore testbestanden voor SSL/TLS beveiliging | FormiPeek',
        ...
        schema: {
          name: 'Gratis JKS voorbeeldbestanden - Download Java KeyStore testbestanden voor SSL/TLS beveiliging',
          description: 'Download gratis JKS Java KeyStore voorbeeldbestanden om SSL/TLS certificaat opslag, Java beveiliging en PKI beheer tools te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van Java KeyStore beheer, JKS parsing, SSL certificaat opslag, Java beveiliging tools en PKI infrastructuur.'
        },
        hero: {
          title: 'JKS voorbeeldbestanden',
          description: 'Download gratis JKS Java KeyStore voorbeeldbestanden voor tests. Meerdere bestandsgroottes beschikbaar om uw Java KeyStore beheer, JKS parsing en SSL certificaat opslag tools te testen.'
        },
        about_description: 'Dit zijn JKS (Java KeyStore) testbestanden in verschillende formaten voor testdoeleinden'
      },
      json: {
        meta: {
          title: 'Gratis JSON voorbeeldbestanden downloaden - JSON data testbestanden voor web ontwikkeling | FormiPeek',
        ...
        schema: {
          name: 'Gratis JSON voorbeeldbestanden - Download JSON data testbestanden voor web ontwikkeling',
          description: 'Download gratis JSON JSON data voorbeeldbestanden om JSON parsing, API integratie en web ontwikkeling tools te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van JSON parsers, API responses, data uitwisseling formaten, web applicaties en JSON validatie tools.'
        },
        hero: {
          title: 'JSON voorbeeldbestanden',
          description: 'Download gratis JSON JSON data voorbeeldbestanden voor tests. Meerdere bestandsgroottes beschikbaar om uw JSON parsers, API integratie en web ontwikkeling tools te testen.'
        },
        about_description: 'Dit zijn JSON (JavaScript Object Notation) testbestanden in verschillende formaten voor testdoeleinden'
      },
      jsonl: {
        meta: {
          title: 'Gratis JSONL voorbeeldbestanden downloaden - JSON Lines testbestanden voor data verwerking | FormiPeek',
        ...
        schema: {
          name: 'Gratis JSONL voorbeeldbestanden - Download JSON Lines testbestanden voor data verwerking',
          description: 'Download gratis JSONL JSON Lines voorbeeldbestanden om data verwerking, JSON streaming en big data tools te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van JSONL parsers, data streaming applicaties, ETL tools, big data verwerking en log bestand analyse tools.'
        },
        hero: {
          title: 'JSONL voorbeeldbestanden',
          description: 'Download gratis JSONL JSON Lines voorbeeldbestanden voor tests. Meerdere bestandsgroottes beschikbaar om uw JSONL parsers, data streaming applicaties en big data verwerking tools te testen.'
        },
        about_description: 'Dit zijn JSONL (JSON Lines) testbestanden in verschillende formaten voor testdoeleinden'
      },
      js: {
        meta: {
          title: 'Gratis JS voorbeeldbestanden downloaden - JavaScript broncode testbestanden voor web ontwikkeling | FormiPeek',
        ...
        schema: {
          name: 'Gratis JS voorbeeldbestanden - Download JavaScript broncode testbestanden voor web ontwikkeling',
          description: 'Download gratis JS JavaScript broncode voorbeeldbestanden om JavaScript uitvoering, web ontwikkeling en front-end tools te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van JavaScript engines, Node.js, web browsers, JavaScript minifiers, code analyse tools en front-end ontwikkeling frameworks.'
        },
        hero: {
          title: 'JS voorbeeldbestanden',
          description: 'Download gratis JS JavaScript broncode voorbeeldbestanden voor tests. Meerdere bestandsgroottes beschikbaar om uw JavaScript engines, Node.js en web ontwikkeling tools te testen.'
        },
        about_description: 'Dit zijn JS (JavaScript) broncode testbestanden in verschillende formaten voor testdoeleinden'
      },
      jsx: {
        meta: {
          title: 'Gratis JSX voorbeeldbestanden downloaden - React JSX testbestanden voor front-end ontwikkeling | FormiPeek',
        ...
        schema: {
          name: 'Gratis JSX voorbeeldbestanden - Download React JSX testbestanden voor front-end ontwikkeling',
          description: 'Download gratis JSX React JSX voorbeeldbestanden om React ontwikkeling, JSX compilatie en front-end frameworks te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van React, JSX transpilers (Babel), front-end build tools, React ontwikkeling omgevingen en moderne JavaScript frameworks.'
        },
        hero: {
          title: 'JSX voorbeeldbestanden',
          description: 'Download gratis JSX React JSX voorbeeldbestanden voor tests. Meerdere bestandsgroottes beschikbaar om React, JSX transpilers en front-end ontwikkeling tools te testen.'
        },
        about_description: 'Dit zijn JSX (React JSX) testbestanden in verschillende formaten voor testdoeleinden'
      },
      jwt: {
        meta: {
          title: 'Gratis JWT voorbeeldbestanden downloaden - JSON Web Token testbestanden voor API beveiliging | FormiPeek',
        ...
        schema: {
          name: 'Gratis JWT voorbeeldbestanden - Download JSON Web Token testbestanden voor API beveiliging',
          description: 'Download gratis JWT JSON Web Token voorbeeldbestanden om API authenticatie, JWT token parsing en beveiliging tools te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van JWT parsers, API authenticatie, token validatie, OAuth 2.0 en beveiliging test tools.'
        },
        hero: {
          title: 'JWT voorbeeldbestanden',
          description: 'Download gratis JWT JSON Web Token voorbeeldbestanden voor tests. Meerdere bestandsgroottes beschikbaar om uw JWT parsers, API authenticatie en beveiliging tools te testen.'
        },
        about_description: 'Dit zijn JWT (JSON Web Token) testbestanden in verschillende formaten voor testdoeleinden'
      },
      key: {
        meta: {
          title: 'Gratis KEY voorbeeldbestanden downloaden - Privésleutel testbestanden voor SSL/TLS beveiliging | FormiPeek',
        ...
        schema: {
          name: 'Gratis KEY voorbeeldbestanden - Download privésleutel testbestanden voor SSL/TLS beveiliging',
          description: 'Download gratis KEY privésleutel voorbeeldbestanden om SSL/TLS certificaten, cryptografische operaties en beveiliging tools te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van privésleutel parsing, OpenSSL, SSL certificaat generatie, cryptografische bibliotheken en beveiligingscertificaat beheer tools.'
        },
        hero: {
          title: 'KEY voorbeeldbestanden',
          description: 'Download gratis KEY privésleutel voorbeeldbestanden voor tests. Meerdere bestandsgroottes beschikbaar om uw privésleutel parsing, OpenSSL en beveiligingscertificaat beheer tools te testen.'
        },
        about_description: 'Dit zijn KEY (privésleutel) testbestanden in verschillende formaten voor testdoeleinden'
      },
      kml: {
        meta: {
          title: 'Gratis KML voorbeeldbestanden downloaden - Keyhole Markup Language testbestanden voor GIS en mapping | FormiPeek',
        ...
        schema: {
          name: 'Gratis KML voorbeeldbestanden - Download Keyhole Markup Language testbestanden voor GIS en mapping',
          description: 'Download gratis KML Keyhole Markup Language geografische data voorbeeldbestanden om GIS applicaties, kaart visualisatie en geospatiale tools te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van Google Earth, GIS software, kaart rendering, geografische data verwerking en geospatiale analyse tools.'
        },
        hero: {
          title: 'KML voorbeeldbestanden',
          description: 'Download gratis KML Keyhole Markup Language geografische data voorbeeldbestanden voor tests. Meerdere bestandsgroottes beschikbaar om uw GIS software, kaart visualisatie en geospatiale analyse tools te testen.'
        },
        about_description: 'Dit zijn KML (Keyhole Markup Language) geografische data testbestanden in verschillende formaten voor testdoeleinden'
      },
      kt: {
        meta: {
          title: 'Gratis KT voorbeeldbestanden downloaden - Kotlin broncode testbestanden voor Android ontwikkeling | FormiPeek',
        ...
        schema: {
          name: 'Gratis KT voorbeeldbestanden - Download Kotlin broncode testbestanden voor Android ontwikkeling',
          description: 'Download gratis KT Kotlin broncode voorbeeldbestanden om Kotlin compilatie, Android ontwikkeling en JVM applicaties te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van Kotlin compilers, Android Studio, Kotlin/JVM, IDE ondersteuning en Kotlin ontwikkeling omgevingen.'
        },
        hero: {
          title: 'KT voorbeeldbestanden',
          description: 'Download gratis KT Kotlin broncode voorbeeldbestanden voor tests. Meerdere bestandsgroottes beschikbaar om uw Kotlin compilers, Android Studio en Kotlin ontwikkeling tools te testen.'
        },
        about_description: 'Dit zijn KT (Kotlin) broncode testbestanden in verschillende formaten voor testdoeleinden'
      },
      log: {
        meta: {
          title: 'Gratis LOG voorbeeldbestanden downloaden - Log testbestanden voor debugging en systeem analyse | FormiPeek',
        ...
        schema: {
          name: 'Gratis LOG voorbeeldbestanden - Download log testbestanden voor debugging en systeem analyse',
          description: 'Download gratis LOG log voorbeeldbestanden om log parsing, systeem analyse en debugging tools te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van log analysers, systeem monitoring tools, debugging applicaties, log aggregatie systemen en systeem diagnostiek tools.'
        },
        hero: {
          title: 'LOG voorbeeldbestanden',
          description: 'Download gratis LOG log voorbeeldbestanden voor tests. Meerdere bestandsgroottes beschikbaar om uw log analysers, systeem monitoring en debugging tools te testen.'
        },
        about_description: 'Dit zijn LOG testbestanden in verschillende formaten voor testdoeleinden'
      },
      lua: {
        meta: {
          title: 'Gratis LUA voorbeeldbestanden downloaden - Lua script testbestanden voor game ontwikkeling en automatisering | FormiPeek',
        ...
        schema: {
          name: 'Gratis LUA voorbeeldbestanden - Download Lua script testbestanden voor game ontwikkeling en automatisering',
          description: 'Download gratis LUA Lua script voorbeeldbestanden om Lua uitvoering, game ontwikkeling en automatisering tools te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van Lua interpreters, game engines, scripting omgevingen, automatisering tools en embedded Lua applicaties.'
        },
        hero: {
          title: 'LUA voorbeeldbestanden',
          description: 'Download gratis LUA Lua script voorbeeldbestanden voor tests. Meerdere bestandsgroottes beschikbaar om uw Lua interpreters, game engines en automatisering tools te testen.'
        },
        about_description: 'Dit zijn LUA (Lua script) testbestanden in verschillende formaten voor testdoeleinden'
      },
      m3u: {
        meta: {
          title: 'Gratis M3U voorbeeldbestanden downloaden - M3U playlist testbestanden voor media spelers | FormiPeek',
        ...
        schema: {
          name: 'Gratis M3U voorbeeldbestanden - Download M3U playlist testbestanden voor media spelers',
          description: 'Download gratis M3U M3U playlist voorbeeldbestanden om media spelers, playlist parsing en audio/video streaming tools te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van media spelers, playlist managers, streaming applicaties, audio spelers en video speler software.'
        },
        hero: {
          title: 'M3U voorbeeldbestanden',
          description: 'Download gratis M3U M3U playlist voorbeeldbestanden voor tests. Meerdere bestandsgroottes beschikbaar om uw media spelers, playlist managers en streaming applicaties te testen.'
        },
        about_description: 'Dit zijn M3U (playlist) testbestanden in verschillende formaten voor testdoeleinden'
      },
      m3u8: {
        meta: {
          title: 'Gratis M3U8 voorbeeldbestanden downloaden - M3U8 HLS playlist testbestanden voor video streaming | FormiPeek',
        ...
        schema: {
          name: 'Gratis M3U8 voorbeeldbestanden - Download M3U8 HLS playlist testbestanden voor video streaming',
          description: 'Download gratis M3U8 M3U8 HLS (HTTP Live Streaming) playlist voorbeeldbestanden om video streaming, HLS spelers en media delivery tools te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van HLS spelers, video streaming platforms, adaptieve bitrate streaming, media servers en video delivery systemen.'
        },
        hero: {
          title: 'M3U8 voorbeeldbestanden',
          description: 'Download gratis M3U8 M3U8 HLS playlist voorbeeldbestanden voor tests. Meerdere bestandsgroottes beschikbaar om uw HLS spelers, video streaming platforms en media delivery systemen te testen.'
        },
        about_description: 'Dit zijn M3U8 (HLS playlist) testbestanden in verschillende formaten voor testdoeleinden'
      },
      makefile: {
        meta: {
          title: 'Gratis Makefile voorbeeldbestanden downloaden - Makefile build configuratie testbestanden | FormiPeek',
        ...
        schema: {
          name: 'Gratis Makefile voorbeeldbestanden - Download Makefile build configuratie testbestanden',
          description: 'Download gratis Makefile build configuratie voorbeeldbestanden om build automatisering, Make build systeem en ontwikkeling tools te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van Make build systeem, build automatisering tools, C/C++ compilatie, build scripts en ontwikkeling build omgevingen.'
        },
        hero: {
          title: 'Makefile voorbeeldbestanden',
          description: 'Download gratis Makefile build configuratie voorbeeldbestanden voor tests. Meerdere bestandsgroottes beschikbaar om uw Make build systeem, build automatisering tools en ontwikkeling build omgevingen te testen.'
        },
        about_description: 'Dit zijn Makefile (build configuratie) testbestanden in verschillende formaten voor testdoeleinden'
      },
      mbtiles: {
        meta: {
          title: 'Gratis MBTiles voorbeeldbestanden downloaden - MBTiles kaart tile database testbestanden | FormiPeek',
        ...
        schema: {
          name: 'Gratis MBTiles voorbeeldbestanden - Download MBTiles kaart tile database testbestanden',
          description: 'Download gratis MBTiles kaart tile database voorbeeldbestanden om kaart rendering, GIS applicaties en mapping tools te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van kaart tile servers, GIS software, kaart rendering engines, mobiele mapping applicaties en offline kaart tools.'
        },
        hero: {
          title: 'MBTiles voorbeeldbestanden',
          description: 'Download gratis MBTiles kaart tile database voorbeeldbestanden voor tests. Meerdere bestandsgroottes beschikbaar om uw kaart tile servers, GIS software en kaart rendering engines te testen.'
        },
        about_description: 'Dit zijn MBTiles (kaart tile database) testbestanden in verschillende formaten voor testdoeleinden'
      },
      md: {
        meta: {
          title: 'Gratis MD voorbeeldbestanden downloaden - Markdown documentatie testbestanden | FormiPeek',
        ...
        schema: {
          name: 'Gratis MD voorbeeldbestanden - Download Markdown documentatie testbestanden',
          description: 'Download gratis MD Markdown documentatie voorbeeldbestanden om Markdown parsing, documentatie tools en content management systemen te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van Markdown parsers, documentatie generators, statische site generators, GitHub Markdown en content management platforms.'
        },
        hero: {
          title: 'MD voorbeeldbestanden',
          description: 'Download gratis MD Markdown documentatie voorbeeldbestanden voor tests. Meerdere bestandsgroottes beschikbaar om uw Markdown parsers, documentatie generators en content management systemen te testen.'
        },
        about_description: 'Dit zijn MD (Markdown) testbestanden in verschillende formaten voor testdoeleinden'
      },
      mdx: {
        meta: {
          title: 'Gratis MDX voorbeeldbestanden downloaden - MDX React Markdown testbestanden voor documentatie | FormiPeek',
        ...
        schema: {
          name: 'Gratis MDX voorbeeldbestanden - Download MDX React Markdown testbestanden voor documentatie',
          description: 'Download gratis MDX MDX (Markdown + JSX) voorbeeldbestanden om React documentatie, statische site generators en content management systemen te testen. Meerdere bestandsgroottes: 100 KB, 1 MB, 5 MB, 50 MB en 100 MB. Perfect voor het testen van MDX parsers, React documentatie tools, Next.js, Gatsby, statische site generators en moderne documentatie platforms.'
        },
        hero: {
          title: 'MDX voorbeeldbestanden',
      ...
      apk: {
        meta: {
          title: 'Gratis APK voorbeeldbestanden downloaden - Android applicatiepakket testbestanden | FormiPeek',
      ...
      appimage: {
        meta: {
          title: 'Gratis AppImage voorbeeldbestanden downloaden - Linux draagbare applicatie testbestanden | FormiPeek',
      ...
      elf: {
        meta: {
          title: 'Gratis ELF voorbeeldbestanden downloaden - Executable and Linkable Format testbestanden voor Linux/Unix | FormiPeek',
      ...
      exe: {
        meta: {
          title: 'Gratis EXE voorbeeldbestanden downloaden - Windows executable testbestanden | FormiPeek',
      ...
      ipa: {
        meta: {
          title: 'Gratis IPA voorbeeldbestanden downloaden - iOS applicatiepakket testbestanden | FormiPeek',
      ...
      jar: {
        meta: {
          title: 'Gratis JAR voorbeeldbestanden downloaden - Java archief testbestanden | FormiPeek',
      ...
      crx: {
        meta: {
          title: 'Gratis CRX voorbeeldbestanden downloaden - Chrome extensie pakket testbestanden | FormiPeek',
      ...
      '3ds': {
        meta: {
          title: 'Gratis 3DS voorbeeldbestanden downloaden - 3D model testbestanden voor 3D printen en modelleren | FormiPeek',
      ...
      '3mf': {
        meta: {
          title: 'Gratis 3MF voorbeeldbestanden downloaden - 3D Manufacturing Format testbestanden voor 3D printen | FormiPeek',
      ...
      ai: {
        meta: {
          title: 'Gratis AI voorbeeldbestanden downloaden - Adobe Illustrator vector graphics testbestanden | FormiPeek',
      ...
      ase: {
        meta: {
          title: 'Gratis ASE voorbeeldbestanden downloaden - Aseprite sprite animatie testbestanden | FormiPeek',
      ...
      'animation-fbx': {
        meta: {
          title: 'Gratis Animation FBX voorbeeldbestanden downloaden - Autodesk FBX 3D animatie testbestanden | FormiPeek',
      ...
      assetbundle: {
        meta: {
          title: 'Gratis AssetBundle voorbeeldbestanden downloaden - Unity AssetBundle testbestanden voor game ontwikkeling | FormiPeek',
      ...
      blend: {
        meta: {
          title: 'Gratis BLEND voorbeeldbestanden downloaden - Blender 3D project testbestanden | FormiPeek',
      ...
      bvh: {
        meta: {
          title: 'Gratis BVH voorbeeldbestanden downloaden - Biovision Hierarchy motion capture testbestanden | FormiPeek',
      ...
      dwg: {
        meta: {
          title: 'Gratis DWG voorbeeldbestanden downloaden - AutoCAD tekening testbestanden voor CAD design | FormiPeek',
      ...
      dxf: {
        meta: {
          title: 'Gratis DXF Voorbeeldbestanden Downloaden - Drawing Exchange Format Testbestanden AutoCAD | FormiPeek',
      ...
      ifc: {
        meta: {
          title: 'Gratis IFC Voorbeeldbestanden Downloaden - Industry Foundation Classes BIM Testbestanden | FormiPeek',
      ...
      iges: {
        meta: {
          title: 'Gratis IGES Voorbeeldbestanden Downloaden - Initial Graphics Exchange Specification CAD Testbestanden | FormiPeek',
      ...
      igs: {
        meta: {
          title: 'Gratis IGS Voorbeeldbestanden Downloaden - Initial Graphics Exchange Specification CAD Testbestanden | FormiPeek',
      ...
      las: {
        meta: {
          title: 'Gratis LAS Voorbeeldbestanden Downloaden - LiDAR Point Cloud Data Testbestanden | FormiPeek',
      ...
      ma: {
        meta: {
          title: 'Gratis MA Voorbeeldbestanden Downloaden - Maya ASCII Scene Testbestanden | FormiPeek',
      ...
      max: {
        meta: {
          title: 'Gratis MAX Voorbeeldbestanden Downloaden - 3ds Max Scene Testbestanden | FormiPeek',
      ...
      mb: {
        meta: {
          title: 'Gratis MB Voorbeeldbestanden Downloaden - Maya Binary Scene Testbestanden | FormiPeek',
      ...
      indd: {
        meta: {
          title: 'Gratis INDD Voorbeeldbestanden Downloaden - Adobe InDesign Document Testbestanden | FormiPeek',
      ...
      'animated-gif': {
        meta: {
          title: 'Gratis Geanimeerde GIF Voorbeeldbestanden Downloaden - Geanimeerde Afbeelding Testbestanden | FormiPeek',
      ...
      apng: {
        meta: {
          title: 'Gratis APNG Voorbeeldbestanden Downloaden - Geanimeerde PNG Afbeelding Testbestanden | FormiPeek',
      ...
      avif: {
        meta: {
          title: 'Gratis AVIF Voorbeeldbestanden Downloaden - AV1 Image File Format Testbestanden | FormiPeek',
      ...
      bmp: {
        meta: {
          title: 'Gratis BMP Voorbeeldbestanden Downloaden - Bitmap Afbeelding Testbestanden | FormiPeek',
      ...
      'barcode-svg': {
        meta: {
          title: 'Gratis Barcode SVG Voorbeeldbestanden Downloaden - Schaalbare Vector Barcode Testbestanden | FormiPeek',
      ...
      avi: {
        meta: {
          title: 'Gratis AVI Voorbeeldbestanden Downloaden - Audio Video Interleave Video Testbestanden | FormiPeek',
      ...
      '3gp': {
        meta: {
          title: 'Gratis 3GP Voorbeeldbestanden Downloaden - 3GPP Mobile Video Testbestanden | FormiPeek',
      ...
      dav: {
        meta: {
          title: 'Gratis DAV Voorbeeldbestanden Downloaden - DAV Video Testbestanden voor Beveiligingscamera\'s | FormiPeek',
      ...
      dds: {
        meta: {
          title: 'Gratis DDS Voorbeeldbestanden Downloaden - DirectDraw Surface Textuur Testbestanden | FormiPeek',
      ...
      dng: {
        meta: {
          title: 'Gratis DNG Voorbeeldbestanden Downloaden - Digital Negative Raw Afbeelding Testbestanden | FormiPeek',
      ...
      eps: {
        meta: {
          title: 'Gratis EPS Voorbeeldbestanden Downloaden - Encapsulated PostScript Vectorafbeelding Testbestanden | FormiPeek',
      ...
      exr: {
        meta: {
          title: 'Gratis EXR Voorbeeldbestanden Downloaden - OpenEXR High Dynamic Range Afbeelding Testbestanden | FormiPeek',
      ...
      hdr: {
        meta: {
          title: 'Gratis HDR Voorbeeldbestanden Downloaden - High Dynamic Range Afbeelding Testbestanden | FormiPeek',
      ...
      heic: {
        meta: {
          title: 'Gratis HEIC Voorbeeldbestanden Downloaden - High Efficiency Image Container Testbestanden | FormiPeek',
      ...
      heif: {
        meta: {
          title: 'Gratis HEIF Voorbeeldbestanden Downloaden - High Efficiency Image Format Testbestanden | FormiPeek',
      ...
      icns: {
        meta: {
          title: 'Gratis ICNS Voorbeeldbestanden Downloaden - macOS Pictogram Testbestanden | FormiPeek',
      ...
      ico: {
        meta: {
          title: 'Gratis ICO Voorbeeldbestanden Downloaden - Windows Pictogram Testbestanden | FormiPeek',
      ...
      jpeg: {
        meta: {
          title: 'Gratis JPEG Voorbeeldbestanden Downloaden - JPEG Afbeelding Testbestanden voor Conversiehulpmiddelen | FormiPeek',
      ...
      jpg: {
        meta: {
          title: 'Gratis JPG Voorbeeldbestanden Downloaden - JPG Afbeelding Testbestanden voor Conversiehulpmiddelen | FormiPeek',
      ...
      m4v: {
        meta: {
          title: 'Gratis M4V Voorbeeldbestanden Downloaden - M4V Video Testbestanden voor Conversiehulpmiddelen | FormiPeek',
      ...
      mkv: {
        meta: {
          title: 'Gratis MKV Voorbeeldbestanden Downloaden - Matroska Video Testbestanden voor Conversiehulpmiddelen | FormiPeek',
      ...
      aac: {
        meta: {
          title: 'Gratis AAC Voorbeeldbestanden Downloaden - Advanced Audio Coding Testbestanden | FormiPeek',
      ...
      ac3: {
        meta: {
          title: 'Gratis AC3 Voorbeeldbestanden Downloaden - Dolby Digital Audio Testbestanden | FormiPeek',
      ...
      aif: {
        meta: {
          title: 'Gratis AIF Voorbeeldbestanden Downloaden - Audio Interchange File Format Testbestanden | FormiPeek',
      ...
      aiff: {
        meta: {
          title: 'Gratis AIFF Voorbeeldbestanden Downloaden - Audio Interchange File Format Testbestanden | FormiPeek',
      ...
      amr: {
        meta: {
          title: 'Gratis AMR Voorbeeldbestanden Downloaden - Adaptive Multi-Rate Audio Testbestanden | FormiPeek',
      ...
      caf: {
        meta: {
          title: 'Gratis CAF Voorbeeldbestanden Downloaden - Core Audio Format Testbestanden | FormiPeek',
      ...
      cue: {
        meta: {
          title: 'Gratis CUE Voorbeeldbestanden Downloaden - CUE Sheet Testbestanden voor Audio CD Branden | FormiPeek',
      ...
      m4a: {
        meta: {
          title: 'Gratis M4A Voorbeeldbestanden Downloaden - M4A Audio Testbestanden voor Conversiehulpmiddelen | FormiPeek',
      ...
      midi: {
        meta: {
          title: 'Gratis MIDI Voorbeeldbestanden Downloaden - MIDI Music Testbestanden voor Muzieksequencing | FormiPeek',
      ...
      ace: {
        meta: {
          title: 'Gratis ACE Voorbeeldbestanden Downloaden - ACE Archief Testbestanden voor Extractiehulpmiddelen | FormiPeek',
      ...
      arj: {
        meta: {
          title: 'Gratis ARJ Voorbeeldbestanden Downloaden - ARJ Archief Testbestanden voor Extractiehulpmiddelen | FormiPeek',
      ...
      bz2: {
        meta: {
          title: 'Gratis BZ2 Voorbeeldbestanden Downloaden - BZ2 Gecomprimeerd Archief Testbestanden | FormiPeek',
      ...
      gz: {
        meta: {
          title: 'Gratis GZ Voorbeeldbestanden Downloaden - GZ Gzip Gecomprimeerd Archief Testbestanden | FormiPeek',
      ...
      cab: {
        meta: {
          title: 'Gratis CAB Voorbeeldbestanden Downloaden - CAB Windows Cabinet Archief Testbestanden | FormiPeek',
      ...
      cpio: {
        meta: {
          title: 'Gratis CPIO Voorbeeldbestanden Downloaden - CPIO Archief Testbestanden voor Extractiehulpmiddelen | FormiPeek',
      ...
      zip: {
        meta: {
          title: 'Gratis ZIP Voorbeeldbestanden Downloaden - ZIP Archief Testbestanden voor Extractiehulpmiddelen | FormiPeek',
      ...
      dmg: {
        meta: {
          title: 'Gratis DMG Voorbeeldbestanden Downloaden - DMG macOS Disk Image Testbestanden | FormiPeek',
      ...
      img: {
        meta: {
          title: 'Gratis IMG Voorbeeldbestanden Downloaden - IMG Disk Image Testbestanden | FormiPeek',
      ...
      iso: {
        meta: {
          title: 'Gratis ISO Voorbeeldbestanden Downloaden - ISO Disk Image Testbestanden | FormiPeek',
      ...
      kmz: {
        meta: {
          title: 'Gratis KMZ Voorbeeldbestanden Downloaden - KMZ Gecomprimeerd KML Testbestanden | FormiPeek',
      ...
      laz: {
        meta: {
          title: 'Gratis LAZ Voorbeeldbestanden Downloaden - LAZ Gecomprimeerd LiDAR Testbestanden | FormiPeek',
      ...
      lha: {
        meta: {
          title: 'Gratis LHA Voorbeeldbestanden Downloaden - LHA Archief Testbestanden voor Extractiehulpmiddelen | FormiPeek',
      ...
      lzh: {
        meta: {
          title: 'Gratis LZH Voorbeeldbestanden Downloaden - LZH Archief Testbestanden voor Extractiehulpmiddelen | FormiPeek',
      ...
      lzma: {
        meta: {
          title: 'Gratis LZMA Voorbeeldbestanden Downloaden - LZMA Gecomprimeerd Archief Testbestanden | FormiPeek',
      ...
      '7z': {
        meta: {
          title: 'Gratis 7Z Voorbeeldbestanden Downloaden - 7Z Archief Testbestanden voor Extractiehulpmiddelen | FormiPeek',

...
export const pt: SamplePageTranslations = {
  sample_page: {
    ...
    formats: {
      docx: {
        meta: {
          title: 'Baixar arquivos de exemplo DOCX gratuitos - Arquivos de teste | FormiPeek',
      ...
      doc: {
        meta: {
          title: 'Baixar arquivos de exemplo DOC gratuitos - Arquivos de teste Microsoft Word DOC | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo DOC gratuitos - Baixar arquivos de teste Microsoft Word DOC',
          description: 'Baixe arquivos de exemplo DOC gratuitos para testar ferramentas de conversão de documentos. Múltiplos tamanhos disponíveis: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar conversores DOC para PDF, DOC para DOCX e processamento de documentos Microsoft Word legados.'
        },
        hero: {
          title: 'Arquivos de exemplo DOC',
          description: 'Baixe arquivos de exemplo DOC gratuitos para testes. Múltiplos tamanhos de arquivo disponíveis para testar suas ferramentas de conversão de documentos, conversores DOC para PDF e processadores de documentos Microsoft Word legados.'
        },
        about_description: 'Estes são arquivos de teste DOC em vários tamanhos para fins de teste'
      },
      pdf: {
        meta: {
          title: 'Baixar arquivos de exemplo PDF gratuitos - Arquivos de teste PDF para ferramentas de conversão | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo PDF gratuitos - Baixar arquivos de teste PDF para ferramentas de conversão',
          description: 'Baixe arquivos de exemplo PDF gratuitos para testar conversores PDF, visualizadores e processadores. Múltiplos tamanhos disponíveis: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar ferramentas PDF para Word, PDF para JPG, compressão PDF e edição PDF.'
        },
        hero: {
          title: 'Arquivos de exemplo PDF',
          description: 'Baixe arquivos de exemplo PDF gratuitos para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus conversores PDF, ferramentas PDF para Word, software de compressão PDF e aplicações de processamento PDF.'
        },
        about_description: 'Estes são arquivos de teste PDF em vários tamanhos para fins de teste'
      },
      odp: {
        meta: {
          title: 'Baixar arquivos de exemplo ODP gratuitos - Arquivos de teste apresentações OpenDocument | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo ODP gratuitos - Baixar arquivos de teste apresentações OpenDocument',
          description: 'Baixe arquivos de exemplo ODP gratuitos para testar ferramentas de conversão de apresentações. Múltiplos tamanhos disponíveis: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar conversores ODP para PPT, ODP para PDF, arquivos LibreOffice Impress e processamento de formatos OpenDocument.'
        },
        hero: {
          title: 'Arquivos de exemplo ODP',
          description: 'Baixe arquivos de exemplo ODP OpenDocument Presentation gratuitos para testes. Múltiplos tamanhos de arquivo disponíveis para testar suas ferramentas de conversão de apresentações, conversores ODP para PPT e processadores de formatos OpenDocument.'
        },
        about_description: 'Estes são arquivos de teste ODP em vários tamanhos para fins de teste'
      },
      rtf: {
        meta: {
          title: 'Baixar arquivos de exemplo RTF gratuitos - Arquivos de teste Rich Text Format | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo RTF gratuitos - Baixar arquivos de teste Rich Text Format',
          description: 'Baixe arquivos de exemplo RTF gratuitos para testar ferramentas de conversão Rich Text Format. Múltiplos tamanhos disponíveis: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar conversores RTF para DOC, RTF para PDF, compatibilidade processadores de texto e conversão de formatos de documentos.'
        },
        hero: {
          title: 'Arquivos de exemplo RTF',
          description: 'Baixe arquivos de exemplo RTF Rich Text Format gratuitos para testes. Múltiplos tamanhos de arquivo disponíveis para testar suas ferramentas de conversão de documentos, conversores RTF para DOC e compatibilidade processadores de texto.'
        },
        about_description: 'Estes são arquivos de teste RTF em vários tamanhos para fins de teste'
      },
      epub: {
        meta: {
          title: 'Baixar arquivos de exemplo EPUB gratuitos - Arquivos de teste eBook para leitores | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo EPUB gratuitos - Baixar arquivos de teste eBook para leitores',
          description: 'Baixe arquivos de exemplo EPUB gratuitos para testar leitores eBook e ferramentas de conversão. Múltiplos tamanhos disponíveis: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar leitores EPUB, conversores EPUB para PDF, EPUB para MOBI, ferramentas publicação digital e compatibilidade formatos eBook.'
        },
        hero: {
          title: 'Arquivos de exemplo EPUB',
          description: 'Baixe arquivos de exemplo EPUB gratuitos para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus leitores eBook, conversores EPUB para PDF, ferramentas EPUB para MOBI e aplicações publicação digital.'
        },
        about_description: 'Estes são arquivos de teste EPUB em vários tamanhos para fins de teste'
      },
      'invoice-pdf': {
        meta: {
          title: 'Baixar arquivos de exemplo PDF faturas gratuitos - Arquivos de teste documentos faturas | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo PDF faturas gratuitos - Baixar arquivos de teste documentos faturas',
          description: 'Baixe arquivos de exemplo PDF faturas gratuitos para testar ferramentas de processamento e análise de faturas. Múltiplos tamanhos disponíveis: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar OCR faturas, extração dados faturas, automação faturas, análise faturas PDF e sistemas gestão documentos.'
        },
        hero: {
          title: 'Arquivos de exemplo PDF faturas',
          description: 'Baixe arquivos de exemplo PDF faturas gratuitos para testes. Múltiplos tamanhos de arquivo disponíveis para testar suas ferramentas de processamento de faturas, software OCR faturas, sistemas extração dados faturas e aplicações gestão documentos.'
        },
        about_description: 'Estes são arquivos de teste PDF faturas em vários tamanhos para fins de teste'
      },
      mobi: {
        meta: {
          title: 'Baixar arquivos de exemplo MOBI gratuitos - Arquivos de teste eBook MOBI para Kindle | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo MOBI gratuitos - Baixar arquivos de teste eBook MOBI para Kindle',
          description: 'Baixe arquivos de exemplo MOBI gratuitos para testar leitores eBook MOBI e ferramentas de conversão. Múltiplos tamanhos disponíveis: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar compatibilidade Kindle, conversores MOBI para EPUB, MOBI para PDF, conversão formatos eBook e aplicações leitura digital.'
        },
        hero: {
          title: 'Arquivos de exemplo MOBI',
          description: 'Baixe arquivos de exemplo MOBI gratuitos para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus leitores eBook MOBI, conversores MOBI para EPUB, ferramentas MOBI para PDF e aplicações compatibilidade Kindle.'
        },
        about_description: 'Estes são arquivos de teste MOBI em vários tamanhos para fins de teste'
      },
      csv: {
        meta: {
          title: 'Baixe arquivos de exemplo CSV grátis - Arquivos de teste CSV para processamento de dados | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo CSV grátis - Baixe arquivos de teste CSV para processamento de dados',
          description: 'Baixe arquivos de exemplo CSV grátis para testar ferramentas de processamento e conversão de dados. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar conversores CSV para Excel, CSV para JSON, ferramentas de importação de dados, aplicações de planilhas e processamento de valores separados por vírgula.'
        },
        hero: {
          title: 'Arquivos de exemplo CSV',
          description: 'Baixe arquivos de exemplo CSV grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar suas ferramentas de conversão CSV, conversores CSV para Excel, aplicações de processamento de dados e software de importação de planilhas.'
        },
        about_description: 'Estes são arquivos de teste CSV em vários tamanhos para fins de teste'
      },
      xls: {
        meta: {
          title: 'Baixe arquivos de exemplo XLS grátis - Arquivos de teste Microsoft Excel XLS | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo XLS grátis - Baixe arquivos de teste Microsoft Excel XLS',
          description: 'Baixe arquivos de exemplo XLS grátis para testar ferramentas de conversão Excel e processamento de dados. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar conversores XLS para XLSX, XLS para CSV, XLS para PDF, extração de dados Excel e processamento de planilhas legadas.'
        },
        hero: {
          title: 'Arquivos de exemplo XLS',
          description: 'Baixe arquivos de exemplo XLS Excel grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar suas ferramentas de conversão Excel, conversores XLS para XLSX, aplicações de processamento de dados e software de importação de planilhas.'
        },
        about_description: 'Estes são arquivos de teste XLS em vários tamanhos para fins de teste'
      },
      xlsx: {
        meta: {
          title: 'Baixe arquivos de exemplo XLSX grátis - Arquivos de teste Excel XLSX para ferramentas de conversão | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo XLSX grátis - Baixe arquivos de teste Excel XLSX para ferramentas de conversão',
          description: 'Baixe arquivos de exemplo XLSX grátis para testar ferramentas de conversão Excel e processamento de dados. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar conversores XLSX para CSV, XLSX para PDF, XLSX para JSON, análise de dados Excel, automação de planilhas e processamento Office Open XML.'
        },
        hero: {
          title: 'Arquivos de exemplo XLSX',
          description: 'Baixe arquivos de exemplo XLSX Excel grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar suas ferramentas de conversão Excel, conversores XLSX para CSV, aplicações de análise de dados e software de automação de planilhas.'
        },
        about_description: 'Estes são arquivos de teste XLSX em vários tamanhos para fins de teste'
      },
      xml: {
        meta: {
          title: 'Baixe arquivos de exemplo XML grátis - Arquivos de teste XML para análise e conversão | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo XML grátis - Baixe arquivos de teste XML para análise e conversão',
          description: 'Baixe arquivos de exemplo XML grátis para testar ferramentas de análise, conversão e processamento de dados XML. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar conversores XML para JSON, XML para CSV, validação XML, processamento de dados estruturados e análise de linguagens de marcação.'
        },
        hero: {
          title: 'Arquivos de exemplo XML',
          description: 'Baixe arquivos de exemplo XML grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar suas ferramentas de análise XML, conversores XML para JSON, software de validação XML e aplicações de processamento de dados estruturados.'
        },
        about_description: 'Estes são arquivos de teste XML em vários tamanhos para fins de teste'
      },
      html: {
        meta: {
          title: 'Baixe arquivos de exemplo HTML grátis - Arquivos de teste HTML para desenvolvimento web | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo HTML grátis - Baixe arquivos de teste HTML para desenvolvimento web',
          description: 'Baixe arquivos de exemplo HTML grátis para testar ferramentas de desenvolvimento web e processamento HTML. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar conversores HTML para PDF, HTML para DOCX, validação HTML, web scraping, renderização de navegador e processamento HyperText Markup Language.'
        },
        hero: {
          title: 'Arquivos de exemplo HTML',
          description: 'Baixe arquivos de exemplo HTML HyperText Markup Language grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar suas ferramentas de análise HTML, conversores HTML para PDF, software de validação HTML e aplicações de desenvolvimento web.'
        },
        about_description: 'Estes são arquivos de teste HTML em vários tamanhos para fins de teste'
      },
      ods: {
        meta: {
          title: 'Baixe arquivos de exemplo ODS grátis - Arquivos de teste planilhas OpenDocument | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo ODS grátis - Baixe arquivos de teste planilhas OpenDocument',
          description: 'Baixe arquivos de exemplo ODS grátis para testar ferramentas de conversão de planilhas e processamento de dados. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar conversores ODS para Excel, ODS para CSV, arquivos LibreOffice Calc, processamento formato OpenDocument e extração de dados de planilhas.'
        },
        hero: {
          title: 'Arquivos de exemplo ODS',
          description: 'Baixe arquivos de exemplo ODS OpenDocument Spreadsheet grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar suas ferramentas de conversão de planilhas, conversores ODS para Excel e processadores de formato OpenDocument.'
        },
        about_description: 'Estes são arquivos de teste ODS em vários tamanhos para fins de teste'
      },
      'ansible-yml': {
        meta: {
          title: 'Baixe arquivos de exemplo Ansible YML grátis - Arquivos de teste configuração YAML | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo Ansible YML grátis - Baixe arquivos de teste configuração YAML',
          description: 'Baixe arquivos de exemplo Ansible YML grátis para testar ferramentas de análise YAML e gerenciamento de configuração. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar playbooks Ansible, validação YAML, automação DevOps, sistemas de gerenciamento de configuração e ferramentas infrastructure as code.'
        },
        hero: {
          title: 'Arquivos de exemplo Ansible YML',
          description: 'Baixe arquivos de exemplo Ansible YML grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar suas ferramentas de análise YAML, validadores de playbooks Ansible, sistemas de gerenciamento de configuração e aplicações de automação DevOps.'
        },
        about_description: 'Estes são arquivos de teste Ansible YML em vários tamanhos para fins de teste'
      },
      'api-response-json': {
        meta: {
          title: 'Baixar arquivos de exemplo API Response JSON grátis - Arquivos de teste JSON para desenvolvimento API | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo API Response JSON grátis - Baixar arquivos de teste JSON para desenvolvimento API',
          description: 'Baixe arquivos de exemplo API Response JSON grátis para testar análise JSON, integração API e ferramentas de desenvolvimento web. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar respostas REST API, validadores JSON, mocking API, testes webhook e processamento de formatos de troca de dados.'
        },
        hero: {
          title: 'Arquivos de exemplo API Response JSON',
          description: 'Baixe arquivos de exemplo API Response JSON grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar suas ferramentas de análise JSON, manipuladores de resposta API, validadores REST API e aplicações de desenvolvimento web.'
        },
        about_description: 'Estes são arquivos de teste API Response JSON em vários tamanhos para fins de teste'
      },
      'arduino-ino': {
        meta: {
          title: 'Baixar arquivos de exemplo Arduino INO grátis - Arquivos de teste sketch Arduino para desenvolvimento embedded | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo Arduino INO grátis - Baixar arquivos de teste sketch Arduino para desenvolvimento embedded',
          description: 'Baixe arquivos de exemplo Arduino INO grátis para testar compilação de sketch Arduino e ferramentas de programação embedded. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar Arduino IDE, validação de sketch, programação de microcontroladores, desenvolvimento de sistemas embedded e testes de dispositivos IoT.'
        },
        hero: {
          title: 'Arquivos de exemplo Arduino INO',
          description: 'Baixe arquivos de exemplo Arduino INO sketch Arduino grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar suas ferramentas de desenvolvimento Arduino, software de compilação de sketch e aplicações de programação embedded.'
        },
        about_description: 'Estes são arquivos de teste Arduino INO (Arduino Sketch) código fonte em vários tamanhos para fins de teste'
      },
      bat: {
        meta: {
          title: 'Baixar arquivos de exemplo BAT grátis - Arquivos de teste script batch para automação Windows | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo BAT grátis - Baixar arquivos de teste script batch para automação Windows',
          description: 'Baixe arquivos de exemplo BAT script batch grátis para testar automação Windows e ferramentas de processamento de linha de comando. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar execução de script batch, automação de tarefas Windows, ferramentas de linha de comando, validadores de script e utilitários de administração do sistema.'
        },
        hero: {
          title: 'Arquivos de exemplo BAT',
          description: 'Baixe arquivos de exemplo BAT script batch grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar suas ferramentas de execução de script batch, software de automação Windows e aplicações de processamento de linha de comando.'
        },
        about_description: 'Estes são arquivos de teste BAT (Batch) em vários tamanhos para fins de teste'
      },
      asc: {
        meta: {
          title: 'Baixar arquivos de exemplo ASC grátis - Arquivos de teste texto ASCII para processamento de texto | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo ASC grátis - Baixar arquivos de teste texto ASCII para processamento de texto',
          description: 'Baixe arquivos de exemplo ASC texto ASCII grátis para testar ferramentas de processamento de texto e codificação. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar codificação ASCII, análise de arquivos de texto, editores de texto simples, validação de codificação de caracteres e ferramentas de conversão de formato de texto.'
        },
        hero: {
          title: 'Arquivos de exemplo ASC',
          description: 'Baixe arquivos de exemplo ASC texto ASCII grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar suas ferramentas de processamento de texto, software de codificação ASCII e aplicações de manipulação de arquivos de texto simples.'
        },
        about_description: 'Estes são arquivos de teste ASC (ASCII Text) em vários tamanhos para fins de teste'
      },
      bib: {
        meta: {
          title: 'Baixar arquivos de exemplo BIB grátis - Arquivos de teste bibliografia para pesquisa acadêmica | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo BIB grátis - Baixar arquivos de teste bibliografia para pesquisa acadêmica',
          description: 'Baixe arquivos de exemplo BIB bibliografia grátis para testar ferramentas de gerenciamento de bibliografia e citações. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar processamento de formato BibTeX, gerenciadores de referências, geradores de citações, ferramentas de escrita acadêmica e integração de bibliografia LaTeX.'
        },
        hero: {
          title: 'Arquivos de exemplo BIB',
          description: 'Baixe arquivos de exemplo BIB bibliografia grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar suas ferramentas de gerenciamento de bibliografia, processadores BibTeX e aplicações de manipulação de citações.'
        },
        about_description: 'Estes são arquivos de teste BIB (Bibliography) em vários tamanhos para fins de teste'
      },
      c: {
        meta: {
          title: 'Baixar arquivos de exemplo C grátis - Arquivos de teste linguagem programação C para desenvolvimento | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo C grátis - Baixar arquivos de teste linguagem programação C para desenvolvimento',
          description: 'Baixe arquivos de exemplo C código fonte grátis para testar compilação de código C e ferramentas de desenvolvimento. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar compiladores C, verificadores de sintaxe, analisadores de código, toolchain GCC, desenvolvimento C embedded e ferramentas de programação de sistemas.'
        },
        hero: {
          title: 'Arquivos de exemplo C',
          description: 'Baixe arquivos de exemplo C código fonte C grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar suas ferramentas de compilação de código C, verificadores de sintaxe C e aplicações de desenvolvimento C.'
        },
        about_description: 'Estes são arquivos de teste código fonte C em vários tamanhos para fins de teste'
      },
      'can-log': {
        meta: {
          title: 'Baixar arquivos de exemplo CAN Log grátis - Arquivos de teste Controller Area Network para automotivo | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo CAN Log grátis - Baixar arquivos de teste Controller Area Network para automotivo',
          description: 'Baixe arquivos de exemplo CAN Log grátis para testar análise de barramento CAN e ferramentas de diagnóstico automotivo. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar analisadores de barramento CAN, ferramentas de diagnóstico automotivo, protocolos de rede de veículos, testes OBD-II e sistemas embedded automotivos.'
        },
        hero: {
          title: 'Arquivos de exemplo CAN Log',
          description: 'Baixe arquivos de exemplo CAN Log Controller Area Network grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar suas ferramentas de análise de barramento CAN, software de diagnóstico automotivo e aplicações de protocolos de rede.'
        },
        about_description: 'Estes são arquivos de teste CAN Log (Controller Area Network) em vários tamanhos para fins de teste'
      },
      cmd: {
        meta: {
          title: 'Baixar arquivos de exemplo CMD grátis - Arquivos de teste script comando Windows para automação | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo CMD grátis - Baixar arquivos de teste script comando Windows para automação',
          description: 'Baixe arquivos de exemplo CMD script comando Windows grátis para testar execução de script batch e ferramentas de automação Windows. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar prompt de comando Windows, execução de arquivos batch, automação de scripts, administração do sistema e ferramentas de agendamento de tarefas Windows.'
        },
        hero: {
          title: 'Arquivos de exemplo CMD',
          description: 'Baixe arquivos de exemplo CMD script comando Windows grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar suas ferramentas de execução de script batch, software de processamento de comando Windows e aplicações de automação.'
        },
        about_description: 'Estes são arquivos de teste CMD (Windows Command Script) em vários tamanhos para fins de teste'
      },
      conf: {
        meta: {
          title: 'Baixar arquivos de exemplo CONF grátis - Arquivos de teste configuração para configuração sistema | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo CONF grátis - Baixar arquivos de teste configuração para configuração sistema',
          description: 'Baixe arquivos de exemplo CONF configuração grátis para testar análise de arquivos de configuração e ferramentas de configuração do sistema. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar configuração de servidores, configurações de aplicações, validadores de arquivos de configuração, ferramentas de administração do sistema e utilitários de implantação de software.'
        },
        hero: {
          title: 'Arquivos de exemplo CONF',
          description: 'Baixe arquivos de exemplo CONF configuração grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar suas ferramentas de análise de arquivos de configuração, software de configuração de servidores e aplicações de configurações de aplicações.'
        },
        about_description: 'Estes são arquivos de teste CONF configuração em vários tamanhos para fins de teste'
      },
      'config-ini': {
        meta: {
          title: 'Baixar arquivos de exemplo Config INI grátis - Arquivos de teste configuração INI para aplicações | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo Config INI grátis - Baixar arquivos de teste configuração INI para aplicações',
          description: 'Baixe arquivos de exemplo Config INI configuração INI grátis para testar análise de arquivos INI e ferramentas de gerenciamento de configuração. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar analisadores INI, configuração de aplicações, gerenciamento de configurações, arquivos INI Windows e utilitários de configuração de software.'
        },
        hero: {
          title: 'Arquivos de exemplo Config INI',
          description: 'Baixe arquivos de exemplo Config INI configuração INI grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar suas ferramentas de análise de arquivos INI, software de gerenciamento de configuração e aplicações de configurações de aplicações.'
        },
        about_description: 'Estes são arquivos de teste Config INI configuração em vários tamanhos para fins de teste'
      },
      cpp: {
        meta: {
          title: 'Baixar arquivos de exemplo CPP grátis - Arquivos de teste linguagem programação C++ para desenvolvimento | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo CPP grátis - Baixar arquivos de teste linguagem programação C++ para desenvolvimento',
          description: 'Baixe arquivos de exemplo CPP código fonte C++ grátis para testar compilação de código C++ e ferramentas de desenvolvimento. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar compiladores C++, verificadores de sintaxe, analisadores de código, toolchain GCC/G++, recursos C++ modernos e ferramentas de programação orientada a objetos.'
        },
        hero: {
          title: 'Arquivos de exemplo CPP',
          description: 'Baixe arquivos de exemplo CPP código fonte C++ grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar suas ferramentas de compilação de código C++, verificadores de sintaxe C++ e aplicações de desenvolvimento C++.'
        },
        about_description: 'Estes são arquivos de teste código fonte C++ em vários tamanhos para fins de teste'
      },
      h: {
        meta: {
          title: 'Baixar arquivos de exemplo H grátis - Arquivos de teste header C/C++ para programação | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo H grátis - Baixar arquivos de teste header C/C++ para programação',
          description: 'Baixe arquivos de exemplo H header C/C++ grátis para testar processamento de arquivos header e ferramentas de desenvolvimento. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar compiladores C/C++, inclusão de arquivos header, ferramentas de pré-processador, organização de código e utilitários de desenvolvimento multiplataforma.'
        },
        hero: {
          title: 'Arquivos de exemplo H',
          description: 'Baixe arquivos de exemplo H header C/C++ grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar suas ferramentas de compilação de código C/C++, software de processamento de arquivos header e aplicações de desenvolvimento.'
        },
        about_description: 'Estes são arquivos de teste H (C/C++ header) em vários tamanhos para fins de teste'
      },
      hpp: {
        meta: {
          title: 'Baixar arquivos de exemplo HPP grátis - Arquivos de teste header C++ para desenvolvimento C++ moderno | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo HPP grátis - Baixar arquivos de teste header C++ para desenvolvimento C++ moderno',
          description: 'Baixe arquivos de exemplo HPP header C++ grátis para testar processamento de arquivos header C++ e ferramentas de desenvolvimento. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar compiladores C++, bibliotecas header-only, metaprogramação de templates, recursos C++ modernos e utilitários de desenvolvimento C++ avançados.'
        },
        hero: {
          title: 'Arquivos de exemplo HPP',
          description: 'Baixe arquivos de exemplo HPP header C++ grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar suas ferramentas de compilação de código C++, software de processamento de arquivos header e aplicações de desenvolvimento C++.'
        },
        about_description: 'Estes são arquivos de teste HPP (C++ header) em vários tamanhos para fins de teste'
      },
      hex: {
        meta: {
          title: 'Baixar arquivos de exemplo HEX grátis - Arquivos de teste hexadecimais para desenvolvimento firmware e sistemas embarcados | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo HEX grátis - Baixar arquivos de teste hexadecimais para desenvolvimento firmware e sistemas embarcados',
          description: 'Baixe arquivos de exemplo HEX hexadecimais grátis para testar programação de firmware, desenvolvimento de sistemas embarcados e análise de dados binários. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar editores hex, carregadores de firmware, programação de microcontroladores e ferramentas de desenvolvimento embarcado.'
        },
        hero: {
          title: 'Arquivos de exemplo HEX',
          description: 'Baixe arquivos de exemplo HEX hexadecimais grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus editores hex, ferramentas de programação de firmware e aplicações de desenvolvimento embarcado.'
        },
        about_description: 'Estes são arquivos de teste HEX (hexadecimal) em vários tamanhos para fins de teste'
      },
      cs: {
        meta: {
          title: 'Baixar arquivos de exemplo CS grátis - Arquivos de teste código fonte C# para desenvolvimento .NET | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo CS grátis - Baixar arquivos de teste código fonte C# para desenvolvimento .NET',
          description: 'Baixe arquivos de exemplo CS código fonte C# grátis para testar compilação C#, desenvolvimento .NET e ferramentas Visual Studio. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar compiladores C#, frameworks .NET, IDE Visual Studio, ferramentas de análise de código e ambientes de desenvolvimento C#.'
        },
        hero: {
          title: 'Arquivos de exemplo CS',
          description: 'Baixe arquivos de exemplo CS código fonte C# grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar sua compilação C#, desenvolvimento .NET e ferramentas Visual Studio.'
        },
        about_description: 'Estes são arquivos de teste CS (C#) código fonte em vários tamanhos para fins de teste'
      },
      css: {
        meta: {
          title: 'Baixar arquivos de exemplo CSS grátis - Arquivos de teste folhas de estilo para desenvolvimento web | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo CSS grátis - Baixar arquivos de teste folhas de estilo para desenvolvimento web',
          description: 'Baixe arquivos de exemplo CSS folhas de estilo grátis para testar estilos web, parsing CSS e ferramentas front-end. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar validadores CSS, pré-processadores (SASS, LESS), minificadores CSS, navegadores web e frameworks de desenvolvimento front-end.'
        },
        hero: {
          title: 'Arquivos de exemplo CSS',
          description: 'Baixe arquivos de exemplo CSS folhas de estilo grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus validadores CSS, pré-processadores e ferramentas de desenvolvimento web.'
        },
        about_description: 'Estes são arquivos de teste CSS (Cascading Style Sheets) em vários tamanhos para fins de teste'
      },
      csr: {
        meta: {
          title: 'Baixar arquivos de exemplo CSR grátis - Arquivos de teste solicitações de assinatura de certificado para SSL/TLS | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo CSR grátis - Baixar arquivos de teste solicitações de assinatura de certificado para SSL/TLS',
          description: 'Baixe arquivos de exemplo CSR solicitações de assinatura de certificado grátis para testar geração de certificados SSL/TLS, gestão PKI e ferramentas de segurança. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar autoridades de certificação, OpenSSL, geração de certificados SSL, infraestrutura PKI e ferramentas de gestão de certificados de segurança.'
        },
        hero: {
          title: 'Arquivos de exemplo CSR',
          description: 'Baixe arquivos de exemplo CSR solicitações de assinatura de certificado grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar sua geração de certificados SSL/TLS e ferramentas de gestão PKI.'
        },
        about_description: 'Estes são arquivos de teste CSR (Certificate Signing Request) em vários tamanhos para fins de teste'
      },
      'customer-database-sql': {
        meta: {
          title: 'Baixar arquivos de exemplo Customer Database SQL grátis - Arquivos de teste base de dados SQL | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo Customer Database SQL grátis - Baixar arquivos de teste base de dados SQL',
          description: 'Baixe arquivos de exemplo Customer Database SQL grátis para testar operações de base de dados SQL, execução de consultas e ferramentas de gestão de bases de dados. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar parsers SQL, ferramentas de importação de bases de dados, SQLite, MySQL, PostgreSQL e sistemas de gestão de bases de dados.'
        },
        hero: {
          title: 'Arquivos de exemplo Customer Database SQL',
          description: 'Baixe arquivos de exemplo Customer Database SQL grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus parsers SQL, ferramentas de importação de bases de dados e sistemas de gestão de bases de dados.'
        },
        about_description: 'Estes são arquivos de teste Customer Database SQL em vários tamanhos para fins de teste'
      },
      dbf: {
        meta: {
          title: 'Baixar arquivos de exemplo DBF grátis - Arquivos de teste base de dados dBASE para gestão de dados | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo DBF grátis - Baixar arquivos de teste base de dados dBASE para gestão de dados',
          description: 'Baixe arquivos de exemplo DBF base de dados dBASE grátis para testar operações de base de dados, importação/exportação de dados e formatos de base de dados legacy. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar compatibilidade dBASE, conversores de bases de dados, ferramentas de migração de dados, aplicações de folhas de cálculo e sistemas de gestão de bases de dados.'
        },
        hero: {
          title: 'Arquivos de exemplo DBF',
          description: 'Baixe arquivos de exemplo DBF base de dados dBASE grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus conversores de bases de dados, ferramentas de migração de dados e sistemas de gestão de bases de dados.'
        },
        about_description: 'Estes são arquivos de teste DBF (base de dados dBASE) em vários tamanhos para fins de teste'
      },
      dem: {
        meta: {
          title: 'Baixar arquivos de exemplo DEM grátis - Arquivos de teste modelos de elevação digital para GIS e mapeamento | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo DEM grátis - Baixar arquivos de teste modelos de elevação digital para GIS e mapeamento',
          description: 'Baixe arquivos de exemplo DEM modelos de elevação digital grátis para testar aplicações GIS, mapeamento de terreno e ferramentas de análise geoespacial. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar software GIS, visualização de terreno, processamento de dados de elevação, aplicações de mapeamento e ferramentas de análise geoespacial.'
        },
        hero: {
          title: 'Arquivos de exemplo DEM',
          description: 'Baixe arquivos de exemplo DEM modelos de elevação digital grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seu software GIS, visualização de terreno e ferramentas de análise geoespacial.'
        },
        about_description: 'Estes são arquivos de teste DEM (Digital Elevation Model) em vários tamanhos para fins de teste'
      },
      der: {
        meta: {
          title: 'Baixar arquivos de exemplo DER grátis - Arquivos de teste certificados Distinguished Encoding Rules | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo DER grátis - Baixar arquivos de teste certificados Distinguished Encoding Rules',
          description: 'Baixe arquivos de exemplo DER certificados Distinguished Encoding Rules grátis para testar certificados SSL/TLS, gestão PKI e ferramentas de segurança. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar parsing de certificados, OpenSSL, infraestrutura PKI, validação de certificados SSL e ferramentas de gestão de certificados de segurança.'
        },
        hero: {
          title: 'Arquivos de exemplo DER',
          description: 'Baixe arquivos de exemplo DER certificados Distinguished Encoding Rules grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seu parsing de certificados, OpenSSL e ferramentas de gestão PKI.'
        },
        about_description: 'Estes são arquivos de teste DER (Distinguished Encoding Rules) certificados em vários tamanhos para fins de teste'
      },
      dmp: {
        meta: {
          title: 'Baixar arquivos de exemplo DMP grátis - Arquivos de teste despejo de memória para depuração e análise | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo DMP grátis - Baixar arquivos de teste despejo de memória para depuração e análise',
          description: 'Baixe arquivos de exemplo DMP despejo de memória grátis para testar análise de falhas, ferramentas de depuração e diagnóstico do sistema. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar depuradores, ferramentas de análise de falhas, analisadores de memória, ferramentas de diagnóstico do sistema e aplicações de análise forense.'
        },
        hero: {
          title: 'Arquivos de exemplo DMP',
          description: 'Baixe arquivos de exemplo DMP despejo de memória grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar sua análise de falhas, depuração e ferramentas de diagnóstico do sistema.'
        },
        about_description: 'Estes são arquivos de teste DMP (despejo de memória) em vários tamanhos para fins de teste'
      },
      'docker-compose-yml': {
        meta: {
          title: 'Baixar arquivos de exemplo Docker Compose YML grátis - Arquivos de teste configuração Docker Compose | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo Docker Compose YML grátis - Baixar arquivos de teste configuração Docker Compose',
          description: 'Baixe arquivos de exemplo Docker Compose YML configuração grátis para testar orquestração de contêineres Docker, aplicações multi-contêiner e ferramentas DevOps. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar Docker Compose, orquestração de contêineres, parsing YAML, automação DevOps e ferramentas de implantação de aplicações containerizadas.'
        },
        hero: {
          title: 'Arquivos de exemplo Docker Compose YML',
          description: 'Baixe arquivos de exemplo Docker Compose YML configuração grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar Docker Compose, orquestração de contêineres e ferramentas de automação DevOps.'
        },
        about_description: 'Estes são arquivos de teste configuração Docker Compose YML em vários tamanhos para fins de teste'
      },
      dockerfile: {
        meta: {
          title: 'Baixar arquivos de exemplo Dockerfile grátis - Arquivos de teste build de contêineres Docker | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo Dockerfile grátis - Baixar arquivos de teste build de contêineres Docker',
          description: 'Baixe arquivos de exemplo Dockerfile build de contêineres Docker grátis para testar containerização, build de Docker e ferramentas DevOps. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar build de Docker, criação de imagens de contêineres, parsing de Dockerfile, ferramentas de containerização e plataformas de automação DevOps.'
        },
        hero: {
          title: 'Arquivos de exemplo Dockerfile',
          description: 'Baixe arquivos de exemplo Dockerfile build de contêineres Docker grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus builds de Docker, criação de imagens de contêineres e ferramentas de containerização.'
        },
        about_description: 'Estes são arquivos de teste Dockerfile (build de contêineres Docker) em vários tamanhos para fins de teste'
      },
      editorconfig: {
        meta: {
          title: 'Baixar arquivos de exemplo EditorConfig grátis - Arquivos de teste configuração de editor | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo EditorConfig grátis - Baixar arquivos de teste configuração de editor',
          description: 'Baixe arquivos de exemplo EditorConfig configuração de editor grátis para testar configurações de editor de código, consistência de formato e ferramentas de desenvolvimento. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar parsers EditorConfig, plugins de editor de código, ferramentas de formato, configuração de IDE e ferramentas de configuração de ambiente de desenvolvimento.'
        },
        hero: {
          title: 'Arquivos de exemplo EditorConfig',
          description: 'Baixe arquivos de exemplo EditorConfig configuração de editor grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus parsers EditorConfig, plugins de editor de código e ferramentas de formato.'
        },
        about_description: 'Estes são arquivos de teste EditorConfig (configuração de editor) em vários tamanhos para fins de teste'
      },
      ini: {
        meta: {
          title: 'Baixar arquivos de exemplo INI grátis - Arquivos de teste configuração INI para aplicações | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo INI grátis - Baixar arquivos de teste configuração INI para aplicações',
          description: 'Baixe arquivos de exemplo INI configuração grátis para testar configurações de aplicações, parsing de arquivos INI e ferramentas de gestão de configuração. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar parsers INI, configuração de aplicações, gestão de configurações, arquivos INI do Windows e utilitários de configuração de software.'
        },
        hero: {
          title: 'Arquivos de exemplo INI',
          description: 'Baixe arquivos de exemplo INI configuração grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus parsers INI, configuração de aplicações e ferramentas de gestão de configurações.'
        },
        about_description: 'Estes são arquivos de teste INI (configuração) em vários tamanhos para fins de teste'
      },
      intelhex: {
        meta: {
          title: 'Baixar arquivos de exemplo IntelHex grátis - Arquivos de teste hexadecimais Intel para desenvolvimento de firmware | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo IntelHex grátis - Baixar arquivos de teste hexadecimais Intel para desenvolvimento de firmware',
          description: 'Baixe arquivos de exemplo IntelHex hexadecimais Intel grátis para testar programação de firmware, desenvolvimento de sistemas embarcados e ferramentas de microcontroladores. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar parsers IntelHex, carregadores de firmware, programação de microcontroladores, ferramentas de desenvolvimento embarcado e aplicações de processamento de arquivos hex.'
        },
        hero: {
          title: 'Arquivos de exemplo IntelHex',
          description: 'Baixe arquivos de exemplo IntelHex hexadecimais Intel grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus parsers IntelHex, carregadores de firmware e ferramentas de desenvolvimento embarcado.'
        },
        about_description: 'Estes são arquivos de teste IntelHex (hexadecimal Intel) em vários tamanhos para fins de teste'
      },
      ipynb: {
        meta: {
          title: 'Baixar arquivos de exemplo IPYNB grátis - Arquivos de teste Jupyter Notebook para ciência de dados | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo IPYNB grátis - Baixar arquivos de teste Jupyter Notebook para ciência de dados',
          description: 'Baixe arquivos de exemplo IPYNB Jupyter Notebook grátis para testar fluxos de trabalho de ciência de dados, execução Python e ferramentas de análise de notebooks. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar Jupyter Notebook, ferramentas de ciência de dados Python, visualizadores de notebooks, aplicações de análise de dados e plataformas de computação científica.'
        },
        hero: {
          title: 'Arquivos de exemplo IPYNB',
          description: 'Baixe arquivos de exemplo IPYNB Jupyter Notebook grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar Jupyter Notebook, ferramentas de ciência de dados Python e aplicações de análise de notebooks.'
        },
        about_description: 'Estes são arquivos de teste IPYNB (Jupyter Notebook) em vários tamanhos para fins de teste'
      },
      java: {
        meta: {
          title: 'Baixar arquivos de exemplo Java grátis - Arquivos de teste código fonte Java para desenvolvimento | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo Java grátis - Baixar arquivos de teste código fonte Java para desenvolvimento',
          description: 'Baixe arquivos de exemplo Java código fonte Java grátis para testar compilação Java, aplicações JVM e ferramentas de desenvolvimento. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar compiladores Java, JVM, suporte de IDE (Eclipse, IntelliJ), ferramentas de build Java (Maven, Gradle) e ambientes de desenvolvimento Java.'
        },
        hero: {
          title: 'Arquivos de exemplo Java',
          description: 'Baixe arquivos de exemplo Java código fonte Java grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus compiladores Java, JVM e ferramentas de desenvolvimento Java.'
        },
        about_description: 'Estes são arquivos de teste código fonte Java em vários tamanhos para fins de teste'
      },
      jks: {
        meta: {
          title: 'Baixar arquivos de exemplo JKS grátis - Arquivos de teste Java KeyStore para segurança SSL/TLS | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo JKS grátis - Baixar arquivos de teste Java KeyStore para segurança SSL/TLS',
          description: 'Baixe arquivos de exemplo JKS Java KeyStore grátis para testar armazenamento de certificados SSL/TLS, segurança Java e ferramentas de gestão PKI. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar gestão de Java KeyStore, parsing de JKS, armazenamento de certificados SSL, ferramentas de segurança Java e infraestrutura PKI.'
        },
        hero: {
          title: 'Arquivos de exemplo JKS',
          description: 'Baixe arquivos de exemplo JKS Java KeyStore grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar sua gestão de Java KeyStore, parsing de JKS e ferramentas de armazenamento de certificados SSL.'
        },
        about_description: 'Estes são arquivos de teste JKS (Java KeyStore) em vários tamanhos para fins de teste'
      },
      json: {
        meta: {
          title: 'Baixar arquivos de exemplo JSON grátis - Arquivos de teste dados JSON para desenvolvimento web | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo JSON grátis - Baixar arquivos de teste dados JSON para desenvolvimento web',
          description: 'Baixe arquivos de exemplo JSON dados JSON grátis para testar parsing JSON, integração API e ferramentas de desenvolvimento web. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar parsers JSON, respostas API, formatos de intercâmbio de dados, aplicações web e ferramentas de validação JSON.'
        },
        hero: {
          title: 'Arquivos de exemplo JSON',
          description: 'Baixe arquivos de exemplo JSON dados JSON grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus parsers JSON, integração API e ferramentas de desenvolvimento web.'
        },
        about_description: 'Estes são arquivos de teste JSON (JavaScript Object Notation) em vários tamanhos para fins de teste'
      },
      jsonl: {
        meta: {
          title: 'Baixar arquivos de exemplo JSONL grátis - Arquivos de teste JSON Lines para processamento de dados | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo JSONL grátis - Baixar arquivos de teste JSON Lines para processamento de dados',
          description: 'Baixe arquivos de exemplo JSONL JSON Lines grátis para testar processamento de dados, streaming JSON e ferramentas de big data. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar parsers JSONL, aplicações de streaming de dados, ferramentas ETL, processamento de big data e ferramentas de análise de arquivos de log.'
        },
        hero: {
          title: 'Arquivos de exemplo JSONL',
          description: 'Baixe arquivos de exemplo JSONL JSON Lines grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus parsers JSONL, aplicações de streaming de dados e ferramentas de processamento de big data.'
        },
        about_description: 'Estes são arquivos de teste JSONL (JSON Lines) em vários tamanhos para fins de teste'
      },
      js: {
        meta: {
          title: 'Baixar arquivos de exemplo JS grátis - Arquivos de teste código fonte JavaScript para desenvolvimento web | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo JS grátis - Baixar arquivos de teste código fonte JavaScript para desenvolvimento web',
          description: 'Baixe arquivos de exemplo JS código fonte JavaScript grátis para testar execução JavaScript, desenvolvimento web e ferramentas front-end. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar motores JavaScript, Node.js, navegadores web, minificadores JavaScript, ferramentas de análise de código e frameworks de desenvolvimento front-end.'
        },
        hero: {
          title: 'Arquivos de exemplo JS',
          description: 'Baixe arquivos de exemplo JS código fonte JavaScript grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus motores JavaScript, Node.js e ferramentas de desenvolvimento web.'
        },
        about_description: 'Estes são arquivos de teste JS (JavaScript) código fonte em vários tamanhos para fins de teste'
      },
      jsx: {
        meta: {
          title: 'Baixar arquivos de exemplo JSX grátis - Arquivos de teste React JSX para desenvolvimento front-end | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo JSX grátis - Baixar arquivos de teste React JSX para desenvolvimento front-end',
          description: 'Baixe arquivos de exemplo JSX React JSX grátis para testar desenvolvimento React, compilação JSX e frameworks front-end. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar React, transpiladores JSX (Babel), ferramentas de build front-end, ambientes de desenvolvimento React e frameworks JavaScript modernos.'
        },
        hero: {
          title: 'Arquivos de exemplo JSX',
          description: 'Baixe arquivos de exemplo JSX React JSX grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar React, transpiladores JSX e ferramentas de desenvolvimento front-end.'
        },
        about_description: 'Estes são arquivos de teste JSX (React JSX) em vários tamanhos para fins de teste'
      },
      jwt: {
        meta: {
          title: 'Baixar arquivos de exemplo JWT grátis - Arquivos de teste JSON Web Token para segurança API | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo JWT grátis - Baixar arquivos de teste JSON Web Token para segurança API',
          description: 'Baixe arquivos de exemplo JWT JSON Web Token grátis para testar autenticação API, parsing de tokens JWT e ferramentas de segurança. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar parsers JWT, autenticação API, validação de tokens, OAuth 2.0 e ferramentas de teste de segurança.'
        },
        hero: {
          title: 'Arquivos de exemplo JWT',
          description: 'Baixe arquivos de exemplo JWT JSON Web Token grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus parsers JWT, autenticação API e ferramentas de segurança.'
        },
        about_description: 'Estes são arquivos de teste JWT (JSON Web Token) em vários tamanhos para fins de teste'
      },
      key: {
        meta: {
          title: 'Baixar arquivos de exemplo KEY grátis - Arquivos de teste chaves privadas para segurança SSL/TLS | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo KEY grátis - Baixar arquivos de teste chaves privadas para segurança SSL/TLS',
          description: 'Baixe arquivos de exemplo KEY chaves privadas grátis para testar certificados SSL/TLS, operações criptográficas e ferramentas de segurança. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar parsing de chaves privadas, OpenSSL, geração de certificados SSL, bibliotecas criptográficas e ferramentas de gestão de certificados de segurança.'
        },
        hero: {
          title: 'Arquivos de exemplo KEY',
          description: 'Baixe arquivos de exemplo KEY chaves privadas grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seu parsing de chaves privadas, OpenSSL e ferramentas de gestão de certificados de segurança.'
        },
        about_description: 'Estes são arquivos de teste KEY (chave privada) em vários tamanhos para fins de teste'
      },
      kml: {
        meta: {
          title: 'Baixar arquivos de exemplo KML grátis - Arquivos de teste Keyhole Markup Language para GIS e mapeamento | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo KML grátis - Baixar arquivos de teste Keyhole Markup Language para GIS e mapeamento',
          description: 'Baixe arquivos de exemplo KML Keyhole Markup Language dados geográficos grátis para testar aplicações GIS, visualização de mapas e ferramentas geoespaciais. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar Google Earth, software GIS, renderização de mapas, processamento de dados geográficos e ferramentas de análise geoespacial.'
        },
        hero: {
          title: 'Arquivos de exemplo KML',
          description: 'Baixe arquivos de exemplo KML Keyhole Markup Language dados geográficos grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seu software GIS, visualização de mapas e ferramentas de análise geoespacial.'
        },
        about_description: 'Estes são arquivos de teste KML (Keyhole Markup Language) dados geográficos em vários tamanhos para fins de teste'
      },
      kt: {
        meta: {
          title: 'Baixar arquivos de exemplo KT grátis - Arquivos de teste código fonte Kotlin para desenvolvimento Android | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo KT grátis - Baixar arquivos de teste código fonte Kotlin para desenvolvimento Android',
          description: 'Baixe arquivos de exemplo KT código fonte Kotlin grátis para testar compilação Kotlin, desenvolvimento Android e aplicações JVM. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar compiladores Kotlin, Android Studio, Kotlin/JVM, suporte de IDE e ambientes de desenvolvimento Kotlin.'
        },
        hero: {
          title: 'Arquivos de exemplo KT',
          description: 'Baixe arquivos de exemplo KT código fonte Kotlin grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus compiladores Kotlin, Android Studio e ferramentas de desenvolvimento Kotlin.'
        },
        about_description: 'Estes são arquivos de teste KT (Kotlin) código fonte em vários tamanhos para fins de teste'
      },
      log: {
        meta: {
          title: 'Baixar arquivos de exemplo LOG grátis - Arquivos de teste logs para depuração e análise do sistema | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo LOG grátis - Baixar arquivos de teste logs para depuração e análise do sistema',
          description: 'Baixe arquivos de exemplo LOG logs grátis para testar parsing de logs, análise do sistema e ferramentas de depuração. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar analisadores de logs, ferramentas de monitoramento do sistema, aplicações de depuração, sistemas de agregação de logs e ferramentas de diagnóstico do sistema.'
        },
        hero: {
          title: 'Arquivos de exemplo LOG',
          description: 'Baixe arquivos de exemplo LOG logs grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus analisadores de logs, monitoramento do sistema e ferramentas de depuração.'
        },
        about_description: 'Estes são arquivos de teste LOG em vários tamanhos para fins de teste'
      },
      lua: {
        meta: {
          title: 'Baixar arquivos de exemplo LUA grátis - Arquivos de teste scripts Lua para desenvolvimento de jogos e automação | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo LUA grátis - Baixar arquivos de teste scripts Lua para desenvolvimento de jogos e automação',
          description: 'Baixe arquivos de exemplo LUA scripts Lua grátis para testar execução Lua, desenvolvimento de jogos e ferramentas de automação. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar interpretadores Lua, motores de jogos, ambientes de scripting, ferramentas de automação e aplicações embarcadas Lua.'
        },
        hero: {
          title: 'Arquivos de exemplo LUA',
          description: 'Baixe arquivos de exemplo LUA scripts Lua grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus interpretadores Lua, motores de jogos e ferramentas de automação.'
        },
        about_description: 'Estes são arquivos de teste LUA (scripts Lua) em vários tamanhos para fins de teste'
      },
      m3u: {
        meta: {
          title: 'Baixar arquivos de exemplo M3U grátis - Arquivos de teste playlist M3U para reprodutores multimídia | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo M3U grátis - Baixar arquivos de teste playlist M3U para reprodutores multimídia',
          description: 'Baixe arquivos de exemplo M3U playlist M3U grátis para testar reprodutores multimídia, parsing de playlists e ferramentas de streaming de áudio/vídeo. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar reprodutores multimídia, gestores de playlists, aplicações de streaming, reprodutores de áudio e software de reprodutores de vídeo.'
        },
        hero: {
          title: 'Arquivos de exemplo M3U',
          description: 'Baixe arquivos de exemplo M3U playlist M3U grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus reprodutores multimídia, gestores de playlists e aplicações de streaming.'
        },
        about_description: 'Estes são arquivos de teste M3U (playlist) em vários tamanhos para fins de teste'
      },
      m3u8: {
        meta: {
          title: 'Baixar arquivos de exemplo M3U8 grátis - Arquivos de teste playlist M3U8 HLS para streaming de vídeo | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo M3U8 grátis - Baixar arquivos de teste playlist M3U8 HLS para streaming de vídeo',
          description: 'Baixe arquivos de exemplo M3U8 playlist M3U8 HLS (HTTP Live Streaming) grátis para testar streaming de vídeo, reprodutores HLS e ferramentas de entrega multimídia. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar reprodutores HLS, plataformas de streaming de vídeo, streaming de bitrate adaptativo, servidores multimídia e sistemas de entrega de vídeo.'
        },
        hero: {
          title: 'Arquivos de exemplo M3U8',
          description: 'Baixe arquivos de exemplo M3U8 playlist M3U8 HLS grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus reprodutores HLS, plataformas de streaming de vídeo e sistemas de entrega multimídia.'
        },
        about_description: 'Estes são arquivos de teste M3U8 (playlist HLS) em vários tamanhos para fins de teste'
      },
      makefile: {
        meta: {
          title: 'Baixar arquivos de exemplo Makefile grátis - Arquivos de teste configuração de build Makefile | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo Makefile grátis - Baixar arquivos de teste configuração de build Makefile',
          description: 'Baixe arquivos de exemplo Makefile configuração de build grátis para testar automação de build, sistema de build Make e ferramentas de desenvolvimento. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar sistema de build Make, ferramentas de automação de build, compilação C/C++, scripts de build e ambientes de build de desenvolvimento.'
        },
        hero: {
          title: 'Arquivos de exemplo Makefile',
          description: 'Baixe arquivos de exemplo Makefile configuração de build grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seu sistema de build Make, ferramentas de automação de build e ambientes de build de desenvolvimento.'
        },
        about_description: 'Estes são arquivos de teste Makefile (configuração de build) em vários tamanhos para fins de teste'
      },
      mbtiles: {
        meta: {
          title: 'Baixar arquivos de exemplo MBTiles grátis - Arquivos de teste base de dados de tiles de mapas MBTiles | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo MBTiles grátis - Baixar arquivos de teste base de dados de tiles de mapas MBTiles',
          description: 'Baixe arquivos de exemplo MBTiles base de dados de tiles de mapas grátis para testar renderização de mapas, aplicações GIS e ferramentas de mapeamento. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar servidores de tiles de mapas, software GIS, motores de renderização de mapas, aplicações de mapeamento móvel e ferramentas de mapas offline.'
        },
        hero: {
          title: 'Arquivos de exemplo MBTiles',
          description: 'Baixe arquivos de exemplo MBTiles base de dados de tiles de mapas grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus servidores de tiles de mapas, software GIS e motores de renderização de mapas.'
        },
        about_description: 'Estes são arquivos de teste MBTiles (base de dados de tiles de mapas) em vários tamanhos para fins de teste'
      },
      md: {
        meta: {
          title: 'Baixar arquivos de exemplo MD grátis - Arquivos de teste documentação Markdown | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo MD grátis - Baixar arquivos de teste documentação Markdown',
          description: 'Baixe arquivos de exemplo MD documentação Markdown grátis para testar parsing Markdown, ferramentas de documentação e sistemas de gestão de conteúdos. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar parsers Markdown, geradores de documentação, geradores de sites estáticos, GitHub Markdown e plataformas de gestão de conteúdos.'
        },
        hero: {
          title: 'Arquivos de exemplo MD',
          description: 'Baixe arquivos de exemplo MD documentação Markdown grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus parsers Markdown, geradores de documentação e sistemas de gestão de conteúdos.'
        },
        about_description: 'Estes são arquivos de teste MD (Markdown) em vários tamanhos para fins de teste'
      },
      mdx: {
        meta: {
          title: 'Baixar arquivos de exemplo MDX grátis - Arquivos de teste MDX React Markdown para documentação | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo MDX grátis - Baixar arquivos de teste MDX React Markdown para documentação',
          description: 'Baixe arquivos de exemplo MDX MDX (Markdown + JSX) grátis para testar documentação React, geradores de sites estáticos e sistemas de gestão de conteúdos. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar parsers MDX, ferramentas de documentação React, Next.js, Gatsby, geradores de sites estáticos e plataformas de documentação modernas.'
        },
        hero: {
          title: 'Arquivos de exemplo MDX',
          description: 'Baixe arquivos de exemplo MDX MDX (Markdown + JSX) grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus parsers MDX, ferramentas de documentação React e geradores de sites estáticos.'
        },
        about_description: 'Estes são arquivos de teste MDX (Markdown + JSX) em vários tamanhos para fins de teste'
      },
      apk: {
        meta: {
          title: 'Baixar arquivos de exemplo APK grátis - Arquivos de teste pacotes aplicação Android | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo APK grátis - Baixar arquivos de teste pacotes aplicação Android',
          description: 'Baixe arquivos de exemplo APK pacotes aplicação Android grátis para testar instalação aplicações Android, análise APK, engenharia reversa e ferramentas desenvolvimento móvel. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar instaladores APK, emuladores Android, analisadores aplicações, scanners segurança e plataformas desenvolvimento aplicações móveis.'
        },
        hero: {
          title: 'Arquivos de exemplo APK',
          description: 'Baixe arquivos de exemplo APK pacotes aplicação Android grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar suas ferramentas instalação aplicações Android, analisadores APK e plataformas desenvolvimento móvel.'
        },
        about_description: 'Estes são arquivos de teste APK (pacote aplicação Android) em vários tamanhos para fins de teste'
      },
      appimage: {
        meta: {
          title: 'Baixar arquivos de exemplo AppImage grátis - Arquivos de teste aplicações portáteis Linux | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo AppImage grátis - Baixar arquivos de teste aplicações portáteis Linux',
          description: 'Baixe arquivos de exemplo AppImage aplicações portáteis Linux grátis para testar distribuição aplicações Linux, execução AppImage e compatibilidade cross-distribuição. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar runners AppImage, lançadores aplicações Linux, ferramentas aplicações portáteis e distribuição software Linux universal.'
        },
        hero: {
          title: 'Arquivos de exemplo AppImage',
          description: 'Baixe arquivos de exemplo AppImage aplicações portáteis Linux grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus runners AppImage, lançadores aplicações Linux e ferramentas aplicações portáteis.'
        },
        about_description: 'Estes são arquivos de teste AppImage (aplicação portátil Linux) em vários tamanhos para fins de teste'
      },
      elf: {
        meta: {
          title: 'Baixar arquivos de exemplo ELF grátis - Arquivos de teste Executable and Linkable Format para Linux/Unix | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo ELF grátis - Baixar arquivos de teste Executable and Linkable Format para Linux/Unix',
          description: 'Baixe arquivos de exemplo ELF Executable and Linkable Format grátis para testar análise binários Linux/Unix, parsing ELF, engenharia reversa e depuração sistema. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar analisadores ELF, desmontadores binários, ferramentas engenharia reversa, depuradores sistema e plataformas análise executáveis Linux.'
        },
        hero: {
          title: 'Arquivos de exemplo ELF',
          description: 'Baixe arquivos de exemplo ELF Executable and Linkable Format grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus analisadores ELF, desmontadores binários e ferramentas engenharia reversa.'
        },
        about_description: 'Estes são arquivos de teste ELF (Executable and Linkable Format) em vários tamanhos para fins de teste'
      },
      exe: {
        meta: {
          title: 'Baixar arquivos de exemplo EXE grátis - Arquivos de teste executáveis Windows | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo EXE grátis - Baixar arquivos de teste executáveis Windows',
          description: 'Baixe arquivos de exemplo EXE executáveis Windows grátis para testar execução aplicações Windows, análise EXE, parsing binários e ferramentas desenvolvimento Windows. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar analisadores executáveis Windows, desmontadores binários, ferramentas engenharia reversa, plataformas análise malware e desenvolvimento aplicações Windows.'
        },
        hero: {
          title: 'Arquivos de exemplo EXE',
          description: 'Baixe arquivos de exemplo EXE executáveis Windows grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus analisadores executáveis Windows, desmontadores binários e ferramentas engenharia reversa.'
        },
        about_description: 'Estes são arquivos de teste EXE (executável Windows) em vários tamanhos para fins de teste'
      },
      ipa: {
        meta: {
          title: 'Baixar arquivos de exemplo IPA grátis - Arquivos de teste pacotes aplicação iOS | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo IPA grátis - Baixar arquivos de teste pacotes aplicação iOS',
          description: 'Baixe arquivos de exemplo IPA pacotes aplicação iOS grátis para testar instalação aplicações iOS, análise IPA, distribuição aplicações iOS e ferramentas desenvolvimento móvel. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar instaladores IPA, simuladores iOS, analisadores aplicações, ferramentas desenvolvimento iOS e plataformas distribuição aplicações móveis.'
        },
        hero: {
          title: 'Arquivos de exemplo IPA',
          description: 'Baixe arquivos de exemplo IPA pacotes aplicação iOS grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar suas ferramentas instalação aplicações iOS, analisadores IPA e plataformas desenvolvimento móvel.'
        },
        about_description: 'Estes são arquivos de teste IPA (pacote aplicação iOS) em vários tamanhos para fins de teste'
      },
      jar: {
        meta: {
          title: 'Baixar arquivos de exemplo JAR grátis - Arquivos de teste arquivos Java | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo JAR grátis - Baixar arquivos de teste arquivos Java',
          description: 'Baixe arquivos de exemplo JAR arquivos Java grátis para testar execução aplicações Java, extração JAR, análise JAR e ferramentas desenvolvimento Java. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar extratores JAR, ambientes execução Java, analisadores JAR, ferramentas desenvolvimento Java e plataformas implantação aplicações Java.'
        },
        hero: {
          title: 'Arquivos de exemplo JAR',
          description: 'Baixe arquivos de exemplo JAR arquivos Java grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus extratores JAR, ambientes execução Java e ferramentas desenvolvimento Java.'
        },
        about_description: 'Estes são arquivos de teste JAR (arquivo Java) em vários tamanhos para fins de teste'
      },
      crx: {
        meta: {
          title: 'Baixar arquivos de exemplo CRX grátis - Arquivos de teste pacotes extensões Chrome | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo CRX grátis - Baixar arquivos de teste pacotes extensões Chrome',
          description: 'Baixe arquivos de exemplo CRX pacotes extensões Chrome grátis para testar instalação extensões Chrome, análise CRX, desenvolvimento extensões navegador e ferramentas extensões web. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar instaladores CRX, analisadores extensões Chrome, ferramentas desenvolvimento extensões navegador e plataformas distribuição extensões web.'
        },
        hero: {
          title: 'Arquivos de exemplo CRX',
          description: 'Baixe arquivos de exemplo CRX pacotes extensões Chrome grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar suas ferramentas instalação extensões Chrome, analisadores CRX e plataformas desenvolvimento extensões navegador.'
        },
        about_description: 'Estes são arquivos de teste CRX (pacote extensões Chrome) em vários tamanhos para fins de teste'
      },
      '3ds': {
        meta: {
          title: 'Baixar arquivos de exemplo 3DS grátis - Arquivos de teste modelos 3D para impressão 3D e modelagem | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo 3DS grátis - Baixar arquivos de teste modelos 3D para impressão 3D e modelagem',
          description: 'Baixe arquivos de exemplo 3DS modelos 3D grátis para testar softwares modelagem 3D, ferramentas impressão 3D, conversão malhas e aplicações visualização 3D. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar visualizadores modelos 3D, impressoras 3D, softwares CAD, editores malhas e aplicações gráficos 3D.'
        },
        hero: {
          title: 'Arquivos de exemplo 3DS',
          description: 'Baixe arquivos de exemplo 3DS modelos 3D grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus softwares modelagem 3D, ferramentas impressão 3D e aplicações visualização 3D.'
        },
        about_description: 'Estes são arquivos de teste 3DS (modelo 3D) em vários tamanhos para fins de teste'
      },
      '3mf': {
        meta: {
          title: 'Baixar arquivos de exemplo 3MF grátis - Arquivos de teste 3D Manufacturing Format para impressão 3D | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo 3MF grátis - Baixar arquivos de teste 3D Manufacturing Format para impressão 3D',
          description: 'Baixe arquivos de exemplo 3MF 3D Manufacturing Format grátis para testar impressão 3D, fabricação aditiva, corte modelos 3D e compatibilidade impressoras 3D. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar cortadores impressoras 3D, softwares fabricação aditiva, visualizadores 3MF, fluxos trabalho impressão 3D e plataformas fabricação 3D modernas.'
        },
        hero: {
          title: 'Arquivos de exemplo 3MF',
          description: 'Baixe arquivos de exemplo 3MF 3D Manufacturing Format grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus cortadores impressoras 3D, softwares fabricação aditiva e fluxos trabalho impressão 3D.'
        },
        about_description: 'Estes são arquivos de teste 3MF (3D Manufacturing Format) em vários tamanhos para fins de teste'
      },
      ai: {
        meta: {
          title: 'Baixar arquivos de exemplo AI grátis - Arquivos de teste gráficos vetoriais Adobe Illustrator | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo AI grátis - Baixar arquivos de teste gráficos vetoriais Adobe Illustrator',
          description: 'Baixe arquivos de exemplo AI gráficos vetoriais Adobe Illustrator grátis para testar edição gráficos vetoriais, conversão arquivos AI, compatibilidade softwares design e ferramentas design gráfico. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar Adobe Illustrator, editores gráficos vetoriais, conversores arquivos AI, softwares design e plataformas design gráfico profissionais.'
        },
        hero: {
          title: 'Arquivos de exemplo AI',
          description: 'Baixe arquivos de exemplo AI gráficos vetoriais Adobe Illustrator grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus editores gráficos vetoriais, conversores arquivos AI e softwares design.'
        },
        about_description: 'Estes são arquivos de teste AI (Adobe Illustrator) gráficos vetoriais em vários tamanhos para fins de teste'
      },
      ase: {
        meta: {
          title: 'Baixar arquivos de exemplo ASE grátis - Arquivos de teste animações sprite Aseprite | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo ASE grátis - Baixar arquivos de teste animações sprite Aseprite',
          description: 'Baixe arquivos de exemplo ASE animações sprite Aseprite grátis para testar edição pixel art, animação sprites, ferramentas desenvolvimento jogos e softwares animação 2D. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar Aseprite, editores pixel art, ferramentas animação sprites, softwares desenvolvimento jogos e plataformas animação 2D.'
        },
        hero: {
          title: 'Arquivos de exemplo ASE',
          description: 'Baixe arquivos de exemplo ASE animações sprite Aseprite grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus editores pixel art, ferramentas animação sprites e softwares desenvolvimento jogos.'
        },
        about_description: 'Estes são arquivos de teste ASE (animação sprite Aseprite) em vários tamanhos para fins de teste'
      },
      'animation-fbx': {
        meta: {
          title: 'Baixar arquivos de exemplo Animation FBX grátis - Arquivos de teste animações 3D Autodesk FBX | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo Animation FBX grátis - Baixar arquivos de teste animações 3D Autodesk FBX',
          description: 'Baixe arquivos de exemplo Animation FBX animações 3D Autodesk FBX grátis para testar animação 3D, rigging personagens, dados motion capture e softwares gráficos 3D. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar softwares animação 3D, motores jogos, ferramentas motion capture, plataformas animação personagens e aplicações gráficos 3D.'
        },
        hero: {
          title: 'Arquivos de exemplo Animation FBX',
          description: 'Baixe arquivos de exemplo Animation FBX animações 3D Autodesk FBX grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus softwares animação 3D, motores jogos e ferramentas motion capture.'
        },
        about_description: 'Estes são arquivos de teste Animation FBX (animação 3D Autodesk FBX) em vários tamanhos para fins de teste'
      },
      assetbundle: {
        meta: {
          title: 'Baixar arquivos de exemplo AssetBundle grátis - Arquivos de teste Unity AssetBundle para desenvolvimento jogos | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo AssetBundle grátis - Baixar arquivos de teste Unity AssetBundle para desenvolvimento jogos',
          description: 'Baixe arquivos de exemplo AssetBundle Unity AssetBundle grátis para testar desenvolvimento jogos Unity, carregamento assets, gestão recursos jogos e ferramentas motor Unity. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar motor Unity, carregadores assets jogos, ferramentas desenvolvimento Unity, gestores recursos jogos e plataformas desenvolvimento jogos Unity.'
        },
        hero: {
          title: 'Arquivos de exemplo AssetBundle',
          description: 'Baixe arquivos de exemplo AssetBundle Unity AssetBundle grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seu motor Unity, carregadores assets jogos e ferramentas desenvolvimento Unity.'
        },
        about_description: 'Estes são arquivos de teste AssetBundle (Unity AssetBundle) em vários tamanhos para fins de teste'
      },
      blend: {
        meta: {
          title: 'Baixar arquivos de exemplo BLEND grátis - Arquivos de teste projetos 3D Blender | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo BLEND grátis - Baixar arquivos de teste projetos 3D Blender',
          description: 'Baixe arquivos de exemplo BLEND projetos 3D Blender grátis para testar modelagem 3D, compatibilidade projetos Blender, fluxos trabalho animação 3D e softwares gráficos 3D. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar software Blender, ferramentas modelagem 3D, visualizadores projetos Blender, plataformas animação 3D e aplicações gráficos 3D profissionais.'
        },
        hero: {
          title: 'Arquivos de exemplo BLEND',
          description: 'Baixe arquivos de exemplo BLEND projetos 3D Blender grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seu software Blender, ferramentas modelagem 3D e plataformas animação 3D.'
        },
        about_description: 'Estes são arquivos de teste BLEND (projeto 3D Blender) em vários tamanhos para fins de teste'
      },
      bvh: {
        meta: {
          title: 'Baixar arquivos de exemplo BVH grátis - Arquivos de teste motion capture Biovision Hierarchy | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo BVH grátis - Baixar arquivos de teste motion capture Biovision Hierarchy',
          description: 'Baixe arquivos de exemplo BVH motion capture Biovision Hierarchy grátis para testar dados motion capture, animação personagens, sistemas animação esquelética e softwares animação 3D. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar visualizadores motion capture, ferramentas animação personagens, sistemas animação esquelética, plataformas animação 3D e softwares análise motion capture.'
        },
        hero: {
          title: 'Arquivos de exemplo BVH',
          description: 'Baixe arquivos de exemplo BVH motion capture Biovision Hierarchy grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus visualizadores motion capture, ferramentas animação personagens e plataformas animação 3D.'
        },
        about_description: 'Estes são arquivos de teste BVH (motion capture Biovision Hierarchy) em vários tamanhos para fins de teste'
      },
      dwg: {
        meta: {
          title: 'Baixar arquivos de exemplo DWG grátis - Arquivos de teste desenhos AutoCAD para design CAD | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de exemplo DWG grátis - Baixar arquivos de teste desenhos AutoCAD para design CAD',
          description: 'Baixe arquivos de exemplo DWG desenhos AutoCAD grátis para testar softwares CAD, compatibilidade AutoCAD, ferramentas desenho técnico e aplicações design engenharia. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar AutoCAD, visualizadores CAD, softwares desenho técnico, ferramentas design engenharia e plataformas CAD profissionais.'
        },
        hero: {
          title: 'Arquivos de exemplo DWG',
          description: 'Baixe arquivos de exemplo DWG desenhos AutoCAD grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus softwares CAD, compatibilidade AutoCAD e ferramentas desenho técnico.'
        },
        about_description: 'Estes são arquivos de teste DWG (desenho AutoCAD) em vários tamanhos para fins de teste'
      },
      dxf: {
        meta: {
          title: 'Baixar Arquivos de Exemplo DXF Grátis - Arquivos de Teste Drawing Exchange Format AutoCAD | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo DXF Grátis - Baixar Arquivos de Teste Drawing Exchange Format',
          description: 'Baixe arquivos de exemplo DXF Drawing Exchange Format grátis para testar softwares CAD, conversores DXF e ferramentas de desenho técnico. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar AutoCAD, visualizadores CAD, analisadores DXF e aplicativos de troca de arquivos de desenho.'
        },
        hero: {
          title: 'Arquivos de Exemplo DXF',
          description: 'Baixe arquivos de exemplo DXF Drawing Exchange Format grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus softwares CAD, conversores DXF e ferramentas de desenho técnico.'
        },
        about_description: 'Estes são arquivos de teste DXF (Drawing Exchange Format) em vários tamanhos para fins de teste'
      },
      ifc: {
        meta: {
          title: 'Baixar Arquivos de Exemplo IFC Grátis - Arquivos de Teste Industry Foundation Classes BIM | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo IFC Grátis - Baixar Arquivos de Teste Industry Foundation Classes BIM',
          description: 'Baixe arquivos de exemplo IFC Industry Foundation Classes grátis para testar softwares BIM, visualizadores IFC, ferramentas de modelagem de informações da construção e aplicativos de gerenciamento de construção. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar Revit, ArchiCAD, analisadores IFC, visualizadores BIM e softwares de design de edifícios.'
        },
        hero: {
          title: 'Arquivos de Exemplo IFC',
          description: 'Baixe arquivos de exemplo IFC Industry Foundation Classes grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus softwares BIM, visualizadores IFC e ferramentas de modelagem de informações da construção.'
        },
        about_description: 'Estes são arquivos de teste IFC (Industry Foundation Classes) em vários tamanhos para fins de teste'
      },
      iges: {
        meta: {
          title: 'Baixar Arquivos de Exemplo IGES Grátis - Arquivos de Teste Initial Graphics Exchange Specification CAD | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo IGES Grátis - Baixar Arquivos de Teste Initial Graphics Exchange Specification CAD',
          description: 'Baixe arquivos de exemplo IGES Initial Graphics Exchange Specification grátis para testar softwares CAD, conversores IGES, ferramentas de modelagem 3D e aplicativos de design de engenharia. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar sistemas CAD, analisadores IGES, ferramentas de troca de modelos 3D e softwares de engenharia.'
        },
        hero: {
          title: 'Arquivos de Exemplo IGES',
          description: 'Baixe arquivos de exemplo IGES Initial Graphics Exchange Specification grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus softwares CAD, conversores IGES e ferramentas de modelagem 3D.'
        },
        about_description: 'Estes são arquivos de teste IGES (Initial Graphics Exchange Specification) em vários tamanhos para fins de teste'
      },
      igs: {
        meta: {
          title: 'Baixar Arquivos de Exemplo IGS Grátis - Arquivos de Teste Initial Graphics Exchange Specification CAD | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo IGS Grátis - Baixar Arquivos de Teste Initial Graphics Exchange Specification CAD',
          description: 'Baixe arquivos de exemplo IGS Initial Graphics Exchange Specification grátis para testar softwares CAD, conversores IGS, ferramentas de modelagem 3D e aplicativos de design de engenharia. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar sistemas CAD, analisadores IGS, ferramentas de troca de modelos 3D e softwares de engenharia.'
        },
        hero: {
          title: 'Arquivos de Exemplo IGS',
          description: 'Baixe arquivos de exemplo IGS Initial Graphics Exchange Specification grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar seus softwares CAD, conversores IGS e ferramentas de modelagem 3D.'
        },
        about_description: 'Estes são arquivos de teste IGS (Initial Graphics Exchange Specification) em vários tamanhos para fins de teste'
      },
      las: {
        meta: {
          title: 'Baixar Arquivos de Exemplo LAS Grátis - Arquivos de Teste Dados Nuvem de Pontos LiDAR | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo LAS Grátis - Baixar Arquivos de Teste Dados Nuvem de Pontos LiDAR',
          description: 'Baixe arquivos de exemplo LAS nuvem de pontos LiDAR grátis para testar processamento de nuvens de pontos, ferramentas de análise LiDAR, softwares de mapeamento 3D e aplicativos geoespaciais. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar analisadores LAS, visualizadores de nuvens de pontos, ferramentas de processamento LiDAR, softwares de mapeamento 3D e plataformas de análise geoespacial.'
        },
        hero: {
          title: 'Arquivos de Exemplo LAS',
          description: 'Baixe arquivos de exemplo LAS nuvem de pontos LiDAR grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar processamento de nuvens de pontos, ferramentas de análise LiDAR e softwares de mapeamento 3D.'
        },
        about_description: 'Estes são arquivos de teste LAS (nuvem de pontos LiDAR) em vários tamanhos para fins de teste'
      },
      ma: {
        meta: {
          title: 'Baixar Arquivos de Exemplo MA Grátis - Arquivos de Teste Cena Maya ASCII | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo MA Grátis - Baixar Arquivos de Teste Cena Maya ASCII',
          description: 'Baixe arquivos de exemplo MA cena Maya ASCII grátis para testar conversão de cenas Maya, softwares de animação 3D, analisadores de arquivos MA e ferramentas de animação. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar Autodesk Maya, visualizadores de arquivos MA, ferramentas de conversão de cenas, plataformas de animação 3D e softwares de fluxo de trabalho de animação.'
        },
        hero: {
          title: 'Arquivos de Exemplo MA',
          description: 'Baixe arquivos de exemplo MA cena Maya ASCII grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar conversão de cenas Maya, softwares de animação 3D e ferramentas de animação.'
        },
        about_description: 'Estes são arquivos de teste MA (cena Maya ASCII) em vários tamanhos para fins de teste'
      },
      max: {
        meta: {
          title: 'Baixar Arquivos de Exemplo MAX Grátis - Arquivos de Teste Cena 3ds Max | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo MAX Grátis - Baixar Arquivos de Teste Cena 3ds Max',
          description: 'Baixe arquivos de exemplo MAX cena 3ds Max grátis para testar conversão de cenas 3ds Max, softwares de modelagem 3D, analisadores de arquivos MAX e ferramentas de design 3D. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar Autodesk 3ds Max, visualizadores de arquivos MAX, ferramentas de conversão de cenas, plataformas de modelagem 3D e softwares de fluxo de trabalho de design 3D.'
        },
        hero: {
          title: 'Arquivos de Exemplo MAX',
          description: 'Baixe arquivos de exemplo MAX cena 3ds Max grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar conversão de cenas 3ds Max, softwares de modelagem 3D e ferramentas de design 3D.'
        },
        about_description: 'Estes são arquivos de teste MAX (cena 3ds Max) em vários tamanhos para fins de teste'
      },
      mb: {
        meta: {
          title: 'Baixar Arquivos de Exemplo MB Grátis - Arquivos de Teste Cena Maya Binary | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo MB Grátis - Baixar Arquivos de Teste Cena Maya Binary',
          description: 'Baixe arquivos de exemplo MB cena Maya Binary grátis para testar conversão de cenas Maya, softwares de animação 3D, analisadores de arquivos MB e ferramentas de animação. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar Autodesk Maya, visualizadores de arquivos MB, ferramentas de conversão de cenas, plataformas de animação 3D e softwares de fluxo de trabalho de animação.'
        },
        hero: {
          title: 'Arquivos de Exemplo MB',
          description: 'Baixe arquivos de exemplo MB cena Maya Binary grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar conversão de cenas Maya, softwares de animação 3D e ferramentas de animação.'
        },
        about_description: 'Estes são arquivos de teste MB (cena Maya Binary) em vários tamanhos para fins de teste'
      },
      indd: {
        meta: {
          title: 'Baixar Arquivos de Exemplo INDD Grátis - Arquivos de Teste Documento Adobe InDesign | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo INDD Grátis - Baixar Arquivos de Teste Documento Adobe InDesign',
          description: 'Baixe arquivos de exemplo INDD documento Adobe InDesign grátis para testar compatibilidade InDesign, conversores INDD, softwares de editoração eletrônica e ferramentas de design de layout. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar Adobe InDesign, visualizadores de arquivos INDD, ferramentas de conversão de documentos, plataformas de editoração eletrônica e softwares de design de layout.'
        },
        hero: {
          title: 'Arquivos de Exemplo INDD',
          description: 'Baixe arquivos de exemplo INDD documento Adobe InDesign grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar compatibilidade InDesign, conversores INDD e softwares de editoração eletrônica.'
        },
        about_description: 'Estes são arquivos de teste INDD (documento Adobe InDesign) em vários tamanhos para fins de teste'
      },
      'animated-gif': {
        meta: {
          title: 'Baixar Arquivos de Exemplo GIF Animado Grátis - Arquivos de Teste Imagens Animadas | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo GIF Animado Grátis - Baixar Arquivos de Teste Imagens Animadas',
          description: 'Baixe arquivos de exemplo GIF animado grátis para testar reprodução de animações GIF, visualizadores de imagens, navegadores web e ferramentas de animação. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar visualizadores GIF, reprodutores de animação, ferramentas de processamento de imagens, plataformas de desenvolvimento web e aplicativos multimídia.'
        },
        hero: {
          title: 'Arquivos de Exemplo GIF Animado',
          description: 'Baixe arquivos de exemplo GIF animado grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar reprodução de animações GIF, visualizadores de imagens e ferramentas de animação.'
        },
        about_description: 'Estes são arquivos de teste GIF animado em vários tamanhos para fins de teste'
      },
      apng: {
        meta: {
          title: 'Baixar Arquivos de Exemplo APNG Grátis - Arquivos de Teste Imagens PNG Animadas | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo APNG Grátis - Baixar Arquivos de Teste Imagens PNG Animadas',
          description: 'Baixe arquivos de exemplo APNG Animated Portable Network Graphics grátis para testar reprodução de animações APNG, visualizadores de imagens, navegadores web e ferramentas de imagens modernas. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar visualizadores APNG, reprodutores de animação, ferramentas de processamento de imagens, plataformas de desenvolvimento web e aplicativos multimídia modernos.'
        },
        hero: {
          title: 'Arquivos de Exemplo APNG',
          description: 'Baixe arquivos de exemplo APNG Animated Portable Network Graphics grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar reprodução de animações APNG, visualizadores de imagens e ferramentas de imagens modernas.'
        },
        about_description: 'Estes são arquivos de teste APNG (Animated Portable Network Graphics) em vários tamanhos para fins de teste'
      },
      avif: {
        meta: {
          title: 'Baixar Arquivos de Exemplo AVIF Grátis - Arquivos de Teste Formato Imagem AV1 | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo AVIF Grátis - Baixar Arquivos de Teste Formato Imagem AV1',
          description: 'Baixe arquivos de exemplo AVIF AV1 Image File Format grátis para testar compressão de imagens moderna, visualizadores AVIF, navegadores web e ferramentas de imagens de próxima geração. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar visualizadores AVIF, ferramentas de processamento de imagens, plataformas de desenvolvimento web, suporte formato imagem moderno e aplicativos multimídia de próxima geração.'
        },
        hero: {
          title: 'Arquivos de Exemplo AVIF',
          description: 'Baixe arquivos de exemplo AVIF AV1 Image File Format grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar compressão de imagens moderna, visualizadores AVIF e ferramentas de imagens de próxima geração.'
        },
        about_description: 'Estes são arquivos de teste AVIF (AV1 Image File Format) em vários tamanhos para fins de teste'
      },
      bmp: {
        meta: {
          title: 'Baixar Arquivos de Exemplo BMP Grátis - Arquivos de Teste Imagens Bitmap | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo BMP Grátis - Baixar Arquivos de Teste Imagens Bitmap',
          description: 'Baixe arquivos de exemplo BMP bitmap grátis para testar visualizadores de imagens, conversores BMP, softwares gráficos e ferramentas de processamento de imagens. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar visualizadores BMP, editores de imagens, ferramentas de conversão gráfica, plataformas de processamento de imagens e suporte formato bitmap.'
        },
        hero: {
          title: 'Arquivos de Exemplo BMP',
          description: 'Baixe arquivos de exemplo BMP bitmap grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar visualizadores de imagens, conversores BMP e softwares gráficos.'
        },
        about_description: 'Estes são arquivos de teste BMP (bitmap) em vários tamanhos para fins de teste'
      },
      'barcode-svg': {
        meta: {
          title: 'Baixar Arquivos de Exemplo Código de Barras SVG Grátis - Arquivos de Teste Códigos de Barras Vetoriais Escaláveis | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo Código de Barras SVG Grátis - Baixar Arquivos de Teste Códigos de Barras Vetoriais Escaláveis',
          description: 'Baixe arquivos de exemplo código de barras SVG grátis para testar geração de códigos de barras, leitores de códigos de barras SVG, ferramentas de gráficos vetoriais e aplicativos de escaneamento de códigos de barras. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar geradores de códigos de barras, visualizadores SVG, ferramentas de escaneamento de códigos de barras, plataformas de gráficos vetoriais e softwares de reconhecimento de códigos de barras.'
        },
        hero: {
          title: 'Arquivos de Exemplo Código de Barras SVG',
          description: 'Baixe arquivos de exemplo código de barras SVG grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar geração de códigos de barras, leitores de códigos de barras SVG e ferramentas de gráficos vetoriais.'
        },
        about_description: 'Estes são arquivos de teste código de barras SVG em vários tamanhos para fins de teste'
      },
      avi: {
        meta: {
          title: 'Baixar Arquivos de Exemplo AVI Grátis - Arquivos de Teste Vídeo Audio Video Interleave | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo AVI Grátis - Baixar Arquivos de Teste Vídeo Audio Video Interleave',
          description: 'Baixe arquivos de exemplo AVI Audio Video Interleave grátis para testar reprodutores de vídeo, conversores AVI, softwares multimídia e ferramentas de processamento de vídeo. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar reprodutores AVI, editores de vídeo, ferramentas de conversão multimídia, plataformas de processamento de vídeo e suporte formato vídeo.'
        },
        hero: {
          title: 'Arquivos de Exemplo AVI',
          description: 'Baixe arquivos de exemplo AVI Audio Video Interleave grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar reprodutores de vídeo, conversores AVI e softwares multimídia.'
        },
        about_description: 'Estes são arquivos de teste AVI (Audio Video Interleave) em vários tamanhos para fins de teste'
      },
      '3gp': {
        meta: {
          title: 'Baixar Arquivos de Exemplo 3GP Grátis - Arquivos de Teste Vídeo Mobile 3GPP | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo 3GP Grátis - Baixar Arquivos de Teste Vídeo Mobile 3GPP',
          description: 'Baixe arquivos de exemplo 3GP vídeo mobile 3GPP grátis para testar reprodutores de vídeo móveis, conversores 3GP, softwares multimídia e ferramentas de processamento de vídeo móvel. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar reprodutores 3GP, editores de vídeo móveis, ferramentas de conversão de vídeo, plataformas multimídia móveis e suporte formato vídeo móvel.'
        },
        hero: {
          title: 'Arquivos de Exemplo 3GP',
          description: 'Baixe arquivos de exemplo 3GP vídeo mobile 3GPP grátis para testes. Múltiplos tamanhos de arquivo disponíveis para testar reprodutores de vídeo móveis, conversores 3GP e softwares multimídia.'
        },
        about_description: 'Estes são arquivos de teste 3GP (vídeo mobile 3GPP) em vários tamanhos para fins de teste'
      },
      dav: {
        meta: {
          title: 'Baixar Arquivos de Exemplo DAV Grátis - Arquivos de Teste Vídeo DAV para Câmeras de Segurança | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo DAV Grátis - Baixar Arquivos de Teste Vídeo DAV para Câmeras de Segurança',
          description: 'Baixe arquivos de exemplo DAV grátis para testar reprodutores de vídeo DAV, processamento de vídeo de câmeras de segurança, conversores DAV e ferramentas de análise de vídeo de vigilância. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar reprodução DAV, conversores DAV para MP4, softwares de câmeras de segurança, ferramentas de vigilância de vídeo e compatibilidade formato DAV.'
        },
        hero: {
          title: 'Arquivos de Exemplo DAV',
          description: 'Baixe arquivos de exemplo DAV grátis para testes. Múltiplos tamanhos disponíveis para testar reprodutores de vídeo DAV, ferramentas de processamento de vídeo de câmeras de segurança e conversores DAV.'
        },
        about_description: 'Estes são arquivos de teste de vídeo DAV em vários tamanhos para fins de teste'
      },
      dds: {
        meta: {
          title: 'Baixar Arquivos de Exemplo DDS Grátis - Arquivos de Teste Texturas DirectDraw Surface | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo DDS Grátis - Baixar Arquivos de Teste Texturas DirectDraw Surface',
          description: 'Baixe arquivos de exemplo DDS DirectDraw Surface grátis para testar conversão de imagens de textura, visualização DDS, ferramentas de desenvolvimento de jogos e softwares de processamento de gráficos. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar carregamento de texturas DDS, conversores DDS para PNG, compatibilidade de motores de jogos, ferramentas de compressão de texturas e suporte formato DirectDraw Surface.'
        },
        hero: {
          title: 'Arquivos de Exemplo DDS',
          description: 'Baixe arquivos de exemplo DDS DirectDraw Surface grátis para testes. Múltiplos tamanhos disponíveis para testar ferramentas de conversão de imagens de textura, visualizadores DDS e softwares de desenvolvimento de jogos.'
        },
        about_description: 'Estes são arquivos de teste DDS (DirectDraw Surface) de imagens de textura em vários tamanhos para fins de teste'
      },
      dng: {
        meta: {
          title: 'Baixar Arquivos de Exemplo DNG Grátis - Arquivos de Teste Imagens Raw Digital Negative | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo DNG Grátis - Baixar Arquivos de Teste Imagens Raw Digital Negative',
          description: 'Baixe arquivos de exemplo DNG Digital Negative de imagens raw grátis para testar processamento de imagens raw, conversão DNG, softwares fotográficos e ferramentas de edição de imagens profissionais. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar conversores DNG para JPEG, editores de imagens raw, visualização DNG, processamento raw de câmera e suporte formato Adobe Digital Negative.'
        },
        hero: {
          title: 'Arquivos de Exemplo DNG',
          description: 'Baixe arquivos de exemplo DNG Digital Negative de imagens raw grátis para testes. Múltiplos tamanhos disponíveis para testar ferramentas de processamento de imagens raw, conversores DNG e softwares fotográficos.'
        },
        about_description: 'Estes são arquivos de teste DNG (Digital Negative) de imagens raw em vários tamanhos para fins de teste'
      },
      eps: {
        meta: {
          title: 'Baixar Arquivos de Exemplo EPS Grátis - Arquivos de Teste Gráficos Vetoriais Encapsulated PostScript | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo EPS Grátis - Baixar Arquivos de Teste Gráficos Vetoriais Encapsulated PostScript',
          description: 'Baixe arquivos de exemplo EPS Encapsulated PostScript grátis para testar conversão de gráficos vetoriais, visualização EPS, processamento PostScript e softwares de design profissionais. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar conversores EPS para PDF, conversores EPS para SVG, editores de gráficos vetoriais, visualizadores PostScript e compatibilidade formato Encapsulated PostScript.'
        },
        hero: {
          title: 'Arquivos de Exemplo EPS',
          description: 'Baixe arquivos de exemplo EPS Encapsulated PostScript grátis para testes. Múltiplos tamanhos disponíveis para testar ferramentas de conversão de gráficos vetoriais, visualizadores EPS e softwares de processamento PostScript.'
        },
        about_description: 'Estes são arquivos de teste EPS (Encapsulated PostScript) de gráficos vetoriais em vários tamanhos para fins de teste'
      },
      exr: {
        meta: {
          title: 'Baixar Arquivos de Exemplo EXR Grátis - Arquivos de Teste Imagens High Dynamic Range OpenEXR | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo EXR Grátis - Baixar Arquivos de Teste Imagens High Dynamic Range OpenEXR',
          description: 'Baixe arquivos de exemplo EXR OpenEXR de imagens High Dynamic Range grátis para testar processamento de imagens HDR, conversão EXR, softwares fotográficos profissionais e ferramentas de efeitos visuais. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar conversores EXR para JPEG, editores de imagens HDR, visualização EXR, processamento High Dynamic Range e suporte formato OpenEXR.'
        },
        hero: {
          title: 'Arquivos de Exemplo EXR',
          description: 'Baixe arquivos de exemplo EXR OpenEXR de imagens High Dynamic Range grátis para testes. Múltiplos tamanhos disponíveis para testar ferramentas de processamento de imagens HDR, conversores EXR e softwares de efeitos visuais.'
        },
        about_description: 'Estes são arquivos de teste EXR (OpenEXR High Dynamic Range) de imagens em vários tamanhos para fins de teste'
      },
      hdr: {
        meta: {
          title: 'Baixar Arquivos de Exemplo HDR Grátis - Arquivos de Teste Imagens High Dynamic Range | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo HDR Grátis - Baixar Arquivos de Teste Imagens High Dynamic Range',
          description: 'Baixe arquivos de exemplo HDR de imagens High Dynamic Range grátis para testar processamento de imagens HDR, conversão HDR, softwares fotográficos e ferramentas de edição de imagens. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar conversores HDR para JPEG, editores de imagens HDR, visualização HDR, ferramentas de mapeamento de tons e suporte formato High Dynamic Range.'
        },
        hero: {
          title: 'Arquivos de Exemplo HDR',
          description: 'Baixe arquivos de exemplo HDR de imagens High Dynamic Range grátis para testes. Múltiplos tamanhos disponíveis para testar ferramentas de processamento de imagens HDR, conversores HDR e softwares fotográficos.'
        },
        about_description: 'Estes são arquivos de teste HDR (High Dynamic Range) de imagens em vários tamanhos para fins de teste'
      },
      heic: {
        meta: {
          title: 'Baixar Arquivos de Exemplo HEIC Grátis - Arquivos de Teste High Efficiency Image Container | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo HEIC Grátis - Baixar Arquivos de Teste High Efficiency Image Container',
          description: 'Baixe arquivos de exemplo HEIC High Efficiency Image Container grátis para testar conversão de imagens HEIC, visualização HEIC, processamento de formatos de imagem modernos e ferramentas de fotografia móvel. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar conversores HEIC para JPEG, conversores HEIC para PNG, processamento de imagens iOS, softwares de visualização HEIC e suporte formato High Efficiency Image Container.'
        },
        hero: {
          title: 'Arquivos de Exemplo HEIC',
          description: 'Baixe arquivos de exemplo HEIC High Efficiency Image Container grátis para testes. Múltiplos tamanhos disponíveis para testar ferramentas de conversão de imagens HEIC, visualizadores HEIC e softwares de processamento de formatos de imagem modernos.'
        },
        about_description: 'Estes são arquivos de teste HEIC (High Efficiency Image Container) de imagens em vários tamanhos para fins de teste'
      },
      heif: {
        meta: {
          title: 'Baixar Arquivos de Exemplo HEIF Grátis - Arquivos de Teste High Efficiency Image Format | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo HEIF Grátis - Baixar Arquivos de Teste High Efficiency Image Format',
          description: 'Baixe arquivos de exemplo HEIF High Efficiency Image Format grátis para testar conversão de imagens HEIF, visualização HEIF, processamento de formatos de imagem modernos e ferramentas de fotografia móvel. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar conversores HEIF para JPEG, conversores HEIF para PNG, processamento de imagens móveis, softwares de visualização HEIF e suporte formato High Efficiency Image Format.'
        },
        hero: {
          title: 'Arquivos de Exemplo HEIF',
          description: 'Baixe arquivos de exemplo HEIF High Efficiency Image Format grátis para testes. Múltiplos tamanhos disponíveis para testar ferramentas de conversão de imagens HEIF, visualizadores HEIF e softwares de processamento de formatos de imagem modernos.'
        },
        about_description: 'Estes são arquivos de teste HEIF (High Efficiency Image Format) de imagens em vários tamanhos para fins de teste'
      },
      icns: {
        meta: {
          title: 'Baixar Arquivos de Exemplo ICNS Grátis - Arquivos de Teste Ícones macOS | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo ICNS Grátis - Baixar Arquivos de Teste Ícones macOS',
          description: 'Baixe arquivos de exemplo ICNS de ícones macOS grátis para testar conversão de ícones macOS, visualização ICNS, ferramentas de design de ícones e desenvolvimento de aplicações macOS. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar conversores ICNS para PNG, conversores ICNS para ICO, editores de ícones macOS, softwares de design de ícones e suporte formato ícones macOS.'
        },
        hero: {
          title: 'Arquivos de Exemplo ICNS',
          description: 'Baixe arquivos de exemplo ICNS de ícones macOS grátis para testes. Múltiplos tamanhos disponíveis para testar ferramentas de conversão de ícones macOS, visualizadores ICNS e softwares de design de ícones.'
        },
        about_description: 'Estes são arquivos de teste ICNS (ícones macOS) em vários tamanhos para fins de teste'
      },
      ico: {
        meta: {
          title: 'Baixar Arquivos de Exemplo ICO Grátis - Arquivos de Teste Ícones Windows | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo ICO Grátis - Baixar Arquivos de Teste Ícones Windows',
          description: 'Baixe arquivos de exemplo ICO de ícones Windows grátis para testar conversão de ícones Windows, visualização ICO, ferramentas de design de ícones e desenvolvimento de aplicações Windows. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar conversores ICO para PNG, conversores ICO para ICNS, editores de ícones Windows, softwares de design de ícones e suporte formato ícones Windows.'
        },
        hero: {
          title: 'Arquivos de Exemplo ICO',
          description: 'Baixe arquivos de exemplo ICO de ícones Windows grátis para testes. Múltiplos tamanhos disponíveis para testar ferramentas de conversão de ícones Windows, visualizadores ICO e softwares de design de ícones.'
        },
        about_description: 'Estes são arquivos de teste ICO (ícones Windows) em vários tamanhos para fins de teste'
      },
      jpeg: {
        meta: {
          title: 'Baixar Arquivos de Exemplo JPEG Grátis - Arquivos de Teste Imagens JPEG para Ferramentas de Conversão | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo JPEG Grátis - Baixar Arquivos de Teste Imagens JPEG para Ferramentas de Conversão',
          description: 'Baixe arquivos de exemplo JPEG grátis para testar conversão de imagens JPEG, compressão JPEG, ferramentas de processamento de imagens e softwares de edição de fotos. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar conversores JPEG para PNG, conversores JPEG para PDF, ferramentas de compressão de imagens, otimização JPEG e suporte formato Joint Photographic Experts Group.'
        },
        hero: {
          title: 'Arquivos de Exemplo JPEG',
          description: 'Baixe arquivos de exemplo JPEG grátis para testes. Múltiplos tamanhos disponíveis para testar ferramentas de conversão de imagens JPEG, softwares de compressão JPEG e aplicações de processamento de imagens.'
        },
        about_description: 'Estes são arquivos de teste de imagens JPEG em vários tamanhos para fins de teste'
      },
      jpg: {
        meta: {
          title: 'Baixar Arquivos de Exemplo JPG Grátis - Arquivos de Teste Imagens JPG para Ferramentas de Conversão | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo JPG Grátis - Baixar Arquivos de Teste Imagens JPG para Ferramentas de Conversão',
          description: 'Baixe arquivos de exemplo JPG grátis para testar conversão de imagens JPG, compressão JPG, ferramentas de processamento de imagens e softwares de edição de fotos. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar conversores JPG para PNG, conversores JPG para PDF, ferramentas de compressão de imagens, otimização JPG e suporte formato Joint Photographic Experts Group.'
        },
        hero: {
          title: 'Arquivos de Exemplo JPG',
          description: 'Baixe arquivos de exemplo JPG grátis para testes. Múltiplos tamanhos disponíveis para testar ferramentas de conversão de imagens JPG, softwares de compressão JPG e aplicações de processamento de imagens.'
        },
        about_description: 'Estes são arquivos de teste de imagens JPG em vários tamanhos para fins de teste'
      },
      m4v: {
        meta: {
          title: 'Baixar Arquivos de Exemplo M4V Grátis - Arquivos de Teste Vídeo M4V para Ferramentas de Conversão | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo M4V Grátis - Baixar Arquivos de Teste Vídeo M4V para Ferramentas de Conversão',
          description: 'Baixe arquivos de exemplo M4V grátis para testar conversão de vídeo M4V, reprodução M4V, ferramentas de processamento de vídeo e softwares multimídia. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar conversores M4V para MP4, conversores M4V para AVI, reprodutores de vídeo, compatibilidade de reprodução M4V e suporte formato vídeo MPEG-4.'
        },
        hero: {
          title: 'Arquivos de Exemplo M4V',
          description: 'Baixe arquivos de exemplo M4V grátis para testes. Múltiplos tamanhos disponíveis para testar ferramentas de conversão de vídeo M4V, softwares de reprodução M4V e aplicações de processamento de vídeo.'
        },
        about_description: 'Estes são arquivos de teste de vídeo M4V em vários tamanhos para fins de teste'
      },
      mkv: {
        meta: {
          title: 'Baixar Arquivos de Exemplo MKV Grátis - Arquivos de Teste Vídeo Matroska para Ferramentas de Conversão | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo MKV Grátis - Baixar Arquivos de Teste Vídeo Matroska para Ferramentas de Conversão',
          description: 'Baixe arquivos de exemplo MKV Matroska grátis para testar conversão de vídeo MKV, reprodução MKV, ferramentas de processamento de vídeo e softwares multimídia. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar conversores MKV para MP4, conversores MKV para AVI, reprodutores de vídeo, compatibilidade de reprodução MKV e suporte formato vídeo Matroska.'
        },
        hero: {
          title: 'Arquivos de Exemplo MKV',
          description: 'Baixe arquivos de exemplo MKV Matroska grátis para testes. Múltiplos tamanhos disponíveis para testar ferramentas de conversão de vídeo MKV, softwares de reprodução MKV e aplicações de processamento de vídeo.'
        },
        about_description: 'Estes são arquivos de teste de vídeo MKV (Matroska) em vários tamanhos para fins de teste'
      },
      aac: {
        meta: {
          title: 'Baixar Arquivos de Exemplo AAC Grátis - Arquivos de Teste Advanced Audio Coding | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo AAC Grátis - Baixar Arquivos de Teste Advanced Audio Coding',
          description: 'Baixe arquivos de exemplo AAC Advanced Audio Coding grátis para testar conversão de áudio, reprodução AAC, ferramentas de processamento de áudio e softwares multimídia. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar conversores AAC para MP3, conversores AAC para WAV, reprodutores de áudio, compatibilidade de reprodução AAC e suporte formato Advanced Audio Coding.'
        },
        hero: {
          title: 'Arquivos de Exemplo AAC',
          description: 'Baixe arquivos de exemplo AAC Advanced Audio Coding grátis para testes. Múltiplos tamanhos disponíveis para testar ferramentas de conversão de áudio, softwares de reprodução AAC e aplicações de processamento de áudio.'
        },
        about_description: 'Estes são arquivos de teste AAC (Advanced Audio Coding) de áudio em vários tamanhos para fins de teste'
      },
      ac3: {
        meta: {
          title: 'Baixar Arquivos de Exemplo AC3 Grátis - Arquivos de Teste Áudio Dolby Digital | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo AC3 Grátis - Baixar Arquivos de Teste Áudio Dolby Digital',
          description: 'Baixe arquivos de exemplo AC3 Dolby Digital grátis para testar conversão de áudio, reprodução AC3, ferramentas de processamento de áudio e softwares multimídia. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar conversores AC3 para MP3, conversores AC3 para WAV, reprodutores de áudio, compatibilidade de reprodução AC3 e suporte formato Dolby Digital.'
        },
        hero: {
          title: 'Arquivos de Exemplo AC3',
          description: 'Baixe arquivos de exemplo AC3 Dolby Digital grátis para testes. Múltiplos tamanhos disponíveis para testar ferramentas de conversão de áudio, softwares de reprodução AC3 e aplicações de processamento de áudio.'
        },
        about_description: 'Estes são arquivos de teste AC3 (Dolby Digital) de áudio em vários tamanhos para fins de teste'
      },
      aif: {
        meta: {
          title: 'Baixar Arquivos de Exemplo AIF Grátis - Arquivos de Teste Audio Interchange File Format | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo AIF Grátis - Baixar Arquivos de Teste Audio Interchange File Format',
          description: 'Baixe arquivos de exemplo AIF Audio Interchange File Format grátis para testar conversão de áudio, reprodução AIF, ferramentas de processamento de áudio e softwares multimídia. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar conversores AIF para MP3, conversores AIF para WAV, reprodutores de áudio, compatibilidade de reprodução AIF e suporte formato Audio Interchange File Format.'
        },
        hero: {
          title: 'Arquivos de Exemplo AIF',
          description: 'Baixe arquivos de exemplo AIF Audio Interchange File Format grátis para testes. Múltiplos tamanhos disponíveis para testar ferramentas de conversão de áudio, softwares de reprodução AIF e aplicações de processamento de áudio.'
        },
        about_description: 'Estes são arquivos de teste AIF (Audio Interchange File Format) de áudio em vários tamanhos para fins de teste'
      },
      aiff: {
        meta: {
          title: 'Baixar Arquivos de Exemplo AIFF Grátis - Arquivos de Teste Audio Interchange File Format | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo AIFF Grátis - Baixar Arquivos de Teste Audio Interchange File Format',
          description: 'Baixe arquivos de exemplo AIFF Audio Interchange File Format grátis para testar conversão de áudio, reprodução AIFF, ferramentas de processamento de áudio e softwares multimídia. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar conversores AIFF para MP3, conversores AIFF para WAV, reprodutores de áudio, compatibilidade de reprodução AIFF e suporte formato Audio Interchange File Format.'
        },
        hero: {
          title: 'Arquivos de Exemplo AIFF',
          description: 'Baixe arquivos de exemplo AIFF Audio Interchange File Format grátis para testes. Múltiplos tamanhos disponíveis para testar ferramentas de conversão de áudio, softwares de reprodução AIFF e aplicações de processamento de áudio.'
        },
        about_description: 'Estes são arquivos de teste AIFF (Audio Interchange File Format) de áudio em vários tamanhos para fins de teste'
      },
      amr: {
        meta: {
          title: 'Baixar Arquivos de Exemplo AMR Grátis - Arquivos de Teste Adaptive Multi-Rate Audio | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo AMR Grátis - Baixar Arquivos de Teste Adaptive Multi-Rate Audio',
          description: 'Baixe arquivos de exemplo AMR Adaptive Multi-Rate grátis para testar conversão de áudio, reprodução AMR, ferramentas de processamento de áudio e softwares multimídia móveis. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar conversores AMR para MP3, conversores AMR para WAV, reprodutores de áudio, compatibilidade de reprodução AMR e suporte formato Adaptive Multi-Rate.'
        },
        hero: {
          title: 'Arquivos de Exemplo AMR',
          description: 'Baixe arquivos de exemplo AMR Adaptive Multi-Rate grátis para testes. Múltiplos tamanhos disponíveis para testar ferramentas de conversão de áudio, softwares de reprodução AMR e aplicações de processamento de áudio.'
        },
        about_description: 'Estes são arquivos de teste AMR (Adaptive Multi-Rate) de áudio em vários tamanhos para fins de teste'
      },
      caf: {
        meta: {
          title: 'Baixar Arquivos de Exemplo CAF Grátis - Arquivos de Teste Core Audio Format | FormiPeek',
        ...
        schema: {
          name: 'Arquivos de Exemplo CAF Grátis - Baixar Arquivos de Teste Core Audio Format',
          description: 'Baixe arquivos de exemplo CAF Core Audio Format grátis para testar conversão de áudio, reprodução CAF, ferramentas de processamento de áudio e softwares multimídia macOS. Múltiplos tamanhos: 100 KB, 1 MB, 5 MB, 50 MB e 100 MB. Perfeito para testar conversores CAF para MP3, conversores CAF para WAV, reprodutores de áudio, compatibilidade de reprodução CAF e suporte formato Core Audio Format.'
        },
        hero: {
          title: 'Arquivos de Exemplo CAF',
      ...
      cue: {
        meta: {
          title: 'Baixar Arquivos de Exemplo CUE Gratuitos - Arquivos de Teste CUE Sheet para Gravação de CD de Áudio | FormiPeek',
      ...
      m4a: {
        meta: {
          title: 'Baixar Arquivos de Exemplo M4A Gratuitos - Arquivos de Teste M4A Audio para Ferramentas de Conversão | FormiPeek',
      ...
      midi: {
        meta: {
          title: 'Baixar Arquivos de Exemplo MIDI Gratuitos - Arquivos de Teste MIDI Music para Sequenciamento Musical | FormiPeek',
      ...
      ace: {
        meta: {
          title: 'Baixar Arquivos de Exemplo ACE Gratuitos - Arquivos de Teste ACE Archive para Ferramentas de Extração | FormiPeek',
      ...
      arj: {
        meta: {
          title: 'Baixar Arquivos de Exemplo ARJ Gratuitos - Arquivos de Teste ARJ Archive para Ferramentas de Extração | FormiPeek',
      ...
      bz2: {
        meta: {
          title: 'Baixar Arquivos de Exemplo BZ2 Gratuitos - Arquivos de Teste BZ2 Compressed Archive | FormiPeek',
      ...
      gz: {
        meta: {
          title: 'Baixar Arquivos de Exemplo GZ Gratuitos - Arquivos de Teste GZ Gzip Compressed Archive | FormiPeek',
      ...
      cab: {
        meta: {
          title: 'Baixar Arquivos de Exemplo CAB Gratuitos - Arquivos de Teste CAB Windows Cabinet Archive | FormiPeek',
      ...
      cpio: {
        meta: {
          title: 'Baixar Arquivos de Exemplo CPIO Gratuitos - Arquivos de Teste CPIO Archive para Ferramentas de Extração | FormiPeek',
      ...
      zip: {
        meta: {
          title: 'Baixar Arquivos de Exemplo ZIP Gratuitos - Arquivos de Teste ZIP Archive para Ferramentas de Extração | FormiPeek',
      ...
      dmg: {
        meta: {
          title: 'Baixar Arquivos de Exemplo DMG Gratuitos - Arquivos de Teste DMG macOS Disk Image | FormiPeek',
      ...
      img: {
        meta: {
          title: 'Baixar Arquivos de Exemplo IMG Gratuitos - Arquivos de Teste IMG Disk Image | FormiPeek',
      ...
      iso: {
        meta: {
          title: 'Baixar Arquivos de Exemplo ISO Gratuitos - Arquivos de Teste ISO Disk Image | FormiPeek',
      ...
      kmz: {
        meta: {
          title: 'Baixar Arquivos de Exemplo KMZ Gratuitos - Arquivos de Teste KMZ Compressed KML | FormiPeek',
      ...
      laz: {
        meta: {
          title: 'Baixar Arquivos de Exemplo LAZ Gratuitos - Arquivos de Teste LAZ Compressed LiDAR | FormiPeek',
      ...
      lha: {
        meta: {
          title: 'Baixar Arquivos de Exemplo LHA Gratuitos - Arquivos de Teste LHA Archive para Ferramentas de Extração | FormiPeek',
      ...
      lzh: {
        meta: {
          title: 'Baixar Arquivos de Exemplo LZH Gratuitos - Arquivos de Teste LZH Archive para Ferramentas de Extração | FormiPeek',
      ...
      lzma: {
        meta: {
          title: 'Baixar Arquivos de Exemplo LZMA Gratuitos - Arquivos de Teste LZMA Compressed Archive | FormiPeek',
      ...
      '7z': {
        meta: {
          title: 'Baixar Arquivos de Exemplo 7Z Gratuitos - Arquivos de Teste 7Z Archive para Ferramentas de Extração | FormiPeek',

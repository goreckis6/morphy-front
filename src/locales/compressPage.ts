...
const compressPageResources: Record<string, CompressPageTranslations> = {
  ...
  es: {
    compress_page: {
      meta: {
        title: 'Compresor de archivos en línea – Reducir tamaño de archivo | MorphyHub',
        description:
          'Comprime imágenes, PDFs, videos y documentos en línea. MorphyHub hace que tus archivos sean más pequeños y rápidos de compartir — sin perder calidad.',
        keywords:
      ...
      schema: {
        ...
        description:
          'Comprime imágenes, PDFs, videos y más directamente en tu navegador con MorphyHub. Reduce el tamaño del archivo manteniendo una gran calidad — rápido y seguro.'
      },
      hero: {
  ...
  fr: {
    compress_page: {
      meta: {
        title: 'Compresseur de fichiers en ligne – Réduire la taille du fichier | MorphyHub',
        description:
          'Compressez des images, PDFs, vidéos et documents en ligne. MorphyHub rend vos fichiers plus petits et plus rapides à partager — sans perte de qualité.',
        keywords:
      ...
      schema: {
        ...
        description:
          'Compressez des images, PDFs, vidéos et plus directement dans votre navigateur avec MorphyHub. Réduisez la taille du fichier tout en conservant une excellente qualité — rapide et sécurisé.'
      },
      hero: {
  ...
  it: {
    compress_page: {
      meta: {
        title: 'Compressore di file online – Riduci dimensione file | MorphyHub',
        description:
          'Comprimi immagini, PDF, video e documenti online. MorphyHub rende i tuoi file più piccoli e veloci da condividere — senza perdere qualità.',
        keywords:
      ...
      schema: {
        ...
        description:
          'Comprimi immagini, PDF, video e altro direttamente nel tuo browser con MorphyHub. Riduci la dimensione del file mantenendo un\'ottima qualità — veloce e sicuro.'
      },
      hero: {
  ...
  nl: {
    compress_page: {
      meta: {
        title: 'Online bestandscompressor – Bestandsgrootte verkleinen | MorphyHub',
        description:
          'Comprimeer afbeeldingen, PDF\'s, video\'s en documenten online. MorphyHub maakt uw bestanden kleiner en sneller om te delen — zonder kwaliteitsverlies.',
        keywords:
      ...
      schema: {
        ...
        description:
          'Comprimeer afbeeldingen, PDF\'s, video\'s en meer direct in uw browser met MorphyHub. Verklein de bestandsgrootte met behoud van uitstekende kwaliteit — snel en veilig.'
      },
      hero: {
  ...
  pt: {
    compress_page: {
      meta: {
        title: 'Compressor de arquivos online – Reduzir tamanho do arquivo | MorphyHub',
        description:
          'Comprima imagens, PDFs, vídeos e documentos online. MorphyHub torna seus arquivos menores e mais rápidos para compartilhar — sem perder qualidade.',
        keywords:
      ...
      schema: {
        ...
        description:
          'Comprima imagens, PDFs, vídeos e mais diretamente no seu navegador com MorphyHub. Reduza o tamanho do arquivo mantendo ótima qualidade — rápido e seguro.'
      },
      hero: {
  ...
  vi: {
    compress_page: {
      meta: {
        title: 'Công cụ nén tệp trực tuyến – Giảm kích thước tệp | MorphyHub',
        description:
          'Nén hình ảnh, PDF, video và tài liệu trực tuyến. MorphyHub làm cho tệp của bạn nhỏ hơn và nhanh hơn để chia sẻ — không mất chất lượng.',
        keywords:
      ...
      schema: {
        ...
        description:
          'Nén hình ảnh, PDF, video và nhiều hơn nữa trực tiếp trong trình duyệt của bạn với MorphyHub. Giảm kích thước tệp trong khi vẫn giữ chất lượng tuyệt vời — nhanh chóng và an toàn.'
      },
      hero: {
  ...
  tr: {
    compress_page: {
      meta: {
        title: 'Çevrimiçi dosya sıkıştırıcı – Dosya boyutunu azalt | MorphyHub',
        description:
          'Görüntüleri, PDF\'leri, videoları ve belgeleri çevrimiçi sıkıştırın. MorphyHub dosyalarınızı daha küçük ve paylaşımı daha hızlı hale getirir — kalite kaybı olmadan.',
        keywords:
      ...
      schema: {
        ...
        description:
          'MorphyHub ile tarayıcınızda doğrudan görüntüleri, PDF\'leri, videoları ve daha fazlasını sıkıştırın. Mükemmel kaliteyi korurken dosya boyutunu azaltın — hızlı ve güvenli.'
      },
      hero: {
  ...
  ru: {
    compress_page: {
      meta: {
        title: 'Онлайн-компрессор файлов – Уменьшить размер файла | MorphyHub',
        description:
          'Сжимайте изображения, PDF, видео и документы онлайн. MorphyHub делает ваши файлы меньше и быстрее для обмена — без потери качества.',
        keywords:
      ...
      schema: {
        ...
        description:
          'Сжимайте изображения, PDF, видео и многое другое прямо в браузере с MorphyHub. Уменьшите размер файла, сохраняя отличное качество — быстро и безопасно.'
      },
      hero: {
  ...
  ar: {
    compress_page: {
      meta: {
        title: 'ضاغط الملفات عبر الإنترنت – تقليل حجم الملف | MorphyHub',
        description:
          'ضغط الصور وملفات PDF والفيديو والمستندات عبر الإنترنت. يجعل MorphyHub ملفاتك أصغر وأسرع للمشاركة — دون فقدان الجودة.',
        keywords:
      ...
      schema: {
        ...
        description:
          'ضغط الصور وملفات PDF والفيديو والمزيد مباشرة في متصفحك مع MorphyHub. قلل حجم الملف مع الحفاظ على جودة رائعة — سريع وآمن.'
      },
      hero: {
  ...
  th: {
    compress_page: {
      meta: {
        title: 'เครื่องมือบีบอัดไฟล์ออนไลน์ – ลดขนาดไฟล์ | MorphyHub',
        description:
          'บีบอัดรูปภาพ PDF วิดีโอ และเอกสารออนไลน์ MorphyHub ทำให้ไฟล์ของคุณเล็กลงและแชร์ได้เร็วขึ้น — โดยไม่สูญเสียคุณภาพ',
        keywords:
      ...
      schema: {
        ...
        description:
          'บีบอัดรูปภาพ PDF วิดีโอ และอื่นๆ โดยตรงในเบราว์เซอร์ของคุณด้วย MorphyHub ลดขนาดไฟล์ในขณะที่ยังคงคุณภาพที่ดี — เร็วและปลอดภัย'
      },
      hero: {
  ...
  ja: {
    compress_page: {
      meta: {
        title: 'オンラインファイル圧縮ツール – ファイルサイズを削減 | MorphyHub',
        description:
          '画像、PDF、動画、ドキュメントをオンラインで圧縮。MorphyHubでファイルを小さく、共有を高速化 — 品質を損なわずに。',
        keywords:
      ...
      schema: {
        name: 'オンラインファイル圧縮ツール',
        description:
          'MorphyHubでブラウザで直接画像、PDF、動画などを圧縮。優れた品質を維持しながらファイルサイズを削減 — 高速で安全。'
      },
      hero: {
        title: 'ファイル圧縮ツール',
        description:
  ...
  zh: {
    compress_page: {
      meta: {
        title: '在线文件压缩工具 – 减小文件大小 | MorphyHub',
        description:
          '在线压缩图像、PDF、视频和文档。MorphyHub使您的文件更小、共享更快 — 不损失质量。',
        keywords:
      ...
      schema: {
        name: '在线文件压缩工具',
        description:
          '使用MorphyHub直接在浏览器中压缩图像、PDF、视频等。在保持出色质量的同时减小文件大小 — 快速且安全。'
      },
      hero: {
        title: '文件压缩工具',
        description:
  ...
  id: {
    compress_page: {
      meta: {
        title: 'Alat kompresi file online – Kurangi ukuran file | MorphyHub',
        description:
          'Kompres gambar, PDF, video, dan dokumen online. MorphyHub membuat file Anda lebih kecil dan lebih cepat untuk dibagikan — tanpa kehilangan kualitas.',
        keywords:
      ...
      schema: {
        ...
        description:
          'Kompres gambar, PDF, video, dan lebih banyak lagi langsung di browser Anda dengan MorphyHub. Kurangi ukuran file sambil mempertahankan kualitas yang bagus — cepat dan aman.'
      },
      hero: {
  ...
  sv: {
    compress_page: {
      meta: {
        title: 'Online filkomprimerare – Minska filstorlek | MorphyHub',
        description:
          'Komprimera bilder, PDF-filer, videor och dokument online. MorphyHub gör dina filer mindre och snabbare att dela — utan kvalitetsförlust.',
        keywords:
      ...
      schema: {
        ...
        description:
          'Komprimera bilder, PDF-filer, videor och mer direkt i din webbläsare med MorphyHub. Minska filstorleken medan du behåller utmärkt kvalitet — snabbt och säkert.'
      },
      hero: {

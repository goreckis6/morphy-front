...
export default function SampleJks() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-jks-100kb.jks', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-jks-1mb.jks', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-jks-5mb.jks', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-jks-50mb.jks', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-jks-100mb.jks', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-jks",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-jks" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-jks" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">JKS Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free JKS sample Java KeyStore files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free JKS sample Java KeyStore files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing Java KeyStore management, JKS parsing, and SSL certificate storage tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About JKS Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                JKS (Java KeyStore) is a proprietary file format used by Java to store cryptographic keys and certificates. JKS files are used for SSL/TLS connections, code signing, and secure authentication in Java applications.
              </p>
              <p className="text-gray-700 mb-4">
                These sample JKS files are provided for testing purposes. They can be used to test Java KeyStore management, JKS parsing tools, and SSL certificate storage applications.
              </p>
            </div>
          </div>
        </div>

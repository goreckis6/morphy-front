...
export default function SampleDbf() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-dbf-100kb.dbf', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-dbf-1mb.dbf', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-dbf-5mb.dbf', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-dbf-50mb.dbf', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-dbf-100mb.dbf', displaySize: '100 MB' }
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-dbf" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-dbf" />
        <script

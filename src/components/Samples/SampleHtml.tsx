...
import { Download, Globe, Clock, CheckCircle, ArrowLeft } from 'lucide-react';
...
export default function SampleHtml() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-html-100kb.html', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-html-1mb.html', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-html-5mb.html', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-html-50mb.html', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-html-100mb.html', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-html",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-html" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-html" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free HTML sample HyperText Markup Language files for testing. Multiple file sizes available to test your HTML parsing and web development tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-orange-50 border border-orange-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test HTML (HyperText Markup Language) files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing HTML parsing, web development, and HTML validation tools</li>

...
export default function SampleDng() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-dng-100kb.dng', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-dng-1mb.dng', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-dng-5mb.dng', displaySize: '5 MB' },
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyhub.com/samples/sample-dng",

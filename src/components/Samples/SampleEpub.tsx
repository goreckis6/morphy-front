...
export default function SampleEpub() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-epub-100kb.epub', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-epub-1mb.epub', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-epub-5mb.epub', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-epub-50mb.epub', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-epub-100mb.epub', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-epub",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-epub" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-epub" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">EPUB Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free EPUB sample eBook files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free EPUB sample eBook files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing eBook readers, EPUB conversion, and digital publishing tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About EPUB Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                EPUB (Electronic Publication) is an e-book file format that uses the ".epub" file extension. EPUB is a free and open standard based on web technologies like HTML, CSS, and XML, making it widely supported across devices and platforms.
              </p>
              <p className="text-gray-700 mb-4">
                These sample EPUB files are provided for testing purposes. They can be used to test eBook readers, EPUB conversion tools, and digital publishing applications.
              </p>
            </div>
          </div>
        </div>

...
export default function SampleApk() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-apk-100kb.apk', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-apk-1mb.apk', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-apk-5mb.apk', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-apk-50mb.apk', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-apk-100mb.apk', displaySize: '100 MB' }
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free APK sample Android application package files for testing. Multiple file sizes available to test your Android app installation, APK analysis, and mobile application processing tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-green-50 border border-green-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test APK (Android Application Package) files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing Android app installation, APK analysis, and mobile application processing tools</li>

...
export default function SampleXml() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-xml-100kb.xml', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-xml-1mb.xml', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-xml-5mb.xml', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-xml-50mb.xml', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-xml-100mb.xml', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-xml",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-xml" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-xml" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free XML sample markup files for testing. Multiple file sizes available to test your XML parsing, data conversion, and markup processing tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-purple-50 border border-purple-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test XML (Extensible Markup Language) markup files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing XML parsing, data conversion, and markup processing tools</li>

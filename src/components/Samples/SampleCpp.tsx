...
export default function SampleCpp() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-cpp-100kb.cpp', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-cpp-1mb.cpp', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-cpp-5mb.cpp', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-cpp-50mb.cpp', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-cpp-100mb.cpp', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-cpp",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-cpp" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-cpp" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-3 mb-4 sm:mb-6">
              <div className="p-2 sm:p-3 bg-gradient-to-br from-purple-600 to-indigo-600 rounded-xl">
          ...
          <div className="mt-8 bg-purple-50 border border-purple-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test C++ (C Plus Plus) source code files in various sizes for testing purposes</li>

...
export default function SampleArduinoIno() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-arduino-ino-100kb.ino', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-arduino-ino-1mb.ino', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-arduino-ino-5mb.ino', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-arduino-ino-50mb.ino', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-arduino-ino-100mb.ino', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "@type": "WebPage",
    "name": "Free Arduino INO Sample Files - Download Test Arduino Code Files",
    "url": "https://morphyimg.com/samples/sample-arduino-ino",
    "description": "Download free Arduino INO sample code files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing Arduino code compilation, syntax checking, and embedded programming tools.",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-arduino-ino" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-arduino-ino" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-3 mb-4 sm:mb-6">
              <div className="p-2 sm:p-3 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-xl">
                <Code className="w-6 h-6 sm:w-8 sm:h-8 text-white" />
              </div>
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900">
                Arduino INO Sample Files
              </h1>
            </div>
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free Arduino INO sample code files for testing. Multiple file sizes available to test your Arduino code compilation, syntax checking, and embedded programming tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test Arduino INO (Arduino code) files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing Arduino code compilation, syntax checking, and embedded programming tools</li>

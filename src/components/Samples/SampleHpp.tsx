...
export default function SampleHpp() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-hpp-100kb.hpp', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-hpp-1mb.hpp', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-hpp-5mb.hpp', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-hpp-50mb.hpp', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-hpp-100mb.hpp', displaySize: '100 MB' }
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-3 mb-4 sm:mb-6">
              <div className="p-2 sm:p-3 bg-gradient-to-br from-sky-500 to-cyan-500 rounded-xl">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free HPP sample C++ header files for testing. Multiple file sizes available to test your C++ code compilation and header file processing tools.
            </p>
          </div>
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-3 sm:space-y-0">
                    <div className="flex items-center space-x-4 flex-1">
                      <div className="p-2 rounded-lg bg-sky-100">
                        <Code className="w-5 h-5 sm:w-6 sm:h-6 text-sky-600" />
                      </div>
                      <div>
                    ...
                    <div className="w-full sm:w-auto sm:ml-4">
                      {downloadingIndex === index ? (
                        ...
                        <button
                          ...
                          className="inline-flex items-center justify-center space-x-2 bg-sky-600 hover:bg-sky-700 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg text-sm sm:text-base font-medium transition-colors w-full sm:w-auto shadow-lg"
                        >
                        ...
                        <button
                          ...
                          className="inline-flex items-center justify-center space-x-2 bg-sky-600 hover:bg-sky-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg text-sm sm:text-base font-medium transition-colors w-full sm:w-auto"
                        >
                          <Download className="w-4 h-4 sm:w-5 sm:h-5" />
                          <span>Download</span>
                        </button>
          ...
          <div className="mt-8 bg-sky-50 border border-sky-200 rounded-lg p-4 sm:p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-2">
              About These Sample Files
            </h3>
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test HPP (C++ header) files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing C++ code compilation, header file processing, and development tools</li>

...
export default function SampleAvi() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-avi-100kb.avi', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-avi-1mb.avi', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-avi-5mb.avi', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-avi-50mb.avi', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-avi-100mb.avi', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-avi",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-avi" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-avi" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free AVI sample video files for testing. Multiple file sizes available to test your video conversion, playback, and AVI format processing tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-cyan-50 border border-cyan-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test AVI (Audio Video Interleave) video files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing video conversion, playback, and AVI format processing tools</li>

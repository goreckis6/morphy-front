...
export default function SampleDem() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-dem-100kb.dem', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-dem-1mb.dem', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-dem-5mb.dem', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-dem-50mb.dem', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-dem-100mb.dem', displaySize: '100 MB' }
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-dem" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-dem" />
        <script

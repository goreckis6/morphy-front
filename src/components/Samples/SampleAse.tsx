...
import { Download, Palette, Clock, CheckCircle, ArrowLeft } from 'lucide-react';
...
export default function SampleAse() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-ase-100kb.ase', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-ase-1mb.ase', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-ase-5mb.ase', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-ase-50mb.ase', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-ase-100mb.ase', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-ase",
    "description": "Download free ASE sample Adobe Swatch Exchange color palette files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing color palette conversion, viewing, and Adobe Swatch Exchange format processing tools.",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-ase" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-ase" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free ASE sample Adobe Swatch Exchange color palette files for testing. Multiple file sizes available to test your color palette conversion, viewing, and Adobe Swatch Exchange format processing tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-purple-50 border border-purple-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test ASE (Adobe Swatch Exchange) color palette files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing color palette conversion, viewing, and Adobe Swatch Exchange format processing tools</li>

...
export default function SampleConf() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-conf-100kb.conf', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-conf-1mb.conf', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-conf-5mb.conf', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-conf-50mb.conf', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-conf-100mb.conf', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-conf",
    "description": "Download free CONF sample configuration files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing configuration file parsing, system setup, and config format processing tools.",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-conf" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-conf" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free CONF sample configuration files for testing. Multiple file sizes available to test your configuration file parsing, system setup, and config format processing tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-gray-50 border border-gray-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test CONF (Configuration) files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing configuration file parsing, system setup, and config format processing tools</li>

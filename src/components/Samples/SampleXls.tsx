...
export default function SampleXls() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-xls-100kb.xls', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-xls-1mb.xls', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-xls-5mb.xls', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-xls-50mb.xls', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-xls-100mb.xls', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-xls",
    "description": "Download free XLS sample spreadsheet files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing Excel file conversion, data processing, and spreadsheet tools.",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-xls" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-xls" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free XLS sample Excel spreadsheet files for testing. Multiple file sizes available to test your Excel file conversion, data processing, and spreadsheet import tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-green-50 border border-green-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test XLS (Microsoft Excel) spreadsheet files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing Excel file conversion, data processing, and spreadsheet import tools</li>

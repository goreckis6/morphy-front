...
export default function SampleDocx() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-docx-100kb.docx', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-docx-1mb.docx', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-docx-5mb.docx', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-docx-50mb.docx', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-docx-100mb.docx', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-docx",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-docx" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-docx" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free DOCX sample files for testing. Multiple file sizes available to test your document conversion and processing tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test DOCX files in various sizes for testing purposes</li>

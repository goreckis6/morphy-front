...
export default function SampleConfigIni() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-config-ini-100kb.ini', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-config-ini-1mb.ini', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-config-ini-5mb.ini', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-config-ini-50mb.ini', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-config-ini-100mb.ini', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "@type": "WebPage",
    "name": "Free Config INI Sample Files - Download Test INI Configuration Files",
    "url": "https://morphyimg.com/samples/sample-config-ini",
    "description": "Download free Config INI sample INI configuration files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing INI file parsing, configuration management, and Windows INI format processing tools.",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-config-ini" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-config-ini" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-3 mb-4 sm:mb-6">
              ...
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900">
                Config INI Sample Files
              </h1>
            </div>
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free Config INI sample INI configuration files for testing. Multiple file sizes available to test your INI file parsing, configuration management, and Windows INI format processing tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-purple-50 border border-purple-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test Config INI (INI configuration) files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing INI file parsing, configuration management, and Windows INI format processing tools</li>

...
export default function SampleLog() {
  ...
  return (
    <>
      <Helmet>
        <title>Free LOG Sample Files Download - Test Log Files | MorphyHub</title>
        ...
        <meta property="og:title" content="Free LOG Sample Files Download - Test Log Files | MorphyHub" />
        ...
        <meta name="twitter:title" content="Free LOG Sample Files Download - Test Log Files | MorphyHub" />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free LOG sample log files for testing. Multiple file sizes available to test your log parsing and log analysis tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-purple-50 border border-purple-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test LOG (log) files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing log parsing and log analysis tools</li>

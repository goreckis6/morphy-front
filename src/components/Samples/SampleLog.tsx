...
export default function SampleLog() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-log-100kb.log', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-log-1mb.log', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-log-5mb.log', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-log-50mb.log', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-log-100mb.log', displaySize: '100 MB' }
  ];
  ...
  return (
    <>
      <Helmet>
        <title>Free LOG Sample Files Download - Test Log Files | MorphyIMG</title>
        <meta name="description" content="Download free LOG sample log files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing log parsing, log analysis, and system monitoring tools." />
        <meta name="keywords" content="LOG sample files, test LOG files, download LOG samples, free LOG test files, log file samples, LOG text files, .log test files, system log files, LOG parsing test files" />
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">LOG Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free LOG sample log files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free LOG sample log files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing log parsing, log analysis, and system monitoring tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About LOG Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                LOG files are text files that contain records of events, activities, or messages generated by applications, operating systems, or services. LOG files are commonly used for debugging, monitoring, and auditing system activities.
              </p>
              <p className="text-gray-700 mb-4">
                These sample LOG files are provided for testing purposes. They can be used to test log parsing, log analysis tools, and system monitoring applications.
              </p>
            </div>
          </div>
        </div>

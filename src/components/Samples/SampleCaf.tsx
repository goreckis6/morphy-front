...
export default function SampleCaf() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-caf-100kb.caf', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-caf-1mb.caf', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-caf-5mb.caf', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-caf-50mb.caf', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-caf-100mb.caf', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "@type": "WebPage",
    "name": "Free CAF Sample Files - Download Test Core Audio Format Files",
    "url": "https://morphyimg.com/samples/sample-caf",
    "description": "Download free CAF sample Core Audio Format files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing audio conversion, playback, and CAF format processing tools.",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-caf" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-caf" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-3 mb-4 sm:mb-6">
              <div className="p-2 sm:p-3 bg-gradient-to-br from-pink-500 to-rose-500 rounded-xl">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free CAF sample Core Audio Format files for testing. Multiple file sizes available to test your audio conversion, playback, and CAF format processing tools.
            </p>
          </div>
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-3 sm:space-y-0">
                    <div className="flex items-center space-x-4 flex-1">
                      <div className="p-2 rounded-lg bg-pink-100">
                        <Music className="w-5 h-5 sm:w-6 sm:h-6 text-pink-600" />
                      </div>
                      <div>
                    ...
                    <div className="w-full sm:w-auto sm:ml-4">
                      {downloadingIndex === index ? (
                        ...
                        <button
                          ...
                          className="inline-flex items-center justify-center space-x-2 bg-pink-600 hover:bg-pink-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg text-sm sm:text-base font-medium transition-colors w-full sm:w-auto"
                        >
                          <Download className="w-4 h-4 sm:w-5 sm:h-5" />
                          <span>Download</span>
                        </button>
          ...
          <div className="mt-8 bg-pink-50 border border-pink-200 rounded-lg p-4 sm:p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-2">
              About These Sample Files
            </h3>
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test CAF (Core Audio Format) audio files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing audio conversion, playback, and CAF format processing tools</li>

...
export default function SampleDer() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-der-100kb.der', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-der-1mb.der', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-der-5mb.der', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-der-50mb.der', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-der-100mb.der', displaySize: '100 MB' }
  ];

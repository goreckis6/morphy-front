...
export default function SampleIpynb() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-ipynb-100kb.ipynb', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-ipynb-1mb.ipynb', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-ipynb-5mb.ipynb', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-ipynb-50mb.ipynb', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-ipynb-100mb.ipynb', displaySize: '100 MB' }
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">IPYNB Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free IPYNB sample Jupyter notebook files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free IPYNB sample Jupyter notebook files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing Jupyter notebook processing, IPYNB parsing, and data science development tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About IPYNB Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                IPYNB (Jupyter Notebook) is a JSON-based file format used by Jupyter Notebook for storing interactive computing sessions. IPYNB files contain code cells, markdown cells, output, and metadata, making them essential for data science and machine learning workflows.
              </p>
              <p className="text-gray-700 mb-4">
                These sample IPYNB files are provided for testing purposes. They can be used to test Jupyter notebook processing, IPYNB parsing tools, and data science development applications.
              </p>
            </div>
          </div>
        </div>

...
export default function SampleC() {
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyhub.com/samples/sample-c",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyhub.com/samples/sample-c" />
        ...
        <link rel="canonical" href="https://morphyhub.com/samples/sample-c" />
        <script

...
export default function SampleC() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-c-100kb.c', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-c-1mb.c', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-c-5mb.c', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-c-50mb.c', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-c-100mb.c', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-c",
    "description": "Download free C sample source code files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing C code compilation, syntax checking, and programming tools.",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="C sample files, test C files, download C samples, free C test files, C source code samples, C programming samples, C code samples, C conversion test files, .c test files, C language samples, programming code samples" />
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-c" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-c" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free C sample source code files for testing. Multiple file sizes available to test your C code compilation, syntax checking, and programming tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test C (C programming language) source code files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing C code compilation, syntax checking, and programming tools</li>

...
export default function SampleIcns() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-icns-100kb.icns', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-icns-1mb.icns', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-icns-5mb.icns', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-icns-50mb.icns', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-icns-100mb.icns', displaySize: '100 MB' }
  ];
  ...
  return (
    <>
      <Helmet>
        <title>Free ICNS Sample Files Download - Test macOS Icon Files | MorphyIMG</title>
        <meta name="description" content="Download free ICNS sample macOS icon files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing macOS icon conversion, ICNS viewing, and icon design tools." />
        <meta name="keywords" content="ICNS sample files, test ICNS files, download ICNS samples, free ICNS test files, macOS icon samples, ICNS icon files, .icns test files, Apple icon files, macOS icon conversion test files" />
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">ICNS Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free ICNS sample macOS icon files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free ICNS sample macOS icon files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing macOS icon conversion, ICNS viewing, and icon design tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About ICNS Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                ICNS (Icon Container) is a file format used by macOS to store icon images. ICNS files can contain multiple icon sizes and resolutions, making them suitable for displaying icons at different sizes on macOS systems.
              </p>
              <p className="text-gray-700 mb-4">
                These sample ICNS files are provided for testing purposes. They can be used to test macOS icon conversion, ICNS viewing tools, and icon design applications.
              </p>
            </div>
          </div>
        </div>

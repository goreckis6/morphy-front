...
export default function SampleAce() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-ace-100kb.ace', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-ace-1mb.ace', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-ace-5mb.ace', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-ace-50mb.ace', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-ace-100mb.ace', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-ace",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-ace" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-ace" />
        <script

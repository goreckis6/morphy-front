...
export default function SampleMax() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-max-100kb.max', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-max-1mb.max', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-max-5mb.max', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-max-50mb.max', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-max-100mb.max', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-max",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-max" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-max" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">MAX Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free MAX sample 3ds Max scene files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free MAX sample 3ds Max scene files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing 3ds Max scene conversion, MAX file parsing, and 3D modeling tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About MAX Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                MAX (3ds Max) is a 3D scene file format used by Autodesk 3ds Max. MAX files contain 3D models, animations, materials, lighting, and scene data. They are binary files that store complete 3D scenes created in 3ds Max.
              </p>
              <p className="text-gray-700 mb-4">
                These sample MAX files are provided for testing purposes. They can be used to test 3ds Max scene conversion, MAX file parsing tools, and 3D modeling applications.
              </p>
            </div>
          </div>
        </div>

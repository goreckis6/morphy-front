...
export default function SampleApng() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-apng-100kb.apng', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-apng-1mb.apng', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-apng-5mb.apng', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-apng-50mb.apng', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-apng-100mb.apng', displaySize: '100 MB' }
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free APNG sample animated PNG files for testing. Multiple file sizes available to test your animated PNG conversion, viewing, and APNG format processing tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-teal-50 border border-teal-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test APNG (Animated Portable Network Graphics) files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing animated PNG conversion, viewing, and APNG format processing tools</li>

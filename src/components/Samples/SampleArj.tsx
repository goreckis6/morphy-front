...
export default function SampleArj() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-arj-100kb.arj', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-arj-1mb.arj', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-arj-5mb.arj', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-arj-50mb.arj', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-arj-100mb.arj', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "@type": "WebPage",
    "name": "Free ARJ Sample Files - Download Test Archive Files",
    "url": "https://morphyhub.com/samples/sample-arj",
    "description": "Download free ARJ sample archive files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing archive extraction, compression, and ARJ format processing tools.",
  ...
  return (
    <>
      <Helmet>
        <title>Free ARJ Sample Files Download - Test Archive Files | MorphyHub</title>
        <meta name="description" content="Download free ARJ sample archive files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing archive extraction, compression, and ARJ format processing tools." />
        <meta name="keywords" content="ARJ sample files, test ARJ files, download ARJ samples, free ARJ test files, archive samples, ARJ compressed files, archive format samples, ARJ conversion test files, .arj test files, file compression samples, legacy archive samples" />
        <meta property="og:title" content="Free ARJ Sample Files Download - Test Archive Files | MorphyHub" />
        <meta property="og:description" content="Download free ARJ sample archive files for testing. Multiple file sizes available for testing archive extraction and compression tools." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://morphyhub.com/samples/sample-arj" />
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:title" content="Free ARJ Sample Files Download - Test Archive Files | MorphyHub" />
        <meta name="twitter:description" content="Download free ARJ sample archive files for testing. Multiple file sizes available." />
        <link rel="canonical" href="https://morphyhub.com/samples/sample-arj" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free ARJ sample archive files for testing. Multiple file sizes available to test your archive extraction, compression, and ARJ format processing tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-orange-50 border border-orange-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test ARJ (Archive) compressed files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing archive extraction, compression, and ARJ format processing tools</li>

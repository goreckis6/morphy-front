...
export default function SampleArj() {
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-arj",
  ...
  return (
    <>
      <Helmet>
        <title>Free ARJ Sample Files Download - Test Archive Files | MorphyIMG</title>
        ...
        <meta property="og:title" content="Free ARJ Sample Files Download - Test Archive Files | MorphyIMG" />
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-arj" />
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:title" content="Free ARJ Sample Files Download - Test Archive Files | MorphyIMG" />
        <meta name="twitter:description" content="Download free ARJ sample archive files for testing. Multiple file sizes available." />
        <link rel="canonical" href="https://morphyimg.com/samples/sample-arj" />
        <script

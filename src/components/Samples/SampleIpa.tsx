...
export default function SampleIpa() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-ipa-100kb.ipa', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-ipa-1mb.ipa', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-ipa-5mb.ipa', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-ipa-50mb.ipa', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-ipa-100mb.ipa', displaySize: '100 MB' }
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">IPA Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free IPA sample iOS application package files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free IPA sample iOS application package files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing iOS app installation, IPA analysis, and mobile application development tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About IPA Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                IPA (iOS App Store Package) is the application archive format used for iOS applications. IPA files contain the compiled application code, resources, and metadata needed to install and run iOS apps on Apple devices.
              </p>
              <p className="text-gray-700 mb-4">
                These sample IPA files are provided for testing purposes. They can be used to test iOS app installation, IPA analysis tools, and mobile application development applications.
              </p>
            </div>
          </div>
        </div>

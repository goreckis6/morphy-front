...
export default function SampleIges() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-iges-100kb.iges', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-iges-1mb.iges', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-iges-5mb.iges', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-iges-50mb.iges', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-iges-100mb.iges', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-iges",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-iges" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-iges" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">IGES Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free IGES sample Initial Graphics Exchange Specification files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free IGES sample Initial Graphics Exchange Specification files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing CAD software, IGES conversion, and 3D model exchange tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About IGES Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                IGES (Initial Graphics Exchange Specification) is a neutral file format used for exchanging CAD data between different CAD systems. IGES files contain 3D model geometry and can be read by most CAD software.
              </p>
              <p className="text-gray-700 mb-4">
                These sample IGES files are provided for testing purposes. They can be used to test CAD software, IGES conversion tools, and 3D model exchange applications.
              </p>
            </div>
          </div>
        </div>

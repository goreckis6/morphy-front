...
export default function SampleJava() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-java-100kb.java', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-java-1mb.java', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-java-5mb.java', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-java-50mb.java', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-java-100mb.java', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-java",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-java" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-java" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">Java Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free Java sample Java source code files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free Java sample Java source code files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing Java code compilation, Java syntax checking, and Java development tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About Java Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                Java source code files contain Java programming language source code. Java is an object-oriented programming language widely used for developing enterprise applications, Android apps, and web applications.
              </p>
              <p className="text-gray-700 mb-4">
                These sample Java files are provided for testing purposes. They can be used to test Java code compilation, Java syntax checking tools, and Java development applications.
              </p>
            </div>
          </div>
        </div>

...
import { Download, Database, Clock, CheckCircle, ArrowLeft } from 'lucide-react';
...
export default function SampleCustomerDatabaseSql() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-customer-database-sql-100kb.sql', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-customer-database-sql-1mb.sql', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-customer-database-sql-5mb.sql', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-customer-database-sql-50mb.sql', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-customer-database-sql-100mb.sql', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-customer-database-sql",
    "description": "Download free Customer Database SQL sample SQL database files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing SQL database imports, SQL parsing, and database management tools.",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-customer-database-sql" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-customer-database-sql" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-3 mb-4 sm:mb-6">
              ...
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900">
                Customer Database SQL Sample Files
              </h1>
            </div>
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free Customer Database SQL sample SQL database files for testing. Multiple file sizes available to test your SQL database imports, SQL parsing, and database management tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-amber-50 border border-amber-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test Customer Database SQL (SQL database) files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing SQL database imports, SQL parsing, and database management tools</li>

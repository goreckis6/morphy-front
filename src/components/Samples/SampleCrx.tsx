...
export default function SampleCrx() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-crx-100kb.crx', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-crx-1mb.crx', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-crx-5mb.crx', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-crx-50mb.crx', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-crx-100mb.crx', displaySize: '100 MB' }
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free CRX sample Chrome extension package files for testing. Multiple file sizes available to test your Chrome extension installation, CRX analysis, and browser extension processing tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test CRX (Chrome Extension) package files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing Chrome extension installation, CRX analysis, and browser extension processing tools</li>

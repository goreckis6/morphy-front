...
export default function SampleDmg() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-dmg-100kb.dmg', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-dmg-1mb.dmg', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-dmg-5mb.dmg', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-dmg-50mb.dmg', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-dmg-100mb.dmg', displaySize: '100 MB' }
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-dmg" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-dmg" />
        <script

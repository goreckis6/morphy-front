...
export default function SampleKml() {
  ...
  return (
    <>
      <Helmet>
        <title>Free KML Sample Files Download - Test Keyhole Markup Language Files | MorphyHub</title>
        ...
        <meta property="og:title" content="Free KML Sample Files Download - Test Keyhole Markup Language Files | MorphyHub" />
        ...
        <meta name="twitter:title" content="Free KML Sample Files Download - Test Keyhole Markup Language Files | MorphyHub" />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free KML sample Keyhole Markup Language files for testing. Multiple file sizes available to test your KML parsing and geographic data processing tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-purple-50 border border-purple-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test KML (Keyhole Markup Language) files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing KML parsing and geographic data processing tools</li>

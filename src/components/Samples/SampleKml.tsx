...
export default function SampleKml() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-kml-100kb.kml', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-kml-1mb.kml', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-kml-5mb.kml', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-kml-50mb.kml', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-kml-100mb.kml', displaySize: '100 MB' }
  ];
  ...
  return (
    <>
      <Helmet>
        <title>Free KML Sample Files Download - Test Keyhole Markup Language Files | MorphyIMG</title>
        <meta name="description" content="Download free KML sample Keyhole Markup Language files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing KML parsing, geographic data processing, and Google Earth integration tools." />
        <meta name="keywords" content="KML sample files, test KML files, download KML samples, free KML test files, Keyhole Markup Language samples, KML geographic data files, .kml test files, Google Earth files, KML parsing test files" />
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">KML Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free KML sample Keyhole Markup Language files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free KML sample Keyhole Markup Language files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing KML parsing, geographic data processing, and Google Earth integration tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About KML Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                KML (Keyhole Markup Language) is an XML-based file format used for displaying geographic data in applications like Google Earth and Google Maps. KML files contain placemarks, paths, polygons, and other geographic information.
              </p>
              <p className="text-gray-700 mb-4">
                These sample KML files are provided for testing purposes. They can be used to test KML parsing, geographic data processing tools, and Google Earth integration applications.
              </p>
            </div>
          </div>
        </div>

...
export default function SampleMkv() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-mkv-100kb.mkv', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-mkv-1mb.mkv', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-mkv-5mb.mkv', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-mkv-50mb.mkv', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-mkv-100mb.mkv', displaySize: '100 MB' }
  ];
  ...
  return (
    <>
      <Helmet>
        <title>Free MKV Sample Files Download - Test Matroska Video Files | MorphyIMG</title>
        <meta name="description" content="Download free MKV sample Matroska video files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing MKV video conversion, MKV playback, and video processing tools." />
        <meta name="keywords" content="MKV sample files, test MKV files, download MKV samples, free MKV test files, Matroska video samples, MKV movie files, .mkv test files, video container files, MKV conversion test files" />
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">MKV Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free MKV sample Matroska video files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free MKV sample Matroska video files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing MKV video conversion, MKV playback, and video processing tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About MKV Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                MKV (Matroska Video) is an open-standard multimedia container format that can hold unlimited video, audio, picture, or subtitle tracks in one file. MKV files are widely used for storing high-quality video content and are known for their flexibility and feature support.
              </p>
              <p className="text-gray-700 mb-4">
                These sample MKV files are provided for testing purposes. They can be used to test MKV video conversion, MKV playback tools, and video processing applications.
              </p>
            </div>
          </div>
        </div>

...
export default function SampleIso() {
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-iso",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-iso" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-iso" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">ISO Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free ISO sample ISO disk image files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free ISO sample ISO disk image files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing ISO disk image mounting, ISO extraction, and disk image processing tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About ISO Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                ISO (ISO 9660) is a disk image file format used to store an exact copy of a CD, DVD, or other optical disc. ISO files contain the complete file system and data from the original disc, making them suitable for creating backups and distributing software.
              </p>
              <p className="text-gray-700 mb-4">
                These sample ISO files are provided for testing purposes. They can be used to test ISO disk image mounting, ISO extraction tools, and disk image processing applications.
              </p>
            </div>
          </div>
        </div>

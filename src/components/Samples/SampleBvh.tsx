...
export default function SampleBvh() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-bvh-100kb.bvh', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-bvh-1mb.bvh', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-bvh-5mb.bvh', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-bvh-50mb.bvh', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-bvh-100mb.bvh', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "@type": "WebPage",
    "name": "Free BVH Sample Files - Download Test Motion Capture Files",
    "url": "https://morphyimg.com/samples/sample-bvh",
    "description": "Download free BVH sample motion capture files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing motion capture processing, animation conversion, and BVH format tools.",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-bvh" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-bvh" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free BVH sample motion capture files for testing. Multiple file sizes available to test your motion capture processing, animation conversion, and BVH format tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-purple-50 border border-purple-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test BVH (Biovision Hierarchy) motion capture files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing motion capture processing, animation conversion, and BVH format tools</li>

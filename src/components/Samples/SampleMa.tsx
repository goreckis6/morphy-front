...
export default function SampleMa() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-ma-100kb.ma', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-ma-1mb.ma', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-ma-5mb.ma', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-ma-50mb.ma', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-ma-100mb.ma', displaySize: '100 MB' }
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">MA Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free MA sample Maya ASCII scene files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free MA sample Maya ASCII scene files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing Maya scene conversion, MA file parsing, and 3D animation tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About MA Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                MA (Maya ASCII) is a 3D scene file format used by Autodesk Maya. MA files contain 3D models, animations, materials, and scene data in human-readable ASCII text format, making them easier to edit and debug than binary formats.
              </p>
              <p className="text-gray-700 mb-4">
                These sample MA files are provided for testing purposes. They can be used to test Maya scene conversion, MA file parsing tools, and 3D animation applications.
              </p>
            </div>
          </div>
        </div>

...
export default function SampleMobi() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-mobi-100kb.mobi', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-mobi-1mb.mobi', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-mobi-5mb.mobi', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-mobi-50mb.mobi', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-mobi-100mb.mobi', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-mobi",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-mobi" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-mobi" />
        <script

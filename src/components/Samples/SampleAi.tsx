...
export default function SampleAi() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-ai-100kb.ai', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-ai-1mb.ai', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-ai-5mb.ai', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-ai-50mb.ai', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-ai-100mb.ai', displaySize: '100 MB' }
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free AI sample Adobe Illustrator vector graphics files for testing. Multiple file sizes available to test your vector graphics conversion, viewing, and Adobe Illustrator format processing tools.
            </p>
          </div>
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-3 sm:space-y-0">
                    <div className="flex items-center space-x-4 flex-1">
                      <div className="p-2 rounded-lg bg-pink-100">
                        <Image className="w-5 h-5 sm:w-6 sm:h-6 text-pink-600" />
                      </div>
                      <div>
          ...
          <div className="mt-8 bg-pink-50 border border-pink-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test AI (Adobe Illustrator) vector graphics files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing vector graphics conversion, viewing, and Adobe Illustrator format processing tools</li>

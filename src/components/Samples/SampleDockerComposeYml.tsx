...
export default function SampleDockerComposeYml() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-docker-compose-yml-100kb.yml', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-docker-compose-yml-1mb.yml', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-docker-compose-yml-5mb.yml', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-docker-compose-yml-50mb.yml', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-docker-compose-yml-100mb.yml', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyhub.com/samples/sample-docker-compose-yml",
          ...
          <div className="text-center mb-8 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-3 mb-4 sm:mb-6">
              ...
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900">
                Docker Compose YML Sample Files
              </h1>
            </div>

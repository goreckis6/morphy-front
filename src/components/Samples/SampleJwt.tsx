...
export default function SampleJwt() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-jwt-100kb.jwt', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-jwt-1mb.jwt', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-jwt-5mb.jwt', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-jwt-50mb.jwt', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-jwt-100mb.jwt', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-jwt",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-jwt" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-jwt" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">JWT Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free JWT sample JSON Web Token files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free JWT sample JSON Web Token files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing JWT token parsing, authentication, and API security tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About JWT Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                JWT (JSON Web Token) is a compact, URL-safe token format used for securely transmitting information between parties. JWTs are commonly used for authentication and authorization in web applications and APIs.
              </p>
              <p className="text-gray-700 mb-4">
                These sample JWT files are provided for testing purposes. They can be used to test JWT token parsing, authentication tools, and API security applications.
              </p>
            </div>
          </div>
        </div>

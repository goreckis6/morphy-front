...
export default function SampleDav() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-dav-100kb.dav', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-dav-1mb.dav', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-dav-5mb.dav', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-dav-50mb.dav', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-dav-100mb.dav', displaySize: '100 MB' }
  ];

...
export default function SampleM4a() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-m4a-100kb.m4a', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-m4a-1mb.m4a', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-m4a-5mb.m4a', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-m4a-50mb.m4a', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-m4a-100mb.m4a', displaySize: '100 MB' }
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">M4A Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free M4A sample M4A audio files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free M4A sample M4A audio files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing M4A audio conversion, M4A playback, and audio processing tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About M4A Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                M4A (MPEG-4 Audio) is an audio file format that uses AAC (Advanced Audio Coding) compression. M4A files are commonly used by Apple devices and iTunes, providing high-quality audio with smaller file sizes compared to MP3.
              </p>
              <p className="text-gray-700 mb-4">
                These sample M4A files are provided for testing purposes. They can be used to test M4A audio conversion, M4A playback tools, and audio processing applications.
              </p>
            </div>
          </div>
        </div>

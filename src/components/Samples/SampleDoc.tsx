...
export default function SampleDoc() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-course-outline-doc-100kb.doc', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-course-outline-doc-1mb.doc', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-course-outline-doc-5mb.doc', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-course-outline-doc-50mb.doc', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-course-outline-doc-100mb.doc', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-doc",
  ...
  return (
    <>
      <Helmet>
        <title>Free DOC Sample Files Download - Test Files | MorphyIMG</title>
        <meta name="description" content="Download free DOC sample files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing document conversion and processing tools." />
        <meta name="keywords" content="DOC sample files, test DOC files, download DOC samples, free DOC test files, document samples, Microsoft Word DOC samples" />
        <meta property="og:title" content="Free DOC Sample Files Download - Test Files | MorphyIMG" />
        <meta property="og:description" content="Download free DOC sample files for testing. Multiple file sizes available for testing document conversion tools." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://morphyimg.com/samples/sample-doc" />
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:title" content="Free DOC Sample Files Download - Test Files | MorphyIMG" />
        <meta name="twitter:description" content="Download free DOC sample files for testing. Multiple file sizes available." />
        <link rel="canonical" href="https://morphyimg.com/samples/sample-doc" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="text-center mb-8 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-3 mb-4 sm:mb-6">
              <div className="p-2 sm:p-3 bg-gradient-to-br from-green-500 to-teal-500 rounded-xl">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free DOC sample files for testing. Multiple file sizes available to test your document conversion and processing tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test DOC files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing document conversion tools and file processors</li>

...
export default function SampleImg() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-img-100kb.img', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-img-1mb.img', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-img-5mb.img', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-img-50mb.img', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-img-100mb.img', displaySize: '100 MB' }
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">IMG Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free IMG sample disk image files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free IMG sample disk image files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing disk image mounting, IMG extraction, and disk image processing tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About IMG Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                IMG (Disk Image) is a file format used to store a complete copy of a disk or disk partition. IMG files are commonly used for creating backups, distributing software, and mounting disk images on various operating systems.
              </p>
              <p className="text-gray-700 mb-4">
                These sample IMG files are provided for testing purposes. They can be used to test disk image mounting, IMG extraction tools, and disk image processing applications.
              </p>
            </div>
          </div>
        </div>

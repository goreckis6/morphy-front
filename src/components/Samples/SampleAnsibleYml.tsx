...
export default function SampleAnsibleYml() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-ansible-yml-100kb.yml', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-ansible-yml-1mb.yml', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-ansible-yml-5mb.yml', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-ansible-yml-50mb.yml', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-ansible-yml-100mb.yml', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-ansible-yml",
  ...
  return (
    <>
      <Helmet>
        <title>Free Ansible YML Sample Files Download - Test Configuration Files | MorphyIMG</title>
        <meta name="description" content="Download free Ansible YML sample configuration files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing YAML parsing, configuration management, and Ansible automation tools." />
        <meta name="keywords" content="Ansible YML sample files, test YML files, download YML samples, free YML test files, YAML samples, Ansible configuration samples, automation file samples, YML conversion test files, .yml test files, configuration management samples, DevOps samples" />
        <meta property="og:title" content="Free Ansible YML Sample Files Download - Test Configuration Files | MorphyIMG" />
        <meta property="og:description" content="Download free Ansible YML sample configuration files for testing. Multiple file sizes available for testing YAML parsing and configuration management tools." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://morphyimg.com/samples/sample-ansible-yml" />
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:title" content="Free Ansible YML Sample Files Download - Test Configuration Files | MorphyIMG" />
        <meta name="twitter:description" content="Download free Ansible YML sample configuration files for testing. Multiple file sizes available." />
        <link rel="canonical" href="https://morphyimg.com/samples/sample-ansible-yml" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-3 mb-4 sm:mb-6">
              <div className="p-2 sm:p-3 bg-gradient-to-br from-red-500 to-orange-500 rounded-xl">
                <Code className="w-6 h-6 sm:w-8 sm:h-8 text-white" />
              </div>
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900">
                Ansible YML Sample Files
              </h1>
            </div>
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free Ansible YML sample configuration files for testing. Multiple file sizes available to test your YAML parsing, configuration management, and Ansible automation tools.
            </p>
          </div>
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-3 sm:space-y-0">
                    <div className="flex items-center space-x-4 flex-1">
                      <div className="p-2 rounded-lg bg-red-100">
                        <Code className="w-5 h-5 sm:w-6 sm:h-6 text-red-600" />
                      </div>
                      <div>
          ...
          <div className="mt-8 bg-red-50 border border-red-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test Ansible YML (YAML) configuration files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing YAML parsing, configuration management, and Ansible automation tools</li>

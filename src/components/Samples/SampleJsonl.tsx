...
export default function SampleJsonl() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-jsonl-100kb.jsonl', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-jsonl-1mb.jsonl', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-jsonl-5mb.jsonl', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-jsonl-50mb.jsonl', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-jsonl-100mb.jsonl', displaySize: '100 MB' }
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">JSONL Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free JSONL sample JSON Lines files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free JSONL sample JSON Lines files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing JSONL parsing, data streaming, and big data processing tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About JSONL Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                JSONL (JSON Lines) is a text format where each line is a valid JSON object. JSONL files are commonly used for streaming data, logging, and processing large datasets, as they can be read line-by-line without loading the entire file into memory.
              </p>
              <p className="text-gray-700 mb-4">
                These sample JSONL files are provided for testing purposes. They can be used to test JSONL parsing, data streaming tools, and big data processing applications.
              </p>
            </div>
          </div>
        </div>

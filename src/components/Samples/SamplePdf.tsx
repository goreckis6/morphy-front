...
export default function SamplePdf() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-pdf-100kb.pdf', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-pdf-1mb.pdf', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-pdf-5mb.pdf', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-pdf-50mb.pdf', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-pdf-100mb.pdf', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-pdf",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-pdf" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-pdf" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free PDF sample files for testing. Multiple file sizes available to test your document conversion and processing tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test PDF files in various sizes for testing purposes</li>

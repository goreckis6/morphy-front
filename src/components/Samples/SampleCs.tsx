...
export default function SampleCs() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-cs-100kb.cs', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-cs-1mb.cs', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-cs-5mb.cs', displaySize: '5 MB' },
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-cs",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-cs" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-cs" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free C# sample source code files for testing. Multiple file sizes available to test your C# code compilation, syntax checking, and .NET programming tools.
            </p>
          </div>

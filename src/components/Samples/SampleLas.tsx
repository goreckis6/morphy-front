...
export default function SampleLas() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-las-100kb.las', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-las-1mb.las', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-las-5mb.las', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-las-50mb.las', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-las-100mb.las', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "@type": "WebPage",
    "name": "Free LAS Sample Files - Download Test LiDAR Point Cloud Data Files",
    "url": "https://morphyimg.com/samples/sample-las",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-las" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-las" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">LAS Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free LAS sample LiDAR point cloud data files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free LAS sample LiDAR point cloud data files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing LAS parsing, point cloud processing, and 3D mapping tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About LAS Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                LAS (LiDAR Aerial Survey) is a binary file format used for storing LiDAR point cloud data. LAS files contain 3D coordinate data, intensity values, and other attributes collected by LiDAR sensors for mapping and surveying applications.
              </p>
              <p className="text-gray-700 mb-4">
                These sample LAS files are provided for testing purposes. They can be used to test LAS parsing, point cloud processing tools, and 3D mapping applications.
              </p>
            </div>
          </div>
        </div>

...
export default function SampleAsc() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-asc-100kb.asc', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-asc-1mb.asc', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-asc-5mb.asc', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-asc-50mb.asc', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-asc-100mb.asc', displaySize: '100 MB' }
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-3 mb-4 sm:mb-6">
              <div className="p-2 sm:p-3 bg-gradient-to-br from-gray-500 to-slate-500 rounded-xl">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free ASC sample ASCII text files for testing. Multiple file sizes available to test your text file processing, ASCII encoding, and plain text format tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-gray-50 border border-gray-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test ASC (ASCII text) files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing text file processing, ASCII encoding, and plain text format tools</li>

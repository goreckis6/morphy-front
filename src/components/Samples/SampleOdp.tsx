...
export default function SampleOdp() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-odp-100kb.odp', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-odp-1mb.odp', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-odp-5mb.odp', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-odp-50mb.odp', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-odp-100mb.odp', displaySize: '100 MB' }
  ];
  ...
  return (
    <>
      <Helmet>
        <title>Free ODP Sample Files Download - Test OpenDocument Presentation Files | MorphyHub</title>
        <meta name="description" content="Download free ODP sample OpenDocument presentation files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing presentation conversion, viewing, and OpenDocument format processing tools." />
        <meta name="keywords" content="ODP sample files, test ODP files, download ODP samples, free ODP test files, OpenDocument presentation samples, presentation file samples, ODP conversion test files, .odp test files, LibreOffice Impress samples, presentation format samples" />
        <meta property="og:title" content="Free ODP Sample Files Download - Test OpenDocument Presentation Files | MorphyHub" />
        ...
        <meta name="twitter:title" content="Free ODP Sample Files Download - Test OpenDocument Presentation Files | MorphyHub" />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free ODP sample OpenDocument presentation files for testing. Multiple file sizes available to test your presentation conversion, viewing, and OpenDocument format processing tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-green-50 border border-green-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test ODP (OpenDocument Presentation) files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing presentation conversion, viewing, and OpenDocument format processing tools</li>

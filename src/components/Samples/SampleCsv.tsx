...
export default function SampleCsv() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-csv-100kb.csv', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-csv-1mb.csv', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-csv-5mb.csv', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-csv-50mb.csv', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-csv-100mb.csv', displaySize: '100 MB' }
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free CSV sample data files for testing. Multiple file sizes available to test your CSV conversion, data processing, and spreadsheet import tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-purple-50 border border-purple-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test CSV (Comma-Separated Values) data files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing CSV conversion, data processing, and spreadsheet import tools</li>

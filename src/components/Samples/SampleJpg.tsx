...
export default function SampleJpg() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-jpg-100kb.jpg', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-jpg-1mb.jpg', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-jpg-5mb.jpg', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-jpg-50mb.jpg', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-jpg-100mb.jpg', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-jpg",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-jpg" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-jpg" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">JPG Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free JPG sample JPG image files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free JPG sample JPG image files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing JPG image conversion, JPG compression, and image processing tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About JPG Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                JPG (Joint Photographic Experts Group) is a widely used image compression format. JPG files use lossy compression to reduce file size while maintaining good image quality, making them ideal for photographs and complex images.
              </p>
              <p className="text-gray-700 mb-4">
                These sample JPG files are provided for testing purposes. They can be used to test JPG image conversion, JPG compression tools, and image processing applications.
              </p>
            </div>
          </div>
        </div>

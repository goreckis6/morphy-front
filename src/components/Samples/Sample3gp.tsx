...
import { Download, Video, Clock, CheckCircle, ArrowLeft } from 'lucide-react';
...
export default function Sample3gp() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-3gp-100kb.3gp', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-3gp-1mb.3gp', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-3gp-5mb.3gp', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-3gp-50mb.3gp', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-3gp-100mb.3gp', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "@type": "WebPage",
    "name": "Free 3GP Sample Files - Download Test Video Files",
    "url": "https://morphyimg.com/samples/sample-3gp",
    "description": "Download free 3GP sample video files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing video conversion, playback, and mobile video format processing tools.",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-3gp" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-3gp" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free 3GP sample mobile video files for testing. Multiple file sizes available to test your video conversion, playback, and mobile video format processing tools.
            </p>
          </div>
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-3 sm:space-y-0">
                    <div className="flex items-center space-x-4 flex-1">
                      <div className="p-2 rounded-lg bg-cyan-100">
                        <Video className="w-5 h-5 sm:w-6 sm:h-6 text-cyan-600" />
                      </div>
                      <div>
          ...
          <div className="mt-8 bg-cyan-50 border border-cyan-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test 3GP (3GPP) mobile video files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing video conversion, playback, and mobile video format processing tools</li>

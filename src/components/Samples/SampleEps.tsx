...
export default function SampleEps() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-eps-100kb.eps', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-eps-1mb.eps', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-eps-5mb.eps', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-eps-50mb.eps', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-eps-100mb.eps', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-eps",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-eps" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-eps" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">EPS Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free EPS sample Encapsulated PostScript files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free EPS sample Encapsulated PostScript files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing vector graphics conversion, EPS viewing, and PostScript processing tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About EPS Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                EPS (Encapsulated PostScript) is a vector graphics file format that is used to describe images or drawings. EPS files can contain both vector and bitmap graphics, and are commonly used in professional printing and design.
              </p>
              <p className="text-gray-700 mb-4">
                These sample EPS files are provided for testing purposes. They can be used to test vector graphics conversion, EPS viewing tools, and PostScript processing applications.
              </p>
            </div>
          </div>
        </div>

...
export default function SampleBz2() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-bz2-100kb.bz2', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-bz2-1mb.bz2', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-bz2-5mb.bz2', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-bz2-50mb.bz2', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-bz2-100mb.bz2', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-bz2",
    "description": "Download free BZ2 sample bzip2 compressed archive files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing archive decompression, compression, and BZ2 format processing tools.",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-bz2" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-bz2" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free BZ2 sample bzip2 compressed archive files for testing. Multiple file sizes available to test your archive decompression, compression, and BZ2 format processing tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-slate-50 border border-slate-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test BZ2 (bzip2) compressed archive files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing archive decompression, compression, and BZ2 format processing tools</li>

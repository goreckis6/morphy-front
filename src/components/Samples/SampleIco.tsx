...
export default function SampleIco() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-ico-100kb.ico', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-ico-1mb.ico', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-ico-5mb.ico', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-ico-50mb.ico', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-ico-100mb.ico', displaySize: '100 MB' }
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">ICO Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free ICO sample Windows icon files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free ICO sample Windows icon files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing Windows icon conversion, ICO viewing, and icon design tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About ICO Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                ICO (Icon) is a file format used by Microsoft Windows to store icon images. ICO files can contain multiple icon sizes and color depths, making them suitable for displaying icons at different sizes on Windows systems.
              </p>
              <p className="text-gray-700 mb-4">
                These sample ICO files are provided for testing purposes. They can be used to test Windows icon conversion, ICO viewing tools, and icon design applications.
              </p>
            </div>
          </div>
        </div>

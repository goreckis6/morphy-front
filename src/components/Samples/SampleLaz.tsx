...
export default function SampleLaz() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-laz-100kb.laz', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-laz-1mb.laz', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-laz-5mb.laz', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-laz-50mb.laz', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-laz-100mb.laz', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "@type": "WebPage",
    "name": "Free LAZ Sample Files - Download Test Compressed LiDAR Point Cloud Data Files",
    "url": "https://morphyimg.com/samples/sample-laz",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-laz" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-laz" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">LAZ Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free LAZ sample compressed LiDAR point cloud data files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free LAZ sample compressed LiDAR point cloud data files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing LAZ extraction, point cloud processing, and 3D mapping tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About LAZ Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                LAZ (LiDAR Aerial Survey Zipped) is a compressed archive format for LAS files. LAZ files use lossless compression to reduce file size while maintaining all LiDAR point cloud data, making them more efficient for storage and transfer.
              </p>
              <p className="text-gray-700 mb-4">
                These sample LAZ files are provided for testing purposes. They can be used to test LAZ extraction, point cloud processing tools, and 3D mapping applications.
              </p>
            </div>
          </div>
        </div>

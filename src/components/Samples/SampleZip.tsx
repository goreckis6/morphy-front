...
export default function SampleZip() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-zip-100kb.zip', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-zip-1mb.zip', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-zip-5mb.zip', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-zip-50mb.zip', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-zip-100mb.zip', displaySize: '100 MB' }
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free ZIP sample archive files for testing. Multiple file sizes available to test your archive extraction, compression, and file archiving tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-orange-50 border border-orange-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test ZIP archive files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing archive extraction, compression, and file archiving tools</li>

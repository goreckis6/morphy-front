...
export default function SampleOds() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-ods-100kb.ods', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-ods-1mb.ods', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-ods-5mb.ods', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-ods-50mb.ods', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-ods-100mb.ods', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-ods",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-ods" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-ods" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free ODS sample OpenDocument spreadsheet files for testing. Multiple file sizes available to test your spreadsheet conversion, data processing, and OpenDocument format tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-emerald-50 border border-emerald-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test ODS (OpenDocument Spreadsheet) files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing spreadsheet conversion, data processing, and OpenDocument format tools</li>

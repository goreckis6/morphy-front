...
export default function SampleMakefile() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-makefile-100kb.makefile', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-makefile-1mb.makefile', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-makefile-5mb.makefile', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-makefile-50mb.makefile', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-makefile-100mb.makefile', displaySize: '100 MB' }
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">Makefile Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free Makefile sample build configuration files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free Makefile sample build configuration files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing Makefile parsing, build system automation, and software compilation tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About Makefile Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                Makefile is a build automation tool configuration file used by the make utility. Makefiles define rules for building software projects, specifying dependencies and commands needed to compile source code into executable programs.
              </p>
              <p className="text-gray-700 mb-4">
                These sample Makefile files are provided for testing purposes. They can be used to test Makefile parsing, build system automation tools, and software compilation applications.
              </p>
            </div>
          </div>
        </div>

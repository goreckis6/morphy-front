...
export default function SampleKt() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-kt-100kb.kt', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-kt-1mb.kt', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-kt-5mb.kt', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-kt-50mb.kt', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-kt-100mb.kt', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "@type": "WebPage",
    "name": "Free KT Sample Files - Download Test Kotlin Code Files",
    "url": "https://morphyimg.com/samples/sample-kt",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-kt" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-kt" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">KT Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free KT sample Kotlin code files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free KT sample Kotlin code files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing Kotlin compilation, KT syntax checking, and Android development tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About KT Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                KT (Kotlin) is a modern programming language developed by JetBrains. Kotlin is widely used for Android development, server-side development, and multiplatform applications. KT files contain Kotlin source code.
              </p>
              <p className="text-gray-700 mb-4">
                These sample KT files are provided for testing purposes. They can be used to test Kotlin compilation, KT syntax checking tools, and Android development applications.
              </p>
            </div>
          </div>
        </div>

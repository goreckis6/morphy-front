...
export default function SampleDockerfile() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-dockerfile-100kb.dockerfile', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-dockerfile-1mb.dockerfile', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-dockerfile-5mb.dockerfile', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-dockerfile-50mb.dockerfile', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-dockerfile-100mb.dockerfile', displaySize: '100 MB' }
  ];

  const formatKey = 'dockerfile';

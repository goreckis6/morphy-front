...
export default function SampleBlend() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-blend-100kb.blend', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-blend-1mb.blend', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-blend-5mb.blend', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-blend-50mb.blend', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-blend-100mb.blend', displaySize: '100 MB' }
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free BLEND sample Blender 3D model files for testing. Multiple file sizes available to test your 3D model conversion, viewing, and Blender format processing tools.
            </p>
          </div>
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-3 sm:space-y-0">
                    <div className="flex items-center space-x-4 flex-1">
                      <div className="p-2 rounded-lg bg-orange-100">
                        <Box className="w-5 h-5 sm:w-6 sm:h-6 text-orange-600" />
                      </div>
                      <div>
          ...
          <div className="mt-8 bg-orange-50 border border-orange-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test BLEND (Blender 3D) files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing 3D model conversion, viewing, and Blender format processing tools</li>

...
export default function SampleAnimationFbx() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-animation-fbx-100kb.fbx', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-animation-fbx-1mb.fbx', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-animation-fbx-5mb.fbx', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-animation-fbx-50mb.fbx', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-animation-fbx-100mb.fbx', displaySize: '100 MB' }
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-3 mb-4 sm:mb-6">
              ...
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900">
                Animation FBX Sample Files
              </h1>
            </div>
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free animation FBX sample 3D animation files for testing. Multiple file sizes available to test your 3D animation conversion, viewing, and FBX format processing tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-amber-50 border border-amber-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test FBX (Filmbox) 3D animation files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing 3D animation conversion, viewing, and FBX format processing tools</li>

...
export default function SampleMbtiles() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-mbtiles-100kb.mbtiles', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-mbtiles-1mb.mbtiles', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-mbtiles-5mb.mbtiles', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-mbtiles-50mb.mbtiles', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-mbtiles-100mb.mbtiles', displaySize: '100 MB' }
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">MBTiles Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free MBTiles sample map database files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free MBTiles sample map database files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing MBTiles parsing, map tile extraction, and geographic data processing tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About MBTiles Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                MBTiles is a file format for storing map tiles in a SQLite database. MBTiles files contain pre-rendered map tiles organized in a database structure, making them efficient for offline map storage and mobile mapping applications.
              </p>
              <p className="text-gray-700 mb-4">
                These sample MBTiles files are provided for testing purposes. They can be used to test MBTiles parsing, map tile extraction tools, and geographic data processing applications.
              </p>
            </div>
          </div>
        </div>

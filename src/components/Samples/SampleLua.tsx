...
export default function SampleLua() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-lua-100kb.lua', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-lua-1mb.lua', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-lua-5mb.lua', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-lua-50mb.lua', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-lua-100mb.lua', displaySize: '100 MB' }
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">LUA Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free LUA sample Lua script files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free LUA sample Lua script files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing Lua script execution, LUA syntax checking, and embedded scripting tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About LUA Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                Lua is a lightweight, high-level programming language designed for embedded systems and scripting. LUA files contain Lua source code and are commonly used in game development, web applications, and embedded systems for scripting functionality.
              </p>
              <p className="text-gray-700 mb-4">
                These sample LUA files are provided for testing purposes. They can be used to test Lua script execution, LUA syntax checking tools, and embedded scripting applications.
              </p>
            </div>
          </div>
        </div>

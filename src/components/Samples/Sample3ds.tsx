...
export default function Sample3ds() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-3ds-100kb.3ds', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-3ds-1mb.3ds', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-3ds-5mb.3ds', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-3ds-50mb.3ds', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-3ds-100mb.3ds', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "@type": "WebPage",
    "name": "Free 3DS Sample Files - Download Test 3D Model Files",
    "url": "https://morphyimg.com/samples/sample-3ds",
    "description": "Download free 3DS sample 3D model files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing 3D model conversion, viewing, and 3DS format processing tools.",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-3ds" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-3ds" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free 3DS sample 3D model files for testing. Multiple file sizes available to test your 3D model conversion, viewing, and 3DS format processing tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-amber-50 border border-amber-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test 3DS (3D Studio) 3D model files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing 3D model conversion, viewing, and 3DS format processing tools</li>

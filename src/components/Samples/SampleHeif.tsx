...
export default function SampleHeif() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-heif-100kb.heif', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-heif-1mb.heif', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-heif-5mb.heif', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-heif-50mb.heif', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-heif-100mb.heif', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-heif",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-heif" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-heif" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free HEIF sample High Efficiency Image Format files for testing. Multiple file sizes available to test your HEIF image conversion and viewing tools.
            </p>
          </div>
                    ...
                    <div className="w-full sm:w-auto sm:ml-4">
                      {downloadingIndex === index ? (
                        ...
                        <button
                          ...
                          className="inline-flex items-center justify-center space-x-2 bg-indigo-600 hover:bg-indigo-700 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg text-sm sm:text-base font-medium transition-colors w-full sm:w-auto shadow-lg"
                        >
          ...
          <div className="mt-8 bg-indigo-50 border border-indigo-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test HEIF (High Efficiency Image Format) image files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing HEIF image conversion, viewing, and processing tools</li>

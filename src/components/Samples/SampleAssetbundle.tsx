...
export default function SampleAssetbundle() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-assetbundle-100kb.assetbundle', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-assetbundle-1mb.assetbundle', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-assetbundle-5mb.assetbundle', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-assetbundle-50mb.assetbundle', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-assetbundle-100mb.assetbundle', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "@type": "WebPage",
    "name": "Free AssetBundle Sample Files - Download Test Unity Game Asset Files",
    "url": "https://morphyimg.com/samples/sample-assetbundle",
    "description": "Download free AssetBundle sample Unity game asset files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing Unity asset loading, game development, and AssetBundle processing tools.",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-assetbundle" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-assetbundle" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-3 mb-4 sm:mb-6">
              ...
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900">
                AssetBundle Sample Files
              </h1>
            </div>
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free AssetBundle sample Unity game asset files for testing. Multiple file sizes available to test your Unity asset loading, game development, and AssetBundle processing tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test AssetBundle (Unity game asset) files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing Unity asset loading, game development, and AssetBundle processing tools</li>

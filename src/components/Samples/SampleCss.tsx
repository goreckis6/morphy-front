...
export default function SampleCss() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-css-100kb.css', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-css-1mb.css', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-css-5mb.css', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-css-50mb.css', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-css-100mb.css', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-css",
    "description": "Download free CSS sample Cascading Style Sheets files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing CSS parsing, styling, and web design tools.",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-css" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-css" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free CSS sample Cascading Style Sheets files for testing. Multiple file sizes available to test your CSS parsing, styling, and web design tools.
            </p>
          </div>
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-3 sm:space-y-0">
                    <div className="flex items-center space-x-4 flex-1">
                      <div className="p-2 rounded-lg bg-cyan-100">
                        <Code className="w-5 h-5 sm:w-6 sm:h-6 text-cyan-600" />
                      </div>
                      <div>
          ...
          <div className="mt-8 bg-cyan-50 border border-cyan-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test CSS (Cascading Style Sheets) files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing CSS parsing, styling, and web design tools</li>

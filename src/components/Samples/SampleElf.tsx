...
export default function SampleElf() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-elf-100kb.elf', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-elf-1mb.elf', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-elf-5mb.elf', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-elf-50mb.elf', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-elf-100mb.elf', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-elf",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-elf" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-elf" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">ELF Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free ELF sample Executable and Linkable Format files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free ELF sample Executable and Linkable Format files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing ELF file analysis, binary parsing, and executable file processing tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About ELF Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                ELF (Executable and Linkable Format) is a common standard file format for executables, object code, shared libraries, and core dumps. It is used on Unix-like systems including Linux and FreeBSD.
              </p>
              <p className="text-gray-700 mb-4">
                These sample ELF files are provided for testing purposes. They can be used to test ELF file analysis, binary parsing tools, and executable file processing applications.
              </p>
            </div>
          </div>
        </div>

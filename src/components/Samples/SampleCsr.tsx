...
export default function SampleCsr() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-csr-100kb.csr', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-csr-1mb.csr', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-csr-5mb.csr', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-csr-50mb.csr', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-csr-100mb.csr', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-csr",
    "description": "Download free CSR sample Certificate Signing Request files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing SSL certificate generation, CSR parsing, and security certificate processing tools.",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-csr" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-csr" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free CSR sample Certificate Signing Request files for testing. Multiple file sizes available to test your SSL certificate generation, CSR parsing, and security certificate processing tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-emerald-50 border border-emerald-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test CSR (Certificate Signing Request) files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing SSL certificate generation, CSR parsing, and security certificate processing tools</li>

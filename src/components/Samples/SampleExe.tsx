...
export default function SampleExe() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-exe-100kb.exe', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-exe-1mb.exe', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-exe-5mb.exe', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-exe-50mb.exe', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-exe-100mb.exe', displaySize: '100 MB' }
  ];
  ...
  return (
    <>
      <Helmet>
        <title>Free EXE Sample Files Download - Test Windows Executable Files | MorphyIMG</title>
        <meta name="description" content="Download free EXE sample Windows executable files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing Windows executable analysis, binary parsing, and application installation tools." />
        <meta name="keywords" content="EXE sample files, test EXE files, download EXE samples, free EXE test files, Windows executable samples, binary executable files, EXE binary files, .exe test files, Windows application samples, EXE parsing test files" />
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">EXE Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free EXE sample Windows executable files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free EXE sample Windows executable files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing Windows executable analysis, binary parsing, and application installation tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About EXE Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                EXE (Executable) is a file format used for Windows executable files. EXE files contain machine code that can be executed directly by the Windows operating system. They are commonly used for installing and running Windows applications.
              </p>
              <p className="text-gray-700 mb-4">
                These sample EXE files are provided for testing purposes. They can be used to test Windows executable analysis, binary parsing tools, and application installation applications.
              </p>
            </div>
          </div>
        </div>

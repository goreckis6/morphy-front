...
export default function SampleBat() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-bat-100kb.bat', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-bat-1mb.bat', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-bat-5mb.bat', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-bat-50mb.bat', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-bat-100mb.bat', displaySize: '100 MB' }
  ];
  ...
  return (
    <>
      <Helmet>
        <title>Free BAT Sample Files Download - Test Batch Script Files | MorphyHub</title>
        <meta name="description" content="Download free BAT sample batch script files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing batch script execution, Windows automation, and command-line processing tools." />
        <meta name="keywords" content="BAT sample files, test BAT files, download BAT samples, free BAT test files, batch script samples, Windows batch files, automation script samples, BAT conversion test files, .bat test files, command-line script samples, Windows automation samples" />
        <meta property="og:title" content="Free BAT Sample Files Download - Test Batch Script Files | MorphyHub" />
        ...
        <meta name="twitter:title" content="Free BAT Sample Files Download - Test Batch Script Files | MorphyHub" />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free BAT sample batch script files for testing. Multiple file sizes available to test your batch script execution, Windows automation, and command-line processing tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-purple-50 border border-purple-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test BAT (Batch) script files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing batch script execution, Windows automation, and command-line processing tools</li>

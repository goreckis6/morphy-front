...
export default function SampleAnimatedGif() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-animated-gif-100kb.gif', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-animated-gif-1mb.gif', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-animated-gif-5mb.gif', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-animated-gif-50mb.gif', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-animated-gif-100mb.gif', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-animated-gif",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-animated-gif" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-animated-gif" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-3 mb-4 sm:mb-6">
              ...
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900">
                Animated GIF Sample Files
              </h1>
            </div>
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free animated GIF sample files for testing. Multiple file sizes available to test your GIF animation conversion, viewing, and animation format processing tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-cyan-50 border border-cyan-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test animated GIF (Graphics Interchange Format) files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing GIF animation conversion, viewing, and animation format processing tools</li>

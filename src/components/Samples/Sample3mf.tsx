...
export default function Sample3mf() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-3mf-100kb.3mf', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-3mf-1mb.3mf', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-3mf-5mb.3mf', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-3mf-50mb.3mf', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-3mf-100mb.3mf', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-3mf",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-3mf" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-3mf" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free 3MF sample 3D printing files for testing. Multiple file sizes available to test your 3D printing conversion, viewing, and 3MF format processing tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-violet-50 border border-violet-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test 3MF (3D Manufacturing Format) 3D printing files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing 3D printing conversion, viewing, and 3MF format processing tools</li>

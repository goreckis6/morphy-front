...
export default function SampleH() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-h-100kb.h', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-h-1mb.h', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-h-5mb.h', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-h-50mb.h', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-h-100mb.h', displaySize: '100 MB' }
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free H sample C/C++ header files for testing. Multiple file sizes available to test your C/C++ code compilation and header file processing tools.
            </p>
          </div>
                    ...
                    <div className="w-full sm:w-auto sm:ml-4">
                      {downloadingIndex === index ? (
                        ...
                        <button
                          ...
                          className="inline-flex items-center justify-center space-x-2 bg-blue-600 hover:bg-blue-700 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg text-sm sm:text-base font-medium transition-colors w-full sm:w-auto shadow-lg"
                        >
          ...
          <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test H (C/C++ header) files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing C/C++ code compilation, header file processing, and development tools</li>

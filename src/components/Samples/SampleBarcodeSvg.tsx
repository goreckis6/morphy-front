...
export default function SampleBarcodeSvg() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-barcode-svg-100kb.svg', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-barcode-svg-1mb.svg', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-barcode-svg-5mb.svg', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-barcode-svg-50mb.svg', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-barcode-svg-100mb.svg', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "@type": "WebPage",
    "name": "Free Barcode SVG Sample Files - Download Test Barcode Image Files",
    "url": "https://morphyimg.com/samples/sample-barcode-svg",
    "description": "Download free barcode SVG sample vector graphics files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing barcode scanning, SVG conversion, and vector graphics processing tools.",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-barcode-svg" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-barcode-svg" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-3 mb-4 sm:mb-6">
              ...
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900">
                Barcode SVG Sample Files
              </h1>
            </div>
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free barcode SVG sample vector graphics files for testing. Multiple file sizes available to test your barcode scanning, SVG conversion, and vector graphics processing tools.
            </p>
          </div>
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-3 sm:space-y-0">
                    <div className="flex items-center space-x-4 flex-1">
                      <div className="p-2 rounded-lg bg-violet-100">
                        <Image className="w-5 h-5 sm:w-6 sm:h-6 text-violet-600" />
                      </div>
                      <div>
          ...
          <div className="mt-8 bg-violet-50 border border-violet-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test barcode SVG (Scalable Vector Graphics) files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing barcode scanning, SVG conversion, and vector graphics processing tools</li>

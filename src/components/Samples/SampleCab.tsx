...
export default function SampleCab() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-cab-100kb.cab', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-cab-1mb.cab', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-cab-5mb.cab', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-cab-50mb.cab', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-cab-100mb.cab', displaySize: '100 MB' }
  ];
  ...
  return (
    <>
      <Helmet>
        <title>Free CAB Sample Files Download - Test Windows Cabinet Files | MorphyHub</title>
        <meta name="description" content="Download free CAB sample Windows cabinet archive files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing archive extraction, compression, and CAB format processing tools." />
        <meta name="keywords" content="CAB sample files, test CAB files, download CAB samples, free CAB test files, Windows cabinet samples, archive samples, CAB compressed files, CAB conversion test files, .cab test files, Windows archive samples, installer archive samples" />
        <meta property="og:title" content="Free CAB Sample Files Download - Test Windows Cabinet Files | MorphyHub" />
        ...
        <meta name="twitter:title" content="Free CAB Sample Files Download - Test Windows Cabinet Files | MorphyHub" />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free CAB sample Windows cabinet archive files for testing. Multiple file sizes available to test your archive extraction, compression, and CAB format processing tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-orange-50 border border-orange-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test CAB (Windows Cabinet) archive files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing archive extraction, compression, and CAB format processing tools</li>

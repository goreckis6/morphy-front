...
export default function SampleIndd() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-indd-100kb.indd', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-indd-1mb.indd', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-indd-5mb.indd', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-indd-50mb.indd', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-indd-100mb.indd', displaySize: '100 MB' }
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">INDD Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free INDD sample Adobe InDesign document files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free INDD sample Adobe InDesign document files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing InDesign document conversion, INDD viewing, and desktop publishing tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About INDD Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                INDD (InDesign Document) is the native file format used by Adobe InDesign for desktop publishing. INDD files contain page layouts, text, images, and formatting information for creating print and digital publications.
              </p>
              <p className="text-gray-700 mb-4">
                These sample INDD files are provided for testing purposes. They can be used to test InDesign document conversion, INDD viewing tools, and desktop publishing applications.
              </p>
            </div>
          </div>
        </div>

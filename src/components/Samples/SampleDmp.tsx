...
export default function SampleDmp() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-dmp-100kb.dmp', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-dmp-1mb.dmp', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-dmp-5mb.dmp', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-dmp-50mb.dmp', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-dmp-100mb.dmp', displaySize: '100 MB' }
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-dmp" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-dmp" />
        <script

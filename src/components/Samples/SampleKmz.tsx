...
export default function SampleKmz() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-kmz-100kb.kmz', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-kmz-1mb.kmz', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-kmz-5mb.kmz', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-kmz-50mb.kmz', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-kmz-100mb.kmz', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "@type": "WebPage",
    "name": "Free KMZ Sample Files - Download Test Compressed Keyhole Markup Language Files",
    "url": "https://morphyimg.com/samples/sample-kmz",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-kmz" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-kmz" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">KMZ Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free KMZ sample compressed Keyhole Markup Language files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free KMZ sample compressed Keyhole Markup Language files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing KMZ extraction, geographic data processing, and Google Earth integration tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About KMZ Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                KMZ (Keyhole Markup Language Zipped) is a compressed archive format that contains KML files and associated resources. KMZ files are ZIP archives that can be opened directly in Google Earth and other geographic applications.
              </p>
              <p className="text-gray-700 mb-4">
                These sample KMZ files are provided for testing purposes. They can be used to test KMZ extraction, geographic data processing tools, and Google Earth integration applications.
              </p>
            </div>
          </div>
        </div>

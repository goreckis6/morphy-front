...
export default function SampleM4v() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-m4v-100kb.m4v', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-m4v-1mb.m4v', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-m4v-5mb.m4v', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-m4v-50mb.m4v', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-m4v-100mb.m4v', displaySize: '100 MB' }
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">M4V Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free M4V sample M4V video files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free M4V sample M4V video files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing M4V video conversion, M4V playback, and video processing tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About M4V Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                M4V (MPEG-4 Video) is a video container format developed by Apple. M4V files are similar to MP4 files but may include DRM protection and are commonly used for iTunes video content and Apple TV.
              </p>
              <p className="text-gray-700 mb-4">
                These sample M4V files are provided for testing purposes. They can be used to test M4V video conversion, M4V playback tools, and video processing applications.
              </p>
            </div>
          </div>
        </div>

...
export default function SampleEditorconfig() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-editorconfig-100kb.editorconfig', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-editorconfig-1mb.editorconfig', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-editorconfig-5mb.editorconfig', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-editorconfig-50mb.editorconfig', displaySize: '50 MB' },
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-editorconfig",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-editorconfig" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-editorconfig" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">EditorConfig Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free EditorConfig sample configuration files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free EditorConfig sample configuration files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing EditorConfig parsing and code formatting configuration tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About EditorConfig Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                EditorConfig is a file format and collection of text editor plugins for maintaining consistent coding styles between different editors and IDEs. The .editorconfig file defines coding style rules for a project.
              </p>
              <p className="text-gray-700 mb-4">
                These sample EditorConfig files are provided for testing purposes. They can be used to test EditorConfig parsing, code formatting tools, and configuration management applications.
              </p>
            </div>
          </div>
        </div>

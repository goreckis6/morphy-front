...
export default function SampleHex() {
  ...
  const pageJsonLd = {
    ...
    "url": "https://morphyimg.com/samples/sample-hex",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-hex" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-hex" />
        <script

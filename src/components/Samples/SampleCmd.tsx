...
export default function SampleCmd() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-cmd-100kb.cmd', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-cmd-1mb.cmd', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-cmd-5mb.cmd', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-cmd-50mb.cmd', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-cmd-100mb.cmd', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "@type": "WebPage",
    "name": "Free CMD Sample Files - Download Test Command Script Files",
    "url": "https://morphyimg.com/samples/sample-cmd",
    "description": "Download free CMD sample command script files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing command script execution, Windows automation, and command-line processing tools.",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-cmd" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-cmd" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free CMD sample command script files for testing. Multiple file sizes available to test your command script execution, Windows automation, and command-line processing tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-slate-50 border border-slate-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test CMD (Command) script files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing command script execution, Windows automation, and command-line processing tools</li>

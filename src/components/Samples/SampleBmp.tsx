...
export default function SampleBmp() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-bmp-100kb.bmp', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-bmp-1mb.bmp', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-bmp-5mb.bmp', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-bmp-50mb.bmp', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-bmp-100mb.bmp', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "@type": "WebPage",
    "name": "Free BMP Sample Files - Download Test Bitmap Image Files",
    "url": "https://morphyimg.com/samples/sample-bmp",
    "description": "Download free BMP sample bitmap image files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing bitmap image conversion, viewing, and BMP format processing tools.",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-bmp" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-bmp" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free BMP sample bitmap image files for testing. Multiple file sizes available to test your bitmap image conversion, viewing, and BMP format processing tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test BMP (Bitmap) image files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing bitmap image conversion, viewing, and BMP format processing tools</li>

...
export default function SampleJsx() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-jsx-100kb.jsx', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-jsx-1mb.jsx', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-jsx-5mb.jsx', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-jsx-50mb.jsx', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-jsx-100mb.jsx', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "@type": "WebPage",
    "name": "Free JSX Sample Files - Download Test React JSX Component Files",
    "url": "https://morphyimg.com/samples/sample-jsx",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-jsx" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-jsx" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">JSX Sample Files</h1>
                <p className="text-gray-600 mt-2">Download free JSX sample React JSX component files for testing</p>
              </div>
            </div>

            <p className="text-gray-700 mb-8">
              Download free JSX sample React JSX component files for testing. Multiple file sizes available: 100 KB, 1 MB, 5 MB, 50 MB, and 100 MB. Perfect for testing React component compilation, JSX syntax checking, and frontend development tools.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About JSX Files</h2>
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                JSX (JavaScript XML) is a syntax extension for JavaScript used in React to write component markup. JSX files combine HTML-like syntax with JavaScript, making it easier to build user interfaces in React applications.
              </p>
              <p className="text-gray-700 mb-4">
                These sample JSX files are provided for testing purposes. They can be used to test React component compilation, JSX syntax checking tools, and frontend development applications.
              </p>
            </div>
          </div>
        </div>

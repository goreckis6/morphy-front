...
export default function SampleAvif() {
  ...
  const sampleFiles: SampleFile[] = [
    { size: '100kb', filename: 'sample-avif-100kb.avif', displaySize: '100 KB' },
    { size: '1mb', filename: 'sample-avif-1mb.avif', displaySize: '1 MB' },
    { size: '5mb', filename: 'sample-avif-5mb.avif', displaySize: '5 MB' },
    { size: '50mb', filename: 'sample-avif-50mb.avif', displaySize: '50 MB' },
    { size: '100mb', filename: 'sample-avif-100mb.avif', displaySize: '100 MB' }
  ];
  ...
  const pageJsonLd = {
    ...
    "@type": "WebPage",
    "name": "Free AVIF Sample Files - Download Test Image Files",
    "url": "https://morphyimg.com/samples/sample-avif",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/samples/sample-avif" />
        ...
        <link rel="canonical" href="https://morphyimg.com/samples/sample-avif" />
        <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Download free AVIF sample image files for testing. Multiple file sizes available to test your AVIF conversion, viewing, and next-generation image format processing tools.
            </p>
          </div>
          ...
          <div className="mt-8 bg-emerald-50 border border-emerald-200 rounded-lg p-4 sm:p-6">
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              <li>• These are test AVIF (AV1 Image File Format) image files in various sizes for testing purposes</li>
              <li>• Files are hosted securely and available for free download</li>
              <li>• Perfect for testing AVIF conversion, viewing, and next-generation image format processing tools</li>

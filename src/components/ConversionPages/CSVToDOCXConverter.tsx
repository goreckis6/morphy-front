        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl text-blue-100 mb-6 max-w-2xl mx-auto">
              Convert CSV files to DOCX format for Microsoft Word documents. Transform tabular data into professional Word documents with tables and formatting.
            </p>
              ...
              {convertedFile && !batchMode && (
                <div className="mt-6 p-6 bg-green-50 border border-green-200 rounded-xl">
                  ...
                  <p className="text-green-700 mb-4">
                    Your CSV file has been successfully converted to DOCX format.
                  </p>
        ...
        <div className="mt-16 bg-white rounded-2xl shadow-xl p-8 sm:p-12">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-lg text-gray-700 mb-6 leading-relaxed">
              Converting CSV files to DOCX format is essential for business documents, professional reports, and Microsoft Word compatibility. While CSV files are excellent for data storage, DOCX format provides the perfect solution for creating professional documents that work seamlessly with Microsoft Word and other office productivity software.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div className="bg-blue-50 p-6 rounded-lg">
                <h4 className="text-xl font-semibold text-blue-900 mb-3">Microsoft Word Compatibility</h4>
                <p className="text-gray-700">
                  DOCX files can be opened directly in Microsoft Word and other office productivity software, ensuring perfect compatibility with business workflows.
                </p>
              </div>
              
              <div className="bg-cyan-50 p-6 rounded-lg">
                <h4 className="text-xl font-semibold text-cyan-900 mb-3">Professional Document Creation</h4>
                <p className="text-gray-700">
                  DOCX format enables the creation of professional documents with proper formatting, styles, and layout for business and academic use.
                </p>
              </div>
              
              <div className="bg-teal-50 p-6 rounded-lg">
                <h4 className="text-xl font-semibold text-teal-900 mb-3">Business Reporting</h4>
                <p className="text-gray-700">
                  DOCX format is perfect for business reporting, data analysis documents, and professional communication of insights and findings.
                </p>
              </div>
              
              <div className="bg-emerald-50 p-6 rounded-lg">
                <h4 className="text-xl font-semibold text-emerald-900 mb-3">Cross-Platform Support</h4>
                <p className="text-gray-700">
                  DOCX format works seamlessly across Windows, macOS, and mobile platforms, making it perfect for cross-platform document sharing and collaboration.
                </p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-blue-600 to-cyan-600 text-white p-8 rounded-xl text-center">
              ...
              <p className="text-lg mb-6 opacity-90">
                Use our free online CSV to DOCX converter to transform your tabular data into professional Word documents.
              </p>

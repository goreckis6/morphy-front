...
export const DOCXToMOBIConverter: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>DOCX to MOBI Converter - Convert Word to Kindle Format</title>
        <meta name="description" content="Convert DOCX files to MOBI format for Amazon Kindle. Transform Word documents into Kindle-compatible ebooks. Free online converter with metadata support." />
        <meta name="keywords" content="DOCX to MOBI, Word to Kindle, Kindle converter, ebook format, Amazon Kindle" />
      </Helmet>

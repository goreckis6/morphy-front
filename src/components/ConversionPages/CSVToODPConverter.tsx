...
export const CSVToODPConverter: React.FC = () => {
  ...
  const {
    ...
    handleBatchDownload,
    resetForm
  } = useCsvConversion({ targetFormat: 'odp' });
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="alternate" hrefLang="id" href={`${window.location.origin}/id/convert/csv-to-odp`} />
        <link rel="alternate" hrefLang="sv" href={`${window.location.origin}/sv/convert/csv-to-odp`} />
        <link rel="alternate" hrefLang="es" href={`${window.location.origin}/es/convert/csv-to-odp`} />
        <link rel="alternate" hrefLang="fr" href={`${window.location.origin}/fr/convert/csv-to-odp`} />
        <link rel="alternate" hrefLang="it" href={`${window.location.origin}/it/convert/csv-to-odp`} />
        <link rel="alternate" hrefLang="nl" href={`${window.location.origin}/nl/convert/csv-to-odp`} />
        <link rel="alternate" hrefLang="pt" href={`${window.location.origin}/pt/convert/csv-to-odp`} />
        <link rel="alternate" hrefLang="vi" href={`${window.location.origin}/vi/convert/csv-to-odp`} />
        <link rel="alternate" hrefLang="tr" href={`${window.location.origin}/tr/convert/csv-to-odp`} />
        <link rel="alternate" hrefLang="ru" href={`${window.location.origin}/ru/convert/csv-to-odp`} />
        <link rel="alternate" hrefLang="ar" href={`${window.location.origin}/ar/convert/csv-to-odp`} />
        <link rel="alternate" hrefLang="th" href={`${window.location.origin}/th/convert/csv-to-odp`} />
        <link rel="alternate" hrefLang="ja" href={`${window.location.origin}/ja/convert/csv-to-odp`} />
        <link rel="alternate" hrefLang="zh" href={`${window.location.origin}/zh/convert/csv-to-odp`} />
      </Helmet>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8">
              ...
              <div className="mt-8">
                <button
                  ...
                  className="w-full bg-gradient-to-r from-lime-600 to-green-600 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:from-lime-700 hover:to-green-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg hover:shadow-xl"
                >
                  {isConverting ? (
                ...
                <div className="mt-6 p-6 bg-green-50 border border-green-200 rounded-xl">
                  ...
                  <div className="space-y-3 max-h-60 overflow-y-auto mb-4">
                    {batchResults.map((result, index) => {
                      const displayName = result.outputFilename || result.filename || (result.originalName ? result.originalName.replace(/\.[^.]+$/, '.odp') : `file_${index + 1}.odp`);

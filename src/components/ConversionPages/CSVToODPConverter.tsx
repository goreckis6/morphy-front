...
export const CSVToODPConverter: React.FC = () => {
  ...
  const handleConvert = async (file: File): Promise<Blob> => {
    const odpContent = `Mock ODP content for ${file.name} - Headers: ${includeHeaders}, Charts: ${addCharts}`;
  ...
  const handleDownload = () => {
    if (convertedFile) {
      ...
      a.href = url;
      a.download = selectedFile ? selectedFile.name.replace('.csv', '.odp') : 'converted.odp';
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl text-violet-100 mb-6 max-w-2xl mx-auto">
              Convert CSV files to ODP format for open-source presentations. Transform tabular data into LibreOffice Impress presentations with charts and tables.
            </p>
        ...
        <div className="mt-16 bg-white rounded-2xl shadow-xl p-8 sm:p-12">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-lg text-gray-700 mb-6 leading-relaxed">
              Converting CSV files to ODP format is essential for open-source presentations, LibreOffice compatibility, and cross-platform document sharing. While CSV files are excellent for data storage, ODP format provides the perfect solution for creating presentations that work seamlessly with LibreOffice Impress and other open-source presentation software.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div className="bg-violet-50 p-6 rounded-lg">
                <h4 className="text-xl font-semibold text-violet-900 mb-3">Open-Source Format</h4>
                <p className="text-gray-700">
                  ODP is an open standard format that ensures your presentations are not locked into proprietary software, providing long-term accessibility and compatibility.
                </p>
              </div>
              
              <div className="bg-purple-50 p-6 rounded-lg">
                <h4 className="text-xl font-semibold text-purple-900 mb-3">LibreOffice Compatibility</h4>
                <p className="text-gray-700">
                  ODP files can be opened directly in LibreOffice Impress and other open-source presentation software, ensuring perfect compatibility with free software.
                </p>
              </div>
              
              <div className="bg-fuchsia-50 p-6 rounded-lg">
                <h4 className="text-xl font-semibold text-fuchsia-900 mb-3">Cross-Platform Support</h4>
                <p className="text-gray-700">
                  ODP format works seamlessly across Windows, macOS, and Linux, making it perfect for cross-platform document sharing and collaboration.
                </p>
              </div>
              ...
              <div className="bg-pink-50 p-6 rounded-lg">
                ...
                <p className="text-gray-700">
                  ODP format supports professional presentation features including charts, graphs, animations, and multimedia elements for engaging presentations.
                </p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-violet-600 to-purple-600 text-white p-8 rounded-xl text-center">
              ...
              <p className="text-lg mb-6 opacity-90">
                Use our free online CSV to ODP converter to transform your tabular data into open-source presentations.
              </p>

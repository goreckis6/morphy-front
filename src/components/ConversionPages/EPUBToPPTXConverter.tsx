        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">
              EPUB to PPTX Converter
            </h1>
            <p className="text-lg sm:text-xl text-purple-100 mb-6 max-w-2xl mx-auto">
              Convert EPUB e-book files to PowerPoint PPTX format for modern presentations. Transform e-books into advanced presentation slides with enhanced features.
            </p>
              ...
              {convertedFile && !batchMode && (
                <div className="mt-6 p-6 bg-green-50 border border-green-200 rounded-xl">
                  ...
                  <p className="text-green-700 mb-4">
                    Your EPUB file has been successfully converted to PPTX format.
                  </p>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white p-8 rounded-xl text-center">
              ...
              <p className="text-lg mb-6 opacity-90">
                Use our free online EPUB to PPTX converter to transform your e-books into modern, professional presentation slides.
              </p>

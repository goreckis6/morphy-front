  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="CSV to PPTX, data to PowerPoint, presentation converter, batch conversion, CSV converter, PPTX converter, PowerPoint converter, data visualization, business presentations" />
        ...
        <link rel="alternate" hrefLang="id" href={`${window.location.origin}/id/convert/csv-to-pptx`} />
        <link rel="alternate" hrefLang="sv" href={`${window.location.origin}/sv/convert/csv-to-pptx`} />
        <link rel="alternate" hrefLang="es" href={`${window.location.origin}/es/convert/csv-to-pptx`} />
        <link rel="alternate" hrefLang="fr" href={`${window.location.origin}/fr/convert/csv-to-pptx`} />
        <link rel="alternate" hrefLang="it" href={`${window.location.origin}/it/convert/csv-to-pptx`} />
        <link rel="alternate" hrefLang="nl" href={`${window.location.origin}/nl/convert/csv-to-pptx`} />
        <link rel="alternate" hrefLang="pt" href={`${window.location.origin}/pt/convert/csv-to-pptx`} />
        <link rel="alternate" hrefLang="vi" href={`${window.location.origin}/vi/convert/csv-to-pptx`} />
        <link rel="alternate" hrefLang="tr" href={`${window.location.origin}/tr/convert/csv-to-pptx`} />
        <link rel="alternate" hrefLang="ru" href={`${window.location.origin}/ru/convert/csv-to-pptx`} />
        <link rel="alternate" hrefLang="ar" href={`${window.location.origin}/ar/convert/csv-to-pptx`} />
        <link rel="alternate" hrefLang="th" href={`${window.location.origin}/th/convert/csv-to-pptx`} />
        <link rel="alternate" hrefLang="ja" href={`${window.location.origin}/ja/convert/csv-to-pptx`} />
        <link rel="alternate" hrefLang="zh" href={`${window.location.origin}/zh/convert/csv-to-pptx`} />
      </Helmet>

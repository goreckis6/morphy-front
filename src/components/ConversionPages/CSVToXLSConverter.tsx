        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl text-emerald-100 mb-6 max-w-2xl mx-auto">
              Convert CSV files to XLS format. Transform tabular data into Excel-compatible spreadsheets with formatting.
            </p>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8">
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-emerald-400 transition-colors">
                ...
                {batchMode && (
                  <p className="text-sm text-emerald-600 mb-4">{getBatchInfoMessage()}</p>
                )}
                <input
                  ref={fileInputRef}
                  type="file"
              ...
              {batchMode && batchFiles.length > 0 && (
                <div className="mt-6">
                  ...
                  {(() => {
                    ...
                    return (
                      <div className={`text-sm font-medium mb-2 ${sizeDisplay.isWarning ? 'text-emerald-700' : 'text-gray-600'}`}>{sizeDisplay.text}</div>
                    );
                  })()}

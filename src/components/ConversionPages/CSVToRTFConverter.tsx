        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl text-orange-100 mb-6 max-w-2xl mx-auto">
              Convert CSV files to RTF format. Transform tabular data into Rich Text Format documents with cross-platform compatibility.
            </p>
                ...
                <div className="mt-6">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    <div className="flex items-center justify-center h-32 bg-gray-100 rounded">
                      <FileType2 className="w-12 h-12 text-gray-400" />
                    </div>
                    ...
                    {batchResults.map((r, idx) => (
                      <div key={idx} className="flex items-center justify-between bg-white rounded-lg p-3 border border-green-100">
                        <div className="text-sm">
                          <div className="font-medium text-gray-900">{r.outputFilename || r.originalName.replace(/\.[^.]+$/, '.rtf')}</div>

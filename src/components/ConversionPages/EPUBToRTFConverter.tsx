  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href={`${window.location.origin}/convert/epub-to-rtf`} />
        <link rel="alternate" hrefLang="en" href={`${window.location.origin}/convert/epub-to-rtf`} />
        <link rel="alternate" hrefLang="pl" href={`${window.location.origin}/pl/convert/epub-to-rtf`} />
        <link rel="alternate" hrefLang="de" href={`${window.location.origin}/de/convert/epub-to-rtf`} />
        <link rel="alternate" hrefLang="id" href={`${window.location.origin}/id/convert/epub-to-rtf`} />
        <link rel="alternate" hrefLang="sv" href={`${window.location.origin}/sv/convert/epub-to-rtf`} />
        <link rel="alternate" hrefLang="es" href={`${window.location.origin}/es/convert/epub-to-rtf`} />
        <link rel="alternate" hrefLang="fr" href={`${window.location.origin}/fr/convert/epub-to-rtf`} />
        <link rel="alternate" hrefLang="it" href={`${window.location.origin}/it/convert/epub-to-rtf`} />
        <link rel="alternate" hrefLang="nl" href={`${window.location.origin}/nl/convert/epub-to-rtf`} />
        <link rel="alternate" hrefLang="pt" href={`${window.location.origin}/pt/convert/epub-to-rtf`} />
        <link rel="alternate" hrefLang="vi" href={`${window.location.origin}/vi/convert/epub-to-rtf`} />
        <link rel="alternate" hrefLang="tr" href={`${window.location.origin}/tr/convert/epub-to-rtf`} />
        <link rel="alternate" hrefLang="ru" href={`${window.location.origin}/ru/convert/epub-to-rtf`} />
        <link rel="alternate" hrefLang="ar" href={`${window.location.origin}/ar/convert/epub-to-rtf`} />
        <link rel="alternate" hrefLang="th" href={`${window.location.origin}/th/convert/epub-to-rtf`} />
        <link rel="alternate" hrefLang="ja" href={`${window.location.origin}/ja/convert/epub-to-rtf`} />
        <link rel="alternate" hrefLang="zh" href={`${window.location.origin}/zh/convert/epub-to-rtf`} />
      </Helmet>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">
              {t('epub_to_rtf.heading')}
            </h1>
            <p className="text-lg sm:text-xl text-sky-100 mb-6 max-w-2xl mx-auto">
              {t('epub_to_rtf.subtitle')}
            </p>
            <div className="flex flex-wrap justify-center gap-4 text-sm text-sky-200">
              <div className="flex items-center gap-2">
                <Zap className="w-4 h-4" />
                <span>{t('epub_to_rtf.badge_fast')}</span>
              </div>
              <div className="flex items-center gap-2">
                <Shield className="w-4 h-4" />
                <span>{t('epub_to_rtf.badge_secure')}</span>
              </div>
              <div className="flex items-center gap-2">
                <Clock className="w-4 h-4" />
                <span>{t('epub_to_rtf.badge_no_registration')}</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8">
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-sky-400 transition-colors">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">
                  {batchMode ? t('epub_to_rtf.upload_batch') : t('epub_to_rtf.upload_single')}
                </h3>
                <p className="text-gray-600 mb-4">
                  {batchMode 
                    ? t('epub_to_rtf.upload_text_batch') 
                    : t('epub_to_rtf.upload_text_single')
                  }
                </p>
                {!batchMode && (
                  <p className="text-sm text-blue-600 mb-4">
                    {t('epub_to_rtf.file_limits_single')}
                  </p>
                )}
                {batchMode && (
                  <p className="text-sm text-sky-600 mb-4">
                    {t('epub_to_rtf.file_limits_batch')}
                  </p>
                )}
                <input
                  ref={fileInputRef}
                          ...
                          <div className="mb-4 p-3 bg-orange-50 border border-orange-200 rounded-lg">
                            <div className="flex items-center">
                              ...
                              <span className="text-sm text-orange-700">
                                {t('epub_to_rtf.batch_size_warning', { count: batchFiles.length })}
                              </span>
                            </div>
                          </div>
                        )}
                ...
                >
                  {isConverting ? (
                    ...
                    <div className="flex items-center justify-center">
                      ...
                      {batchMode ? t('epub_to_rtf.convert_files', { count: batchFiles.length }) : t('epub_to_rtf.convert_to_rtf')}
                    </div>
                  )}
                </button>
              </div>
              ...
              {convertedFile && !batchMode && (
                <div className="mt-6 p-6 bg-green-50 border border-green-200 rounded-xl">
                  <div className="flex items-center mb-4">
                    ...
                    <h4 className="text-lg font-semibold text-green-800">{t('epub_to_rtf.conversion_complete')}</h4>
                  </div>
                  <p className="text-green-700 mb-4">
                    {t('epub_to_rtf.success_message')}
                  </p>
              ...
              {batchMode && batchConverted && batchResults.length > 0 && (
                <div className={`mt-6 p-6 rounded-xl border ${
                  ...
                  <p className={`mb-4 ${
                    ...
                    {t('epub_to_rtf.files_converted', { count: batchResults.filter(r => r.success).length })}
                  </p>
                          ...
                          <div className="text-sm flex-1 min-w-0">
                            ...
                            {!result.success && result.error && (
                              <div className="text-xs text-red-600 mt-1 ml-6 break-words">
                                {t('epub_to_rtf.failed_to_convert', { filename: result.originalName })}
                              </div>
                            )}
                          </div>
          ...
          <div className="space-y-6">
              ...
              <div className="mb-6">
                <label className="flex items-center">
                  <input
                    ...
                    className="rounded border-gray-300 text-sky-600 focus:ring-sky-500"
                  />
                  <span className="ml-2 text-sm text-gray-700">{t('epub_to_rtf.include_images')}</span>
                </label>
              </div>
              ...
              <div className="mb-6">
                <label className="flex items-center">
                  <input
                    ...
                    className="rounded border-gray-300 text-sky-600 focus:ring-sky-500"
                  />
                  <span className="ml-2 text-sm text-gray-700">{t('epub_to_rtf.extract_metadata')}</span>
                </label>
              </div>
              ...
              <div className="mb-6">
                <label className="flex items-center">
                  <input
                    ...
                    className="rounded border-gray-300 text-sky-600 focus:ring-sky-500"
                  />
                  <span className="ml-2 text-sm text-gray-700">{t('epub_to_rtf.universal_compatible')}</span>
                </label>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6">
              <h3 className="text-xl font-semibold mb-6 flex items-center">
                ...
                {t('epub_to_rtf.use_cases_title')}
              </h3>
              <div className="space-y-3">
                {[
                  t('epub_to_rtf.use_case_1'),
                  t('epub_to_rtf.use_case_2'),
                  t('epub_to_rtf.use_case_3'),
                  t('epub_to_rtf.use_case_4'),
                  t('epub_to_rtf.use_case_5'),
                  t('epub_to_rtf.use_case_6')
                ].map((useCase, index) => (
                  <div key={index} className="flex items-center">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              <div className="bg-purple-50 p-6 rounded-lg">
                ...
                <p className="text-gray-700">
                  {t('epub_to_rtf.benefit_4_text')}
                </p>
              </div>
            </div>

            <h3 className="text-2xl font-semibold text-gray-900 mb-4 mt-8">{t('epub_to_rtf.common_uses_title')}</h3>
            
            <div className="space-y-4 mb-8">
              <div className="flex items-start">
                <div className="w-2 h-2 bg-sky-500 rounded-full mt-3 mr-4 flex-shrink-0"></div>
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 mb-2">{t('epub_to_rtf.common_use_1_title')}</h4>
                  <p className="text-gray-700">{t('epub_to_rtf.common_use_1_text')}</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 mb-2">{t('epub_to_rtf.common_use_2_title')}</h4>
                  <p className="text-gray-700">{t('epub_to_rtf.common_use_2_text')}</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 mb-2">{t('epub_to_rtf.common_use_3_title')}</h4>
                  <p className="text-gray-700">{t('epub_to_rtf.common_use_3_text')}</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 mb-2">{t('epub_to_rtf.common_use_4_title')}</h4>
                  <p className="text-gray-700">{t('epub_to_rtf.common_use_4_text')}</p>
                </div>
              </div>
            </div>

            <div className="bg-gradient-to-r from-sky-600 to-blue-600 text-white p-8 rounded-xl text-center">
              <h3 className="text-2xl font-bold mb-4">{t('epub_to_rtf.cta_title')}</h3>
              <p className="text-lg mb-6 opacity-90">
                {t('epub_to_rtf.cta_text')}
              </p>

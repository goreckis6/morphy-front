  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://formipeek.com/compress/jpg" />
      </Helmet>
              ...
              {batchCompressed && batchMode && batchResults.length > 0 && (
                <div className="mt-6 p-4 sm:p-6 bg-green-50 border border-green-200 rounded-xl">
                  <div className="flex items-center mb-3 sm:mb-4">
                    ...
                    <h4 className="text-base sm:text-lg font-semibold text-green-800 break-words">{t('compress_jpg.batch_compression_complete')}</h4>
                  </div>

...
import { Image, Upload, Eye, ArrowLeft, Monitor, Palette, Zap, Info, Star, Sparkles, Layers, FileImage } from 'lucide-react';
...
import './translations/bmpViewerTranslations'; // Register translations
...
export const BMPViewer: React.FC = () => {
  ...
  const getBasePath = () => {
    ...
    if (path.includes('/viewers/bmp')) {
      return path.replace('/editor', '').replace(/\/viewers\/bmp.*/, '/viewers/bmp');
    }
    // Handle language prefixes
    const langMatch = path.match(/\/([a-z]{2})\/viewers\/bmp/);
    if (langMatch) {
      const [, lang] = langMatch;
      return `/${lang}/viewers/bmp`;
    }
  ...
  const handleFilesSelected = (files: File[]) => {
    ...
    setSelectedFiles((prev: File[]) => [...prev, ...bmpFiles]);
  };
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-cyan-50">
        ...
        <div className="relative overflow-hidden">
          {/* Animated Background */}
          <div className="absolute inset-0 bg-gradient-to-br from-blue-600 via-cyan-600 to-sky-700">
            <div 
          ...
          <div className="absolute -bottom-8 left-1/2 w-72 h-72 bg-sky-400 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-blob animation-delay-4000"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 relative z-10">
          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-6 sm:p-8 lg:p-10 mb-8 border border-white/50">
            ...
            <FileUpload 
              ...
              showTotalSize={true}
              translationKeys={{
                dragDropText: t('viewers.bmp.upload.drag_drop_text'),
                clickBrowseText: t('viewers.bmp.upload.click_browse_text'),
                chooseFilesButton: t('viewers.bmp.upload.choose_files_button'),
                maxFilesInfo: t('viewers.bmp.upload.max_files_info')
              }}
            />
          </div>

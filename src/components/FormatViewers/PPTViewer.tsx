...
export const PPTViewer: React.FC = () => {
  ...
  const handleViewPPT = async (file: File) => {
    ...
    try {
      ...
      const response = await fetch('https://morphy-2-n2tb.onrender.com/api/preview/ppt', {
        method: 'POST',
        body: formData,
      });
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl shadow-lg p-8 border border-blue-200 hover:shadow-xl transition-all transform hover:scale-105">
              <div className="bg-white p-3 rounded-xl w-fit mb-4">
                <FileSlides className="w-8 h-8 text-blue-600" />
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">
                Full Rendering
              </h3>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-gray-300 mb-6">
                Free professional PPT/PPTX viewer for all your PowerPoint presentation files.
              </p>
              
              <div className="flex items-center justify-center space-x-2 text-sm text-gray-300">
                <span>© 2025 MorphyIMG. Built for presenters worldwide.</span>
              </div>
            </div>
          </div>
        </footer>

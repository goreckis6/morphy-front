...
export const ODSViewer: React.FC = () => {
  ...
  const featuresRaw = t('viewers.ods.features', { returnObjects: true });
  const advantagesRaw = t('viewers.ods.advantages', { returnObjects: true });
  const useCasesRaw = t('viewers.ods.use_cases', { returnObjects: true });
  const specsRaw = t('viewers.ods.specs', { returnObjects: true });
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="flex flex-wrap justify-center gap-2 sm:gap-3">
                <div className="px-2.5 sm:px-3 py-1 sm:py-1.5 bg-white/20 backdrop-blur-md rounded-full border border-white/30 shadow-md">
                  <span className="text-white text-xs sm:text-sm font-semibold">{t('viewers.ods.quick_stats.open_standard', '✓ Open Standard')}</span>
                </div>
                <div className="px-2.5 sm:px-3 py-1 sm:py-1.5 bg-white/20 backdrop-blur-md rounded-full border border-white/30 shadow-md">
                  <span className="text-white text-xs sm:text-sm font-semibold">{t('viewers.ods.quick_stats.free_format', '🆓 Free Format')}</span>
                </div>
                <div className="px-2.5 sm:px-3 py-1 sm:py-1.5 bg-white/20 backdrop-blur-md rounded-full border border-white/30 shadow-md">
                  <span className="text-white text-xs sm:text-sm font-semibold">{t('viewers.ods.quick_stats.fast_processing', '⚡ Fast Processing')}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 relative z-10">
          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-6 sm:p-8 lg:p-10 mb-8 border border-white/50">
            ...
            <FileUpload 
              ...
              showTotalSize={true}
              translationKeys={{
                dragDropText: t('viewers.ods.upload.drag_drop_text', 'Drag & Drop Your Files Here'),
                clickBrowseText: t('viewers.ods.upload.click_browse_text', 'or click the button below to browse'),
                chooseFilesButton: t('viewers.ods.upload.choose_files_button', 'Choose Files'),
                maxFilesInfo: t('viewers.ods.upload.max_files_info', 'Max {maxFiles} files • Up to {maxSize} Total')
              }}
            />
            {validationError && (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {features.map((feature, index) => {
              ...
              const iconNodes = [
                ...
                <BarChart3 className="w-8 h-8 text-white" key="chart" />,
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-100">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-xl font-bold text-gray-900">{t('viewers.ods.advantages_title')}</h3>
                  </div>
                ...
                <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-6 border border-emerald-100">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-xl font-bold text-gray-900">{t('viewers.ods.use_cases_title')}</h3>
                  </div>
                  <ul className="space-y-3">
              ...
              <table className="min-w-full">
                <thead>
                  <tr className="bg-gradient-to-r from-gray-50 to-gray-100">
                    <th className="px-6 py-4 text-left text-sm font-bold text-gray-700 uppercase tracking-wider">{t('viewers.ods.specs_header_label')}</th>
                    <th className="px-6 py-4 text-left text-sm font-bold text-gray-700 uppercase tracking-wider">{t('viewers.ods.specs_header_value')}</th>
                  </tr>
                </thead>
          ...
          <div className="bg-gradient-to-br from-white via-green-50/50 to-emerald-50/50 backdrop-blur-xl rounded-3xl shadow-2xl p-6 sm:p-8 lg:p-10 mb-8 border border-green-100">
            <div className="flex items-center gap-4 mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900">
                {t('viewers.ods.seo_title', 'Why Choose Our ODS Viewer?')}
              </h2>
            </div>
            
            <div className="prose max-w-none text-gray-700">
              <p className="text-base sm:text-lg mb-6 leading-relaxed">
                {t('viewers.ods.seo_intro', 'Our ODS viewer provides a seamless experience for viewing and managing OpenDocument Spreadsheet files directly in your browser.')}
              </p>
              ...
              <div className="space-y-6">
                <div className="bg-white/60 rounded-xl p-6 border border-green-100">
                  <h3 className="text-lg font-bold text-gray-900 mb-3 flex items-center gap-2">
                    ...
                    {t('viewers.ods.seo_viewing_title', 'Professional Spreadsheet Viewing')}
                  </h3>
                  <p className="text-gray-700 leading-relaxed">
                    {t('viewers.ods.seo_viewing_text', 'View ODS spreadsheets with high-quality rendering, table formatting, and open standard compatibility.')}
                  </p>
                </div>
                ...
                <div className="bg-white/60 rounded-xl p-6 border border-green-100">
                  <h3 className="text-lg font-bold text-gray-900 mb-3 flex items-center gap-2">
                    ...
                    {t('viewers.ods.seo_features_title', 'Advanced Features')}
                  </h3>
                  <p className="text-gray-700 leading-relaxed">
                    {t('viewers.ods.seo_features_text', 'Access powerful ODS viewing features including table formatting, data visualization, and open standard support.')}
                  </p>
                </div>
                ...
                <div className="bg-white/60 rounded-xl p-6 border border-green-100">
                  <h3 className="text-lg font-bold text-gray-900 mb-3 flex items-center gap-2">
                    ...
                    {t('viewers.ods.seo_security_title', 'Secure & Private')}
                  </h3>
                  <p className="text-gray-700 leading-relaxed">
                    {t('viewers.ods.seo_security_text', 'Your ODS files are processed securely and never stored on our servers.')}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="text-center mb-12">
            ...
            >
              ...
              <span>{t('viewers.ods.buttons.back', 'Back to All Viewers').replace(/^←\s*/, '')}</span>
            </a>
          </div>
        </div>

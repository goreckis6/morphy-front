          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-lg text-gray-600 mt-2">
                Upload and preview PDF documents online
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {selectedFiles.length > 0 && (
          <div className="bg-white rounded-xl shadow-lg p-8">
            <h2 className="text-2xl font-bold text-gray-800 mb-6">
              Preview PDF Files ({selectedFiles.length})
            </h2>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex space-x-2">
                      <button
                        ...
                        className="bg-red-600 hover:bg-red-700 text-white text-sm font-medium py-2 px-4 rounded-lg transition-colors flex items-center space-x-2"
                      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-gray-300 mb-6">
              Professional PDF viewer and converter for all your document processing needs.
            </p>

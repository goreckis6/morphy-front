...
export const ORFViewer: React.FC = () => {
  ...
  const handleViewORF = async (file: File) => {
    ...
    try {
      ...
      const response = await fetch('https://morphy-2-n2tb.onrender.com/api/preview/orf', {
        method: 'POST',
        body: formData,
      });
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        {/* Hero Section */}
        <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-700">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-gray-300 mb-6">
                Free professional ORF viewer for all your Olympus and OM System RAW files.
              </p>
              
              <div className="flex items-center justify-center space-x-2 text-sm text-gray-300">
                <span>© 2025 MorphyIMG. Built for Olympus photographers.</span>
              </div>
            </div>
          </div>
        </footer>

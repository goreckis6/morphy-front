    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">
                ORF Viewer & Converter
              </h1>
              <p className="text-lg text-gray-600 mt-2">
                Upload, view, and convert Olympus RAW (ORF) image files
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {selectedFiles.length > 0 && (
          <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
            <h2 className="text-2xl font-bold text-gray-800 mb-6">
              Preview Olympus RAW Files ({selectedFiles.length})
            </h2>
              ...
              {selectedFiles.map((file, index) => (
                <div key={index} className="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-shadow">
                  ...
                  <div className="text-sm text-gray-500 mb-4">
                    {(file.size / 1024 / 1024).toFixed(2)} MB • Olympus RAW
                  </div>
                  <div className="flex space-x-2">
                    <button
                      onClick={() => setViewerFile(file)}
                      className="flex-1 bg-cyan-600 hover:bg-cyan-700 text-white text-sm font-medium py-3 px-4 rounded-lg transition-colors flex items-center justify-center space-x-2"
                    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <p className="text-gray-600">
              Professional RAW format from Olympus Micro Four Thirds cameras
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <p className="text-gray-600">
              Advanced in-body image stabilization data preserved in RAW files
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <p className="text-gray-600">
              Access to Olympus's creative art filters and color modes
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          ...
          <div className="text-center mt-6">
            <a
              href="/"
              className="bg-cyan-600 hover:bg-cyan-700 text-white font-bold py-3 px-8 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
              Back to Home
            </a>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-gray-300 mb-6">
              Professional ORF viewer and converter for all your Olympus RAW processing needs.
            </p>
            
            <div className="flex items-center justify-center space-x-2 text-sm text-gray-300">
              <span>© 2025 MorphyIMG. Built for Olympus professionals.</span>
            </div>
          </div>
        </div>
      </footer>

...
import { Image, Upload, Eye, Download, Share2, ArrowLeft, Zap, Globe, Palette } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-lg text-gray-600 mt-2">
                Upload, view, and convert WebP images with superior compression
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {selectedFiles.length > 0 && (
          <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
            <h2 className="text-2xl font-bold text-gray-800 mb-6">
              Preview WebP Files ({selectedFiles.length})
            </h2>
            ...
            <table className="min-w-full">
              ...
              <tbody className="divide-y divide-gray-200">
                ...
                <tr>
                  ...
                  <td className="px-6 py-4 text-sm text-gray-600">16,383 × 16,383 pixels</td>
                </tr>
                <tr>

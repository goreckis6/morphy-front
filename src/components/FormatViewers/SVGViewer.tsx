        ...
        <div className="relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-base sm:text-lg lg:text-xl text-indigo-100 mb-4 sm:mb-5 px-4 max-w-2xl">
              ...
              <div className="flex flex-wrap justify-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                <div className="bg-white/10 backdrop-blur-sm rounded-full px-3 sm:px-4 py-1.5 sm:py-2 border border-white/20">
                  <span className="text-sm sm:text-base text-white font-medium">
                    {t('viewers.svg.quick_stats.vector_graphics')}
                  </span>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-full px-3 sm:px-4 py-1.5 sm:py-2 border border-white/20">
                  <span className="text-sm sm:text-base text-white font-medium">
                    {t('viewers.svg.quick_stats.scalable')}
                  </span>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-full px-3 sm:px-4 py-1.5 sm:py-2 border border-white/20">
                  <span className="text-sm sm:text-base text-white font-medium">
                    {t('viewers.svg.quick_stats.fast_processing')}
                  </span>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          {selectedFiles.length > 0 && (
            <div className="mb-8 text-center">
              <button
                ...
                className="inline-flex items-center gap-3 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-bold py-4 px-8 sm:px-10 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-xl text-lg sm:text-xl"
              >
                <Eye className="w-6 h-6" />
                <span>{t('viewers.svg.buttons.view_files')}</span>
              </button>
            </div>
          )}
                ...
                <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl p-6 border border-indigo-100">
                  ...
                  <ul className="space-y-3">
                    {advantages.map((advantage, idx) => (
                      <li key={idx} className="text-gray-700 leading-relaxed" dangerouslySetInnerHTML={{ __html: `<span class="text-indigo-600 font-bold mr-2">•</span>${advantage}` }} />
                    ))}
                  </ul>
                </div>
              ...
              <table className="min-w-full bg-white/50 backdrop-blur-sm rounded-2xl overflow-hidden border border-gray-200">
                <thead>
                  <tr className="bg-gradient-to-r from-indigo-500 to-purple-600">
                    <th className="px-6 py-4 text-left text-sm font-bold text-white">{t('viewers.svg.specs_header_label')}</th>
                    <th className="px-6 py-4 text-left text-sm font-bold text-white">{t('viewers.svg.specs_header_value')}</th>
                  </tr>
                </thead>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mb-8">
            <div className="bg-white/80 backdrop-blur-xl rounded-2xl p-6 border border-white/50 shadow-lg">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">{t('viewers.svg.seo_viewing_title')}</h3>
              <p className="text-gray-600 leading-relaxed">{t('viewers.svg.seo_viewing_text')}</p>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-2xl p-6 border border-white/50 shadow-lg">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">{t('viewers.svg.seo_conversion_title')}</h3>
              <p className="text-gray-600 leading-relaxed">{t('viewers.svg.seo_conversion_text')}</p>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-2xl p-6 border border-white/50 shadow-lg">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">{t('viewers.svg.seo_optimization_title')}</h3>
              <p className="text-gray-600 leading-relaxed">{t('viewers.svg.seo_optimization_text')}</p>
            </div>
          </div>
          ...
          <div className="text-center mb-8">
            <button
              onClick={() => window.location.href = '/viewers'}
              className="inline-flex items-center gap-2 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-bold py-4 px-8 sm:px-10 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
              <ArrowLeft className="w-5 h-5" />
              <span>{t('viewers.svg.buttons.back', 'Back to All Viewers').replace(/^←\s*/, '')}</span>
            </button>
          </div>
        </div>

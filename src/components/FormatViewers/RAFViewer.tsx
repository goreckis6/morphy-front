...
export const RAFViewer: React.FC = () => {
  ...
  const handleViewRAF = async (file: File) => {
    ...
    try {
      ...
      const response = await fetch('https://morphy-2-n2tb.onrender.com/api/preview/raf', {
        method: 'POST',
        body: formData,
      });
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://morphyimg.com/viewers/raf" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "url": "https://morphyimg.com/viewers/raf",
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-gray-300 mb-6">
                Free professional RAF viewer for all your Fujifilm X-Trans RAW files.
              </p>
              
              <div className="flex items-center justify-center space-x-2 text-sm text-gray-300">
                <span>© 2025 MorphyIMG. Built for Fujifilm photographers.</span>
              </div>
            </div>
          </div>
        </footer>

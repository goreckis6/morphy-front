...
export const JSViewer: React.FC = () => {
  ...
  const features = t('viewers.js.features', { returnObjects: true }) as Array<{ title: string; description: string }>;
  const advantages = t('viewers.js.advantages', { returnObjects: true }) as string[];
  const useCases = t('viewers.js.use_cases', { returnObjects: true }) as string[];
  const specs = t('viewers.js.specs', { returnObjects: true }) as Array<{ label: string; value: string }>;
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border border-gray-200">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center space-x-3">
                  ...
                  <h2 className="text-3xl font-bold text-gray-900">
                    {t('viewers.js.files_heading', { count: selectedFiles.length })}
                  </h2>
                </div>
              </div>
              ...
              <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <div className="flex items-start space-x-3">
                  <Info className="w-5 h-5 text-blue-600 mt-0.5" />
                        <div>
                    <h4 className="font-semibold text-blue-900 mb-1">{t('viewers.js.how_to_title')}</h4>
                    <p className="text-sm text-blue-700" dangerouslySetInnerHTML={{ __html: t('viewers.js.how_to_description') }} />
                        </div>
                </div>
              </div>
                  ...
                  <div key={index} className="bg-gradient-to-br from-gray-50 to-yellow-50 rounded-xl p-4 hover:shadow-lg transition-all transform hover:scale-105 border border-gray-200">
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        <span>{t('viewers.js.buttons.view')}</span>
                      </button>
                      <button
                      ...
                      >
                        ...
                        <span>{t('viewers.js.buttons.download')}</span>
                      </button>
                    </div>
                  </div>
                ))}
        ...
        {/* Features Section */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {features.map((feature, index) => {
              ...
              const icons = [
                <Code className="w-8 h-8 text-yellow-600" key="code" />,
                <Terminal className="w-8 h-8 text-green-600" key="terminal" />,
                <Zap className="w-8 h-8 text-blue-600" key="zap" />
              ];
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border border-gray-200">
            ...
            <div className="prose max-w-none text-gray-600">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-6">
                <div>
                  <h3 className="text-lg font-semibold text-gray-800 mb-4">{t('viewers.js.advantages_title')}</h3>
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-800 mb-4">{t('viewers.js.use_cases_title')}</h3>
                  <ul className="space-y-2 text-sm">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-gray-800 mb-4">{t('viewers.js.specs_title')}</h3>
          <div className="overflow-x-auto">
                  <table className="min-w-full">
                    <thead>
                      <tr className="bg-gray-100">
                        <th className="px-4 py-2 text-left text-sm font-semibold text-gray-700">{t('viewers.js.specs_header_label')}</th>
                        <th className="px-4 py-2 text-left text-sm font-semibold text-gray-700">{t('viewers.js.specs_header_value')}</th>
                      </tr>
                    </thead>

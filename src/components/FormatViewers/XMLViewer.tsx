...
export const XMLViewer: React.FC = () => {
  ...
  const handleViewXML = async (file: File) => {
    ...
    try {
      ...
      const response = await fetch('https://api.formipeek.com/api/preview/xml', {
        method: 'POST',
        body: formData,
      });
  ...
  return (
    <>
      <Helmet>
        <title>Free XML Viewer - View & Validate XML Files Online | FormiPeek</title>
        ...
        <meta property="og:title" content="Free XML Viewer - View & Validate XML Files Online | FormiPeek" />
        ...
        <meta name="twitter:title" content="Free XML Viewer - View & Validate XML Files Online | FormiPeek" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "url": "https://formipeek.com/viewers/xml",

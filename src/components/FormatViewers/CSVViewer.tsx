...
export const CSVViewer: React.FC = () => {
  ...
  const handleViewCSV = async (file: File) => {
    try {
      ...
      const response = await fetch('https://morphy-2-n2tb.onrender.com/api/preview/csv', {
        method: 'POST',
        body: formData,
      });
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-gray-300 mb-6">
                Free professional CSV viewer for all your data viewing needs.
              </p>
              
              <div className="flex items-center justify-center space-x-2 text-sm text-gray-300">
                <span>© 2025 MorphyIMG. Built for data professionals.</span>
              </div>
            </div>
          </div>
        </footer>

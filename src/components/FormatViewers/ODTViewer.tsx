...
export function ODTViewer() {
  ...
  const handleFileView = async (file: UploadedFile) => {
    ...
    // For ODT files, we'll show a placeholder since actual ODT parsing requires specialized libraries
    setFileContent(`ODT Document: ${file.name}

This is a preview of your OpenDocument Text file. 
ODT files contain rich text formatting, images, and complex document structures.
...
To view the full content with proper formatting, please use a compatible application like LibreOffice Writer, OpenOffice Writer, or Google Docs.`);
  };
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-gray-900">ODT Viewer</h1>
                  <p className="text-sm text-gray-600">OpenDocument Text Format</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-sm border p-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">Upload ODT Files</h2>
              ...
              >
                ...
                <p className="text-lg font-medium text-gray-700 mb-2">
                  {isDragActive ? 'Drop ODT files here' : 'Upload ODT Documents'}
                </p>
                <p className="text-gray-500">
                  Drag & drop ODT files here, or click to browse
                </p>
            ...
            <div className="bg-white rounded-xl shadow-sm border p-6">
              ...
              {selectedFile ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500">
                    Upload and select an ODT file to preview its content
                  </p>
                </div>
              )}
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-gray-300 mb-6">
              Professional ODT viewer and converter for all your document processing needs.
            </p>

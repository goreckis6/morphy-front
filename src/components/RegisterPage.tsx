...
import { UserPlus, Mail, Lock, User, RefreshCw, AlertCircle, CheckCircle } from 'lucide-react';
...
export const RegisterPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative bg-gradient-to-br from-blue-600 to-teal-600 py-16 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl">
            Get Started for Free
          </h1>
          <p className="mt-4 max-w-3xl mx-auto text-xl text-blue-100">
            Create your account and enjoy unlimited file conversions
          </p>
        </div>
      </div>
      ...
      <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">Join thousands of users converting files for free</p>
          </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <ul className="mt-2 text-sm text-blue-700 space-y-1">
                    ...
                    <li>• Access to 50+ file formats</li>
                    <li>• Conversion history & statistics</li>
